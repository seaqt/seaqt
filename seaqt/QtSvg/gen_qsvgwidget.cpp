...
bool miqt_exec_callback_QSvgWidget_nativeEvent(QSvgWidget*, intptr_t, struct seaqt_string, void*, long*);
...
public:
	...
	friend bool QSvgWidget_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, long* result);
...
bool QSvgWidget_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, long* result) {
	QByteArray eventType_QByteArray(eventType.data, eventType.len);
	return static_cast<VirtualQSvgWidget*>(self)->QSvgWidget::nativeEvent(eventType_QByteArray, message, static_cast<long*>(result));
}
