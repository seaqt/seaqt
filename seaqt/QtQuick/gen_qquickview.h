...
struct QQuickView_VTable {
	...
	void (*closeEvent)(struct QQuickView_VTable* vtbl, QQuickView* self, QCloseEvent* param1);
	...
	void (*paintEvent)(struct QQuickView_VTable* vtbl, QQuickView* self, QPaintEvent* param1);
	...
	bool (*nativeEvent)(struct QQuickView_VTable* vtbl, QQuickView* self, struct miqt_string eventType, void* message, intptr_t* result);
