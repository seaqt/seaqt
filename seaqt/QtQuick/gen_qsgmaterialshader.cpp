...
QMatrix4x4* QSGMaterialShader__RenderState_combinedMatrix_index(const QSGMaterialShader__RenderState* self, ptrdiff_t index) {
...
QMatrix4x4* QSGMaterialShader__RenderState_projectionMatrix_index(const QSGMaterialShader__RenderState* self, ptrdiff_t index) {
...
ptrdiff_t QSGMaterialShader__RenderState_projectionMatrixCount(const QSGMaterialShader__RenderState* self) {
	qsizetype _ret = self->projectionMatrixCount();
...
int QSGMaterialShader__GraphicsPipelineState_opColor(const QSGMaterialShader__GraphicsPipelineState* self) {
	QSGMaterialShader::GraphicsPipelineState::BlendOp opColor_ret = self->opColor;
	return static_cast<int>(opColor_ret);
}
...
int QSGMaterialShader__GraphicsPipelineState_opAlpha(const QSGMaterialShader__GraphicsPipelineState* self) {
	QSGMaterialShader::GraphicsPipelineState::BlendOp opAlpha_ret = self->opAlpha;
	return static_cast<int>(opAlpha_ret);
}
