...
void QQuickItem_connect_paletteChanged(QQuickItem* self, intptr_t slot) {
	VirtualQQuickItem::connect(self, static_cast<void (QQuickItem::*)()>(&QQuickItem::paletteChanged), self, [=]() {
...
void QQuickItem_connect_paletteCreated(QQuickItem* self, intptr_t slot) {
	VirtualQQuickItem::connect(self, static_cast<void (QQuickItem::*)()>(&QQuickItem::paletteCreated), self, [=]() {
...
void QQuickItem_virtualbase_geometryChange(void* self, QRectF* newGeometry, QRectF* oldGeometry) {
	...
	( (VirtualQQuickItem*)(self) )->QQuickItem::geometryChange(*newGeometry, *oldGeometry);
