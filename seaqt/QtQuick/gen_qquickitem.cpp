...
struct seaqt_string QQuickItem_trUtf82(const char* s, const char* c) {
...
struct seaqt_string QQuickItem_trUtf83(const char* s, const char* c, int n) {
...
void QQuickItem_virtualbase_windowDeactivateEvent(void* self) {
	static_cast<VirtualQQuickItem*>(self)->QQuickItem::windowDeactivateEvent();
}
...
void QQuickItem_virtualbase_geometryChanged(void* self, QRectF* newGeometry, QRectF* oldGeometry) {
	static_cast<VirtualQQuickItem*>(self)->QQuickItem::geometryChanged(*newGeometry, *oldGeometry);
}
