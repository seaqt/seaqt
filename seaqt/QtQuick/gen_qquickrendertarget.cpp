...
QQuickRenderTarget* QQuickRenderTarget_fromOpenGLTexture_textureId_format_pixelSize_sampleCount_arraySize_flags(unsigned int textureId, unsigned int format, QSize* pixelSize, int sampleCount, int arraySize, int flags) {
