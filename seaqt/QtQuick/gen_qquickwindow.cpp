...
bool miqt_exec_callback_QQuickWindow_nativeEvent(QQuickWindow*, intptr_t, struct seaqt_string, void*, long*);
...
public:
	...
	friend bool QQuickWindow_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, long* result);
...
bool QQuickWindow_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, long* result) {
	QByteArray eventType_QByteArray(eventType.data, eventType.len);
	return static_cast<VirtualQQuickWindow*>(self)->QQuickWindow::nativeEvent(eventType_QByteArray, message, static_cast<long*>(result));
}
