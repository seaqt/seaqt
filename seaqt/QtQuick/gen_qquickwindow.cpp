...
public:
	...
	friend void* QQuickWindow_protectedbase_resolveInterface(const void* self, const char* name, int revision);
...
void QQuickWindow_connect_paletteChanged(QQuickWindow* self, intptr_t slot, void (*callback)(intptr_t), void (*release)(intptr_t)) {
	...
	VirtualQQuickWindow::connect(self, static_cast<void (QQuickWindow::*)()>(&QQuickWindow::paletteChanged), self, local_caller{slot, callback, release});
}
...
void QQuickWindow_connect_paletteCreated(QQuickWindow* self, intptr_t slot, void (*callback)(intptr_t), void (*release)(intptr_t)) {
	...
	VirtualQQuickWindow::connect(self, static_cast<void (QQuickWindow::*)()>(&QQuickWindow::paletteCreated), self, local_caller{slot, callback, release});
}
...
void QQuickWindow_connect_beforeFrameBegin(QQuickWindow* self, intptr_t slot, void (*callback)(intptr_t), void (*release)(intptr_t)) {
	...
	VirtualQQuickWindow::connect(self, static_cast<void (QQuickWindow::*)()>(&QQuickWindow::beforeFrameBegin), self, local_caller{slot, callback, release});
}
...
void QQuickWindow_connect_afterFrameEnd(QQuickWindow* self, intptr_t slot, void (*callback)(intptr_t), void (*release)(intptr_t)) {
	...
	VirtualQQuickWindow::connect(self, static_cast<void (QQuickWindow::*)()>(&QQuickWindow::afterFrameEnd), self, local_caller{slot, callback, release});
}
...
void* QQuickWindow_protectedbase_resolveInterface(const void* self, const char* name, int revision) {
