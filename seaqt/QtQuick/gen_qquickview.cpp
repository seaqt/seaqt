...
public:
	...
	VirtualQQuickView(const QQuickView_VTable* vtbl, QAnyStringView uri, QAnyStringView typeName): QQuickView(uri, typeName), vtbl(vtbl) {}
	...
	VirtualQQuickView(const QQuickView_VTable* vtbl, QAnyStringView uri, QAnyStringView typeName, QWindow* parent): QQuickView(uri, typeName, parent), vtbl(vtbl) {}
...
VirtualQQuickView* QQuickView_new_uri_typeName(const QQuickView_VTable* vtbl, size_t vdata, struct seaqt_string uri, struct seaqt_string typeName) {
	...
	void* _mem_ = ::operator new(seaqt_aligned_sizeof<VirtualQQuickView>() + vdata, std::nothrow);
	return _mem_ ? new (_mem_)VirtualQQuickView(vtbl, uri_QString, typeName_QString) : nullptr;
}
...
VirtualQQuickView* QQuickView_new_uri_typeName_parent(const QQuickView_VTable* vtbl, size_t vdata, struct seaqt_string uri, struct seaqt_string typeName, QWindow* parent) {
	QAnyStringView uri_QString = QAnyStringView(uri.data, uri.len);
	QAnyStringView typeName_QString = QAnyStringView(typeName.data, typeName.len);
	void* _mem_ = ::operator new(seaqt_aligned_sizeof<VirtualQQuickView>() + vdata, std::nothrow);
	return _mem_ ? new (_mem_)VirtualQQuickView(vtbl, uri_QString, typeName_QString, parent) : nullptr;
}
...
void QQuickView_loadFromModule(QQuickView* self, struct seaqt_string uri, struct seaqt_string typeName) {
	QAnyStringView uri_QString = QAnyStringView(uri.data, uri.len);
	QAnyStringView typeName_QString = QAnyStringView(typeName.data, typeName.len);
...
void* QQuickView_protectedbase_resolveInterface(const VirtualQQuickView* self, const char* name, int revision) {
	return self->QQuickView::resolveInterface(name, static_cast<int>(revision));
}
