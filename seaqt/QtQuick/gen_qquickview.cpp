...
bool miqt_exec_callback_QQuickView_nativeEvent(QQuickView*, intptr_t, struct seaqt_string, void*, long*);
...
public:
	...
	friend bool QQuickView_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, long* result);
...
bool QQuickView_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, long* result) {
	QByteArray eventType_QByteArray(eventType.data, eventType.len);
	return static_cast<VirtualQQuickView*>(self)->QQuickView::nativeEvent(eventType_QByteArray, message, static_cast<long*>(result));
}
