...
QQuickRenderControl* QQuickRenderControl_new() {
	return new (std::nothrow) VirtualQQuickRenderControl();
}

QQuickRenderControl* QQuickRenderControl_new2(QObject* parent) {
	return new (std::nothrow) VirtualQQuickRenderControl(parent);
}
...
QMetaObject* QQuickRenderControl_virtualbase_metaObject(const void* self) {
	return (QMetaObject*) static_cast<const VirtualQQuickRenderControl*>(self)->QQuickRenderControl::metaObject();
}
...
void* QQuickRenderControl_virtualbase_metacast(void* self, const char* param1) {
	return static_cast<VirtualQQuickRenderControl*>(self)->QQuickRenderControl::qt_metacast(param1);
}
...
int QQuickRenderControl_virtualbase_metacall(void* self, int param1, int param2, void** param3) {
	return static_cast<VirtualQQuickRenderControl*>(self)->QQuickRenderControl::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
}
...
QWindow* QQuickRenderControl_virtualbase_renderWindow(void* self, QPoint* offset) {
	return static_cast<VirtualQQuickRenderControl*>(self)->QQuickRenderControl::renderWindow(offset);
}
...
bool QQuickRenderControl_virtualbase_event(void* self, QEvent* event) {
	return static_cast<VirtualQQuickRenderControl*>(self)->QQuickRenderControl::event(event);
}
...
bool QQuickRenderControl_virtualbase_eventFilter(void* self, QObject* watched, QEvent* event) {
	return static_cast<VirtualQQuickRenderControl*>(self)->QQuickRenderControl::eventFilter(watched, event);
}
...
void QQuickRenderControl_virtualbase_timerEvent(void* self, QTimerEvent* event) {
	static_cast<VirtualQQuickRenderControl*>(self)->QQuickRenderControl::timerEvent(event);
}
...
void QQuickRenderControl_virtualbase_childEvent(void* self, QChildEvent* event) {
	static_cast<VirtualQQuickRenderControl*>(self)->QQuickRenderControl::childEvent(event);
}
...
void QQuickRenderControl_virtualbase_customEvent(void* self, QEvent* event) {
	static_cast<VirtualQQuickRenderControl*>(self)->QQuickRenderControl::customEvent(event);
}
...
void QQuickRenderControl_virtualbase_connectNotify(void* self, QMetaMethod* signal) {
	static_cast<VirtualQQuickRenderControl*>(self)->QQuickRenderControl::connectNotify(*signal);
}
...
void QQuickRenderControl_virtualbase_disconnectNotify(void* self, QMetaMethod* signal) {
	static_cast<VirtualQQuickRenderControl*>(self)->QQuickRenderControl::disconnectNotify(*signal);
}
