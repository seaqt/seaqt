...
struct QQuickItem_VTable {
	...
	void (*windowDeactivateEvent)(struct QQuickItem_VTable* vtbl, QQuickItem* self);
	void (*geometryChanged)(struct QQuickItem_VTable* vtbl, QQuickItem* self, QRectF* newGeometry, QRectF* oldGeometry);
