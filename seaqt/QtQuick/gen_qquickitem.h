...
typedef struct QQuickItem_VTable{
	...
	void (*windowDeactivateEvent)(VirtualQQuickItem* self);
	void (*geometryChanged)(VirtualQQuickItem* self, QRectF* newGeometry, QRectF* oldGeometry);
...
void QQuickItem_windowDeactivateEvent(QQuickItem* self);
void QQuickItem_geometryChanged(QQuickItem* self, QRectF* newGeometry, QRectF* oldGeometry);
