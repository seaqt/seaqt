...
typedef struct QSGTexture_VTable{
	...
	long long (*comparisonKey)(const VirtualQSGTexture* self);
...
long long QSGTexture_virtualbase_comparisonKey(const VirtualQSGTexture* self);
...
typedef struct QSGDynamicTexture_VTable{
	...
	long long (*comparisonKey)(const VirtualQSGDynamicTexture* self);
...
long long QSGDynamicTexture_virtualbase_comparisonKey(const VirtualQSGDynamicTexture* self);
