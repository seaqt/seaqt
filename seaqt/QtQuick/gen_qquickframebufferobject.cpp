...
void QQuickFramebufferObject_virtualbase_geometryChanged(void* self, QRectF* newGeometry, QRectF* oldGeometry) {
	static_cast<VirtualQQuickFramebufferObject*>(self)->QQuickFramebufferObject::geometryChanged(*newGeometry, *oldGeometry);
}
...
void QQuickFramebufferObject_virtualbase_windowDeactivateEvent(void* self) {
	static_cast<VirtualQQuickFramebufferObject*>(self)->QQuickFramebufferObject::windowDeactivateEvent();
}
