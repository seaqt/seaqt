...
struct QQuickFramebufferObject_VTable {
	...
	void (*geometryChanged)(struct QQuickFramebufferObject_VTable* vtbl, QQuickFramebufferObject* self, QRectF* newGeometry, QRectF* oldGeometry);
	...
	void (*windowDeactivateEvent)(struct QQuickFramebufferObject_VTable* vtbl, QQuickFramebufferObject* self);
