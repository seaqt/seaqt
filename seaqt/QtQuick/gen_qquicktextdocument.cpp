...
uint8_t QQuickTextDocument_status(const QQuickTextDocument* self) {
	QQuickTextDocument::Status _ret = self->status();
...
void QQuickTextDocument_connect_textDocumentChanged(QQuickTextDocument* self, intptr_t slot, void (*callback)(intptr_t), void (*release)(intptr_t)) {
	QQuickTextDocument::connect(self, static_cast<void (QQuickTextDocument::*)()>(&QQuickTextDocument::textDocumentChanged), self, [callback, release = seaqt::release_callback{slot,release}]() {
...
void QQuickTextDocument_connect_sourceChanged(QQuickTextDocument* self, intptr_t slot, void (*callback)(intptr_t), void (*release)(intptr_t)) {
	QQuickTextDocument::connect(self, static_cast<void (QQuickTextDocument::*)()>(&QQuickTextDocument::sourceChanged), self, [callback, release = seaqt::release_callback{slot,release}]() {
			callback(release.slot);
	});
}
...
void QQuickTextDocument_connect_modifiedChanged(QQuickTextDocument* self, intptr_t slot, void (*callback)(intptr_t), void (*release)(intptr_t)) {
	QQuickTextDocument::connect(self, static_cast<void (QQuickTextDocument::*)()>(&QQuickTextDocument::modifiedChanged), self, [callback, release = seaqt::release_callback{slot,release}]() {
			callback(release.slot);
	});
}
...
void QQuickTextDocument_connect_statusChanged(QQuickTextDocument* self, intptr_t slot, void (*callback)(intptr_t), void (*release)(intptr_t)) {
	QQuickTextDocument::connect(self, static_cast<void (QQuickTextDocument::*)()>(&QQuickTextDocument::statusChanged), self, [callback, release = seaqt::release_callback{slot,release}]() {
			callback(release.slot);
	});
}
...
void QQuickTextDocument_connect_errorStringChanged(QQuickTextDocument* self, intptr_t slot, void (*callback)(intptr_t), void (*release)(intptr_t)) {
	QQuickTextDocument::connect(self, static_cast<void (QQuickTextDocument::*)()>(&QQuickTextDocument::errorStringChanged), self, [callback, release = seaqt::release_callback{slot,release}]() {
			callback(release.slot);
	});
}
