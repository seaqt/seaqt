...
QWebEngineDesktopMediaRequest* QWebEngineDesktopMediaRequest_new() {
	return new (std::nothrow) QWebEngineDesktopMediaRequest();
}

QWebEngineDesktopMediaRequest* QWebEngineDesktopMediaRequest_new_from(QWebEngineDesktopMediaRequest* from) {
