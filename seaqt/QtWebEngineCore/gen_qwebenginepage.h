...
struct QWebEnginePage_VTable {
	void (*destructor)(struct QWebEnginePage_VTable* vtbl, QWebEnginePage* self);
	QMetaObject* (*metaObject)(struct QWebEnginePage_VTable* vtbl, const QWebEnginePage* self);
	void* (*metacast)(struct QWebEnginePage_VTable* vtbl, QWebEnginePage* self, const char* param1);
	int (*metacall)(struct QWebEnginePage_VTable* vtbl, QWebEnginePage* self, int param1, int param2, void** param3);
	void (*triggerAction)(struct QWebEnginePage_VTable* vtbl, QWebEnginePage* self, int action, bool checked);
	bool (*event)(struct QWebEnginePage_VTable* vtbl, QWebEnginePage* self, QEvent* param1);
	QWebEnginePage* (*createWindow)(struct QWebEnginePage_VTable* vtbl, QWebEnginePage* self, int type);
	struct miqt_array /* of struct miqt_string */  (*chooseFiles)(struct QWebEnginePage_VTable* vtbl, QWebEnginePage* self, int mode, struct miqt_array /* of struct miqt_string */  oldFiles, struct miqt_array /* of struct miqt_string */  acceptedMimeTypes);
	void (*javaScriptAlert)(struct QWebEnginePage_VTable* vtbl, QWebEnginePage* self, QUrl* securityOrigin, struct miqt_string msg);
	bool (*javaScriptConfirm)(struct QWebEnginePage_VTable* vtbl, QWebEnginePage* self, QUrl* securityOrigin, struct miqt_string msg);
	void (*javaScriptConsoleMessage)(struct QWebEnginePage_VTable* vtbl, QWebEnginePage* self, int level, struct miqt_string message, int lineNumber, struct miqt_string sourceID);
	bool (*acceptNavigationRequest)(struct QWebEnginePage_VTable* vtbl, QWebEnginePage* self, QUrl* url, int type, bool isMainFrame);
	bool (*eventFilter)(struct QWebEnginePage_VTable* vtbl, QWebEnginePage* self, QObject* watched, QEvent* event);
	void (*timerEvent)(struct QWebEnginePage_VTable* vtbl, QWebEnginePage* self, QTimerEvent* event);
	void (*childEvent)(struct QWebEnginePage_VTable* vtbl, QWebEnginePage* self, QChildEvent* event);
	void (*customEvent)(struct QWebEnginePage_VTable* vtbl, QWebEnginePage* self, QEvent* event);
	void (*connectNotify)(struct QWebEnginePage_VTable* vtbl, QWebEnginePage* self, QMetaMethod* signal);
	void (*disconnectNotify)(struct QWebEnginePage_VTable* vtbl, QWebEnginePage* self, QMetaMethod* signal);
};
