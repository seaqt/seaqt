...
struct seaqt_array /* of struct seaqt_string */  QWebEnginePage_chooseFiles(QWebEnginePage* self, int mode, struct seaqt_array /* of struct seaqt_string */  oldFiles, struct seaqt_array /* of struct seaqt_string */  acceptedMimeTypes);
void QWebEnginePage_javaScriptAlert(QWebEnginePage* self, QUrl* securityOrigin, struct seaqt_string msg);
bool QWebEnginePage_javaScriptConfirm(QWebEnginePage* self, QUrl* securityOrigin, struct seaqt_string msg);
void QWebEnginePage_javaScriptConsoleMessage(QWebEnginePage* self, int level, struct seaqt_string message, int lineNumber, struct seaqt_string sourceID);
