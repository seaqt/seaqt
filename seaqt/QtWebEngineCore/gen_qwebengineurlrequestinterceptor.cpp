...
public:
	...
	virtual ~VirtualQWebEngineUrlRequestInterceptor() override = default;
...
QWebEngineUrlRequestInterceptor* QWebEngineUrlRequestInterceptor_new() {
	return new (std::nothrow) VirtualQWebEngineUrlRequestInterceptor();
}

QWebEngineUrlRequestInterceptor* QWebEngineUrlRequestInterceptor_new2(QObject* p) {
	return new (std::nothrow) VirtualQWebEngineUrlRequestInterceptor(p);
}
...
QMetaObject* QWebEngineUrlRequestInterceptor_virtualbase_metaObject(const void* self) {
	return (QMetaObject*) static_cast<const VirtualQWebEngineUrlRequestInterceptor*>(self)->QWebEngineUrlRequestInterceptor::metaObject();
}
...
void* QWebEngineUrlRequestInterceptor_virtualbase_metacast(void* self, const char* param1) {
	return static_cast<VirtualQWebEngineUrlRequestInterceptor*>(self)->QWebEngineUrlRequestInterceptor::qt_metacast(param1);
}
...
int QWebEngineUrlRequestInterceptor_virtualbase_metacall(void* self, int param1, int param2, void** param3) {
	return static_cast<VirtualQWebEngineUrlRequestInterceptor*>(self)->QWebEngineUrlRequestInterceptor::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
}
...
bool QWebEngineUrlRequestInterceptor_virtualbase_event(void* self, QEvent* event) {
	return static_cast<VirtualQWebEngineUrlRequestInterceptor*>(self)->QWebEngineUrlRequestInterceptor::event(event);
}
...
bool QWebEngineUrlRequestInterceptor_virtualbase_eventFilter(void* self, QObject* watched, QEvent* event) {
	return static_cast<VirtualQWebEngineUrlRequestInterceptor*>(self)->QWebEngineUrlRequestInterceptor::eventFilter(watched, event);
}
...
void QWebEngineUrlRequestInterceptor_virtualbase_timerEvent(void* self, QTimerEvent* event) {
	static_cast<VirtualQWebEngineUrlRequestInterceptor*>(self)->QWebEngineUrlRequestInterceptor::timerEvent(event);
}
...
void QWebEngineUrlRequestInterceptor_virtualbase_childEvent(void* self, QChildEvent* event) {
	static_cast<VirtualQWebEngineUrlRequestInterceptor*>(self)->QWebEngineUrlRequestInterceptor::childEvent(event);
}
...
void QWebEngineUrlRequestInterceptor_virtualbase_customEvent(void* self, QEvent* event) {
	static_cast<VirtualQWebEngineUrlRequestInterceptor*>(self)->QWebEngineUrlRequestInterceptor::customEvent(event);
}
...
void QWebEngineUrlRequestInterceptor_virtualbase_connectNotify(void* self, QMetaMethod* signal) {
	static_cast<VirtualQWebEngineUrlRequestInterceptor*>(self)->QWebEngineUrlRequestInterceptor::connectNotify(*signal);
}
...
void QWebEngineUrlRequestInterceptor_virtualbase_disconnectNotify(void* self, QMetaMethod* signal) {
	static_cast<VirtualQWebEngineUrlRequestInterceptor*>(self)->QWebEngineUrlRequestInterceptor::disconnectNotify(*signal);
}
