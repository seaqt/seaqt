...
uint8_t QWebEngineProfile_persistentPermissionsPolicy(const QWebEngineProfile* self) {
	QWebEngineProfile::PersistentPermissionsPolicy _ret = self->persistentPermissionsPolicy();
...
struct seaqt_array /* of QSslCertificate* */  QWebEngineProfile_additionalTrustedCertificates(const QWebEngineProfile* self) {
	QList<QSslCertificate> _ret = self->additionalTrustedCertificates();
	// Convert QList<> from C++ memory to manually-managed C memory
...
QWebEnginePermission* QWebEngineProfile_queryPermission(const QWebEngineProfile* self, QUrl* securityOrigin, uint8_t permissionType) {
...
struct seaqt_array /* of QWebEnginePermission* */  QWebEngineProfile_listAllPermissions(const QWebEngineProfile* self) {
...
struct seaqt_array /* of QWebEnginePermission* */  QWebEngineProfile_listPermissionsForOrigin(const QWebEngineProfile* self, QUrl* securityOrigin) {
...
struct seaqt_array /* of QWebEnginePermission* */  QWebEngineProfile_listPermissionsForPermissionType(const QWebEngineProfile* self, uint8_t permissionType) {
...
QWebEngineExtensionManager* QWebEngineProfile_extensionManager(const QWebEngineProfile* self) {
...
void QWebEngineProfile_connect_clearHttpCacheCompleted(QWebEngineProfile* self, intptr_t slot, void (*callback)(intptr_t), void (*release)(intptr_t)) {
	QWebEngineProfile::connect(self, static_cast<void (QWebEngineProfile::*)()>(&QWebEngineProfile::clearHttpCacheCompleted), self, [callback, release = seaqt::release_callback{slot,release}]() {
