#pragma once
#ifndef SEAQT_QTWEBENGINECORE_GEN_QWEBENGINEHISTORY_H
#define SEAQT_QTWEBENGINECORE_GEN_QWEBENGINEHISTORY_H
...
struct seaqt_map /* of int to struct seaqt_string */  QWebEngineHistoryModel_roleNames(const QWebEngineHistoryModel* self);
...
struct seaqt_array /* of QWebEngineHistoryItem* */  QWebEngineHistory_backItems(const QWebEngineHistory* self, int maxItems);
struct seaqt_array /* of QWebEngineHistoryItem* */  QWebEngineHistory_forwardItems(const QWebEngineHistory* self, int maxItems);
