...
QNetworkConfigurationManager* QNetworkConfigurationManager_new() {
	return new (std::nothrow) VirtualQNetworkConfigurationManager();
}

QNetworkConfigurationManager* QNetworkConfigurationManager_new2(QObject* parent) {
	return new (std::nothrow) VirtualQNetworkConfigurationManager(parent);
}
...
QMetaObject* QNetworkConfigurationManager_virtualbase_metaObject(const void* self) {
	return (QMetaObject*) static_cast<const VirtualQNetworkConfigurationManager*>(self)->QNetworkConfigurationManager::metaObject();
}
...
void* QNetworkConfigurationManager_virtualbase_metacast(void* self, const char* param1) {
	return static_cast<VirtualQNetworkConfigurationManager*>(self)->QNetworkConfigurationManager::qt_metacast(param1);
}
...
int QNetworkConfigurationManager_virtualbase_metacall(void* self, int param1, int param2, void** param3) {
	return static_cast<VirtualQNetworkConfigurationManager*>(self)->QNetworkConfigurationManager::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
}
...
bool QNetworkConfigurationManager_virtualbase_event(void* self, QEvent* event) {
	return static_cast<VirtualQNetworkConfigurationManager*>(self)->QNetworkConfigurationManager::event(event);
}
...
bool QNetworkConfigurationManager_virtualbase_eventFilter(void* self, QObject* watched, QEvent* event) {
	return static_cast<VirtualQNetworkConfigurationManager*>(self)->QNetworkConfigurationManager::eventFilter(watched, event);
}
...
void QNetworkConfigurationManager_virtualbase_timerEvent(void* self, QTimerEvent* event) {
	static_cast<VirtualQNetworkConfigurationManager*>(self)->QNetworkConfigurationManager::timerEvent(event);
}
...
void QNetworkConfigurationManager_virtualbase_childEvent(void* self, QChildEvent* event) {
	static_cast<VirtualQNetworkConfigurationManager*>(self)->QNetworkConfigurationManager::childEvent(event);
}
...
void QNetworkConfigurationManager_virtualbase_customEvent(void* self, QEvent* event) {
	static_cast<VirtualQNetworkConfigurationManager*>(self)->QNetworkConfigurationManager::customEvent(event);
}
...
void QNetworkConfigurationManager_virtualbase_connectNotify(void* self, QMetaMethod* signal) {
	static_cast<VirtualQNetworkConfigurationManager*>(self)->QNetworkConfigurationManager::connectNotify(*signal);
}
...
void QNetworkConfigurationManager_virtualbase_disconnectNotify(void* self, QMetaMethod* signal) {
	static_cast<VirtualQNetworkConfigurationManager*>(self)->QNetworkConfigurationManager::disconnectNotify(*signal);
}
