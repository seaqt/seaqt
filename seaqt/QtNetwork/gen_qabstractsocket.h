...
typedef struct QAbstractSocket_VTable{
	...
	bool (*bind)(VirtualQAbstractSocket* self, QHostAddress* address, unsigned short port, int mode);
	void (*connectToHost)(VirtualQAbstractSocket* self, struct seaqt_string hostName, unsigned short port, int mode, int protocol);
