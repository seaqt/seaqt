#pragma once
#ifndef SEAQT_QTNETWORK_GEN_QSSLCONFIGURATION_H
#define SEAQT_QTNETWORK_GEN_QSSLCONFIGURATION_H
...
struct seaqt_array /* of QSslCertificate* */  QSslConfiguration_localCertificateChain(const QSslConfiguration* self);
void QSslConfiguration_setLocalCertificateChain(QSslConfiguration* self, struct seaqt_array /* of QSslCertificate* */  localChain);
...
struct seaqt_array /* of QSslCertificate* */  QSslConfiguration_peerCertificateChain(const QSslConfiguration* self);
...
struct seaqt_string QSslConfiguration_sessionTicket(const QSslConfiguration* self);
void QSslConfiguration_setSessionTicket(QSslConfiguration* self, struct seaqt_string sessionTicket);
...
struct seaqt_array /* of QSslEllipticCurve* */  QSslConfiguration_ellipticCurves(const QSslConfiguration* self);
void QSslConfiguration_setEllipticCurves(QSslConfiguration* self, struct seaqt_array /* of QSslEllipticCurve* */  curves);
struct seaqt_array /* of QSslEllipticCurve* */  QSslConfiguration_supportedEllipticCurves();
struct seaqt_string QSslConfiguration_preSharedKeyIdentityHint(const QSslConfiguration* self);
void QSslConfiguration_setPreSharedKeyIdentityHint(QSslConfiguration* self, struct seaqt_string hint);
...
void QSslConfiguration_setBackendConfigurationOption(QSslConfiguration* self, struct seaqt_string name, QVariant* value);
...
void QSslConfiguration_setAllowedNextProtocols(QSslConfiguration* self, struct seaqt_array /* of struct seaqt_string */  protocols);
