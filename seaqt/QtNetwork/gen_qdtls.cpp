...
void QDtls_connect_pskRequired(QDtls* self, intptr_t slot) {
	VirtualQDtls::connect(self, static_cast<void (QDtls::*)(QSslPreSharedKeyAuthenticator*)>(&QDtls::pskRequired), self, [=](QSslPreSharedKeyAuthenticator* authenticator) {
...
void QDtls_connect_handshakeTimeout(QDtls* self, intptr_t slot) {
	VirtualQDtls::connect(self, static_cast<void (QDtls::*)()>(&QDtls::handshakeTimeout), self, [=]() {
