...
QMetaObject* miqt_exec_callback_QTcpServer_metaObject(const QTcpServer*, intptr_t);
void* miqt_exec_callback_QTcpServer_metacast(QTcpServer*, intptr_t, const char*);
int miqt_exec_callback_QTcpServer_metacall(QTcpServer*, intptr_t, int, int, void**);
...
public:
	...
	virtual ~VirtualQTcpServer() override = default;
	...
	virtual const QMetaObject* metaObject() const override {
		...
		QMetaObject* callback_return_value = miqt_exec_callback_QTcpServer_metaObject(this, handle__metaObject);
	...
	virtual int qt_metacall(QMetaObject::Call param1, int param2, void** param3) override {
		...
		int sigval2 = param2;
		void** sigval3 = param3;
		int callback_return_value = miqt_exec_callback_QTcpServer_metacall(this, handle__metacall, sigval1, sigval2, sigval3);
...
QTcpServer* QTcpServer_new() {
	return new (std::nothrow) VirtualQTcpServer();
}

QTcpServer* QTcpServer_new2(QObject* parent) {
	return new (std::nothrow) VirtualQTcpServer(parent);
}
...
QMetaObject* QTcpServer_virtualbase_metaObject(const void* self) {
	return (QMetaObject*) static_cast<const VirtualQTcpServer*>(self)->QTcpServer::metaObject();
}
...
void* QTcpServer_virtualbase_metacast(void* self, const char* param1) {
	return static_cast<VirtualQTcpServer*>(self)->QTcpServer::qt_metacast(param1);
}
...
int QTcpServer_virtualbase_metacall(void* self, int param1, int param2, void** param3) {
	return static_cast<VirtualQTcpServer*>(self)->QTcpServer::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
}
...
bool QTcpServer_virtualbase_hasPendingConnections(const void* self) {
	return static_cast<const VirtualQTcpServer*>(self)->QTcpServer::hasPendingConnections();
}
...
QTcpSocket* QTcpServer_virtualbase_nextPendingConnection(void* self) {
	return static_cast<VirtualQTcpServer*>(self)->QTcpServer::nextPendingConnection();
}
...
void QTcpServer_virtualbase_incomingConnection(void* self, intptr_t handle) {
	static_cast<VirtualQTcpServer*>(self)->QTcpServer::incomingConnection((qintptr)(handle));
}
...
bool QTcpServer_virtualbase_event(void* self, QEvent* event) {
	return static_cast<VirtualQTcpServer*>(self)->QTcpServer::event(event);
}
...
bool QTcpServer_virtualbase_eventFilter(void* self, QObject* watched, QEvent* event) {
	return static_cast<VirtualQTcpServer*>(self)->QTcpServer::eventFilter(watched, event);
}
...
void QTcpServer_virtualbase_timerEvent(void* self, QTimerEvent* event) {
	static_cast<VirtualQTcpServer*>(self)->QTcpServer::timerEvent(event);
}
...
void QTcpServer_virtualbase_childEvent(void* self, QChildEvent* event) {
	static_cast<VirtualQTcpServer*>(self)->QTcpServer::childEvent(event);
}
...
void QTcpServer_virtualbase_customEvent(void* self, QEvent* event) {
	static_cast<VirtualQTcpServer*>(self)->QTcpServer::customEvent(event);
}
...
void QTcpServer_virtualbase_connectNotify(void* self, QMetaMethod* signal) {
	static_cast<VirtualQTcpServer*>(self)->QTcpServer::connectNotify(*signal);
}
...
void QTcpServer_virtualbase_disconnectNotify(void* self, QMetaMethod* signal) {
	static_cast<VirtualQTcpServer*>(self)->QTcpServer::disconnectNotify(*signal);
}
...
void QTcpServer_connect_pendingConnectionAvailable(QTcpServer* self, intptr_t slot) {
	QTcpServer::connect(self, &QTcpServer::pendingConnectionAvailable, self, [=]() {
