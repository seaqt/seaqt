#pragma once
#ifndef SEAQT_QTNETWORK_GEN_QSSLCIPHER_H
#define SEAQT_QTNETWORK_GEN_QSSLCIPHER_H
...
struct seaqt_string QSslCipher_name(const QSslCipher* self);
int QSslCipher_supportedBits(const QSslCipher* self);
int QSslCipher_usedBits(const QSslCipher* self);
struct seaqt_string QSslCipher_keyExchangeMethod(const QSslCipher* self);
struct seaqt_string QSslCipher_authenticationMethod(const QSslCipher* self);
struct seaqt_string QSslCipher_encryptionMethod(const QSslCipher* self);
struct seaqt_string QSslCipher_protocolString(const QSslCipher* self);
