...
public:
	...
	friend bool QSslSocket_virtualbase_bind(void* self, QHostAddress* address, uint16_t port, int mode);
...
void QSslSocket_connect_encrypted(QSslSocket* self, intptr_t slot) {
	VirtualQSslSocket::connect(self, static_cast<void (QSslSocket::*)()>(&QSslSocket::encrypted), self, [=]() {
...
void QSslSocket_connect_peerVerifyError(QSslSocket* self, intptr_t slot) {
	VirtualQSslSocket::connect(self, static_cast<void (QSslSocket::*)(const QSslError&)>(&QSslSocket::peerVerifyError), self, [=](const QSslError& error) {
...
void QSslSocket_connect_sslErrors(QSslSocket* self, intptr_t slot) {
	VirtualQSslSocket::connect(self, static_cast<void (QSslSocket::*)(const QList<QSslError>&)>(&QSslSocket::sslErrors), self, [=](const QList<QSslError>& errors) {
...
void QSslSocket_connect_modeChanged(QSslSocket* self, intptr_t slot) {
	VirtualQSslSocket::connect(self, static_cast<void (QSslSocket::*)(QSslSocket::SslMode)>(&QSslSocket::modeChanged), self, [=](QSslSocket::SslMode newMode) {
...
void QSslSocket_connect_encryptedBytesWritten(QSslSocket* self, intptr_t slot) {
	VirtualQSslSocket::connect(self, static_cast<void (QSslSocket::*)(qint64)>(&QSslSocket::encryptedBytesWritten), self, [=](qint64 totalBytes) {
...
void QSslSocket_connect_preSharedKeyAuthenticationRequired(QSslSocket* self, intptr_t slot) {
	VirtualQSslSocket::connect(self, static_cast<void (QSslSocket::*)(QSslPreSharedKeyAuthenticator*)>(&QSslSocket::preSharedKeyAuthenticationRequired), self, [=](QSslPreSharedKeyAuthenticator* authenticator) {
...
void QSslSocket_connect_newSessionTicketReceived(QSslSocket* self, intptr_t slot) {
	VirtualQSslSocket::connect(self, static_cast<void (QSslSocket::*)()>(&QSslSocket::newSessionTicketReceived), self, [=]() {
...
void QSslSocket_connect_alertSent(QSslSocket* self, intptr_t slot) {
	VirtualQSslSocket::connect(self, static_cast<void (QSslSocket::*)(QSsl::AlertLevel, QSsl::AlertType, const QString&)>(&QSslSocket::alertSent), self, [=](QSsl::AlertLevel level, QSsl::AlertType type, const QString& description) {
...
void QSslSocket_connect_alertReceived(QSslSocket* self, intptr_t slot) {
	VirtualQSslSocket::connect(self, static_cast<void (QSslSocket::*)(QSsl::AlertLevel, QSsl::AlertType, const QString&)>(&QSslSocket::alertReceived), self, [=](QSsl::AlertLevel level, QSsl::AlertType type, const QString& description) {
		QSsl::AlertLevel level_ret = level;
		int sigval1 = static_cast<int>(level_ret);
		QSsl::AlertType type_ret = type;
		int sigval2 = static_cast<int>(type_ret);
...
void QSslSocket_connect_handshakeInterruptedOnError(QSslSocket* self, intptr_t slot) {
	VirtualQSslSocket::connect(self, static_cast<void (QSslSocket::*)(const QSslError&)>(&QSslSocket::handshakeInterruptedOnError), self, [=](const QSslError& error) {
		const QSslError& error_ret = error;
		// Cast returned reference into pointer
		QSslError* sigval1 = const_cast<QSslError*>(&error_ret);
...
long long QSslSocket_virtualbase_skipData(void* self, long long maxSize) {
	...
	qint64 _ret = ( (VirtualQSslSocket*)(self) )->QSslSocket::skipData(static_cast<qint64>(maxSize));
	return static_cast<long long>(_ret);
...
bool QSslSocket_virtualbase_bind(void* self, QHostAddress* address, uint16_t port, int mode) {
	...
	return ( (VirtualQSslSocket*)(self) )->QSslSocket::bind(*address, static_cast<quint16>(port), static_cast<VirtualQSslSocket::BindMode>(mode));
