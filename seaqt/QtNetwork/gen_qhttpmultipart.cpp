...
QHttpMultiPart* QHttpMultiPart_new() {
	return new (std::nothrow) VirtualQHttpMultiPart();
}

QHttpMultiPart* QHttpMultiPart_new2(int contentType) {
	return new (std::nothrow) VirtualQHttpMultiPart(static_cast<QHttpMultiPart::ContentType>(contentType));
}

QHttpMultiPart* QHttpMultiPart_new3(QObject* parent) {
	return new (std::nothrow) VirtualQHttpMultiPart(parent);
}

QHttpMultiPart* QHttpMultiPart_new4(int contentType, QObject* parent) {
	return new (std::nothrow) VirtualQHttpMultiPart(static_cast<QHttpMultiPart::ContentType>(contentType), parent);
}
...
QMetaObject* QHttpMultiPart_virtualbase_metaObject(const void* self) {
	return (QMetaObject*) static_cast<const VirtualQHttpMultiPart*>(self)->QHttpMultiPart::metaObject();
}
...
void* QHttpMultiPart_virtualbase_metacast(void* self, const char* param1) {
	return static_cast<VirtualQHttpMultiPart*>(self)->QHttpMultiPart::qt_metacast(param1);
}
...
int QHttpMultiPart_virtualbase_metacall(void* self, int param1, int param2, void** param3) {
	return static_cast<VirtualQHttpMultiPart*>(self)->QHttpMultiPart::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
}
...
bool QHttpMultiPart_virtualbase_event(void* self, QEvent* event) {
	return static_cast<VirtualQHttpMultiPart*>(self)->QHttpMultiPart::event(event);
}
...
bool QHttpMultiPart_virtualbase_eventFilter(void* self, QObject* watched, QEvent* event) {
	return static_cast<VirtualQHttpMultiPart*>(self)->QHttpMultiPart::eventFilter(watched, event);
}
...
void QHttpMultiPart_virtualbase_timerEvent(void* self, QTimerEvent* event) {
	static_cast<VirtualQHttpMultiPart*>(self)->QHttpMultiPart::timerEvent(event);
}
...
void QHttpMultiPart_virtualbase_childEvent(void* self, QChildEvent* event) {
	static_cast<VirtualQHttpMultiPart*>(self)->QHttpMultiPart::childEvent(event);
}
...
void QHttpMultiPart_virtualbase_customEvent(void* self, QEvent* event) {
	static_cast<VirtualQHttpMultiPart*>(self)->QHttpMultiPart::customEvent(event);
}
...
void QHttpMultiPart_virtualbase_connectNotify(void* self, QMetaMethod* signal) {
	static_cast<VirtualQHttpMultiPart*>(self)->QHttpMultiPart::connectNotify(*signal);
}
...
void QHttpMultiPart_virtualbase_disconnectNotify(void* self, QMetaMethod* signal) {
	static_cast<VirtualQHttpMultiPart*>(self)->QHttpMultiPart::disconnectNotify(*signal);
}
