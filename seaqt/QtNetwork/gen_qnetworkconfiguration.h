#pragma once
#ifndef SEAQT_QTNETWORK_GEN_QNETWORKCONFIGURATION_H
#define SEAQT_QTNETWORK_GEN_QNETWORKCONFIGURATION_H
...
struct seaqt_string QNetworkConfiguration_bearerTypeName(const QNetworkConfiguration* self);
struct seaqt_string QNetworkConfiguration_identifier(const QNetworkConfiguration* self);
bool QNetworkConfiguration_isRoamingAvailable(const QNetworkConfiguration* self);
struct seaqt_array /* of QNetworkConfiguration* */  QNetworkConfiguration_children(const QNetworkConfiguration* self);
struct seaqt_string QNetworkConfiguration_name(const QNetworkConfiguration* self);
