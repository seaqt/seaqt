...
void QHttpHeaders_setDateTimeValue_QAnyStringView_QDateTime(QHttpHeaders* self, struct seaqt_string name, QDateTime* dateTime) {
	QAnyStringView name_QString = QAnyStringView(name.data, name.len);
	self->setDateTimeValue(name_QString, *dateTime);
}

void QHttpHeaders_setDateTimeValue_QHttpHeaders_WellKnownHeader_QDateTime(QHttpHeaders* self, int name, QDateTime* dateTime) {
	self->setDateTimeValue(static_cast<QHttpHeaders::WellKnownHeader>(name), *dateTime);
}
