...
void QLocalSocket_connect_errorWithSocketError(QLocalSocket* self, intptr_t slot) {
	VirtualQLocalSocket::connect(self, static_cast<void (QLocalSocket::*)(QLocalSocket::LocalSocketError)>(&QLocalSocket::error), self, [=](QLocalSocket::LocalSocketError socketError) {
