...
QSslServer* QSslServer_new() {
	return new (std::nothrow) VirtualQSslServer();
}

QSslServer* QSslServer_new2(QObject* parent) {
	return new (std::nothrow) VirtualQSslServer(parent);
}
...
QMetaObject* QSslServer_virtualbase_metaObject(const void* self) {
	return (QMetaObject*) static_cast<const VirtualQSslServer*>(self)->QSslServer::metaObject();
}
...
void* QSslServer_virtualbase_metacast(void* self, const char* param1) {
	return static_cast<VirtualQSslServer*>(self)->QSslServer::qt_metacast(param1);
}
...
int QSslServer_virtualbase_metacall(void* self, int param1, int param2, void** param3) {
	return static_cast<VirtualQSslServer*>(self)->QSslServer::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
}
...
void QSslServer_virtualbase_incomingConnection(void* self, intptr_t socket) {
	static_cast<VirtualQSslServer*>(self)->QSslServer::incomingConnection((qintptr)(socket));
}
...
bool QSslServer_virtualbase_hasPendingConnections(const void* self) {
	return static_cast<const VirtualQSslServer*>(self)->QSslServer::hasPendingConnections();
}
...
QTcpSocket* QSslServer_virtualbase_nextPendingConnection(void* self) {
	return static_cast<VirtualQSslServer*>(self)->QSslServer::nextPendingConnection();
}
...
bool QSslServer_virtualbase_event(void* self, QEvent* event) {
	return static_cast<VirtualQSslServer*>(self)->QSslServer::event(event);
}
...
bool QSslServer_virtualbase_eventFilter(void* self, QObject* watched, QEvent* event) {
	return static_cast<VirtualQSslServer*>(self)->QSslServer::eventFilter(watched, event);
}
...
void QSslServer_virtualbase_timerEvent(void* self, QTimerEvent* event) {
	static_cast<VirtualQSslServer*>(self)->QSslServer::timerEvent(event);
}
...
void QSslServer_virtualbase_childEvent(void* self, QChildEvent* event) {
	static_cast<VirtualQSslServer*>(self)->QSslServer::childEvent(event);
}
...
void QSslServer_virtualbase_customEvent(void* self, QEvent* event) {
	static_cast<VirtualQSslServer*>(self)->QSslServer::customEvent(event);
}
...
void QSslServer_virtualbase_connectNotify(void* self, QMetaMethod* signal) {
	static_cast<VirtualQSslServer*>(self)->QSslServer::connectNotify(*signal);
}
...
void QSslServer_virtualbase_disconnectNotify(void* self, QMetaMethod* signal) {
	static_cast<VirtualQSslServer*>(self)->QSslServer::disconnectNotify(*signal);
}
