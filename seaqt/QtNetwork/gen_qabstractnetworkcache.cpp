...
struct seaqt_array /* of struct seaqt_map  tuple of struct seaqt_string and struct seaqt_string   */  QNetworkCacheMetaData_rawHeaders(const QNetworkCacheMetaData* self) {
	...
	for (size_t i = 0, e = _ret.length(); i < e; ++i) {
		...
		struct seaqt_string* _lv_first_arr = static_cast<struct seaqt_string*>(malloc(sizeof(struct seaqt_string)));
		struct seaqt_string* _lv_second_arr = static_cast<struct seaqt_string*>(malloc(sizeof(struct seaqt_string)));
		QByteArray _lv_first_qb = _lv_ret.first;
		struct seaqt_string _lv_first_ms;
		...
		struct seaqt_string _lv_second_ms;
...
void QNetworkCacheMetaData_setRawHeaders(QNetworkCacheMetaData* self, struct seaqt_array /* of struct seaqt_map  tuple of struct seaqt_string and struct seaqt_string   */  headers) {
	QNetworkCacheMetaData::RawHeaderList headers_QList;
	headers_QList.reserve(headers.len);
	struct seaqt_map /* tuple of struct seaqt_string and struct seaqt_string */ * headers_arr = static_cast<struct seaqt_map /* tuple of struct seaqt_string and struct seaqt_string */ *>(headers.data);
	for(size_t i = 0; i < headers.len; ++i) {
		QPair<QByteArray, QByteArray> headers_arr_i_QPair;
		struct seaqt_string* headers_arr_i_first_arr = static_cast<struct seaqt_string*>(headers_arr[i].keys);
		struct seaqt_string* headers_arr_i_second_arr = static_cast<struct seaqt_string*>(headers_arr[i].values);
...
struct seaqt_map /* of int to QVariant* */  QNetworkCacheMetaData_attributes(const QNetworkCacheMetaData* self) {
...
void QNetworkCacheMetaData_setAttributes(QNetworkCacheMetaData* self, struct seaqt_map /* of int to QVariant* */  attributes) {
...
struct seaqt_string QAbstractNetworkCache_trUtf8(const char* s) {
	QString _ret = QAbstractNetworkCache::trUtf8(s);
	// Convert QString from UTF-16 in C++ RAII memory to UTF-8 in manually-managed C memory
	QByteArray _b = _ret.toUtf8();
	struct seaqt_string _ms;
	_ms.len = _b.length();
...
struct seaqt_string QAbstractNetworkCache_trUtf82(const char* s, const char* c) {
	QString _ret = QAbstractNetworkCache::trUtf8(s, c);
	// Convert QString from UTF-16 in C++ RAII memory to UTF-8 in manually-managed C memory
	QByteArray _b = _ret.toUtf8();
	struct seaqt_string _ms;
	_ms.len = _b.length();
...
struct seaqt_string QAbstractNetworkCache_trUtf83(const char* s, const char* c, int n) {
	QString _ret = QAbstractNetworkCache::trUtf8(s, c, static_cast<int>(n));
	// Convert QString from UTF-16 in C++ RAII memory to UTF-8 in manually-managed C memory
	QByteArray _b = _ret.toUtf8();
	struct seaqt_string _ms;
	_ms.len = _b.length();
