#pragma once
#ifndef SEAQT_QTNETWORK_GEN_QSSLPRESHAREDKEYAUTHENTICATOR_H
#define SEAQT_QTNETWORK_GEN_QSSLPRESHAREDKEYAUTHENTICATOR_H
...
const QMetaObject* QSslPreSharedKeyAuthenticator_staticMetaObject();
