...
struct QUdpSocket_VTable {
	...
	bool (*bind)(struct QUdpSocket_VTable* vtbl, QUdpSocket* self, QHostAddress* address, uint16_t port, int mode);
	...
	long long (*skipData)(struct QUdpSocket_VTable* vtbl, QUdpSocket* self, long long maxSize);
