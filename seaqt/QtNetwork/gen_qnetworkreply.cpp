...
struct seaqt_string QNetworkReply_trUtf8_s(const char* s) {
...
struct seaqt_array /* of struct seaqt_map  tuple of struct seaqt_string and struct seaqt_string   */  QNetworkReply_rawHeaderPairs(const QNetworkReply* self) {
...
void QNetworkReply_error_QNetworkReply_NetworkError(QNetworkReply* self, int param1) {
	self->error(static_cast<QNetworkReply::NetworkError>(param1));
}

void QNetworkReply_connect_error_QNetworkReply_NetworkError(QNetworkReply* self, intptr_t slot, void (*callback)(intptr_t, int), void (*release)(intptr_t)) {
	QNetworkReply::connect(self, static_cast<void (QNetworkReply::*)(QNetworkReply::NetworkError)>(&QNetworkReply::error), self, [callback, release = seaqt::release_callback{slot,release}](QNetworkReply::NetworkError param1) {
