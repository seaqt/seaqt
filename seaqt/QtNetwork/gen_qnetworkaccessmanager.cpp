...
struct seaqt_string QNetworkAccessManager_trUtf8(const char* s) {
...
struct seaqt_string QNetworkAccessManager_trUtf82(const char* s, const char* c) {
...
struct seaqt_string QNetworkAccessManager_trUtf83(const char* s, const char* c, int n) {
