...
void miqt_exec_callback_QDnsLookup_nameChanged(intptr_t, struct seaqt_string);
...
QMetaObject* miqt_exec_callback_QDnsLookup_metaObject(const QDnsLookup*, intptr_t);
void* miqt_exec_callback_QDnsLookup_metacast(QDnsLookup*, intptr_t, const char*);
...
public:
	...
	virtual ~VirtualQDnsLookup() override = default;
	...
	virtual const QMetaObject* metaObject() const override {
		...
		QMetaObject* callback_return_value = miqt_exec_callback_QDnsLookup_metaObject(this, handle__metaObject);
	...
	virtual void* qt_metacast(const char* param1) override {
		...
		void* callback_return_value = miqt_exec_callback_QDnsLookup_metacast(this, handle__metacast, sigval1);
		return callback_return_value;
	}
...
QDnsLookup* QDnsLookup_new() {
	return new (std::nothrow) VirtualQDnsLookup();
}

QDnsLookup* QDnsLookup_new2(int type, struct seaqt_string name) {
	QString name_QString = QString::fromUtf8(name.data, name.len);
	return new (std::nothrow) VirtualQDnsLookup(static_cast<QDnsLookup::Type>(type), name_QString);
}

QDnsLookup* QDnsLookup_new3(int type, struct seaqt_string name, QHostAddress* nameserver) {
	QString name_QString = QString::fromUtf8(name.data, name.len);
	return new (std::nothrow) VirtualQDnsLookup(static_cast<QDnsLookup::Type>(type), name_QString, *nameserver);
}

QDnsLookup* QDnsLookup_new4(QObject* parent) {
	return new (std::nothrow) VirtualQDnsLookup(parent);
}

QDnsLookup* QDnsLookup_new5(int type, struct seaqt_string name, QObject* parent) {
	QString name_QString = QString::fromUtf8(name.data, name.len);
	return new (std::nothrow) VirtualQDnsLookup(static_cast<QDnsLookup::Type>(type), name_QString, parent);
}

QDnsLookup* QDnsLookup_new6(int type, struct seaqt_string name, QHostAddress* nameserver, QObject* parent) {
	QString name_QString = QString::fromUtf8(name.data, name.len);
	return new (std::nothrow) VirtualQDnsLookup(static_cast<QDnsLookup::Type>(type), name_QString, *nameserver, parent);
}
...
bool QDnsLookup_override_virtual_metaObject(void* self, intptr_t slot) {
	VirtualQDnsLookup* self_cast = dynamic_cast<VirtualQDnsLookup*>( (QDnsLookup*)(self) );
...
QMetaObject* QDnsLookup_virtualbase_metaObject(const void* self) {
	return (QMetaObject*) static_cast<const VirtualQDnsLookup*>(self)->QDnsLookup::metaObject();
}
...
void* QDnsLookup_virtualbase_metacast(void* self, const char* param1) {
	return static_cast<VirtualQDnsLookup*>(self)->QDnsLookup::qt_metacast(param1);
}
...
int QDnsLookup_virtualbase_metacall(void* self, int param1, int param2, void** param3) {
	return static_cast<VirtualQDnsLookup*>(self)->QDnsLookup::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
}
...
bool QDnsLookup_virtualbase_event(void* self, QEvent* event) {
	return static_cast<VirtualQDnsLookup*>(self)->QDnsLookup::event(event);
}
...
bool QDnsLookup_virtualbase_eventFilter(void* self, QObject* watched, QEvent* event) {
	return static_cast<VirtualQDnsLookup*>(self)->QDnsLookup::eventFilter(watched, event);
}
...
void QDnsLookup_virtualbase_timerEvent(void* self, QTimerEvent* event) {
	static_cast<VirtualQDnsLookup*>(self)->QDnsLookup::timerEvent(event);
}
...
void QDnsLookup_virtualbase_childEvent(void* self, QChildEvent* event) {
	static_cast<VirtualQDnsLookup*>(self)->QDnsLookup::childEvent(event);
}
...
void QDnsLookup_virtualbase_customEvent(void* self, QEvent* event) {
	static_cast<VirtualQDnsLookup*>(self)->QDnsLookup::customEvent(event);
}
...
void QDnsLookup_virtualbase_connectNotify(void* self, QMetaMethod* signal) {
	static_cast<VirtualQDnsLookup*>(self)->QDnsLookup::connectNotify(*signal);
}
...
void QDnsLookup_virtualbase_disconnectNotify(void* self, QMetaMethod* signal) {
	static_cast<VirtualQDnsLookup*>(self)->QDnsLookup::disconnectNotify(*signal);
}
