...
QDnsTlsAssociationRecord* QDnsTlsAssociationRecord_new_from(QDnsTlsAssociationRecord* from) {
	return new (std::nothrow) QDnsTlsAssociationRecord(*from);
}

void QDnsTlsAssociationRecord_operatorAssign(QDnsTlsAssociationRecord* self, QDnsTlsAssociationRecord* from) {
	self->operator=(*from);
}
...
struct seaqt_string QDnsTlsAssociationRecord_name(const QDnsTlsAssociationRecord* self) {
	QString _ret = self->name();
	// Convert QString from UTF-16 in C++ RAII memory to UTF-8 in manually-managed C memory
	QByteArray _b = _ret.toUtf8();
	struct seaqt_string _ms;
...
uint8_t QDnsTlsAssociationRecord_usage(const QDnsTlsAssociationRecord* self) {
	QDnsTlsAssociationRecord::CertificateUsage _ret = self->usage();
	return static_cast<uint8_t>(_ret);
}

uint8_t QDnsTlsAssociationRecord_selector(const QDnsTlsAssociationRecord* self) {
	QDnsTlsAssociationRecord::Selector _ret = self->selector();
	return static_cast<uint8_t>(_ret);
}

uint8_t QDnsTlsAssociationRecord_matchType(const QDnsTlsAssociationRecord* self) {
	QDnsTlsAssociationRecord::MatchingType _ret = self->matchType();
	return static_cast<uint8_t>(_ret);
}

struct seaqt_string QDnsTlsAssociationRecord_value(const QDnsTlsAssociationRecord* self) {
...
const QMetaObject* QDnsTlsAssociationRecord_staticMetaObject() { return &QDnsTlsAssociationRecord::staticMetaObject; }
...
public:
	...
	VirtualQDnsLookup(const QDnsLookup_VTable* vtbl, QDnsLookup::Type type, const QString& name, const QHostAddress& nameserver, quint16 port): QDnsLookup(type, name, nameserver, port), vtbl(vtbl) {}
	VirtualQDnsLookup(const QDnsLookup_VTable* vtbl, QDnsLookup::Type type, const QString& name, QDnsLookup::Protocol protocol, const QHostAddress& nameserver): QDnsLookup(type, name, protocol, nameserver), vtbl(vtbl) {}
	...
	VirtualQDnsLookup(const QDnsLookup_VTable* vtbl, QDnsLookup::Type type, const QString& name, const QHostAddress& nameserver, quint16 port, QObject* parent): QDnsLookup(type, name, nameserver, port, parent), vtbl(vtbl) {}
	VirtualQDnsLookup(const QDnsLookup_VTable* vtbl, QDnsLookup::Type type, const QString& name, QDnsLookup::Protocol protocol, const QHostAddress& nameserver, quint16 port): QDnsLookup(type, name, protocol, nameserver, port), vtbl(vtbl) {}
	VirtualQDnsLookup(const QDnsLookup_VTable* vtbl, QDnsLookup::Type type, const QString& name, QDnsLookup::Protocol protocol, const QHostAddress& nameserver, quint16 port, QObject* parent): QDnsLookup(type, name, protocol, nameserver, port, parent), vtbl(vtbl) {}
...
VirtualQDnsLookup* QDnsLookup_new_type_name_nameserver_port(const QDnsLookup_VTable* vtbl, size_t vdata, int type, struct seaqt_string name, QHostAddress* nameserver, unsigned short port) {
	QString name_QString = QString::fromUtf8(name.data, name.len);
	void* _mem_ = ::operator new(seaqt_aligned_sizeof<VirtualQDnsLookup>() + vdata, std::nothrow);
	return _mem_ ? new (_mem_)VirtualQDnsLookup(vtbl, static_cast<QDnsLookup::Type>(type), name_QString, *nameserver, static_cast<quint16>(port)) : nullptr;
}

VirtualQDnsLookup* QDnsLookup_new_type_name_protocol_nameserver(const QDnsLookup_VTable* vtbl, size_t vdata, int type, struct seaqt_string name, uint8_t protocol, QHostAddress* nameserver) {
	QString name_QString = QString::fromUtf8(name.data, name.len);
	void* _mem_ = ::operator new(seaqt_aligned_sizeof<VirtualQDnsLookup>() + vdata, std::nothrow);
	return _mem_ ? new (_mem_)VirtualQDnsLookup(vtbl, static_cast<QDnsLookup::Type>(type), name_QString, static_cast<QDnsLookup::Protocol>(protocol), *nameserver) : nullptr;
}
...
VirtualQDnsLookup* QDnsLookup_new_type_name_nameserver_port_parent(const QDnsLookup_VTable* vtbl, size_t vdata, int type, struct seaqt_string name, QHostAddress* nameserver, unsigned short port, QObject* parent) {
	QString name_QString = QString::fromUtf8(name.data, name.len);
	void* _mem_ = ::operator new(seaqt_aligned_sizeof<VirtualQDnsLookup>() + vdata, std::nothrow);
	return _mem_ ? new (_mem_)VirtualQDnsLookup(vtbl, static_cast<QDnsLookup::Type>(type), name_QString, *nameserver, static_cast<quint16>(port), parent) : nullptr;
}

VirtualQDnsLookup* QDnsLookup_new_type_name_protocol_nameserver_port(const QDnsLookup_VTable* vtbl, size_t vdata, int type, struct seaqt_string name, uint8_t protocol, QHostAddress* nameserver, unsigned short port) {
	QString name_QString = QString::fromUtf8(name.data, name.len);
	void* _mem_ = ::operator new(seaqt_aligned_sizeof<VirtualQDnsLookup>() + vdata, std::nothrow);
	return _mem_ ? new (_mem_)VirtualQDnsLookup(vtbl, static_cast<QDnsLookup::Type>(type), name_QString, static_cast<QDnsLookup::Protocol>(protocol), *nameserver, static_cast<quint16>(port)) : nullptr;
}

VirtualQDnsLookup* QDnsLookup_new_type_name_protocol_nameserver_port_parent(const QDnsLookup_VTable* vtbl, size_t vdata, int type, struct seaqt_string name, uint8_t protocol, QHostAddress* nameserver, unsigned short port, QObject* parent) {
	QString name_QString = QString::fromUtf8(name.data, name.len);
	void* _mem_ = ::operator new(seaqt_aligned_sizeof<VirtualQDnsLookup>() + vdata, std::nothrow);
	return _mem_ ? new (_mem_)VirtualQDnsLookup(vtbl, static_cast<QDnsLookup::Type>(type), name_QString, static_cast<QDnsLookup::Protocol>(protocol), *nameserver, static_cast<quint16>(port), parent) : nullptr;
}
...
void QDnsLookup_setNameserver_nameserver(QDnsLookup* self, QHostAddress* nameserver) {
...
uint8_t QDnsLookup_nameserverProtocol(const QDnsLookup* self) {
	QDnsLookup::Protocol _ret = self->nameserverProtocol();
	return static_cast<uint8_t>(_ret);
}
...
void QDnsLookup_setNameserver_protocol_nameserver(QDnsLookup* self, uint8_t protocol, QHostAddress* nameserver) {
	self->setNameserver(static_cast<QDnsLookup::Protocol>(protocol), *nameserver);
}

void QDnsLookup_setNameserver_nameserver_port(QDnsLookup* self, QHostAddress* nameserver, unsigned short port) {
...
struct seaqt_array /* of QDnsTlsAssociationRecord* */  QDnsLookup_tlsAssociationRecords(const QDnsLookup* self) {
...
unsigned short QDnsLookup_defaultPortForProtocol(uint8_t protocol) {
	quint16 _ret = QDnsLookup::defaultPortForProtocol(static_cast<QDnsLookup::Protocol>(protocol));
	return static_cast<unsigned short>(_ret);
}
...
void QDnsLookup_connect_nameserverPortChanged(QDnsLookup* self, intptr_t slot, void (*callback)(intptr_t, unsigned short), void (*release)(intptr_t)) {
	QDnsLookup::connect(self, static_cast<void (QDnsLookup::*)(quint16)>(&QDnsLookup::nameserverPortChanged), self, [callback, release = seaqt::release_callback{slot,release}](quint16 port) {
...
void QDnsLookup_connect_nameserverProtocolChanged(QDnsLookup* self, intptr_t slot, void (*callback)(intptr_t, uint8_t), void (*release)(intptr_t)) {
	QDnsLookup::connect(self, static_cast<void (QDnsLookup::*)(QDnsLookup::Protocol)>(&QDnsLookup::nameserverProtocolChanged), self, [callback, release = seaqt::release_callback{slot,release}](QDnsLookup::Protocol protocol) {
...
void QDnsLookup_setNameserver_protocol_nameserver_port(QDnsLookup* self, uint8_t protocol, QHostAddress* nameserver, unsigned short port) {
