...
public:
	...
	friend void QPrintDialog_virtualbase_enterEvent(VirtualQPrintDialog* self, QEnterEvent* event);
	...
	friend bool QPrintDialog_virtualbase_nativeEvent(VirtualQPrintDialog* self, struct seaqt_string eventType, void* message, intptr_t* result);
	...
	friend double QPrintDialog_protectedbase_getDecodedMetricF(const VirtualQPrintDialog* self, int metricA, int metricB);
};
...
bool QPrintDialog_virtualbase_nativeEvent(VirtualQPrintDialog* self, struct seaqt_string eventType, void* message, intptr_t* result) {
	...
	return self->QPrintDialog::nativeEvent(eventType_QByteArray, message, (qintptr*)(result));
}
...
double QPrintDialog_protectedbase_getDecodedMetricF(const VirtualQPrintDialog* self, int metricA, int metricB) {
	return self->QPrintDialog::getDecodedMetricF(static_cast<VirtualQPrintDialog::PaintDeviceMetric>(metricA), static_cast<VirtualQPrintDialog::PaintDeviceMetric>(metricB));
}
