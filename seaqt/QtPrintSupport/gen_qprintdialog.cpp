...
bool miqt_exec_callback_QPrintDialog_nativeEvent(QPrintDialog*, intptr_t, struct seaqt_string, void*, long*);
...
public:
	...
	friend bool QPrintDialog_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, long* result);
...
bool QPrintDialog_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, long* result) {
	QByteArray eventType_QByteArray(eventType.data, eventType.len);
	return static_cast<VirtualQPrintDialog*>(self)->QPrintDialog::nativeEvent(eventType_QByteArray, message, static_cast<long*>(result));
}
