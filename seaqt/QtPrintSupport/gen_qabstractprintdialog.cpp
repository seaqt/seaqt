...
bool miqt_exec_callback_QAbstractPrintDialog_nativeEvent(QAbstractPrintDialog*, intptr_t, struct seaqt_string, void*, long*);
...
public:
	...
	friend bool QAbstractPrintDialog_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, long* result);
...
bool QAbstractPrintDialog_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, long* result) {
	QByteArray eventType_QByteArray(eventType.data, eventType.len);
	return static_cast<VirtualQAbstractPrintDialog*>(self)->QAbstractPrintDialog::nativeEvent(eventType_QByteArray, message, static_cast<long*>(result));
}
