...
public:
	...
	friend double QAbstractPrintDialog_protectedbase_getDecodedMetricF(const VirtualQAbstractPrintDialog* self, int metricA, int metricB);
};
...
double QAbstractPrintDialog_protectedbase_getDecodedMetricF(const VirtualQAbstractPrintDialog* self, int metricA, int metricB) {
	return self->QAbstractPrintDialog::getDecodedMetricF(static_cast<VirtualQAbstractPrintDialog::PaintDeviceMetric>(metricA), static_cast<VirtualQAbstractPrintDialog::PaintDeviceMetric>(metricB));
}
