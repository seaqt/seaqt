...
bool miqt_exec_callback_QPrintPreviewDialog_nativeEvent(QPrintPreviewDialog*, intptr_t, struct miqt_string, void*, long*);
...
public:
	...
	friend bool QPrintPreviewDialog_virtualbase_nativeEvent(void* self, struct miqt_string eventType, void* message, long* result);
...
void QPrintPreviewDialog_connect_paintRequested(QPrintPreviewDialog* self, intptr_t slot) {
	VirtualQPrintPreviewDialog::connect(self, static_cast<void (QPrintPreviewDialog::*)(QPrinter*)>(&QPrintPreviewDialog::paintRequested), self, [=](QPrinter* printer) {
...
bool QPrintPreviewDialog_virtualbase_nativeEvent(void* self, struct miqt_string eventType, void* message, long* result) {
	...
	return ( (VirtualQPrintPreviewDialog*)(self) )->QPrintPreviewDialog::nativeEvent(eventType_QByteArray, message, static_cast<long*>(result));
