...
public:
	...
	friend double QPrintPreviewDialog_protectedbase_getDecodedMetricF(const VirtualQPrintPreviewDialog* self, int metricA, int metricB);
};
...
void QPrintPreviewDialog_connect_paintRequested(QPrintPreviewDialog* self, intptr_t slot, void (*callback)(intptr_t, QPrinter*), void (*release)(intptr_t)) {
	QPrintPreviewDialog::connect(self, static_cast<void (QPrintPreviewDialog::*)(QPrinter*)>(&QPrintPreviewDialog::paintRequested), self, [callback, release = seaqt::release_callback{slot,release}](QPrinter* printer) {
...
double QPrintPreviewDialog_protectedbase_getDecodedMetricF(const VirtualQPrintPreviewDialog* self, int metricA, int metricB) {
	return self->QPrintPreviewDialog::getDecodedMetricF(static_cast<VirtualQPrintPreviewDialog::PaintDeviceMetric>(metricA), static_cast<VirtualQPrintPreviewDialog::PaintDeviceMetric>(metricB));
}
