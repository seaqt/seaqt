...
public:
	...
	friend double QPrinter_protectedbase_getDecodedMetricF(const VirtualQPrinter* self, int metricA, int metricB);
};
...
double QPrinter_protectedbase_getDecodedMetricF(const VirtualQPrinter* self, int metricA, int metricB) {
	return self->QPrinter::getDecodedMetricF(static_cast<VirtualQPrinter::PaintDeviceMetric>(metricA), static_cast<VirtualQPrinter::PaintDeviceMetric>(metricB));
}
