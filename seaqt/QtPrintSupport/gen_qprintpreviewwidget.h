...
typedef struct QPrintPreviewWidget_VTable{
	...
	void (*enterEvent)(VirtualQPrintPreviewWidget* self, QEnterEvent* event);
	...
	bool (*nativeEvent)(VirtualQPrintPreviewWidget* self, struct seaqt_string eventType, void* message, intptr_t* result);
