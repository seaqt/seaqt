...
struct QPrintPreviewWidget_VTable {
	...
	void (*enterEvent)(struct QPrintPreviewWidget_VTable* vtbl, QPrintPreviewWidget* self, QEvent* event);
	...
	bool (*nativeEvent)(struct QPrintPreviewWidget_VTable* vtbl, QPrintPreviewWidget* self, struct miqt_string eventType, void* message, long* result);
