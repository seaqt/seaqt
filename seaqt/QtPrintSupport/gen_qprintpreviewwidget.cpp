...
bool miqt_exec_callback_QPrintPreviewWidget_nativeEvent(QPrintPreviewWidget*, intptr_t, struct seaqt_string, void*, long*);
...
public:
	...
	friend bool QPrintPreviewWidget_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, long* result);
...
bool QPrintPreviewWidget_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, long* result) {
	QByteArray eventType_QByteArray(eventType.data, eventType.len);
	return static_cast<VirtualQPrintPreviewWidget*>(self)->QPrintPreviewWidget::nativeEvent(eventType_QByteArray, message, static_cast<long*>(result));
}
