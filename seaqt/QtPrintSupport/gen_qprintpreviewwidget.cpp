...
public:
	...
	friend double QPrintPreviewWidget_protectedbase_getDecodedMetricF(const VirtualQPrintPreviewWidget* self, int metricA, int metricB);
};
...
double QPrintPreviewWidget_protectedbase_getDecodedMetricF(const VirtualQPrintPreviewWidget* self, int metricA, int metricB) {
	return self->QPrintPreviewWidget::getDecodedMetricF(static_cast<VirtualQPrintPreviewWidget::PaintDeviceMetric>(metricA), static_cast<VirtualQPrintPreviewWidget::PaintDeviceMetric>(metricB));
}
