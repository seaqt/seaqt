...
public:
	...
	friend void QPrintPreviewWidget_virtualbase_enterEvent(VirtualQPrintPreviewWidget* self, QEvent* event);
	...
	friend bool QPrintPreviewWidget_virtualbase_nativeEvent(VirtualQPrintPreviewWidget* self, struct seaqt_string eventType, void* message, long* result);
...
VirtualQPrintPreviewWidget* QPrintPreviewWidget_new(const QPrintPreviewWidget_VTable* vtbl, size_t vdata, QPrinter* printer) {
...
VirtualQPrintPreviewWidget* QPrintPreviewWidget_new2(const QPrintPreviewWidget_VTable* vtbl, size_t vdata) {
	void* _mem_ = ::operator new(seaqt_aligned_sizeof<VirtualQPrintPreviewWidget>() + vdata, std::nothrow);
	return _mem_ ? new (_mem_)VirtualQPrintPreviewWidget(vtbl) : nullptr;
}

VirtualQPrintPreviewWidget* QPrintPreviewWidget_new3(const QPrintPreviewWidget_VTable* vtbl, size_t vdata, QPrinter* printer, QWidget* parent) {
	void* _mem_ = ::operator new(seaqt_aligned_sizeof<VirtualQPrintPreviewWidget>() + vdata, std::nothrow);
	return _mem_ ? new (_mem_)VirtualQPrintPreviewWidget(vtbl, printer, parent) : nullptr;
}

VirtualQPrintPreviewWidget* QPrintPreviewWidget_new4(const QPrintPreviewWidget_VTable* vtbl, size_t vdata, QPrinter* printer, QWidget* parent, int flags) {
	void* _mem_ = ::operator new(seaqt_aligned_sizeof<VirtualQPrintPreviewWidget>() + vdata, std::nothrow);
	return _mem_ ? new (_mem_)VirtualQPrintPreviewWidget(vtbl, printer, parent, static_cast<Qt::WindowFlags>(flags)) : nullptr;
}

VirtualQPrintPreviewWidget* QPrintPreviewWidget_new5(const QPrintPreviewWidget_VTable* vtbl, size_t vdata, QWidget* parent) {
	void* _mem_ = ::operator new(seaqt_aligned_sizeof<VirtualQPrintPreviewWidget>() + vdata, std::nothrow);
...
void QPrintPreviewWidget_connect_paintRequested(QPrintPreviewWidget* self, intptr_t slot, void (*callback)(intptr_t, QPrinter*), void (*release)(intptr_t)) {
	...
	QPrintPreviewWidget::connect(self, static_cast<void (QPrintPreviewWidget::*)(QPrinter*)>(&QPrintPreviewWidget::paintRequested), self, local_caller{slot, callback, release});
}
...
bool QPrintPreviewWidget_virtualbase_nativeEvent(VirtualQPrintPreviewWidget* self, struct seaqt_string eventType, void* message, long* result) {
	...
	return self->QPrintPreviewWidget::nativeEvent(eventType_QByteArray, message, static_cast<long*>(result));
}
