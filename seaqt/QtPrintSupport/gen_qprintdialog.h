...
struct QPrintDialog_VTable {
	...
	void (*enterEvent)(struct QPrintDialog_VTable* vtbl, QPrintDialog* self, QEnterEvent* event);
	...
	bool (*nativeEvent)(struct QPrintDialog_VTable* vtbl, QPrintDialog* self, struct miqt_string eventType, void* message, intptr_t* result);
