...
struct QPrintPreviewDialog_VTable {
	...
	void (*enterEvent)(struct QPrintPreviewDialog_VTable* vtbl, QPrintPreviewDialog* self, QEnterEvent* event);
	...
	bool (*nativeEvent)(struct QPrintPreviewDialog_VTable* vtbl, QPrintPreviewDialog* self, struct miqt_string eventType, void* message, intptr_t* result);
