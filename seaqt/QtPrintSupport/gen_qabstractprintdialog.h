...
typedef struct QAbstractPrintDialog_VTable{
	...
	void (*enterEvent)(VirtualQAbstractPrintDialog* self, QEvent* event);
	...
	bool (*nativeEvent)(VirtualQAbstractPrintDialog* self, struct seaqt_string eventType, void* message, long* result);
...
bool QAbstractPrintDialog_virtualbase_nativeEvent(VirtualQAbstractPrintDialog* self, struct seaqt_string eventType, void* message, long* result);
