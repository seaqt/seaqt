...
struct QAbstractPrintDialog_VTable {
	...
	void (*enterEvent)(struct QAbstractPrintDialog_VTable* vtbl, QAbstractPrintDialog* self, QEnterEvent* event);
	...
	bool (*nativeEvent)(struct QAbstractPrintDialog_VTable* vtbl, QAbstractPrintDialog* self, struct miqt_string eventType, void* message, intptr_t* result);
