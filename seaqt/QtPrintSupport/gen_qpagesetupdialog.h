...
typedef struct QPageSetupDialog_VTable{
	...
	void (*enterEvent)(VirtualQPageSetupDialog* self, QEvent* event);
	...
	bool (*nativeEvent)(VirtualQPageSetupDialog* self, struct seaqt_string eventType, void* message, long* result);
...
struct seaqt_string QPageSetupDialog_trUtf8_s(const char* s);
...
struct seaqt_string QPageSetupDialog_trUtf8_s_c(const char* s, const char* c);
struct seaqt_string QPageSetupDialog_trUtf8_s_c_n(const char* s, const char* c, int n);
