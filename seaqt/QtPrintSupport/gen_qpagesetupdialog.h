...
struct QPageSetupDialog_VTable {
	...
	void (*enterEvent)(struct QPageSetupDialog_VTable* vtbl, QPageSetupDialog* self, QEvent* event);
	...
	bool (*nativeEvent)(struct QPageSetupDialog_VTable* vtbl, QPageSetupDialog* self, struct miqt_string eventType, void* message, long* result);
