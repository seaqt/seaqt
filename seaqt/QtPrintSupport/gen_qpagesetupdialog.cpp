...
bool QPageSetupDialog_virtualbase_nativeEvent(void* self, struct miqt_string eventType, void* message, long* result) {
	...
	return ( (VirtualQPageSetupDialog*)(self) )->QPageSetupDialog::nativeEvent(eventType_QByteArray, message, static_cast<long*>(result));
...
void QPageSetupDialog_protectedbase_adjustPosition(void* self, QWidget* param1) {
	VirtualQPageSetupDialog* self_cast = static_cast<VirtualQPageSetupDialog*>( (QPageSetupDialog*)(self) );
