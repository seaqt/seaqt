...
public:
	...
	friend double QPageSetupDialog_protectedbase_getDecodedMetricF(const VirtualQPageSetupDialog* self, int metricA, int metricB);
};
...
double QPageSetupDialog_protectedbase_getDecodedMetricF(const VirtualQPageSetupDialog* self, int metricA, int metricB) {
	return self->QPageSetupDialog::getDecodedMetricF(static_cast<VirtualQPageSetupDialog::PaintDeviceMetric>(metricA), static_cast<VirtualQPageSetupDialog::PaintDeviceMetric>(metricB));
}
