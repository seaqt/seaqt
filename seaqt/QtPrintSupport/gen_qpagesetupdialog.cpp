...
bool miqt_exec_callback_QPageSetupDialog_nativeEvent(QPageSetupDialog*, intptr_t, struct seaqt_string, void*, long*);
...
public:
	...
	friend bool QPageSetupDialog_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, long* result);
...
bool QPageSetupDialog_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, long* result) {
	QByteArray eventType_QByteArray(eventType.data, eventType.len);
	return static_cast<VirtualQPageSetupDialog*>(self)->QPageSetupDialog::nativeEvent(eventType_QByteArray, message, static_cast<long*>(result));
}
