...
public:
	...
	virtual ~VirtualQDesignerContainerExtension() override = default;
...
QDesignerContainerExtension* QDesignerContainerExtension_new() {
	return new (std::nothrow) VirtualQDesignerContainerExtension();
}
...
bool QDesignerContainerExtension_override_virtual_count(void* self, intptr_t slot) {
	VirtualQDesignerContainerExtension* self_cast = dynamic_cast<VirtualQDesignerContainerExtension*>( (QDesignerContainerExtension*)(self) );
