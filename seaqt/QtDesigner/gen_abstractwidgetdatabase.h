...
struct seaqt_string QDesignerWidgetDataBaseItemInterface_virtualbase_name(const void* self);
bool QDesignerWidgetDataBaseItemInterface_override_virtual_setName(void* self, intptr_t slot);
void QDesignerWidgetDataBaseItemInterface_virtualbase_setName(void* self, struct seaqt_string name);
bool QDesignerWidgetDataBaseItemInterface_override_virtual_group(void* self, intptr_t slot);
struct seaqt_string QDesignerWidgetDataBaseItemInterface_virtualbase_group(const void* self);
bool QDesignerWidgetDataBaseItemInterface_override_virtual_setGroup(void* self, intptr_t slot);
void QDesignerWidgetDataBaseItemInterface_virtualbase_setGroup(void* self, struct seaqt_string group);
bool QDesignerWidgetDataBaseItemInterface_override_virtual_toolTip(void* self, intptr_t slot);
struct seaqt_string QDesignerWidgetDataBaseItemInterface_virtualbase_toolTip(const void* self);
bool QDesignerWidgetDataBaseItemInterface_override_virtual_setToolTip(void* self, intptr_t slot);
void QDesignerWidgetDataBaseItemInterface_virtualbase_setToolTip(void* self, struct seaqt_string toolTip);
bool QDesignerWidgetDataBaseItemInterface_override_virtual_whatsThis(void* self, intptr_t slot);
struct seaqt_string QDesignerWidgetDataBaseItemInterface_virtualbase_whatsThis(const void* self);
bool QDesignerWidgetDataBaseItemInterface_override_virtual_setWhatsThis(void* self, intptr_t slot);
void QDesignerWidgetDataBaseItemInterface_virtualbase_setWhatsThis(void* self, struct seaqt_string whatsThis);
bool QDesignerWidgetDataBaseItemInterface_override_virtual_includeFile(void* self, intptr_t slot);
struct seaqt_string QDesignerWidgetDataBaseItemInterface_virtualbase_includeFile(const void* self);
bool QDesignerWidgetDataBaseItemInterface_override_virtual_setIncludeFile(void* self, intptr_t slot);
void QDesignerWidgetDataBaseItemInterface_virtualbase_setIncludeFile(void* self, struct seaqt_string includeFile);
...
struct seaqt_string QDesignerWidgetDataBaseItemInterface_virtualbase_pluginPath(const void* self);
bool QDesignerWidgetDataBaseItemInterface_override_virtual_setPluginPath(void* self, intptr_t slot);
void QDesignerWidgetDataBaseItemInterface_virtualbase_setPluginPath(void* self, struct seaqt_string path);
...
struct seaqt_string QDesignerWidgetDataBaseItemInterface_virtualbase_extends(const void* self);
bool QDesignerWidgetDataBaseItemInterface_override_virtual_setExtends(void* self, intptr_t slot);
void QDesignerWidgetDataBaseItemInterface_virtualbase_setExtends(void* self, struct seaqt_string s);
bool QDesignerWidgetDataBaseItemInterface_override_virtual_setDefaultPropertyValues(void* self, intptr_t slot);
void QDesignerWidgetDataBaseItemInterface_virtualbase_setDefaultPropertyValues(void* self, struct seaqt_array /* of QVariant* */  list);
bool QDesignerWidgetDataBaseItemInterface_override_virtual_defaultPropertyValues(void* self, intptr_t slot);
struct seaqt_array /* of QVariant* */  QDesignerWidgetDataBaseItemInterface_virtualbase_defaultPropertyValues(const void* self);
