...
struct seaqt_array /* of QObject* */  miqt_exec_callback_QDesignerMetaDataBaseInterface_objects(const QDesignerMetaDataBaseInterface*, intptr_t);
...
class VirtualQDesignerMetaDataBaseInterface final : public QDesignerMetaDataBaseInterface {
public:
	...
	virtual ~VirtualQDesignerMetaDataBaseInterface() override = default;
	...
	virtual QList<QObject *> objects() const override {
		...
		struct seaqt_array /* of QObject* */  callback_return_value = miqt_exec_callback_QDesignerMetaDataBaseInterface_objects(this, handle__objects);
...
QDesignerMetaDataBaseInterface* QDesignerMetaDataBaseInterface_new() {
	return new (std::nothrow) VirtualQDesignerMetaDataBaseInterface();
}

QDesignerMetaDataBaseInterface* QDesignerMetaDataBaseInterface_new2(QObject* parent) {
	return new (std::nothrow) VirtualQDesignerMetaDataBaseInterface(parent);
}
...
bool QDesignerMetaDataBaseInterface_override_virtual_item(void* self, intptr_t slot) {
	VirtualQDesignerMetaDataBaseInterface* self_cast = dynamic_cast<VirtualQDesignerMetaDataBaseInterface*>( (QDesignerMetaDataBaseInterface*)(self) );
	if (self_cast == nullptr) {
		return false;
	}
...
bool QDesignerMetaDataBaseInterface_virtualbase_event(void* self, QEvent* event) {
	return static_cast<VirtualQDesignerMetaDataBaseInterface*>(self)->QDesignerMetaDataBaseInterface::event(event);
}
...
bool QDesignerMetaDataBaseInterface_virtualbase_eventFilter(void* self, QObject* watched, QEvent* event) {
	return static_cast<VirtualQDesignerMetaDataBaseInterface*>(self)->QDesignerMetaDataBaseInterface::eventFilter(watched, event);
}
...
void QDesignerMetaDataBaseInterface_virtualbase_timerEvent(void* self, QTimerEvent* event) {
	static_cast<VirtualQDesignerMetaDataBaseInterface*>(self)->QDesignerMetaDataBaseInterface::timerEvent(event);
}
...
void QDesignerMetaDataBaseInterface_virtualbase_childEvent(void* self, QChildEvent* event) {
	static_cast<VirtualQDesignerMetaDataBaseInterface*>(self)->QDesignerMetaDataBaseInterface::childEvent(event);
}
...
void QDesignerMetaDataBaseInterface_virtualbase_customEvent(void* self, QEvent* event) {
	static_cast<VirtualQDesignerMetaDataBaseInterface*>(self)->QDesignerMetaDataBaseInterface::customEvent(event);
}
...
void QDesignerMetaDataBaseInterface_virtualbase_connectNotify(void* self, QMetaMethod* signal) {
	static_cast<VirtualQDesignerMetaDataBaseInterface*>(self)->QDesignerMetaDataBaseInterface::connectNotify(*signal);
}
...
void QDesignerMetaDataBaseInterface_virtualbase_disconnectNotify(void* self, QMetaMethod* signal) {
	static_cast<VirtualQDesignerMetaDataBaseInterface*>(self)->QDesignerMetaDataBaseInterface::disconnectNotify(*signal);
}
