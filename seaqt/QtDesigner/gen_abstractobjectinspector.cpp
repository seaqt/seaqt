...
public:
	...
	friend double QDesignerObjectInspectorInterface_protectedbase_getDecodedMetricF(const VirtualQDesignerObjectInspectorInterface* self, int metricA, int metricB);
};
...
double QDesignerObjectInspectorInterface_protectedbase_getDecodedMetricF(const VirtualQDesignerObjectInspectorInterface* self, int metricA, int metricB) {
	return self->QDesignerObjectInspectorInterface::getDecodedMetricF(static_cast<VirtualQDesignerObjectInspectorInterface::PaintDeviceMetric>(metricA), static_cast<VirtualQDesignerObjectInspectorInterface::PaintDeviceMetric>(metricB));
}
