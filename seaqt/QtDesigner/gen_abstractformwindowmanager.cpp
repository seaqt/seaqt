...
void miqt_exec_callback_QDesignerFormWindowManagerInterface_dragItems(QDesignerFormWindowManagerInterface*, intptr_t, struct seaqt_array /* of QDesignerDnDItemInterface* */ );
...
class VirtualQDesignerFormWindowManagerInterface final : public QDesignerFormWindowManagerInterface {
public:
	...
	virtual ~VirtualQDesignerFormWindowManagerInterface() override = default;
...
QDesignerFormWindowManagerInterface* QDesignerFormWindowManagerInterface_new() {
	return new (std::nothrow) VirtualQDesignerFormWindowManagerInterface();
}

QDesignerFormWindowManagerInterface* QDesignerFormWindowManagerInterface_new2(QObject* parent) {
	return new (std::nothrow) VirtualQDesignerFormWindowManagerInterface(parent);
}
...
bool QDesignerFormWindowManagerInterface_override_virtual_action(void* self, intptr_t slot) {
	VirtualQDesignerFormWindowManagerInterface* self_cast = dynamic_cast<VirtualQDesignerFormWindowManagerInterface*>( (QDesignerFormWindowManagerInterface*)(self) );
...
bool QDesignerFormWindowManagerInterface_virtualbase_event(void* self, QEvent* event) {
	return static_cast<VirtualQDesignerFormWindowManagerInterface*>(self)->QDesignerFormWindowManagerInterface::event(event);
}
...
bool QDesignerFormWindowManagerInterface_virtualbase_eventFilter(void* self, QObject* watched, QEvent* event) {
	return static_cast<VirtualQDesignerFormWindowManagerInterface*>(self)->QDesignerFormWindowManagerInterface::eventFilter(watched, event);
}
...
void QDesignerFormWindowManagerInterface_virtualbase_timerEvent(void* self, QTimerEvent* event) {
	static_cast<VirtualQDesignerFormWindowManagerInterface*>(self)->QDesignerFormWindowManagerInterface::timerEvent(event);
}
...
void QDesignerFormWindowManagerInterface_virtualbase_childEvent(void* self, QChildEvent* event) {
	static_cast<VirtualQDesignerFormWindowManagerInterface*>(self)->QDesignerFormWindowManagerInterface::childEvent(event);
}
...
void QDesignerFormWindowManagerInterface_virtualbase_customEvent(void* self, QEvent* event) {
	static_cast<VirtualQDesignerFormWindowManagerInterface*>(self)->QDesignerFormWindowManagerInterface::customEvent(event);
}
...
void QDesignerFormWindowManagerInterface_virtualbase_connectNotify(void* self, QMetaMethod* signal) {
	static_cast<VirtualQDesignerFormWindowManagerInterface*>(self)->QDesignerFormWindowManagerInterface::connectNotify(*signal);
}
...
void QDesignerFormWindowManagerInterface_virtualbase_disconnectNotify(void* self, QMetaMethod* signal) {
	static_cast<VirtualQDesignerFormWindowManagerInterface*>(self)->QDesignerFormWindowManagerInterface::disconnectNotify(*signal);
}
