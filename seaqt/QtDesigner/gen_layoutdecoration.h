...
struct seaqt_array /* of QWidget* */  QDesignerLayoutDecorationExtension_virtualbase_widgets(const void* self, QLayout* layout);
...
struct seaqt_map /* tuple of int and int */  QDesignerLayoutDecorationExtension_virtualbase_currentCell(const void* self);
bool QDesignerLayoutDecorationExtension_override_virtual_insertWidget(void* self, intptr_t slot);
void QDesignerLayoutDecorationExtension_virtualbase_insertWidget(void* self, QWidget* widget, struct seaqt_map /* tuple of int and int */  cell);
