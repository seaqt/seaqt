...
typedef struct QDesignerLayoutDecorationExtension_VTable{
	...
	int (*indexOf)(const VirtualQDesignerLayoutDecorationExtension* self, QWidget* widget);
	int (*indexOfWithItem)(const VirtualQDesignerLayoutDecorationExtension* self, QLayoutItem* item);
	...
	int (*findItemAt)(const VirtualQDesignerLayoutDecorationExtension* self, QPoint* pos);
	int (*findItemAt2)(const VirtualQDesignerLayoutDecorationExtension* self, int row, int column);
...
int QDesignerLayoutDecorationExtension_virtualbase_indexOf(const VirtualQDesignerLayoutDecorationExtension* self, QWidget* widget);
int QDesignerLayoutDecorationExtension_virtualbase_indexOfWithItem(const VirtualQDesignerLayoutDecorationExtension* self, QLayoutItem* item);
...
int QDesignerLayoutDecorationExtension_virtualbase_findItemAt(const VirtualQDesignerLayoutDecorationExtension* self, QPoint* pos);
int QDesignerLayoutDecorationExtension_virtualbase_findItemAt2(const VirtualQDesignerLayoutDecorationExtension* self, int row, int column);
