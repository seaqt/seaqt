...
public:
	...
	virtual ~VirtualQDesignerFormEditorInterface() override = default;
...
QDesignerFormEditorInterface* QDesignerFormEditorInterface_new() {
	return new (std::nothrow) VirtualQDesignerFormEditorInterface();
}

QDesignerFormEditorInterface* QDesignerFormEditorInterface_new2(QObject* parent) {
	return new (std::nothrow) VirtualQDesignerFormEditorInterface(parent);
}
...
struct seaqt_string QDesignerFormEditorInterface_tr(const char* s) {
...
struct seaqt_string QDesignerFormEditorInterface_resourceLocation(const QDesignerFormEditorInterface* self) {
...
struct seaqt_array /* of QDesignerOptionsPageInterface* */  QDesignerFormEditorInterface_optionsPages(const QDesignerFormEditorInterface* self) {
...
void QDesignerFormEditorInterface_setOptionsPages(QDesignerFormEditorInterface* self, struct seaqt_array /* of QDesignerOptionsPageInterface* */  optionsPages) {
...
struct seaqt_array /* of QObject* */  QDesignerFormEditorInterface_pluginInstances(const QDesignerFormEditorInterface* self) {
...
QIcon* QDesignerFormEditorInterface_createIcon(struct seaqt_string name) {
	QString name_QString = QString::fromUtf8(name.data, name.len);
	return new QIcon(QDesignerFormEditorInterface::createIcon(name_QString));
}

struct seaqt_string QDesignerFormEditorInterface_tr2(const char* s, const char* c) {
...
struct seaqt_string QDesignerFormEditorInterface_tr3(const char* s, const char* c, int n) {
...
bool QDesignerFormEditorInterface_override_virtual_event(void* self, intptr_t slot) {
	VirtualQDesignerFormEditorInterface* self_cast = dynamic_cast<VirtualQDesignerFormEditorInterface*>( (QDesignerFormEditorInterface*)(self) );
...
bool QDesignerFormEditorInterface_virtualbase_event(void* self, QEvent* event) {
	return static_cast<VirtualQDesignerFormEditorInterface*>(self)->QDesignerFormEditorInterface::event(event);
}
...
bool QDesignerFormEditorInterface_virtualbase_eventFilter(void* self, QObject* watched, QEvent* event) {
	return static_cast<VirtualQDesignerFormEditorInterface*>(self)->QDesignerFormEditorInterface::eventFilter(watched, event);
}
...
void QDesignerFormEditorInterface_virtualbase_timerEvent(void* self, QTimerEvent* event) {
	static_cast<VirtualQDesignerFormEditorInterface*>(self)->QDesignerFormEditorInterface::timerEvent(event);
}
...
void QDesignerFormEditorInterface_virtualbase_childEvent(void* self, QChildEvent* event) {
	static_cast<VirtualQDesignerFormEditorInterface*>(self)->QDesignerFormEditorInterface::childEvent(event);
}
...
void QDesignerFormEditorInterface_virtualbase_customEvent(void* self, QEvent* event) {
	static_cast<VirtualQDesignerFormEditorInterface*>(self)->QDesignerFormEditorInterface::customEvent(event);
}
...
void QDesignerFormEditorInterface_virtualbase_connectNotify(void* self, QMetaMethod* signal) {
	static_cast<VirtualQDesignerFormEditorInterface*>(self)->QDesignerFormEditorInterface::connectNotify(*signal);
}
...
void QDesignerFormEditorInterface_virtualbase_disconnectNotify(void* self, QMetaMethod* signal) {
	static_cast<VirtualQDesignerFormEditorInterface*>(self)->QDesignerFormEditorInterface::disconnectNotify(*signal);
}
