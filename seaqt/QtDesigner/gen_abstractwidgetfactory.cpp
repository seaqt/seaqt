...
QWidget* miqt_exec_callback_QDesignerWidgetFactoryInterface_createWidget(const QDesignerWidgetFactoryInterface*, intptr_t, struct seaqt_string, QWidget*);
...
class VirtualQDesignerWidgetFactoryInterface final : public QDesignerWidgetFactoryInterface {
public:
	...
	virtual ~VirtualQDesignerWidgetFactoryInterface() override = default;
...
QDesignerWidgetFactoryInterface* QDesignerWidgetFactoryInterface_new() {
	return new (std::nothrow) VirtualQDesignerWidgetFactoryInterface();
}

QDesignerWidgetFactoryInterface* QDesignerWidgetFactoryInterface_new2(QObject* parent) {
	return new (std::nothrow) VirtualQDesignerWidgetFactoryInterface(parent);
}
...
bool QDesignerWidgetFactoryInterface_override_virtual_core(void* self, intptr_t slot) {
	VirtualQDesignerWidgetFactoryInterface* self_cast = dynamic_cast<VirtualQDesignerWidgetFactoryInterface*>( (QDesignerWidgetFactoryInterface*)(self) );
...
bool QDesignerWidgetFactoryInterface_virtualbase_event(void* self, QEvent* event) {
	return static_cast<VirtualQDesignerWidgetFactoryInterface*>(self)->QDesignerWidgetFactoryInterface::event(event);
}
...
bool QDesignerWidgetFactoryInterface_virtualbase_eventFilter(void* self, QObject* watched, QEvent* event) {
	return static_cast<VirtualQDesignerWidgetFactoryInterface*>(self)->QDesignerWidgetFactoryInterface::eventFilter(watched, event);
}
...
void QDesignerWidgetFactoryInterface_virtualbase_timerEvent(void* self, QTimerEvent* event) {
	static_cast<VirtualQDesignerWidgetFactoryInterface*>(self)->QDesignerWidgetFactoryInterface::timerEvent(event);
}
...
void QDesignerWidgetFactoryInterface_virtualbase_childEvent(void* self, QChildEvent* event) {
	static_cast<VirtualQDesignerWidgetFactoryInterface*>(self)->QDesignerWidgetFactoryInterface::childEvent(event);
}
...
void QDesignerWidgetFactoryInterface_virtualbase_customEvent(void* self, QEvent* event) {
	static_cast<VirtualQDesignerWidgetFactoryInterface*>(self)->QDesignerWidgetFactoryInterface::customEvent(event);
}
...
void QDesignerWidgetFactoryInterface_virtualbase_connectNotify(void* self, QMetaMethod* signal) {
	static_cast<VirtualQDesignerWidgetFactoryInterface*>(self)->QDesignerWidgetFactoryInterface::connectNotify(*signal);
}
...
void QDesignerWidgetFactoryInterface_virtualbase_disconnectNotify(void* self, QMetaMethod* signal) {
	static_cast<VirtualQDesignerWidgetFactoryInterface*>(self)->QDesignerWidgetFactoryInterface::disconnectNotify(*signal);
}
