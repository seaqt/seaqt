...
void miqt_exec_callback_QDesignerIntegrationInterface_propertyChanged(intptr_t, QDesignerFormWindowInterface*, struct seaqt_string, QVariant*);
void miqt_exec_callback_QDesignerIntegrationInterface_objectNameChanged(intptr_t, QDesignerFormWindowInterface*, QObject*, struct seaqt_string, struct seaqt_string);
void miqt_exec_callback_QDesignerIntegrationInterface_helpRequested(intptr_t, struct seaqt_string, struct seaqt_string);
void miqt_exec_callback_QDesignerIntegrationInterface_navigateToSlot(intptr_t, struct seaqt_string, struct seaqt_string, struct seaqt_array /* of struct seaqt_string */ );
void miqt_exec_callback_QDesignerIntegrationInterface_navigateToSlotWithSlotSignature(intptr_t, struct seaqt_string);
...
struct seaqt_string miqt_exec_callback_QDesignerIntegrationInterface_headerSuffix(const QDesignerIntegrationInterface*, intptr_t);
void miqt_exec_callback_QDesignerIntegrationInterface_setHeaderSuffix(QDesignerIntegrationInterface*, intptr_t, struct seaqt_string);
...
struct seaqt_string miqt_exec_callback_QDesignerIntegrationInterface_contextHelpId(const QDesignerIntegrationInterface*, intptr_t);
void miqt_exec_callback_QDesignerIntegrationInterface_setFeatures(QDesignerIntegrationInterface*, intptr_t, int);
void miqt_exec_callback_QDesignerIntegrationInterface_updateProperty(QDesignerIntegrationInterface*, intptr_t, struct seaqt_string, QVariant*, bool);
void miqt_exec_callback_QDesignerIntegrationInterface_updateProperty2(QDesignerIntegrationInterface*, intptr_t, struct seaqt_string, QVariant*);
void miqt_exec_callback_QDesignerIntegrationInterface_resetProperty(QDesignerIntegrationInterface*, intptr_t, struct seaqt_string);
void miqt_exec_callback_QDesignerIntegrationInterface_addDynamicProperty(QDesignerIntegrationInterface*, intptr_t, struct seaqt_string, QVariant*);
void miqt_exec_callback_QDesignerIntegrationInterface_removeDynamicProperty(QDesignerIntegrationInterface*, intptr_t, struct seaqt_string);
...
struct seaqt_string miqt_exec_callback_QDesignerIntegration_headerSuffix(const QDesignerIntegration*, intptr_t);
void miqt_exec_callback_QDesignerIntegration_setHeaderSuffix(QDesignerIntegration*, intptr_t, struct seaqt_string);
...
struct seaqt_string miqt_exec_callback_QDesignerIntegration_contextHelpId(const QDesignerIntegration*, intptr_t);
void miqt_exec_callback_QDesignerIntegration_updateProperty(QDesignerIntegration*, intptr_t, struct seaqt_string, QVariant*, bool);
void miqt_exec_callback_QDesignerIntegration_updateProperty2(QDesignerIntegration*, intptr_t, struct seaqt_string, QVariant*);
void miqt_exec_callback_QDesignerIntegration_resetProperty(QDesignerIntegration*, intptr_t, struct seaqt_string);
void miqt_exec_callback_QDesignerIntegration_addDynamicProperty(QDesignerIntegration*, intptr_t, struct seaqt_string, QVariant*);
void miqt_exec_callback_QDesignerIntegration_removeDynamicProperty(QDesignerIntegration*, intptr_t, struct seaqt_string);
...
class VirtualQDesignerIntegrationInterface final : public QDesignerIntegrationInterface {
public:
	...
	virtual ~VirtualQDesignerIntegrationInterface() override = default;
	...
	virtual QString headerSuffix() const override {
		...
		struct seaqt_string callback_return_value = miqt_exec_callback_QDesignerIntegrationInterface_headerSuffix(this, handle__headerSuffix);
	...
	virtual void setHeaderSuffix(const QString& headerSuffix) override {
		...
		struct seaqt_string headerSuffix_ms;
		...
		struct seaqt_string sigval1 = headerSuffix_ms;
	...
	virtual QString contextHelpId() const override {
		...
		struct seaqt_string callback_return_value = miqt_exec_callback_QDesignerIntegrationInterface_contextHelpId(this, handle__contextHelpId);
		QString callback_return_value_QString = QString::fromUtf8(callback_return_value.data, callback_return_value.len);
		return callback_return_value_QString;
	}
...
QDesignerIntegrationInterface* QDesignerIntegrationInterface_new(QDesignerFormEditorInterface* core) {
	return new (std::nothrow) VirtualQDesignerIntegrationInterface(core);
}

QDesignerIntegrationInterface* QDesignerIntegrationInterface_new2(QDesignerFormEditorInterface* core, QObject* parent) {
	return new (std::nothrow) VirtualQDesignerIntegrationInterface(core, parent);
}
...
void QDesignerIntegrationInterface_emitNavigateToSlot(QDesignerIntegrationInterface* self, struct seaqt_string objectName, struct seaqt_string signalSignature, struct seaqt_array /* of struct seaqt_string */  parameterNames) {
...
void QDesignerIntegrationInterface_emitNavigateToSlotWithSlotSignature(QDesignerIntegrationInterface* self, struct seaqt_string slotSignature) {
...
void QDesignerIntegrationInterface_navigateToSlot(QDesignerIntegrationInterface* self, struct seaqt_string objectName, struct seaqt_string signalSignature, struct seaqt_array /* of struct seaqt_string */  parameterNames) {
	QString objectName_QString = QString::fromUtf8(objectName.data, objectName.len);
	QString signalSignature_QString = QString::fromUtf8(signalSignature.data, signalSignature.len);
	QStringList parameterNames_QList;
	parameterNames_QList.reserve(parameterNames.len);
...
void QDesignerIntegrationInterface_navigateToSlotWithSlotSignature(QDesignerIntegrationInterface* self, struct seaqt_string slotSignature) {
	QString slotSignature_QString = QString::fromUtf8(slotSignature.data, slotSignature.len);
...
void QDesignerIntegrationInterface_updateProperty(QDesignerIntegrationInterface* self, struct seaqt_string name, QVariant* value, bool enableSubPropertyHandling) {
	QString name_QString = QString::fromUtf8(name.data, name.len);
	self->updateProperty(name_QString, *value, enableSubPropertyHandling);
}

void QDesignerIntegrationInterface_updateProperty2(QDesignerIntegrationInterface* self, struct seaqt_string name, QVariant* value) {
	QString name_QString = QString::fromUtf8(name.data, name.len);
...
bool QDesignerIntegrationInterface_override_virtual_containerWindow(void* self, intptr_t slot) {
	VirtualQDesignerIntegrationInterface* self_cast = dynamic_cast<VirtualQDesignerIntegrationInterface*>( (QDesignerIntegrationInterface*)(self) );
...
bool QDesignerIntegrationInterface_virtualbase_event(void* self, QEvent* event) {
	return static_cast<VirtualQDesignerIntegrationInterface*>(self)->QDesignerIntegrationInterface::event(event);
}
...
bool QDesignerIntegrationInterface_virtualbase_eventFilter(void* self, QObject* watched, QEvent* event) {
	return static_cast<VirtualQDesignerIntegrationInterface*>(self)->QDesignerIntegrationInterface::eventFilter(watched, event);
}
...
void QDesignerIntegrationInterface_virtualbase_timerEvent(void* self, QTimerEvent* event) {
	static_cast<VirtualQDesignerIntegrationInterface*>(self)->QDesignerIntegrationInterface::timerEvent(event);
}
...
void QDesignerIntegrationInterface_virtualbase_childEvent(void* self, QChildEvent* event) {
	static_cast<VirtualQDesignerIntegrationInterface*>(self)->QDesignerIntegrationInterface::childEvent(event);
}
...
void QDesignerIntegrationInterface_virtualbase_customEvent(void* self, QEvent* event) {
	static_cast<VirtualQDesignerIntegrationInterface*>(self)->QDesignerIntegrationInterface::customEvent(event);
}
...
void QDesignerIntegrationInterface_virtualbase_connectNotify(void* self, QMetaMethod* signal) {
	static_cast<VirtualQDesignerIntegrationInterface*>(self)->QDesignerIntegrationInterface::connectNotify(*signal);
}
...
void QDesignerIntegrationInterface_virtualbase_disconnectNotify(void* self, QMetaMethod* signal) {
	static_cast<VirtualQDesignerIntegrationInterface*>(self)->QDesignerIntegrationInterface::disconnectNotify(*signal);
}
...
public:
	...
	virtual ~VirtualQDesignerIntegration() override = default;
	...
	virtual QString headerSuffix() const override {
		...
		struct seaqt_string callback_return_value = miqt_exec_callback_QDesignerIntegration_headerSuffix(this, handle__headerSuffix);
		QString callback_return_value_QString = QString::fromUtf8(callback_return_value.data, callback_return_value.len);
		return callback_return_value_QString;
	}

	friend struct seaqt_string QDesignerIntegration_virtualbase_headerSuffix(const void* self);
	...
	friend void QDesignerIntegration_virtualbase_setHeaderSuffix(void* self, struct seaqt_string headerSuffix);
	...
	virtual QString contextHelpId() const override {
		...
		struct seaqt_string callback_return_value = miqt_exec_callback_QDesignerIntegration_contextHelpId(this, handle__contextHelpId);
		QString callback_return_value_QString = QString::fromUtf8(callback_return_value.data, callback_return_value.len);
		return callback_return_value_QString;
	}

	friend struct seaqt_string QDesignerIntegration_virtualbase_contextHelpId(const void* self);
	...
	friend void QDesignerIntegration_virtualbase_updateProperty(void* self, struct seaqt_string name, QVariant* value, bool enableSubPropertyHandling);
	...
	friend void QDesignerIntegration_virtualbase_updateProperty2(void* self, struct seaqt_string name, QVariant* value);
	...
	friend void QDesignerIntegration_virtualbase_resetProperty(void* self, struct seaqt_string name);
	...
	friend void QDesignerIntegration_virtualbase_addDynamicProperty(void* self, struct seaqt_string name, QVariant* value);
	...
	friend void QDesignerIntegration_virtualbase_removeDynamicProperty(void* self, struct seaqt_string name);
...
QDesignerIntegration* QDesignerIntegration_new(QDesignerFormEditorInterface* core) {
	return new (std::nothrow) VirtualQDesignerIntegration(core);
}

QDesignerIntegration* QDesignerIntegration_new2(QDesignerFormEditorInterface* core, QObject* parent) {
	return new (std::nothrow) VirtualQDesignerIntegration(core, parent);
}
...
void QDesignerIntegration_updateProperty(QDesignerIntegration* self, struct seaqt_string name, QVariant* value, bool enableSubPropertyHandling) {
	QString name_QString = QString::fromUtf8(name.data, name.len);
	self->updateProperty(name_QString, *value, enableSubPropertyHandling);
}

void QDesignerIntegration_updateProperty2(QDesignerIntegration* self, struct seaqt_string name, QVariant* value) {
	QString name_QString = QString::fromUtf8(name.data, name.len);
	self->updateProperty(name_QString, *value);
}
...
bool QDesignerIntegration_override_virtual_headerSuffix(void* self, intptr_t slot) {
	VirtualQDesignerIntegration* self_cast = dynamic_cast<VirtualQDesignerIntegration*>( (QDesignerIntegration*)(self) );
	if (self_cast == nullptr) {
		return false;
	}
...
struct seaqt_string QDesignerIntegration_virtualbase_headerSuffix(const void* self) {
	QString _ret = static_cast<const VirtualQDesignerIntegration*>(self)->QDesignerIntegration::headerSuffix();
	// Convert QString from UTF-16 in C++ RAII memory to UTF-8 in manually-managed C memory
	QByteArray _b = _ret.toUtf8();
	struct seaqt_string _ms;
	_ms.len = _b.length();
...
void QDesignerIntegration_virtualbase_setHeaderSuffix(void* self, struct seaqt_string headerSuffix) {
	QString headerSuffix_QString = QString::fromUtf8(headerSuffix.data, headerSuffix.len);
	static_cast<VirtualQDesignerIntegration*>(self)->QDesignerIntegration::setHeaderSuffix(headerSuffix_QString);
}
...
bool QDesignerIntegration_virtualbase_isHeaderLowercase(const void* self) {
	return static_cast<const VirtualQDesignerIntegration*>(self)->QDesignerIntegration::isHeaderLowercase();
}
...
void QDesignerIntegration_virtualbase_setHeaderLowercase(void* self, bool headerLowerCase) {
	static_cast<VirtualQDesignerIntegration*>(self)->QDesignerIntegration::setHeaderLowercase(headerLowerCase);
}
...
int QDesignerIntegration_virtualbase_features(const void* self) {
	VirtualQDesignerIntegration::Feature _ret = static_cast<const VirtualQDesignerIntegration*>(self)->QDesignerIntegration::features();
	return static_cast<int>(_ret);
}
...
void QDesignerIntegration_virtualbase_setFeatures(void* self, int f) {
	static_cast<VirtualQDesignerIntegration*>(self)->QDesignerIntegration::setFeatures(static_cast<VirtualQDesignerIntegration::Feature>(f));
}
...
int QDesignerIntegration_virtualbase_resourceFileWatcherBehaviour(const void* self) {
	VirtualQDesignerIntegration::ResourceFileWatcherBehaviour _ret = static_cast<const VirtualQDesignerIntegration*>(self)->QDesignerIntegration::resourceFileWatcherBehaviour();
	return static_cast<int>(_ret);
}
...
void QDesignerIntegration_virtualbase_setResourceFileWatcherBehaviour(void* self, int behaviour) {
	static_cast<VirtualQDesignerIntegration*>(self)->QDesignerIntegration::setResourceFileWatcherBehaviour(static_cast<VirtualQDesignerIntegration::ResourceFileWatcherBehaviour>(behaviour));
}
...
QWidget* QDesignerIntegration_virtualbase_containerWindow(const void* self, QWidget* widget) {
	return static_cast<const VirtualQDesignerIntegration*>(self)->QDesignerIntegration::containerWindow(widget);
}
...
QDesignerResourceBrowserInterface* QDesignerIntegration_virtualbase_createResourceBrowser(void* self, QWidget* parent) {
	return static_cast<VirtualQDesignerIntegration*>(self)->QDesignerIntegration::createResourceBrowser(parent);
}
...
struct seaqt_string QDesignerIntegration_virtualbase_contextHelpId(const void* self) {
	QString _ret = static_cast<const VirtualQDesignerIntegration*>(self)->QDesignerIntegration::contextHelpId();
	// Convert QString from UTF-16 in C++ RAII memory to UTF-8 in manually-managed C memory
	QByteArray _b = _ret.toUtf8();
	struct seaqt_string _ms;
	_ms.len = _b.length();
...
void QDesignerIntegration_virtualbase_updateProperty(void* self, struct seaqt_string name, QVariant* value, bool enableSubPropertyHandling) {
	QString name_QString = QString::fromUtf8(name.data, name.len);
	static_cast<VirtualQDesignerIntegration*>(self)->QDesignerIntegration::updateProperty(name_QString, *value, enableSubPropertyHandling);
}
...
void QDesignerIntegration_virtualbase_updateProperty2(void* self, struct seaqt_string name, QVariant* value) {
	QString name_QString = QString::fromUtf8(name.data, name.len);
	static_cast<VirtualQDesignerIntegration*>(self)->QDesignerIntegration::updateProperty(name_QString, *value);
}
...
void QDesignerIntegration_virtualbase_resetProperty(void* self, struct seaqt_string name) {
	QString name_QString = QString::fromUtf8(name.data, name.len);
	static_cast<VirtualQDesignerIntegration*>(self)->QDesignerIntegration::resetProperty(name_QString);
}
...
void QDesignerIntegration_virtualbase_addDynamicProperty(void* self, struct seaqt_string name, QVariant* value) {
	QString name_QString = QString::fromUtf8(name.data, name.len);
	static_cast<VirtualQDesignerIntegration*>(self)->QDesignerIntegration::addDynamicProperty(name_QString, *value);
}
...
void QDesignerIntegration_virtualbase_removeDynamicProperty(void* self, struct seaqt_string name) {
	QString name_QString = QString::fromUtf8(name.data, name.len);
	static_cast<VirtualQDesignerIntegration*>(self)->QDesignerIntegration::removeDynamicProperty(name_QString);
}
...
void QDesignerIntegration_virtualbase_updateActiveFormWindow(void* self, QDesignerFormWindowInterface* formWindow) {
	static_cast<VirtualQDesignerIntegration*>(self)->QDesignerIntegration::updateActiveFormWindow(formWindow);
}
...
void QDesignerIntegration_virtualbase_setupFormWindow(void* self, QDesignerFormWindowInterface* formWindow) {
	static_cast<VirtualQDesignerIntegration*>(self)->QDesignerIntegration::setupFormWindow(formWindow);
}
...
void QDesignerIntegration_virtualbase_updateSelection(void* self) {
	static_cast<VirtualQDesignerIntegration*>(self)->QDesignerIntegration::updateSelection();
}
...
void QDesignerIntegration_virtualbase_updateCustomWidgetPlugins(void* self) {
	static_cast<VirtualQDesignerIntegration*>(self)->QDesignerIntegration::updateCustomWidgetPlugins();
}
...
bool QDesignerIntegration_virtualbase_event(void* self, QEvent* event) {
	return static_cast<VirtualQDesignerIntegration*>(self)->QDesignerIntegration::event(event);
}
...
bool QDesignerIntegration_virtualbase_eventFilter(void* self, QObject* watched, QEvent* event) {
	return static_cast<VirtualQDesignerIntegration*>(self)->QDesignerIntegration::eventFilter(watched, event);
}
...
void QDesignerIntegration_virtualbase_timerEvent(void* self, QTimerEvent* event) {
	static_cast<VirtualQDesignerIntegration*>(self)->QDesignerIntegration::timerEvent(event);
}
...
void QDesignerIntegration_virtualbase_childEvent(void* self, QChildEvent* event) {
	static_cast<VirtualQDesignerIntegration*>(self)->QDesignerIntegration::childEvent(event);
}
...
void QDesignerIntegration_virtualbase_customEvent(void* self, QEvent* event) {
	static_cast<VirtualQDesignerIntegration*>(self)->QDesignerIntegration::customEvent(event);
}
...
void QDesignerIntegration_virtualbase_connectNotify(void* self, QMetaMethod* signal) {
	static_cast<VirtualQDesignerIntegration*>(self)->QDesignerIntegration::connectNotify(*signal);
}
...
void QDesignerIntegration_virtualbase_disconnectNotify(void* self, QMetaMethod* signal) {
	static_cast<VirtualQDesignerIntegration*>(self)->QDesignerIntegration::disconnectNotify(*signal);
}
