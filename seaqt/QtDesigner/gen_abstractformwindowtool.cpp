...
class VirtualQDesignerFormWindowToolInterface final : public QDesignerFormWindowToolInterface {
public:
	...
	virtual ~VirtualQDesignerFormWindowToolInterface() override = default;
...
QDesignerFormWindowToolInterface* QDesignerFormWindowToolInterface_new() {
	return new (std::nothrow) VirtualQDesignerFormWindowToolInterface();
}

QDesignerFormWindowToolInterface* QDesignerFormWindowToolInterface_new2(QObject* parent) {
	return new (std::nothrow) VirtualQDesignerFormWindowToolInterface(parent);
}
...
bool QDesignerFormWindowToolInterface_override_virtual_core(void* self, intptr_t slot) {
	VirtualQDesignerFormWindowToolInterface* self_cast = dynamic_cast<VirtualQDesignerFormWindowToolInterface*>( (QDesignerFormWindowToolInterface*)(self) );
...
bool QDesignerFormWindowToolInterface_virtualbase_event(void* self, QEvent* event) {
	return static_cast<VirtualQDesignerFormWindowToolInterface*>(self)->QDesignerFormWindowToolInterface::event(event);
}
...
bool QDesignerFormWindowToolInterface_virtualbase_eventFilter(void* self, QObject* watched, QEvent* event) {
	return static_cast<VirtualQDesignerFormWindowToolInterface*>(self)->QDesignerFormWindowToolInterface::eventFilter(watched, event);
}
...
void QDesignerFormWindowToolInterface_virtualbase_timerEvent(void* self, QTimerEvent* event) {
	static_cast<VirtualQDesignerFormWindowToolInterface*>(self)->QDesignerFormWindowToolInterface::timerEvent(event);
}
...
void QDesignerFormWindowToolInterface_virtualbase_childEvent(void* self, QChildEvent* event) {
	static_cast<VirtualQDesignerFormWindowToolInterface*>(self)->QDesignerFormWindowToolInterface::childEvent(event);
}
...
void QDesignerFormWindowToolInterface_virtualbase_customEvent(void* self, QEvent* event) {
	static_cast<VirtualQDesignerFormWindowToolInterface*>(self)->QDesignerFormWindowToolInterface::customEvent(event);
}
...
void QDesignerFormWindowToolInterface_virtualbase_connectNotify(void* self, QMetaMethod* signal) {
	static_cast<VirtualQDesignerFormWindowToolInterface*>(self)->QDesignerFormWindowToolInterface::connectNotify(*signal);
}
...
void QDesignerFormWindowToolInterface_virtualbase_disconnectNotify(void* self, QMetaMethod* signal) {
	static_cast<VirtualQDesignerFormWindowToolInterface*>(self)->QDesignerFormWindowToolInterface::disconnectNotify(*signal);
}
