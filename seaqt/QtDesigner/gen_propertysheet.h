...
int QDesignerPropertySheetExtension_virtualbase_indexOf(const void* self, struct seaqt_string name);
bool QDesignerPropertySheetExtension_override_virtual_propertyName(void* self, intptr_t slot);
struct seaqt_string QDesignerPropertySheetExtension_virtualbase_propertyName(const void* self, int index);
bool QDesignerPropertySheetExtension_override_virtual_propertyGroup(void* self, intptr_t slot);
struct seaqt_string QDesignerPropertySheetExtension_virtualbase_propertyGroup(const void* self, int index);
bool QDesignerPropertySheetExtension_override_virtual_setPropertyGroup(void* self, intptr_t slot);
void QDesignerPropertySheetExtension_virtualbase_setPropertyGroup(void* self, int index, struct seaqt_string group);
