...
public:
	...
	friend double QDesignerActionEditorInterface_protectedbase_getDecodedMetricF(const VirtualQDesignerActionEditorInterface* self, int metricA, int metricB);
};
...
double QDesignerActionEditorInterface_protectedbase_getDecodedMetricF(const VirtualQDesignerActionEditorInterface* self, int metricA, int metricB) {
	return self->QDesignerActionEditorInterface::getDecodedMetricF(static_cast<VirtualQDesignerActionEditorInterface::PaintDeviceMetric>(metricA), static_cast<VirtualQDesignerActionEditorInterface::PaintDeviceMetric>(metricB));
}
