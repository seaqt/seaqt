...
class VirtualQDesignerFormEditorPluginInterface final : public QDesignerFormEditorPluginInterface {
public:

	VirtualQDesignerFormEditorPluginInterface(): QDesignerFormEditorPluginInterface() {}

	virtual ~VirtualQDesignerFormEditorPluginInterface() override = default;
...
QDesignerFormEditorPluginInterface* QDesignerFormEditorPluginInterface_new() {
	return new (std::nothrow) VirtualQDesignerFormEditorPluginInterface();
}
...
bool QDesignerFormEditorPluginInterface_override_virtual_isInitialized(void* self, intptr_t slot) {
	VirtualQDesignerFormEditorPluginInterface* self_cast = dynamic_cast<VirtualQDesignerFormEditorPluginInterface*>( (QDesignerFormEditorPluginInterface*)(self) );
