...
struct seaqt_string QDesignerIntegrationInterface_virtualbase_headerSuffix(const void* self);
bool QDesignerIntegrationInterface_override_virtual_setHeaderSuffix(void* self, intptr_t slot);
void QDesignerIntegrationInterface_virtualbase_setHeaderSuffix(void* self, struct seaqt_string headerSuffix);
...
struct seaqt_string QDesignerIntegrationInterface_virtualbase_contextHelpId(const void* self);
...
void QDesignerIntegrationInterface_virtualbase_updateProperty(void* self, struct seaqt_string name, QVariant* value, bool enableSubPropertyHandling);
bool QDesignerIntegrationInterface_override_virtual_updateProperty2(void* self, intptr_t slot);
void QDesignerIntegrationInterface_virtualbase_updateProperty2(void* self, struct seaqt_string name, QVariant* value);
bool QDesignerIntegrationInterface_override_virtual_resetProperty(void* self, intptr_t slot);
void QDesignerIntegrationInterface_virtualbase_resetProperty(void* self, struct seaqt_string name);
bool QDesignerIntegrationInterface_override_virtual_addDynamicProperty(void* self, intptr_t slot);
void QDesignerIntegrationInterface_virtualbase_addDynamicProperty(void* self, struct seaqt_string name, QVariant* value);
bool QDesignerIntegrationInterface_override_virtual_removeDynamicProperty(void* self, intptr_t slot);
void QDesignerIntegrationInterface_virtualbase_removeDynamicProperty(void* self, struct seaqt_string name);
