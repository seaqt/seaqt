...
void QDesignerWidgetBoxInterface_virtualbase_dropWidgets(void* self, struct seaqt_array /* of QDesignerDnDItemInterface* */  item_list, QPoint* global_mouse_pos);
bool QDesignerWidgetBoxInterface_override_virtual_setFileName(void* self, intptr_t slot);
void QDesignerWidgetBoxInterface_virtualbase_setFileName(void* self, struct seaqt_string file_name);
bool QDesignerWidgetBoxInterface_override_virtual_fileName(void* self, intptr_t slot);
struct seaqt_string QDesignerWidgetBoxInterface_virtualbase_fileName(const void* self);
