...
public:
	...
	friend double QDesignerWidgetBoxInterface_protectedbase_getDecodedMetricF(const VirtualQDesignerWidgetBoxInterface* self, int metricA, int metricB);
};
...
double QDesignerWidgetBoxInterface_protectedbase_getDecodedMetricF(const VirtualQDesignerWidgetBoxInterface* self, int metricA, int metricB) {
	return self->QDesignerWidgetBoxInterface::getDecodedMetricF(static_cast<VirtualQDesignerWidgetBoxInterface::PaintDeviceMetric>(metricA), static_cast<VirtualQDesignerWidgetBoxInterface::PaintDeviceMetric>(metricB));
}
