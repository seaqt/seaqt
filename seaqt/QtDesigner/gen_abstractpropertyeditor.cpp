...
public:
	...
	friend double QDesignerPropertyEditorInterface_protectedbase_getDecodedMetricF(const VirtualQDesignerPropertyEditorInterface* self, int metricA, int metricB);
};
...
double QDesignerPropertyEditorInterface_protectedbase_getDecodedMetricF(const VirtualQDesignerPropertyEditorInterface* self, int metricA, int metricB) {
	return self->QDesignerPropertyEditorInterface::getDecodedMetricF(static_cast<VirtualQDesignerPropertyEditorInterface::PaintDeviceMetric>(metricA), static_cast<VirtualQDesignerPropertyEditorInterface::PaintDeviceMetric>(metricB));
}
