...
struct seaqt_string QDesignerPropertyEditorInterface_virtualbase_currentPropertyName(const void* self);
...
void QDesignerPropertyEditorInterface_virtualbase_setPropertyValue(void* self, struct seaqt_string name, QVariant* value, bool changed);
