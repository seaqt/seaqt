...
typedef struct QSqlQueryModel_VTable{
	...
	bool (*clearItemData)(VirtualQSqlQueryModel* self, QModelIndex* index);
	...
	void (*multiData)(const VirtualQSqlQueryModel* self, QModelIndex* index, QModelRoleDataSpan* roleDataSpan);
	bool (*submit)(VirtualQSqlQueryModel* self);
	void (*revert)(VirtualQSqlQueryModel* self);
	void (*resetInternalData)(VirtualQSqlQueryModel* self);
