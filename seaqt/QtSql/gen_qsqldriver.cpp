...
void miqt_exec_callback_QSqlDriver_notification(intptr_t, struct seaqt_string, int, QVariant*);
...
void QSqlDriver_connect_notification(QSqlDriver* self, intptr_t slot) {
	QSqlDriver::connect(self, static_cast<void (QSqlDriver::*)(const QString&, QSqlDriver::NotificationSource, const QVariant&)>(&QSqlDriver::notification), self, [=](const QString& name, QSqlDriver::NotificationSource source, const QVariant& payload) {
		...
		miqt_exec_callback_QSqlDriver_notification(slot, sigval1, sigval2, sigval3);
	});
}
...
bool QSqlDriver_override_virtual_maximumIdentifierLength(void* self, intptr_t slot) {
	...
	self_cast->handle__maximumIdentifierLength = slot;
	return true;
}

int QSqlDriver_virtualbase_maximumIdentifierLength(const void* self, int type) {
	return static_cast<const VirtualQSqlDriver*>(self)->QSqlDriver::maximumIdentifierLength(static_cast<VirtualQSqlDriver::IdentifierType>(type));
}
