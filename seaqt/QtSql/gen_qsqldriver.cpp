...
void miqt_exec_callback_QSqlDriver_notification(intptr_t, struct seaqt_string);
void miqt_exec_callback_QSqlDriver_notification2(intptr_t, struct seaqt_string, int, QVariant*);
QMetaObject* miqt_exec_callback_QSqlDriver_metaObject(const QSqlDriver*, intptr_t);
void* miqt_exec_callback_QSqlDriver_metacast(QSqlDriver*, intptr_t, const char*);
int miqt_exec_callback_QSqlDriver_metacall(QSqlDriver*, intptr_t, int, int, void**);
...
struct seaqt_array /* of struct seaqt_string */  miqt_exec_callback_QSqlDriver_tables(const QSqlDriver*, intptr_t, int);
QSqlIndex* miqt_exec_callback_QSqlDriver_primaryIndex(const QSqlDriver*, intptr_t, struct seaqt_string);
QSqlRecord* miqt_exec_callback_QSqlDriver_record(const QSqlDriver*, intptr_t, struct seaqt_string);
struct seaqt_string miqt_exec_callback_QSqlDriver_formatValue(const QSqlDriver*, intptr_t, QSqlField*, bool);
struct seaqt_string miqt_exec_callback_QSqlDriver_escapeIdentifier(const QSqlDriver*, intptr_t, struct seaqt_string, int);
struct seaqt_string miqt_exec_callback_QSqlDriver_sqlStatement(const QSqlDriver*, intptr_t, int, struct seaqt_string, QSqlRecord*, bool);
...
bool miqt_exec_callback_QSqlDriver_open(QSqlDriver*, intptr_t, struct seaqt_string, struct seaqt_string, struct seaqt_string, struct seaqt_string, int, struct seaqt_string);
bool miqt_exec_callback_QSqlDriver_subscribeToNotification(QSqlDriver*, intptr_t, struct seaqt_string);
bool miqt_exec_callback_QSqlDriver_unsubscribeFromNotification(QSqlDriver*, intptr_t, struct seaqt_string);
struct seaqt_array /* of struct seaqt_string */  miqt_exec_callback_QSqlDriver_subscribedToNotifications(const QSqlDriver*, intptr_t);
bool miqt_exec_callback_QSqlDriver_isIdentifierEscaped(const QSqlDriver*, intptr_t, struct seaqt_string, int);
struct seaqt_string miqt_exec_callback_QSqlDriver_stripDelimiters(const QSqlDriver*, intptr_t, struct seaqt_string, int);
...
public:
	...
	virtual ~VirtualQSqlDriver() override = default;
	...
	virtual const QMetaObject* metaObject() const override {
		...
		QMetaObject* callback_return_value = miqt_exec_callback_QSqlDriver_metaObject(this, handle__metaObject);
		return callback_return_value;
	}

	friend QMetaObject* QSqlDriver_virtualbase_metaObject(const void* self);
	...
	virtual void* qt_metacast(const char* param1) override {
		...
		void* callback_return_value = miqt_exec_callback_QSqlDriver_metacast(this, handle__metacast, sigval1);
		return callback_return_value;
	}

	friend void* QSqlDriver_virtualbase_metacast(void* self, const char* param1);
	...
	virtual int qt_metacall(QMetaObject::Call param1, int param2, void** param3) override {
		...
		int sigval2 = param2;
		void** sigval3 = param3;
		int callback_return_value = miqt_exec_callback_QSqlDriver_metacall(this, handle__metacall, sigval1, sigval2, sigval3);
		return static_cast<int>(callback_return_value);
	}

	friend int QSqlDriver_virtualbase_metacall(void* self, int param1, int param2, void** param3);
	...
	virtual QStringList tables(QSql::TableType tableType) const override {
		...
		struct seaqt_array /* of struct seaqt_string */  callback_return_value = miqt_exec_callback_QSqlDriver_tables(this, handle__tables, sigval1);
	...
	friend struct seaqt_array /* of struct seaqt_string */  QSqlDriver_virtualbase_tables(const void* self, int tableType);
	...
	friend QSqlIndex* QSqlDriver_virtualbase_primaryIndex(const void* self, struct seaqt_string tableName);
	...
	friend QSqlRecord* QSqlDriver_virtualbase_record(const void* self, struct seaqt_string tableName);
	...
	virtual QString formatValue(const QSqlField& field, bool trimStrings) const override {
		...
		struct seaqt_string callback_return_value = miqt_exec_callback_QSqlDriver_formatValue(this, handle__formatValue, sigval1, sigval2);
		QString callback_return_value_QString = QString::fromUtf8(callback_return_value.data, callback_return_value.len);
		return callback_return_value_QString;
	}

	friend struct seaqt_string QSqlDriver_virtualbase_formatValue(const void* self, QSqlField* field, bool trimStrings);
	...
	virtual QString escapeIdentifier(const QString& identifier, QSqlDriver::IdentifierType type) const override {
		...
		struct seaqt_string callback_return_value = miqt_exec_callback_QSqlDriver_escapeIdentifier(this, handle__escapeIdentifier, sigval1, sigval2);
		QString callback_return_value_QString = QString::fromUtf8(callback_return_value.data, callback_return_value.len);
		return callback_return_value_QString;
	}

	friend struct seaqt_string QSqlDriver_virtualbase_escapeIdentifier(const void* self, struct seaqt_string identifier, int type);
	...
	virtual QString sqlStatement(QSqlDriver::StatementType type, const QString& tableName, const QSqlRecord& rec, bool preparedStatement) const override {
		...
		struct seaqt_string callback_return_value = miqt_exec_callback_QSqlDriver_sqlStatement(this, handle__sqlStatement, sigval1, sigval2, sigval3, sigval4);
		QString callback_return_value_QString = QString::fromUtf8(callback_return_value.data, callback_return_value.len);
		return callback_return_value_QString;
	}

	friend struct seaqt_string QSqlDriver_virtualbase_sqlStatement(const void* self, int type, struct seaqt_string tableName, QSqlRecord* rec, bool preparedStatement);
	...
	friend bool QSqlDriver_virtualbase_subscribeToNotification(void* self, struct seaqt_string name);
	...
	friend bool QSqlDriver_virtualbase_unsubscribeFromNotification(void* self, struct seaqt_string name);
	...
	virtual QStringList subscribedToNotifications() const override {
		...
		struct seaqt_array /* of struct seaqt_string */  callback_return_value = miqt_exec_callback_QSqlDriver_subscribedToNotifications(this, handle__subscribedToNotifications);
		QStringList callback_return_value_QList;
		callback_return_value_QList.reserve(callback_return_value.len);
		struct seaqt_string* callback_return_value_arr = static_cast<struct seaqt_string*>(callback_return_value.data);
		for(size_t i = 0; i < callback_return_value.len; ++i) {
	...
	friend struct seaqt_array /* of struct seaqt_string */  QSqlDriver_virtualbase_subscribedToNotifications(const void* self);
	...
	friend bool QSqlDriver_virtualbase_isIdentifierEscaped(const void* self, struct seaqt_string identifier, int type);
	...
	virtual QString stripDelimiters(const QString& identifier, QSqlDriver::IdentifierType type) const override {
		...
		QSqlDriver::IdentifierType type_ret = type;
		int sigval2 = static_cast<int>(type_ret);
		struct seaqt_string callback_return_value = miqt_exec_callback_QSqlDriver_stripDelimiters(this, handle__stripDelimiters, sigval1, sigval2);
		QString callback_return_value_QString = QString::fromUtf8(callback_return_value.data, callback_return_value.len);
		return callback_return_value_QString;
	}

	friend struct seaqt_string QSqlDriver_virtualbase_stripDelimiters(const void* self, struct seaqt_string identifier, int type);
...
QSqlDriver* QSqlDriver_new() {
	return new (std::nothrow) VirtualQSqlDriver();
}

QSqlDriver* QSqlDriver_new2(QObject* parent) {
	return new (std::nothrow) VirtualQSqlDriver(parent);
}
...
struct seaqt_string QSqlDriver_trUtf8(const char* s) {
...
void QSqlDriver_notification(QSqlDriver* self, struct seaqt_string name) {
	QString name_QString = QString::fromUtf8(name.data, name.len);
...
void QSqlDriver_notification2(QSqlDriver* self, struct seaqt_string name, int source, QVariant* payload) {
	QString name_QString = QString::fromUtf8(name.data, name.len);
...
struct seaqt_string QSqlDriver_trUtf82(const char* s, const char* c) {
...
struct seaqt_string QSqlDriver_trUtf83(const char* s, const char* c, int n) {
...
bool QSqlDriver_override_virtual_metaObject(void* self, intptr_t slot) {
	VirtualQSqlDriver* self_cast = dynamic_cast<VirtualQSqlDriver*>( (QSqlDriver*)(self) );
...
QMetaObject* QSqlDriver_virtualbase_metaObject(const void* self) {
	return (QMetaObject*) static_cast<const VirtualQSqlDriver*>(self)->QSqlDriver::metaObject();
}
...
void* QSqlDriver_virtualbase_metacast(void* self, const char* param1) {
	return static_cast<VirtualQSqlDriver*>(self)->QSqlDriver::qt_metacast(param1);
}
...
int QSqlDriver_virtualbase_metacall(void* self, int param1, int param2, void** param3) {
	return static_cast<VirtualQSqlDriver*>(self)->QSqlDriver::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
}
...
bool QSqlDriver_virtualbase_isOpen(const void* self) {
	return static_cast<const VirtualQSqlDriver*>(self)->QSqlDriver::isOpen();
}
...
bool QSqlDriver_virtualbase_beginTransaction(void* self) {
	return static_cast<VirtualQSqlDriver*>(self)->QSqlDriver::beginTransaction();
}
...
bool QSqlDriver_virtualbase_commitTransaction(void* self) {
	return static_cast<VirtualQSqlDriver*>(self)->QSqlDriver::commitTransaction();
}
...
bool QSqlDriver_virtualbase_rollbackTransaction(void* self) {
	return static_cast<VirtualQSqlDriver*>(self)->QSqlDriver::rollbackTransaction();
}
...
struct seaqt_array /* of struct seaqt_string */  QSqlDriver_virtualbase_tables(const void* self, int tableType) {
	QStringList _ret = static_cast<const VirtualQSqlDriver*>(self)->QSqlDriver::tables(static_cast<QSql::TableType>(tableType));
	// Convert QList<> from C++ memory to manually-managed C memory
	struct seaqt_string* _arr = static_cast<struct seaqt_string*>(malloc(sizeof(struct seaqt_string) * _ret.length()));
	for (size_t i = 0, e = _ret.length(); i < e; ++i) {
		QString _lv_ret = _ret[i];
...
QSqlIndex* QSqlDriver_virtualbase_primaryIndex(const void* self, struct seaqt_string tableName) {
	QString tableName_QString = QString::fromUtf8(tableName.data, tableName.len);
	return new QSqlIndex(static_cast<const VirtualQSqlDriver*>(self)->QSqlDriver::primaryIndex(tableName_QString));
}
...
QSqlRecord* QSqlDriver_virtualbase_record(const void* self, struct seaqt_string tableName) {
	QString tableName_QString = QString::fromUtf8(tableName.data, tableName.len);
	return new QSqlRecord(static_cast<const VirtualQSqlDriver*>(self)->QSqlDriver::record(tableName_QString));
}
...
struct seaqt_string QSqlDriver_virtualbase_formatValue(const void* self, QSqlField* field, bool trimStrings) {
	QString _ret = static_cast<const VirtualQSqlDriver*>(self)->QSqlDriver::formatValue(*field, trimStrings);
	// Convert QString from UTF-16 in C++ RAII memory to UTF-8 in manually-managed C memory
	QByteArray _b = _ret.toUtf8();
	struct seaqt_string _ms;
	_ms.len = _b.length();
...
struct seaqt_string QSqlDriver_virtualbase_escapeIdentifier(const void* self, struct seaqt_string identifier, int type) {
	QString identifier_QString = QString::fromUtf8(identifier.data, identifier.len);
	QString _ret = static_cast<const VirtualQSqlDriver*>(self)->QSqlDriver::escapeIdentifier(identifier_QString, static_cast<VirtualQSqlDriver::IdentifierType>(type));
	// Convert QString from UTF-16 in C++ RAII memory to UTF-8 in manually-managed C memory
	QByteArray _b = _ret.toUtf8();
	struct seaqt_string _ms;
	_ms.len = _b.length();
...
struct seaqt_string QSqlDriver_virtualbase_sqlStatement(const void* self, int type, struct seaqt_string tableName, QSqlRecord* rec, bool preparedStatement) {
	QString tableName_QString = QString::fromUtf8(tableName.data, tableName.len);
	QString _ret = static_cast<const VirtualQSqlDriver*>(self)->QSqlDriver::sqlStatement(static_cast<VirtualQSqlDriver::StatementType>(type), tableName_QString, *rec, preparedStatement);
	// Convert QString from UTF-16 in C++ RAII memory to UTF-8 in manually-managed C memory
	QByteArray _b = _ret.toUtf8();
	struct seaqt_string _ms;
	_ms.len = _b.length();
...
QVariant* QSqlDriver_virtualbase_handle(const void* self) {
	return new QVariant(static_cast<const VirtualQSqlDriver*>(self)->QSqlDriver::handle());
}
...
bool QSqlDriver_virtualbase_subscribeToNotification(void* self, struct seaqt_string name) {
	QString name_QString = QString::fromUtf8(name.data, name.len);
	return static_cast<VirtualQSqlDriver*>(self)->QSqlDriver::subscribeToNotification(name_QString);
}
...
bool QSqlDriver_virtualbase_unsubscribeFromNotification(void* self, struct seaqt_string name) {
	QString name_QString = QString::fromUtf8(name.data, name.len);
	return static_cast<VirtualQSqlDriver*>(self)->QSqlDriver::unsubscribeFromNotification(name_QString);
}
...
struct seaqt_array /* of struct seaqt_string */  QSqlDriver_virtualbase_subscribedToNotifications(const void* self) {
	QStringList _ret = static_cast<const VirtualQSqlDriver*>(self)->QSqlDriver::subscribedToNotifications();
	// Convert QList<> from C++ memory to manually-managed C memory
	struct seaqt_string* _arr = static_cast<struct seaqt_string*>(malloc(sizeof(struct seaqt_string) * _ret.length()));
	for (size_t i = 0, e = _ret.length(); i < e; ++i) {
		QString _lv_ret = _ret[i];
...
bool QSqlDriver_virtualbase_isIdentifierEscaped(const void* self, struct seaqt_string identifier, int type) {
	QString identifier_QString = QString::fromUtf8(identifier.data, identifier.len);
	return static_cast<const VirtualQSqlDriver*>(self)->QSqlDriver::isIdentifierEscaped(identifier_QString, static_cast<VirtualQSqlDriver::IdentifierType>(type));
}
...
struct seaqt_string QSqlDriver_virtualbase_stripDelimiters(const void* self, struct seaqt_string identifier, int type) {
	QString identifier_QString = QString::fromUtf8(identifier.data, identifier.len);
	QString _ret = static_cast<const VirtualQSqlDriver*>(self)->QSqlDriver::stripDelimiters(identifier_QString, static_cast<VirtualQSqlDriver::IdentifierType>(type));
	// Convert QString from UTF-16 in C++ RAII memory to UTF-8 in manually-managed C memory
	QByteArray _b = _ret.toUtf8();
	struct seaqt_string _ms;
	_ms.len = _b.length();
...
bool QSqlDriver_virtualbase_cancelQuery(void* self) {
	return static_cast<VirtualQSqlDriver*>(self)->QSqlDriver::cancelQuery();
}
...
void QSqlDriver_virtualbase_setOpen(void* self, bool o) {
	static_cast<VirtualQSqlDriver*>(self)->QSqlDriver::setOpen(o);
}
...
void QSqlDriver_virtualbase_setOpenError(void* self, bool e) {
	static_cast<VirtualQSqlDriver*>(self)->QSqlDriver::setOpenError(e);
}
...
void QSqlDriver_virtualbase_setLastError(void* self, QSqlError* e) {
	static_cast<VirtualQSqlDriver*>(self)->QSqlDriver::setLastError(*e);
}
...
bool QSqlDriver_virtualbase_event(void* self, QEvent* event) {
	return static_cast<VirtualQSqlDriver*>(self)->QSqlDriver::event(event);
}
...
bool QSqlDriver_virtualbase_eventFilter(void* self, QObject* watched, QEvent* event) {
	return static_cast<VirtualQSqlDriver*>(self)->QSqlDriver::eventFilter(watched, event);
}
...
void QSqlDriver_virtualbase_timerEvent(void* self, QTimerEvent* event) {
	static_cast<VirtualQSqlDriver*>(self)->QSqlDriver::timerEvent(event);
}
...
void QSqlDriver_virtualbase_childEvent(void* self, QChildEvent* event) {
	static_cast<VirtualQSqlDriver*>(self)->QSqlDriver::childEvent(event);
}
...
void QSqlDriver_virtualbase_customEvent(void* self, QEvent* event) {
	static_cast<VirtualQSqlDriver*>(self)->QSqlDriver::customEvent(event);
}
...
void QSqlDriver_virtualbase_connectNotify(void* self, QMetaMethod* signal) {
	static_cast<VirtualQSqlDriver*>(self)->QSqlDriver::connectNotify(*signal);
}
...
void QSqlDriver_virtualbase_disconnectNotify(void* self, QMetaMethod* signal) {
	static_cast<VirtualQSqlDriver*>(self)->QSqlDriver::disconnectNotify(*signal);
}
