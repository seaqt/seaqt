#pragma once
#ifndef SEAQT_QTSQL_GEN_QSQLFIELD_H
#define SEAQT_QTSQL_GEN_QSQLFIELD_H
...
void QSqlField_setName(QSqlField* self, struct seaqt_string name);
struct seaqt_string QSqlField_name(const QSqlField* self);
void QSqlField_setTableName(QSqlField* self, struct seaqt_string tableName);
struct seaqt_string QSqlField_tableName(const QSqlField* self);
...
const QMetaObject* QSqlField_staticMetaObject();
