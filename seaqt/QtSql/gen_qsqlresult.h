#pragma once
#ifndef SEAQT_QTSQL_GEN_QSQLRESULT_H
#define SEAQT_QTSQL_GEN_QSQLRESULT_H
...
void QSqlResult_setQuery(QSqlResult* self, struct seaqt_string query);
...
bool QSqlResult_prepare(QSqlResult* self, struct seaqt_string query);
bool QSqlResult_savePrepare(QSqlResult* self, struct seaqt_string sqlquery);
void QSqlResult_bindValue_pos_val_type(QSqlResult* self, int pos, QVariant* val, int type);
void QSqlResult_bindValue_placeholder_val_type(QSqlResult* self, struct seaqt_string placeholder, QVariant* val, int type);
QVariant* QSqlResult_data(QSqlResult* self, int i);
bool QSqlResult_isNull(QSqlResult* self, int i);
bool QSqlResult_reset(QSqlResult* self, struct seaqt_string sqlquery);
...
void QSqlResult_virtual_hook(QSqlResult* self, int id, void* data);
