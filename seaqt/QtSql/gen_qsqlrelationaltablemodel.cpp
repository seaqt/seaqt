...
public:
	...
	VirtualQSqlRelationalTableModel(const QSqlRelationalTableModel_VTable* vtbl, QObject* parent, QSqlDatabase db): QSqlRelationalTableModel(parent, db), vtbl(vtbl) {}
