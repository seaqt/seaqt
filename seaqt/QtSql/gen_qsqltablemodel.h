...
typedef struct QSqlTableModel_VTable{
	...
	bool (*clearItemData)(VirtualQSqlTableModel* self, QModelIndex* index);
	...
	void (*multiData)(const VirtualQSqlTableModel* self, QModelIndex* index, QModelRoleDataSpan* roleDataSpan);
	void (*resetInternalData)(VirtualQSqlTableModel* self);
