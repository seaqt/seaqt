...
bool QSqlDriver_virtualbase_open(void* self, struct seaqt_string db, struct seaqt_string user, struct seaqt_string password, struct seaqt_string host, int port, struct seaqt_string connOpts);
