...
bool miqt_exec_callback_QSqlQueryModel_clearItemData(QSqlQueryModel*, intptr_t, QModelIndex*);
...
void miqt_exec_callback_QSqlQueryModel_multiData(const QSqlQueryModel*, intptr_t, QModelIndex*, QModelRoleDataSpan*);
...
void miqt_exec_callback_QSqlQueryModel_resetInternalData(QSqlQueryModel*, intptr_t);
...
public:
	...
	virtual bool clearItemData(const QModelIndex& index) override {
		...
		// Cast returned reference into pointer
		QModelIndex* sigval1 = const_cast<QModelIndex*>(&index_ret);
		bool callback_return_value = miqt_exec_callback_QSqlQueryModel_clearItemData(this, handle__clearItemData, sigval1);
		return callback_return_value;
	}

	friend bool QSqlQueryModel_virtualbase_clearItemData(void* self, QModelIndex* index);
	...
	virtual void multiData(const QModelIndex& index, QModelRoleDataSpan roleDataSpan) const override {
		...
		miqt_exec_callback_QSqlQueryModel_multiData(this, handle__multiData, sigval1, sigval2);

	}

	friend void QSqlQueryModel_virtualbase_multiData(const void* self, QModelIndex* index, QModelRoleDataSpan* roleDataSpan);
	...
	virtual void resetInternalData() override {
		...
		miqt_exec_callback_QSqlQueryModel_resetInternalData(this, handle__resetInternalData);

	}

	friend void QSqlQueryModel_virtualbase_resetInternalData(void* self);
...
bool QSqlQueryModel_virtualbase_clearItemData(void* self, QModelIndex* index) {
	return static_cast<VirtualQSqlQueryModel*>(self)->QSqlQueryModel::clearItemData(*index);
}
...
void QSqlQueryModel_virtualbase_multiData(const void* self, QModelIndex* index, QModelRoleDataSpan* roleDataSpan) {
	static_cast<const VirtualQSqlQueryModel*>(self)->QSqlQueryModel::multiData(*index, *roleDataSpan);
}
...
void QSqlQueryModel_virtualbase_resetInternalData(void* self) {
	static_cast<VirtualQSqlQueryModel*>(self)->QSqlQueryModel::resetInternalData();
}
