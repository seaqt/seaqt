...
VirtualQWizard* QWizard_new2(const QWizard_VTable* vtbl, size_t vdata, QWidget* parent) {
	void* _mem_ = ::operator new(seaqt_aligned_sizeof<VirtualQWizard>() + vdata, std::nothrow);
...
VirtualQWizardPage* QWizardPage_new2(const QWizardPage_VTable* vtbl, size_t vdata, QWidget* parent) {
	void* _mem_ = ::operator new(seaqt_aligned_sizeof<VirtualQWizardPage>() + vdata, std::nothrow);
