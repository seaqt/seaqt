...
typedef struct QCommandLinkButton_VTable{
	...
	void (*initStyleOption)(const VirtualQCommandLinkButton* self, QStyleOptionButton* option);
	...
	void (*mouseMoveEvent)(VirtualQCommandLinkButton* self, QMouseEvent* param1);
	...
	void (*enterEvent)(VirtualQCommandLinkButton* self, QEnterEvent* event);
	...
	bool (*nativeEvent)(VirtualQCommandLinkButton* self, struct seaqt_string eventType, void* message, intptr_t* result);
...
double QCommandLinkButton_protectedbase_getDecodedMetricF(const VirtualQCommandLinkButton* self, int metricA, int metricB);
