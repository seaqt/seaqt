...
struct QCommandLinkButton_VTable {
	...
	void (*initStyleOption)(struct QCommandLinkButton_VTable* vtbl, const QCommandLinkButton* self, QStyleOptionButton* option);
	...
	void (*mouseMoveEvent)(struct QCommandLinkButton_VTable* vtbl, QCommandLinkButton* self, QMouseEvent* param1);
	...
	void (*enterEvent)(struct QCommandLinkButton_VTable* vtbl, QCommandLinkButton* self, QEnterEvent* event);
	...
	bool (*nativeEvent)(struct QCommandLinkButton_VTable* vtbl, QCommandLinkButton* self, struct miqt_string eventType, void* message, intptr_t* result);
