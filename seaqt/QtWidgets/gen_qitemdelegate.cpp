...
void miqt_exec_callback_QItemDelegate_drawDisplay(const QItemDelegate*, intptr_t, QPainter*, QStyleOptionViewItem*, QRect*, struct seaqt_string);
...
struct seaqt_array /* of int */  miqt_exec_callback_QItemDelegate_paintingRoles(const QItemDelegate*, intptr_t);
...
public:
	...
	friend void QItemDelegate_virtualbase_drawDisplay(const void* self, QPainter* painter, QStyleOptionViewItem* option, QRect* rect, struct seaqt_string text);
	...
	virtual QVector<int> paintingRoles() const override {
		...
		struct seaqt_array /* of int */  callback_return_value = miqt_exec_callback_QItemDelegate_paintingRoles(this, handle__paintingRoles);
	...
	friend struct seaqt_array /* of int */  QItemDelegate_virtualbase_paintingRoles(const void* self);
	...
	friend QRect* QItemDelegate_protectedbase_textRectangle(bool* _dynamic_cast_ok, const void* self, QPainter* painter, QRect* rect, QFont* font, struct seaqt_string text);
...
QItemDelegate* QItemDelegate_new() {
	return new (std::nothrow) VirtualQItemDelegate();
}

QItemDelegate* QItemDelegate_new2(QObject* parent) {
	return new (std::nothrow) VirtualQItemDelegate(parent);
}
...
QMetaObject* QItemDelegate_virtualbase_metaObject(const void* self) {
	return (QMetaObject*) static_cast<const VirtualQItemDelegate*>(self)->QItemDelegate::metaObject();
}
...
void* QItemDelegate_virtualbase_metacast(void* self, const char* param1) {
	return static_cast<VirtualQItemDelegate*>(self)->QItemDelegate::qt_metacast(param1);
}
...
int QItemDelegate_virtualbase_metacall(void* self, int param1, int param2, void** param3) {
	return static_cast<VirtualQItemDelegate*>(self)->QItemDelegate::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
}
...
void QItemDelegate_virtualbase_paint(const void* self, QPainter* painter, QStyleOptionViewItem* option, QModelIndex* index) {
	static_cast<const VirtualQItemDelegate*>(self)->QItemDelegate::paint(painter, *option, *index);
}
...
QSize* QItemDelegate_virtualbase_sizeHint(const void* self, QStyleOptionViewItem* option, QModelIndex* index) {
	return new QSize(static_cast<const VirtualQItemDelegate*>(self)->QItemDelegate::sizeHint(*option, *index));
}
...
QWidget* QItemDelegate_virtualbase_createEditor(const void* self, QWidget* parent, QStyleOptionViewItem* option, QModelIndex* index) {
	return static_cast<const VirtualQItemDelegate*>(self)->QItemDelegate::createEditor(parent, *option, *index);
}
...
void QItemDelegate_virtualbase_setEditorData(const void* self, QWidget* editor, QModelIndex* index) {
	static_cast<const VirtualQItemDelegate*>(self)->QItemDelegate::setEditorData(editor, *index);
}
...
void QItemDelegate_virtualbase_setModelData(const void* self, QWidget* editor, QAbstractItemModel* model, QModelIndex* index) {
	static_cast<const VirtualQItemDelegate*>(self)->QItemDelegate::setModelData(editor, model, *index);
}
...
void QItemDelegate_virtualbase_updateEditorGeometry(const void* self, QWidget* editor, QStyleOptionViewItem* option, QModelIndex* index) {
	static_cast<const VirtualQItemDelegate*>(self)->QItemDelegate::updateEditorGeometry(editor, *option, *index);
}
...
void QItemDelegate_virtualbase_drawDisplay(const void* self, QPainter* painter, QStyleOptionViewItem* option, QRect* rect, struct seaqt_string text) {
	QString text_QString = QString::fromUtf8(text.data, text.len);
	static_cast<const VirtualQItemDelegate*>(self)->QItemDelegate::drawDisplay(painter, *option, *rect, text_QString);
}
...
void QItemDelegate_virtualbase_drawDecoration(const void* self, QPainter* painter, QStyleOptionViewItem* option, QRect* rect, QPixmap* pixmap) {
	static_cast<const VirtualQItemDelegate*>(self)->QItemDelegate::drawDecoration(painter, *option, *rect, *pixmap);
}
...
void QItemDelegate_virtualbase_drawFocus(const void* self, QPainter* painter, QStyleOptionViewItem* option, QRect* rect) {
	static_cast<const VirtualQItemDelegate*>(self)->QItemDelegate::drawFocus(painter, *option, *rect);
}
...
void QItemDelegate_virtualbase_drawCheck(const void* self, QPainter* painter, QStyleOptionViewItem* option, QRect* rect, int state) {
	static_cast<const VirtualQItemDelegate*>(self)->QItemDelegate::drawCheck(painter, *option, *rect, static_cast<Qt::CheckState>(state));
}
...
bool QItemDelegate_virtualbase_eventFilter(void* self, QObject* object, QEvent* event) {
	return static_cast<VirtualQItemDelegate*>(self)->QItemDelegate::eventFilter(object, event);
}
...
bool QItemDelegate_virtualbase_editorEvent(void* self, QEvent* event, QAbstractItemModel* model, QStyleOptionViewItem* option, QModelIndex* index) {
	return static_cast<VirtualQItemDelegate*>(self)->QItemDelegate::editorEvent(event, model, *option, *index);
}
...
void QItemDelegate_virtualbase_destroyEditor(const void* self, QWidget* editor, QModelIndex* index) {
	static_cast<const VirtualQItemDelegate*>(self)->QItemDelegate::destroyEditor(editor, *index);
}
...
bool QItemDelegate_virtualbase_helpEvent(void* self, QHelpEvent* event, QAbstractItemView* view, QStyleOptionViewItem* option, QModelIndex* index) {
	return static_cast<VirtualQItemDelegate*>(self)->QItemDelegate::helpEvent(event, view, *option, *index);
}
...
struct seaqt_array /* of int */  QItemDelegate_virtualbase_paintingRoles(const void* self) {
	QVector<int> _ret = static_cast<const VirtualQItemDelegate*>(self)->QItemDelegate::paintingRoles();
...
bool QItemDelegate_virtualbase_event(void* self, QEvent* event) {
	return static_cast<VirtualQItemDelegate*>(self)->QItemDelegate::event(event);
}
...
void QItemDelegate_virtualbase_timerEvent(void* self, QTimerEvent* event) {
	static_cast<VirtualQItemDelegate*>(self)->QItemDelegate::timerEvent(event);
}
...
void QItemDelegate_virtualbase_childEvent(void* self, QChildEvent* event) {
	static_cast<VirtualQItemDelegate*>(self)->QItemDelegate::childEvent(event);
}
...
void QItemDelegate_virtualbase_customEvent(void* self, QEvent* event) {
	static_cast<VirtualQItemDelegate*>(self)->QItemDelegate::customEvent(event);
}
...
void QItemDelegate_virtualbase_connectNotify(void* self, QMetaMethod* signal) {
	static_cast<VirtualQItemDelegate*>(self)->QItemDelegate::connectNotify(*signal);
}
...
void QItemDelegate_virtualbase_disconnectNotify(void* self, QMetaMethod* signal) {
	static_cast<VirtualQItemDelegate*>(self)->QItemDelegate::disconnectNotify(*signal);
}
...
QRect* QItemDelegate_protectedbase_textRectangle(bool* _dynamic_cast_ok, const void* self, QPainter* painter, QRect* rect, QFont* font, struct seaqt_string text) {
	VirtualQItemDelegate* self_cast = dynamic_cast<VirtualQItemDelegate*>( (QItemDelegate*)(self) );
	if (self_cast == nullptr) {
		*_dynamic_cast_ok = false;
		return nullptr;
