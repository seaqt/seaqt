...
bool miqt_exec_callback_QLCDNumber_nativeEvent(QLCDNumber*, intptr_t, struct seaqt_string, void*, intptr_t*);
...
public:
	...
	virtual ~VirtualQLCDNumber() override = default;
	...
	friend bool QLCDNumber_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, intptr_t* result);
...
QLCDNumber* QLCDNumber_new() {
	return new (std::nothrow) VirtualQLCDNumber();
}

QLCDNumber* QLCDNumber_new2(unsigned int numDigits) {
	return new (std::nothrow) VirtualQLCDNumber(static_cast<uint>(numDigits));
}

QLCDNumber* QLCDNumber_new3(QWidget* parent) {
	return new (std::nothrow) VirtualQLCDNumber(parent);
}

QLCDNumber* QLCDNumber_new4(unsigned int numDigits, QWidget* parent) {
	return new (std::nothrow) VirtualQLCDNumber(static_cast<uint>(numDigits), parent);
}
...
bool QLCDNumber_override_virtual_metaObject(void* self, intptr_t slot) {
	VirtualQLCDNumber* self_cast = dynamic_cast<VirtualQLCDNumber*>( (QLCDNumber*)(self) );
...
QMetaObject* QLCDNumber_virtualbase_metaObject(const void* self) {
	return (QMetaObject*) static_cast<const VirtualQLCDNumber*>(self)->QLCDNumber::metaObject();
}
...
void* QLCDNumber_virtualbase_metacast(void* self, const char* param1) {
	return static_cast<VirtualQLCDNumber*>(self)->QLCDNumber::qt_metacast(param1);
}
...
int QLCDNumber_virtualbase_metacall(void* self, int param1, int param2, void** param3) {
	return static_cast<VirtualQLCDNumber*>(self)->QLCDNumber::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
}
...
QSize* QLCDNumber_virtualbase_sizeHint(const void* self) {
	return new QSize(static_cast<const VirtualQLCDNumber*>(self)->QLCDNumber::sizeHint());
}
...
bool QLCDNumber_virtualbase_event(void* self, QEvent* e) {
	return static_cast<VirtualQLCDNumber*>(self)->QLCDNumber::event(e);
}
...
void QLCDNumber_virtualbase_paintEvent(void* self, QPaintEvent* param1) {
	static_cast<VirtualQLCDNumber*>(self)->QLCDNumber::paintEvent(param1);
}
...
void QLCDNumber_virtualbase_changeEvent(void* self, QEvent* param1) {
	static_cast<VirtualQLCDNumber*>(self)->QLCDNumber::changeEvent(param1);
}
...
void QLCDNumber_virtualbase_initStyleOption(const void* self, QStyleOptionFrame* option) {
	static_cast<const VirtualQLCDNumber*>(self)->QLCDNumber::initStyleOption(option);
}
...
int QLCDNumber_virtualbase_devType(const void* self) {
	return static_cast<const VirtualQLCDNumber*>(self)->QLCDNumber::devType();
}
...
void QLCDNumber_virtualbase_setVisible(void* self, bool visible) {
	static_cast<VirtualQLCDNumber*>(self)->QLCDNumber::setVisible(visible);
}
...
QSize* QLCDNumber_virtualbase_minimumSizeHint(const void* self) {
	return new QSize(static_cast<const VirtualQLCDNumber*>(self)->QLCDNumber::minimumSizeHint());
}
...
int QLCDNumber_virtualbase_heightForWidth(const void* self, int param1) {
	return static_cast<const VirtualQLCDNumber*>(self)->QLCDNumber::heightForWidth(static_cast<int>(param1));
}
...
bool QLCDNumber_virtualbase_hasHeightForWidth(const void* self) {
	return static_cast<const VirtualQLCDNumber*>(self)->QLCDNumber::hasHeightForWidth();
}
...
QPaintEngine* QLCDNumber_virtualbase_paintEngine(const void* self) {
	return static_cast<const VirtualQLCDNumber*>(self)->QLCDNumber::paintEngine();
}
...
void QLCDNumber_virtualbase_mousePressEvent(void* self, QMouseEvent* event) {
	static_cast<VirtualQLCDNumber*>(self)->QLCDNumber::mousePressEvent(event);
}
...
void QLCDNumber_virtualbase_mouseReleaseEvent(void* self, QMouseEvent* event) {
	static_cast<VirtualQLCDNumber*>(self)->QLCDNumber::mouseReleaseEvent(event);
}
...
void QLCDNumber_virtualbase_mouseDoubleClickEvent(void* self, QMouseEvent* event) {
	static_cast<VirtualQLCDNumber*>(self)->QLCDNumber::mouseDoubleClickEvent(event);
}
...
void QLCDNumber_virtualbase_mouseMoveEvent(void* self, QMouseEvent* event) {
	static_cast<VirtualQLCDNumber*>(self)->QLCDNumber::mouseMoveEvent(event);
}
...
void QLCDNumber_virtualbase_wheelEvent(void* self, QWheelEvent* event) {
	static_cast<VirtualQLCDNumber*>(self)->QLCDNumber::wheelEvent(event);
}
...
void QLCDNumber_virtualbase_keyPressEvent(void* self, QKeyEvent* event) {
	static_cast<VirtualQLCDNumber*>(self)->QLCDNumber::keyPressEvent(event);
}
...
void QLCDNumber_virtualbase_keyReleaseEvent(void* self, QKeyEvent* event) {
	static_cast<VirtualQLCDNumber*>(self)->QLCDNumber::keyReleaseEvent(event);
}
...
void QLCDNumber_virtualbase_focusInEvent(void* self, QFocusEvent* event) {
	static_cast<VirtualQLCDNumber*>(self)->QLCDNumber::focusInEvent(event);
}
...
void QLCDNumber_virtualbase_focusOutEvent(void* self, QFocusEvent* event) {
	static_cast<VirtualQLCDNumber*>(self)->QLCDNumber::focusOutEvent(event);
}
...
void QLCDNumber_virtualbase_enterEvent(void* self, QEnterEvent* event) {
	static_cast<VirtualQLCDNumber*>(self)->QLCDNumber::enterEvent(event);
}
...
void QLCDNumber_virtualbase_leaveEvent(void* self, QEvent* event) {
	static_cast<VirtualQLCDNumber*>(self)->QLCDNumber::leaveEvent(event);
}
...
void QLCDNumber_virtualbase_moveEvent(void* self, QMoveEvent* event) {
	static_cast<VirtualQLCDNumber*>(self)->QLCDNumber::moveEvent(event);
}
...
void QLCDNumber_virtualbase_resizeEvent(void* self, QResizeEvent* event) {
	static_cast<VirtualQLCDNumber*>(self)->QLCDNumber::resizeEvent(event);
}
...
void QLCDNumber_virtualbase_closeEvent(void* self, QCloseEvent* event) {
	static_cast<VirtualQLCDNumber*>(self)->QLCDNumber::closeEvent(event);
}
...
void QLCDNumber_virtualbase_contextMenuEvent(void* self, QContextMenuEvent* event) {
	static_cast<VirtualQLCDNumber*>(self)->QLCDNumber::contextMenuEvent(event);
}
...
void QLCDNumber_virtualbase_tabletEvent(void* self, QTabletEvent* event) {
	static_cast<VirtualQLCDNumber*>(self)->QLCDNumber::tabletEvent(event);
}
...
void QLCDNumber_virtualbase_actionEvent(void* self, QActionEvent* event) {
	static_cast<VirtualQLCDNumber*>(self)->QLCDNumber::actionEvent(event);
}
...
void QLCDNumber_virtualbase_dragEnterEvent(void* self, QDragEnterEvent* event) {
	static_cast<VirtualQLCDNumber*>(self)->QLCDNumber::dragEnterEvent(event);
}
...
void QLCDNumber_virtualbase_dragMoveEvent(void* self, QDragMoveEvent* event) {
	static_cast<VirtualQLCDNumber*>(self)->QLCDNumber::dragMoveEvent(event);
}
...
void QLCDNumber_virtualbase_dragLeaveEvent(void* self, QDragLeaveEvent* event) {
	static_cast<VirtualQLCDNumber*>(self)->QLCDNumber::dragLeaveEvent(event);
}
...
void QLCDNumber_virtualbase_dropEvent(void* self, QDropEvent* event) {
	static_cast<VirtualQLCDNumber*>(self)->QLCDNumber::dropEvent(event);
}
...
void QLCDNumber_virtualbase_showEvent(void* self, QShowEvent* event) {
	static_cast<VirtualQLCDNumber*>(self)->QLCDNumber::showEvent(event);
}
...
void QLCDNumber_virtualbase_hideEvent(void* self, QHideEvent* event) {
	static_cast<VirtualQLCDNumber*>(self)->QLCDNumber::hideEvent(event);
}
...
bool QLCDNumber_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, intptr_t* result) {
	QByteArray eventType_QByteArray(eventType.data, eventType.len);
	return static_cast<VirtualQLCDNumber*>(self)->QLCDNumber::nativeEvent(eventType_QByteArray, message, (qintptr*)(result));
}
...
int QLCDNumber_virtualbase_metric(const void* self, int param1) {
	return static_cast<const VirtualQLCDNumber*>(self)->QLCDNumber::metric(static_cast<VirtualQLCDNumber::PaintDeviceMetric>(param1));
}
...
void QLCDNumber_virtualbase_initPainter(const void* self, QPainter* painter) {
	static_cast<const VirtualQLCDNumber*>(self)->QLCDNumber::initPainter(painter);
}
...
QPaintDevice* QLCDNumber_virtualbase_redirected(const void* self, QPoint* offset) {
	return static_cast<const VirtualQLCDNumber*>(self)->QLCDNumber::redirected(offset);
}
...
QPainter* QLCDNumber_virtualbase_sharedPainter(const void* self) {
	return static_cast<const VirtualQLCDNumber*>(self)->QLCDNumber::sharedPainter();
}
...
void QLCDNumber_virtualbase_inputMethodEvent(void* self, QInputMethodEvent* param1) {
	static_cast<VirtualQLCDNumber*>(self)->QLCDNumber::inputMethodEvent(param1);
}
...
QVariant* QLCDNumber_virtualbase_inputMethodQuery(const void* self, int param1) {
	return new QVariant(static_cast<const VirtualQLCDNumber*>(self)->QLCDNumber::inputMethodQuery(static_cast<Qt::InputMethodQuery>(param1)));
}
...
bool QLCDNumber_virtualbase_focusNextPrevChild(void* self, bool next) {
	return static_cast<VirtualQLCDNumber*>(self)->QLCDNumber::focusNextPrevChild(next);
}
...
bool QLCDNumber_virtualbase_eventFilter(void* self, QObject* watched, QEvent* event) {
	return static_cast<VirtualQLCDNumber*>(self)->QLCDNumber::eventFilter(watched, event);
}
...
void QLCDNumber_virtualbase_timerEvent(void* self, QTimerEvent* event) {
	static_cast<VirtualQLCDNumber*>(self)->QLCDNumber::timerEvent(event);
}
...
void QLCDNumber_virtualbase_childEvent(void* self, QChildEvent* event) {
	static_cast<VirtualQLCDNumber*>(self)->QLCDNumber::childEvent(event);
}
...
void QLCDNumber_virtualbase_customEvent(void* self, QEvent* event) {
	static_cast<VirtualQLCDNumber*>(self)->QLCDNumber::customEvent(event);
}
...
void QLCDNumber_virtualbase_connectNotify(void* self, QMetaMethod* signal) {
	static_cast<VirtualQLCDNumber*>(self)->QLCDNumber::connectNotify(*signal);
}
...
void QLCDNumber_virtualbase_disconnectNotify(void* self, QMetaMethod* signal) {
	static_cast<VirtualQLCDNumber*>(self)->QLCDNumber::disconnectNotify(*signal);
}
