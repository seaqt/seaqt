...
public:
	...
	friend bool QLCDNumber_virtualbase_nativeEvent(VirtualQLCDNumber* self, struct seaqt_string eventType, void* message, intptr_t* result);
	...
	friend double QLCDNumber_protectedbase_getDecodedMetricF(const VirtualQLCDNumber* self, int metricA, int metricB);
};
...
void QLCDNumber_connect_overflow(QLCDNumber* self, intptr_t slot, void (*callback)(intptr_t), void (*release)(intptr_t)) {
	QLCDNumber::connect(self, static_cast<void (QLCDNumber::*)()>(&QLCDNumber::overflow), self, [callback, release = seaqt::release_callback{slot,release}]() {
...
double QLCDNumber_protectedbase_getDecodedMetricF(const VirtualQLCDNumber* self, int metricA, int metricB) {
	return self->QLCDNumber::getDecodedMetricF(static_cast<VirtualQLCDNumber::PaintDeviceMetric>(metricA), static_cast<VirtualQLCDNumber::PaintDeviceMetric>(metricB));
}
