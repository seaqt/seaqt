...
bool miqt_exec_callback_QLCDNumber_nativeEvent(QLCDNumber*, intptr_t, struct seaqt_string, void*, long*);
...
public:
	...
	friend bool QLCDNumber_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, long* result);
...
bool QLCDNumber_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, long* result) {
	QByteArray eventType_QByteArray(eventType.data, eventType.len);
	return static_cast<VirtualQLCDNumber*>(self)->QLCDNumber::nativeEvent(eventType_QByteArray, message, static_cast<long*>(result));
}
