...
typedef struct QTreeWidget_VTable{
	...
	bool (*edit2)(VirtualQTreeWidget* self, QModelIndex* index, int trigger, QEvent* event);
	...
	QStyleOptionViewItem* (*viewOptions)(const VirtualQTreeWidget* self);
	...
	void (*changeEvent)(VirtualQTreeWidget* self, QEvent* param1);
	...
	void (*enterEvent)(VirtualQTreeWidget* self, QEvent* event);
	...
	bool (*nativeEvent)(VirtualQTreeWidget* self, struct seaqt_string eventType, void* message, long* result);
