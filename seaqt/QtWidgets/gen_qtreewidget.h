...
struct QTreeWidget_VTable {
	...
	void (*changeEvent)(struct QTreeWidget_VTable* vtbl, QTreeWidget* self, QEvent* event);
	...
	QAbstractItemDelegate* (*itemDelegateForIndex)(struct QTreeWidget_VTable* vtbl, const QTreeWidget* self, QModelIndex* index);
	...
	void (*initViewItemOption)(struct QTreeWidget_VTable* vtbl, const QTreeWidget* self, QStyleOptionViewItem* option);
	...
	void (*initStyleOption)(struct QTreeWidget_VTable* vtbl, const QTreeWidget* self, QStyleOptionFrame* option);
	...
	void (*enterEvent)(struct QTreeWidget_VTable* vtbl, QTreeWidget* self, QEnterEvent* event);
	...
	bool (*nativeEvent)(struct QTreeWidget_VTable* vtbl, QTreeWidget* self, struct miqt_string eventType, void* message, intptr_t* result);
