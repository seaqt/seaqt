...
public:
	...
	friend double QKeySequenceEdit_protectedbase_getDecodedMetricF(const VirtualQKeySequenceEdit* self, int metricA, int metricB);
};
...
void QKeySequenceEdit_setFinishingKeyCombinations(QKeySequenceEdit* self, struct seaqt_array /* of QKeyCombination* */  finishingKeyCombinations) {
...
struct seaqt_array /* of QKeyCombination* */  QKeySequenceEdit_finishingKeyCombinations(const QKeySequenceEdit* self) {
...
void QKeySequenceEdit_connect_editingFinished(QKeySequenceEdit* self, intptr_t slot, void (*callback)(intptr_t), void (*release)(intptr_t)) {
	QKeySequenceEdit::connect(self, static_cast<void (QKeySequenceEdit::*)()>(&QKeySequenceEdit::editingFinished), self, [callback, release = seaqt::release_callback{slot,release}]() {
...
void QKeySequenceEdit_connect_keySequenceChanged(QKeySequenceEdit* self, intptr_t slot, void (*callback)(intptr_t, QKeySequence*), void (*release)(intptr_t)) {
	QKeySequenceEdit::connect(self, static_cast<void (QKeySequenceEdit::*)(const QKeySequence&)>(&QKeySequenceEdit::keySequenceChanged), self, [callback, release = seaqt::release_callback{slot,release}](const QKeySequence& keySequence) {
...
double QKeySequenceEdit_protectedbase_getDecodedMetricF(const VirtualQKeySequenceEdit* self, int metricA, int metricB) {
	return self->QKeySequenceEdit::getDecodedMetricF(static_cast<VirtualQKeySequenceEdit::PaintDeviceMetric>(metricA), static_cast<VirtualQKeySequenceEdit::PaintDeviceMetric>(metricB));
}
