...
bool miqt_exec_callback_QKeySequenceEdit_nativeEvent(QKeySequenceEdit*, intptr_t, struct seaqt_string, void*, long*);
...
public:
	...
	friend bool QKeySequenceEdit_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, long* result);
...
void QKeySequenceEdit_virtualbase_focusOutEvent(void* self, QFocusEvent* event) {
	static_cast<VirtualQKeySequenceEdit*>(self)->QKeySequenceEdit::focusOutEvent(event);
}
...
bool QKeySequenceEdit_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, long* result) {
	QByteArray eventType_QByteArray(eventType.data, eventType.len);
	return static_cast<VirtualQKeySequenceEdit*>(self)->QKeySequenceEdit::nativeEvent(eventType_QByteArray, message, static_cast<long*>(result));
}
