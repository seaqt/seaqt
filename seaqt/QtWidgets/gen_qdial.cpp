...
void miqt_exec_callback_QDial_enterEvent(QDial*, intptr_t, QEnterEvent*);
...
bool miqt_exec_callback_QDial_nativeEvent(QDial*, intptr_t, struct seaqt_string, void*, intptr_t*);
...
public:
	...
	virtual void initStyleOption(QStyleOptionSlider* option) const override {
		...
		miqt_exec_callback_QDial_initStyleOption(this, handle__initStyleOption, sigval1);

	}

	friend void QDial_virtualbase_initStyleOption(const void* self, QStyleOptionSlider* option);
	...
	friend void QDial_virtualbase_enterEvent(void* self, QEnterEvent* event);
	...
	friend bool QDial_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, intptr_t* result);
...
void QDial_virtualbase_initStyleOption(const void* self, QStyleOptionSlider* option) {
	static_cast<const VirtualQDial*>(self)->QDial::initStyleOption(option);
}
...
bool QDial_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, intptr_t* result) {
	QByteArray eventType_QByteArray(eventType.data, eventType.len);
	return static_cast<VirtualQDial*>(self)->QDial::nativeEvent(eventType_QByteArray, message, (qintptr*)(result));
}
