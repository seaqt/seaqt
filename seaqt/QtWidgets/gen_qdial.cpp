...
public:
	...
	friend bool QDial_virtualbase_nativeEvent(VirtualQDial* self, struct seaqt_string eventType, void* message, intptr_t* result);
	...
	friend double QDial_protectedbase_getDecodedMetricF(const VirtualQDial* self, int metricA, int metricB);
};
...
bool QDial_virtualbase_nativeEvent(VirtualQDial* self, struct seaqt_string eventType, void* message, intptr_t* result) {
...
double QDial_protectedbase_getDecodedMetricF(const VirtualQDial* self, int metricA, int metricB) {
	return self->QDial::getDecodedMetricF(static_cast<VirtualQDial::PaintDeviceMetric>(metricA), static_cast<VirtualQDial::PaintDeviceMetric>(metricB));
}
