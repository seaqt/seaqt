...
struct QFrame_VTable {
	...
	void (*initStyleOption)(struct QFrame_VTable* vtbl, const QFrame* self, QStyleOptionFrame* option);
	...
	void (*enterEvent)(struct QFrame_VTable* vtbl, QFrame* self, QEnterEvent* event);
	...
	bool (*nativeEvent)(struct QFrame_VTable* vtbl, QFrame* self, struct miqt_string eventType, void* message, intptr_t* result);
