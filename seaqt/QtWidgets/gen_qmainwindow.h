...
typedef struct QMainWindow_VTable{
	...
	void (*enterEvent)(VirtualQMainWindow* self, QEnterEvent* event);
	...
	bool (*nativeEvent)(VirtualQMainWindow* self, struct seaqt_string eventType, void* message, intptr_t* result);
