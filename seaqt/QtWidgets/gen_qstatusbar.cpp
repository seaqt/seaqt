...
bool miqt_exec_callback_QStatusBar_nativeEvent(QStatusBar*, intptr_t, struct seaqt_string, void*, intptr_t*);
...
public:
	...
	friend bool QStatusBar_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, intptr_t* result);
...
bool QStatusBar_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, intptr_t* result) {
	QByteArray eventType_QByteArray(eventType.data, eventType.len);
	return static_cast<VirtualQStatusBar*>(self)->QStatusBar::nativeEvent(eventType_QByteArray, message, (qintptr*)(result));
}
