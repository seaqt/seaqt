...
public:
	...
	friend bool QStatusBar_virtualbase_nativeEvent(VirtualQStatusBar* self, struct seaqt_string eventType, void* message, long* result);
...
VirtualQStatusBar* QStatusBar_new(const QStatusBar_VTable* vtbl, size_t vdata, QWidget* parent) {
...
VirtualQStatusBar* QStatusBar_new2(const QStatusBar_VTable* vtbl, size_t vdata) {
	void* _mem_ = ::operator new(seaqt_aligned_sizeof<VirtualQStatusBar>() + vdata, std::nothrow);
...
bool QStatusBar_virtualbase_nativeEvent(VirtualQStatusBar* self, struct seaqt_string eventType, void* message, long* result) {
