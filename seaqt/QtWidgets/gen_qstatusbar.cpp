...
void miqt_exec_callback_QStatusBar_messageChanged(intptr_t, struct seaqt_string);
...
bool miqt_exec_callback_QStatusBar_nativeEvent(QStatusBar*, intptr_t, struct seaqt_string, void*, long*);
...
public:
	...
	virtual ~VirtualQStatusBar() override = default;
	...
	virtual int qt_metacall(QMetaObject::Call param1, int param2, void** param3) override {
		...
		int sigval2 = param2;
		void** sigval3 = param3;
		int callback_return_value = miqt_exec_callback_QStatusBar_metacall(this, handle__metacall, sigval1, sigval2, sigval3);
	...
	friend bool QStatusBar_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, long* result);
...
QStatusBar* QStatusBar_new(QWidget* parent) {
	return new (std::nothrow) VirtualQStatusBar(parent);
}

QStatusBar* QStatusBar_new2() {
	return new (std::nothrow) VirtualQStatusBar();
}
...
struct seaqt_string QStatusBar_trUtf8(const char* s) {
...
struct seaqt_string QStatusBar_trUtf82(const char* s, const char* c) {
...
struct seaqt_string QStatusBar_trUtf83(const char* s, const char* c, int n) {
...
QMetaObject* QStatusBar_virtualbase_metaObject(const void* self) {
	return (QMetaObject*) static_cast<const VirtualQStatusBar*>(self)->QStatusBar::metaObject();
}
...
void* QStatusBar_virtualbase_metacast(void* self, const char* param1) {
	return static_cast<VirtualQStatusBar*>(self)->QStatusBar::qt_metacast(param1);
}
...
int QStatusBar_virtualbase_metacall(void* self, int param1, int param2, void** param3) {
	return static_cast<VirtualQStatusBar*>(self)->QStatusBar::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
}
...
void QStatusBar_virtualbase_showEvent(void* self, QShowEvent* param1) {
	static_cast<VirtualQStatusBar*>(self)->QStatusBar::showEvent(param1);
}
...
void QStatusBar_virtualbase_paintEvent(void* self, QPaintEvent* param1) {
	static_cast<VirtualQStatusBar*>(self)->QStatusBar::paintEvent(param1);
}
...
void QStatusBar_virtualbase_resizeEvent(void* self, QResizeEvent* param1) {
	static_cast<VirtualQStatusBar*>(self)->QStatusBar::resizeEvent(param1);
}
...
bool QStatusBar_virtualbase_event(void* self, QEvent* param1) {
	return static_cast<VirtualQStatusBar*>(self)->QStatusBar::event(param1);
}
...
int QStatusBar_virtualbase_devType(const void* self) {
	return static_cast<const VirtualQStatusBar*>(self)->QStatusBar::devType();
}
...
void QStatusBar_virtualbase_setVisible(void* self, bool visible) {
	static_cast<VirtualQStatusBar*>(self)->QStatusBar::setVisible(visible);
}
...
QSize* QStatusBar_virtualbase_sizeHint(const void* self) {
	return new QSize(static_cast<const VirtualQStatusBar*>(self)->QStatusBar::sizeHint());
}
...
QSize* QStatusBar_virtualbase_minimumSizeHint(const void* self) {
	return new QSize(static_cast<const VirtualQStatusBar*>(self)->QStatusBar::minimumSizeHint());
}
...
int QStatusBar_virtualbase_heightForWidth(const void* self, int param1) {
	return static_cast<const VirtualQStatusBar*>(self)->QStatusBar::heightForWidth(static_cast<int>(param1));
}
...
bool QStatusBar_virtualbase_hasHeightForWidth(const void* self) {
	return static_cast<const VirtualQStatusBar*>(self)->QStatusBar::hasHeightForWidth();
}
...
QPaintEngine* QStatusBar_virtualbase_paintEngine(const void* self) {
	return static_cast<const VirtualQStatusBar*>(self)->QStatusBar::paintEngine();
}
...
void QStatusBar_virtualbase_mousePressEvent(void* self, QMouseEvent* event) {
	static_cast<VirtualQStatusBar*>(self)->QStatusBar::mousePressEvent(event);
}
...
void QStatusBar_virtualbase_mouseReleaseEvent(void* self, QMouseEvent* event) {
	static_cast<VirtualQStatusBar*>(self)->QStatusBar::mouseReleaseEvent(event);
}
...
void QStatusBar_virtualbase_mouseDoubleClickEvent(void* self, QMouseEvent* event) {
	static_cast<VirtualQStatusBar*>(self)->QStatusBar::mouseDoubleClickEvent(event);
}
...
void QStatusBar_virtualbase_mouseMoveEvent(void* self, QMouseEvent* event) {
	static_cast<VirtualQStatusBar*>(self)->QStatusBar::mouseMoveEvent(event);
}
...
void QStatusBar_virtualbase_wheelEvent(void* self, QWheelEvent* event) {
	static_cast<VirtualQStatusBar*>(self)->QStatusBar::wheelEvent(event);
}
...
void QStatusBar_virtualbase_keyPressEvent(void* self, QKeyEvent* event) {
	static_cast<VirtualQStatusBar*>(self)->QStatusBar::keyPressEvent(event);
}
...
void QStatusBar_virtualbase_keyReleaseEvent(void* self, QKeyEvent* event) {
	static_cast<VirtualQStatusBar*>(self)->QStatusBar::keyReleaseEvent(event);
}
...
void QStatusBar_virtualbase_focusInEvent(void* self, QFocusEvent* event) {
	static_cast<VirtualQStatusBar*>(self)->QStatusBar::focusInEvent(event);
}
...
void QStatusBar_virtualbase_focusOutEvent(void* self, QFocusEvent* event) {
	static_cast<VirtualQStatusBar*>(self)->QStatusBar::focusOutEvent(event);
}
...
void QStatusBar_virtualbase_enterEvent(void* self, QEvent* event) {
	static_cast<VirtualQStatusBar*>(self)->QStatusBar::enterEvent(event);
}
...
void QStatusBar_virtualbase_leaveEvent(void* self, QEvent* event) {
	static_cast<VirtualQStatusBar*>(self)->QStatusBar::leaveEvent(event);
}
...
void QStatusBar_virtualbase_moveEvent(void* self, QMoveEvent* event) {
	static_cast<VirtualQStatusBar*>(self)->QStatusBar::moveEvent(event);
}
...
void QStatusBar_virtualbase_closeEvent(void* self, QCloseEvent* event) {
	static_cast<VirtualQStatusBar*>(self)->QStatusBar::closeEvent(event);
}
...
void QStatusBar_virtualbase_contextMenuEvent(void* self, QContextMenuEvent* event) {
	static_cast<VirtualQStatusBar*>(self)->QStatusBar::contextMenuEvent(event);
}
...
void QStatusBar_virtualbase_tabletEvent(void* self, QTabletEvent* event) {
	static_cast<VirtualQStatusBar*>(self)->QStatusBar::tabletEvent(event);
}
...
void QStatusBar_virtualbase_actionEvent(void* self, QActionEvent* event) {
	static_cast<VirtualQStatusBar*>(self)->QStatusBar::actionEvent(event);
}
...
void QStatusBar_virtualbase_dragEnterEvent(void* self, QDragEnterEvent* event) {
	static_cast<VirtualQStatusBar*>(self)->QStatusBar::dragEnterEvent(event);
}
...
void QStatusBar_virtualbase_dragMoveEvent(void* self, QDragMoveEvent* event) {
	static_cast<VirtualQStatusBar*>(self)->QStatusBar::dragMoveEvent(event);
}
...
void QStatusBar_virtualbase_dragLeaveEvent(void* self, QDragLeaveEvent* event) {
	static_cast<VirtualQStatusBar*>(self)->QStatusBar::dragLeaveEvent(event);
}
...
void QStatusBar_virtualbase_dropEvent(void* self, QDropEvent* event) {
	static_cast<VirtualQStatusBar*>(self)->QStatusBar::dropEvent(event);
}
...
void QStatusBar_virtualbase_hideEvent(void* self, QHideEvent* event) {
	static_cast<VirtualQStatusBar*>(self)->QStatusBar::hideEvent(event);
}
...
bool QStatusBar_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, long* result) {
	QByteArray eventType_QByteArray(eventType.data, eventType.len);
	return static_cast<VirtualQStatusBar*>(self)->QStatusBar::nativeEvent(eventType_QByteArray, message, static_cast<long*>(result));
}
...
void QStatusBar_virtualbase_changeEvent(void* self, QEvent* param1) {
	static_cast<VirtualQStatusBar*>(self)->QStatusBar::changeEvent(param1);
}
...
int QStatusBar_virtualbase_metric(const void* self, int param1) {
	return static_cast<const VirtualQStatusBar*>(self)->QStatusBar::metric(static_cast<VirtualQStatusBar::PaintDeviceMetric>(param1));
}
...
void QStatusBar_virtualbase_initPainter(const void* self, QPainter* painter) {
	static_cast<const VirtualQStatusBar*>(self)->QStatusBar::initPainter(painter);
}
...
QPaintDevice* QStatusBar_virtualbase_redirected(const void* self, QPoint* offset) {
	return static_cast<const VirtualQStatusBar*>(self)->QStatusBar::redirected(offset);
}
...
QPainter* QStatusBar_virtualbase_sharedPainter(const void* self) {
	return static_cast<const VirtualQStatusBar*>(self)->QStatusBar::sharedPainter();
}
...
void QStatusBar_virtualbase_inputMethodEvent(void* self, QInputMethodEvent* param1) {
	static_cast<VirtualQStatusBar*>(self)->QStatusBar::inputMethodEvent(param1);
}
...
QVariant* QStatusBar_virtualbase_inputMethodQuery(const void* self, int param1) {
	return new QVariant(static_cast<const VirtualQStatusBar*>(self)->QStatusBar::inputMethodQuery(static_cast<Qt::InputMethodQuery>(param1)));
}
...
bool QStatusBar_virtualbase_focusNextPrevChild(void* self, bool next) {
	return static_cast<VirtualQStatusBar*>(self)->QStatusBar::focusNextPrevChild(next);
}
...
bool QStatusBar_virtualbase_eventFilter(void* self, QObject* watched, QEvent* event) {
	return static_cast<VirtualQStatusBar*>(self)->QStatusBar::eventFilter(watched, event);
}
...
void QStatusBar_virtualbase_timerEvent(void* self, QTimerEvent* event) {
	static_cast<VirtualQStatusBar*>(self)->QStatusBar::timerEvent(event);
}
...
void QStatusBar_virtualbase_childEvent(void* self, QChildEvent* event) {
	static_cast<VirtualQStatusBar*>(self)->QStatusBar::childEvent(event);
}
...
void QStatusBar_virtualbase_customEvent(void* self, QEvent* event) {
	static_cast<VirtualQStatusBar*>(self)->QStatusBar::customEvent(event);
}
...
void QStatusBar_virtualbase_connectNotify(void* self, QMetaMethod* signal) {
	static_cast<VirtualQStatusBar*>(self)->QStatusBar::connectNotify(*signal);
}
...
void QStatusBar_virtualbase_disconnectNotify(void* self, QMetaMethod* signal) {
	static_cast<VirtualQStatusBar*>(self)->QStatusBar::disconnectNotify(*signal);
}
