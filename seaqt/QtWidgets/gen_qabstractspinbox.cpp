...
public:
	...
	friend double QAbstractSpinBox_protectedbase_getDecodedMetricF(const VirtualQAbstractSpinBox* self, int metricA, int metricB);
};
...
void QAbstractSpinBox_connect_returnPressed(QAbstractSpinBox* self, intptr_t slot, void (*callback)(intptr_t), void (*release)(intptr_t)) {
	QAbstractSpinBox::connect(self, static_cast<void (QAbstractSpinBox::*)()>(&QAbstractSpinBox::returnPressed), self, [callback, release = seaqt::release_callback{slot,release}]() {
			callback(release.slot);
	});
}
...
double QAbstractSpinBox_protectedbase_getDecodedMetricF(const VirtualQAbstractSpinBox* self, int metricA, int metricB) {
	return self->QAbstractSpinBox::getDecodedMetricF(static_cast<VirtualQAbstractSpinBox::PaintDeviceMetric>(metricA), static_cast<VirtualQAbstractSpinBox::PaintDeviceMetric>(metricB));
}
