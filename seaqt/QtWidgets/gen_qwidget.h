...
struct QWidget_VTable {
	...
	void (*enterEvent)(struct QWidget_VTable* vtbl, QWidget* self, QEvent* event);
	...
	bool (*nativeEvent)(struct QWidget_VTable* vtbl, QWidget* self, struct miqt_string eventType, void* message, long* result);
