...
typedef struct QWidget_VTable{
	...
	void (*enterEvent)(VirtualQWidget* self, QEvent* event);
	...
	bool (*nativeEvent)(VirtualQWidget* self, struct seaqt_string eventType, void* message, long* result);
...
bool QWidget_nativeEvent(QWidget* self, struct seaqt_string eventType, void* message, long* result);
