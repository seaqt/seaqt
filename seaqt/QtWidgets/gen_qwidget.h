...
struct QWidget_VTable {
	void (*destructor)(struct QWidget_VTable* vtbl, QWidget* self);
	QMetaObject* (*metaObject)(struct QWidget_VTable* vtbl, const QWidget* self);
	void* (*metacast)(struct QWidget_VTable* vtbl, QWidget* self, const char* param1);
	int (*metacall)(struct QWidget_VTable* vtbl, QWidget* self, int param1, int param2, void** param3);
	int (*devType)(struct QWidget_VTable* vtbl, const QWidget* self);
	void (*setVisible)(struct QWidget_VTable* vtbl, QWidget* self, bool visible);
	QSize* (*sizeHint)(struct QWidget_VTable* vtbl, const QWidget* self);
	QSize* (*minimumSizeHint)(struct QWidget_VTable* vtbl, const QWidget* self);
	int (*heightForWidth)(struct QWidget_VTable* vtbl, const QWidget* self, int param1);
	bool (*hasHeightForWidth)(struct QWidget_VTable* vtbl, const QWidget* self);
	QPaintEngine* (*paintEngine)(struct QWidget_VTable* vtbl, const QWidget* self);
	bool (*event)(struct QWidget_VTable* vtbl, QWidget* self, QEvent* event);
	void (*mousePressEvent)(struct QWidget_VTable* vtbl, QWidget* self, QMouseEvent* event);
	void (*mouseReleaseEvent)(struct QWidget_VTable* vtbl, QWidget* self, QMouseEvent* event);
	void (*mouseDoubleClickEvent)(struct QWidget_VTable* vtbl, QWidget* self, QMouseEvent* event);
	void (*mouseMoveEvent)(struct QWidget_VTable* vtbl, QWidget* self, QMouseEvent* event);
	void (*wheelEvent)(struct QWidget_VTable* vtbl, QWidget* self, QWheelEvent* event);
	void (*keyPressEvent)(struct QWidget_VTable* vtbl, QWidget* self, QKeyEvent* event);
	void (*keyReleaseEvent)(struct QWidget_VTable* vtbl, QWidget* self, QKeyEvent* event);
	void (*focusInEvent)(struct QWidget_VTable* vtbl, QWidget* self, QFocusEvent* event);
	void (*focusOutEvent)(struct QWidget_VTable* vtbl, QWidget* self, QFocusEvent* event);
	void (*enterEvent)(struct QWidget_VTable* vtbl, QWidget* self, QEnterEvent* event);
	void (*leaveEvent)(struct QWidget_VTable* vtbl, QWidget* self, QEvent* event);
	void (*paintEvent)(struct QWidget_VTable* vtbl, QWidget* self, QPaintEvent* event);
	void (*moveEvent)(struct QWidget_VTable* vtbl, QWidget* self, QMoveEvent* event);
	void (*resizeEvent)(struct QWidget_VTable* vtbl, QWidget* self, QResizeEvent* event);
	void (*closeEvent)(struct QWidget_VTable* vtbl, QWidget* self, QCloseEvent* event);
	void (*contextMenuEvent)(struct QWidget_VTable* vtbl, QWidget* self, QContextMenuEvent* event);
	void (*tabletEvent)(struct QWidget_VTable* vtbl, QWidget* self, QTabletEvent* event);
	void (*actionEvent)(struct QWidget_VTable* vtbl, QWidget* self, QActionEvent* event);
	void (*dragEnterEvent)(struct QWidget_VTable* vtbl, QWidget* self, QDragEnterEvent* event);
	void (*dragMoveEvent)(struct QWidget_VTable* vtbl, QWidget* self, QDragMoveEvent* event);
	void (*dragLeaveEvent)(struct QWidget_VTable* vtbl, QWidget* self, QDragLeaveEvent* event);
	void (*dropEvent)(struct QWidget_VTable* vtbl, QWidget* self, QDropEvent* event);
	void (*showEvent)(struct QWidget_VTable* vtbl, QWidget* self, QShowEvent* event);
	void (*hideEvent)(struct QWidget_VTable* vtbl, QWidget* self, QHideEvent* event);
	bool (*nativeEvent)(struct QWidget_VTable* vtbl, QWidget* self, struct miqt_string eventType, void* message, intptr_t* result);
	void (*changeEvent)(struct QWidget_VTable* vtbl, QWidget* self, QEvent* param1);
	int (*metric)(struct QWidget_VTable* vtbl, const QWidget* self, int param1);
	void (*initPainter)(struct QWidget_VTable* vtbl, const QWidget* self, QPainter* painter);
	QPaintDevice* (*redirected)(struct QWidget_VTable* vtbl, const QWidget* self, QPoint* offset);
	QPainter* (*sharedPainter)(struct QWidget_VTable* vtbl, const QWidget* self);
	void (*inputMethodEvent)(struct QWidget_VTable* vtbl, QWidget* self, QInputMethodEvent* param1);
	QVariant* (*inputMethodQuery)(struct QWidget_VTable* vtbl, const QWidget* self, int param1);
	bool (*focusNextPrevChild)(struct QWidget_VTable* vtbl, QWidget* self, bool next);
	bool (*eventFilter)(struct QWidget_VTable* vtbl, QWidget* self, QObject* watched, QEvent* event);
	void (*timerEvent)(struct QWidget_VTable* vtbl, QWidget* self, QTimerEvent* event);
	void (*childEvent)(struct QWidget_VTable* vtbl, QWidget* self, QChildEvent* event);
	void (*customEvent)(struct QWidget_VTable* vtbl, QWidget* self, QEvent* event);
	void (*connectNotify)(struct QWidget_VTable* vtbl, QWidget* self, QMetaMethod* signal);
	void (*disconnectNotify)(struct QWidget_VTable* vtbl, QWidget* self, QMetaMethod* signal);
};
