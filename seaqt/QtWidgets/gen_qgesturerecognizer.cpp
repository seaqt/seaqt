...
QGestureRecognizer* QGestureRecognizer_new() {
	return new (std::nothrow) VirtualQGestureRecognizer();
}
...
QGesture* QGestureRecognizer_virtualbase_create(void* self, QObject* target) {
	return static_cast<VirtualQGestureRecognizer*>(self)->QGestureRecognizer::create(target);
}
...
void QGestureRecognizer_virtualbase_reset(void* self, QGesture* state) {
	static_cast<VirtualQGestureRecognizer*>(self)->QGestureRecognizer::reset(state);
}
