...
bool miqt_exec_callback_QMenu_nativeEvent(QMenu*, intptr_t, struct seaqt_string, void*, long*);
...
public:
	...
	friend void QMenu_virtualbase_enterEvent(void* self, QEvent* param1);
	...
	friend bool QMenu_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, long* result);
...
bool QMenu_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, long* result) {
	QByteArray eventType_QByteArray(eventType.data, eventType.len);
	return static_cast<VirtualQMenu*>(self)->QMenu::nativeEvent(eventType_QByteArray, message, static_cast<long*>(result));
}
