...
struct QLabel_VTable {
	...
	void (*initStyleOption)(struct QLabel_VTable* vtbl, const QLabel* self, QStyleOptionFrame* option);
	...
	void (*enterEvent)(struct QLabel_VTable* vtbl, QLabel* self, QEnterEvent* event);
	...
	bool (*nativeEvent)(struct QLabel_VTable* vtbl, QLabel* self, struct miqt_string eventType, void* message, intptr_t* result);
