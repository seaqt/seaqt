...
public:
	...
	friend double QPlainTextEdit_protectedbase_getDecodedMetricF(const VirtualQPlainTextEdit* self, int metricA, int metricB);
};
...
double QPlainTextEdit_protectedbase_getDecodedMetricF(const VirtualQPlainTextEdit* self, int metricA, int metricB) {
	return self->QPlainTextEdit::getDecodedMetricF(static_cast<VirtualQPlainTextEdit::PaintDeviceMetric>(metricA), static_cast<VirtualQPlainTextEdit::PaintDeviceMetric>(metricB));
}
