...
bool miqt_exec_callback_QStackedWidget_nativeEvent(QStackedWidget*, intptr_t, struct seaqt_string, void*, long*);
...
public:
	...
	friend bool QStackedWidget_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, long* result);
...
bool QStackedWidget_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, long* result) {
	QByteArray eventType_QByteArray(eventType.data, eventType.len);
	return static_cast<VirtualQStackedWidget*>(self)->QStackedWidget::nativeEvent(eventType_QByteArray, message, static_cast<long*>(result));
}
