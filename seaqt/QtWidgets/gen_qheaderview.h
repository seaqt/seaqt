...
typedef struct QHeaderView_VTable{
	...
	void (*initStyleOptionForIndex)(const VirtualQHeaderView* self, QStyleOptionHeader* option, int logicalIndex);
	void (*initStyleOption)(const VirtualQHeaderView* self, QStyleOptionHeader* option);
	...
	QAbstractItemDelegate* (*itemDelegateForIndex)(const VirtualQHeaderView* self, QModelIndex* index);
	...
	void (*initViewItemOption)(const VirtualQHeaderView* self, QStyleOptionViewItem* option);
	...
	void (*enterEvent)(VirtualQHeaderView* self, QEnterEvent* event);
	...
	bool (*nativeEvent)(VirtualQHeaderView* self, struct seaqt_string eventType, void* message, intptr_t* result);
