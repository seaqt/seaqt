...
bool miqt_exec_callback_QErrorMessage_nativeEvent(QErrorMessage*, intptr_t, struct seaqt_string, void*, intptr_t*);
...
public:
	...
	friend bool QErrorMessage_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, intptr_t* result);
...
bool QErrorMessage_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, intptr_t* result) {
	QByteArray eventType_QByteArray(eventType.data, eventType.len);
	return static_cast<VirtualQErrorMessage*>(self)->QErrorMessage::nativeEvent(eventType_QByteArray, message, (qintptr*)(result));
}
