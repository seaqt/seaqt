...
public:
	...
	friend double QErrorMessage_protectedbase_getDecodedMetricF(const VirtualQErrorMessage* self, int metricA, int metricB);
};
...
double QErrorMessage_protectedbase_getDecodedMetricF(const VirtualQErrorMessage* self, int metricA, int metricB) {
	return self->QErrorMessage::getDecodedMetricF(static_cast<VirtualQErrorMessage::PaintDeviceMetric>(metricA), static_cast<VirtualQErrorMessage::PaintDeviceMetric>(metricB));
}
