...
struct QFileDialog_VTable {
	...
	void (*enterEvent)(struct QFileDialog_VTable* vtbl, QFileDialog* self, QEnterEvent* event);
	...
	bool (*nativeEvent)(struct QFileDialog_VTable* vtbl, QFileDialog* self, struct miqt_string eventType, void* message, intptr_t* result);
