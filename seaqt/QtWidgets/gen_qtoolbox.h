...
typedef struct QToolBox_VTable{
	...
	void (*initStyleOption)(const VirtualQToolBox* self, QStyleOptionFrame* option);
	...
	void (*enterEvent)(VirtualQToolBox* self, QEnterEvent* event);
	...
	bool (*nativeEvent)(VirtualQToolBox* self, struct seaqt_string eventType, void* message, intptr_t* result);
