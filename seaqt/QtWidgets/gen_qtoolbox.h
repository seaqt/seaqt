...
struct QToolBox_VTable {
	...
	void (*initStyleOption)(struct QToolBox_VTable* vtbl, const QToolBox* self, QStyleOptionFrame* option);
	...
	void (*enterEvent)(struct QToolBox_VTable* vtbl, QToolBox* self, QEnterEvent* event);
	...
	bool (*nativeEvent)(struct QToolBox_VTable* vtbl, QToolBox* self, struct miqt_string eventType, void* message, intptr_t* result);
