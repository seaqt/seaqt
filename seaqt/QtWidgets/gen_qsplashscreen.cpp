...
public:
	...
	friend double QSplashScreen_protectedbase_getDecodedMetricF(const VirtualQSplashScreen* self, int metricA, int metricB);
};
...
double QSplashScreen_protectedbase_getDecodedMetricF(const VirtualQSplashScreen* self, int metricA, int metricB) {
	return self->QSplashScreen::getDecodedMetricF(static_cast<VirtualQSplashScreen::PaintDeviceMetric>(metricA), static_cast<VirtualQSplashScreen::PaintDeviceMetric>(metricB));
}
