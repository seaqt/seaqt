...
public:
	...
	VirtualQSplashScreen(const QSplashScreen_VTable* vtbl, QWidget* parent): QSplashScreen(parent), vtbl(vtbl) {}
	...
	VirtualQSplashScreen(const QSplashScreen_VTable* vtbl, QWidget* parent, const QPixmap& pixmap): QSplashScreen(parent, pixmap), vtbl(vtbl) {}
	VirtualQSplashScreen(const QSplashScreen_VTable* vtbl, QWidget* parent, const QPixmap& pixmap, Qt::WindowFlags f): QSplashScreen(parent, pixmap, f), vtbl(vtbl) {}
	...
	friend bool QSplashScreen_virtualbase_nativeEvent(VirtualQSplashScreen* self, struct seaqt_string eventType, void* message, long* result);
...
VirtualQSplashScreen* QSplashScreen_new(const QSplashScreen_VTable* vtbl, size_t vdata, QWidget* parent) {
...
VirtualQSplashScreen* QSplashScreen_new2(const QSplashScreen_VTable* vtbl, size_t vdata) {
	void* _mem_ = ::operator new(seaqt_aligned_sizeof<VirtualQSplashScreen>() + vdata, std::nothrow);
	return _mem_ ? new (_mem_)VirtualQSplashScreen(vtbl) : nullptr;
}

VirtualQSplashScreen* QSplashScreen_new3(const QSplashScreen_VTable* vtbl, size_t vdata, QScreen* screen) {
	void* _mem_ = ::operator new(seaqt_aligned_sizeof<VirtualQSplashScreen>() + vdata, std::nothrow);
