...
bool miqt_exec_callback_QListWidget_nativeEvent(QListWidget*, intptr_t, struct seaqt_string, void*, intptr_t*);
...
public:
	...
	friend bool QListWidget_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, intptr_t* result);
...
void QListWidget_virtualbase_initViewItemOption(const void* self, QStyleOptionViewItem* option) {
	static_cast<const VirtualQListWidget*>(self)->QListWidget::initViewItemOption(option);
}
...
QAbstractItemDelegate* QListWidget_virtualbase_itemDelegateForIndex(const void* self, QModelIndex* index) {
	return static_cast<const VirtualQListWidget*>(self)->QListWidget::itemDelegateForIndex(*index);
}
...
void QListWidget_virtualbase_initStyleOption(const void* self, QStyleOptionFrame* option) {
	static_cast<const VirtualQListWidget*>(self)->QListWidget::initStyleOption(option);
}
...
bool QListWidget_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, intptr_t* result) {
	QByteArray eventType_QByteArray(eventType.data, eventType.len);
	return static_cast<VirtualQListWidget*>(self)->QListWidget::nativeEvent(eventType_QByteArray, message, (qintptr*)(result));
}
