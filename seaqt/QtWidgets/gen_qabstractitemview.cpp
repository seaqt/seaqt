...
public:
	...
	friend double QAbstractItemView_protectedbase_getDecodedMetricF(const VirtualQAbstractItemView* self, int metricA, int metricB);
};
...
double QAbstractItemView_protectedbase_getDecodedMetricF(const VirtualQAbstractItemView* self, int metricA, int metricB) {
	return self->QAbstractItemView::getDecodedMetricF(static_cast<VirtualQAbstractItemView::PaintDeviceMetric>(metricA), static_cast<VirtualQAbstractItemView::PaintDeviceMetric>(metricB));
}
