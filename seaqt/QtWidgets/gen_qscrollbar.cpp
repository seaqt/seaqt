...
public:
	...
	friend void QScrollBar_virtualbase_enterEvent(VirtualQScrollBar* self, QEvent* event);
	...
	friend bool QScrollBar_virtualbase_nativeEvent(VirtualQScrollBar* self, struct seaqt_string eventType, void* message, long* result);
	...
	friend void QScrollBar_protectedbase_initStyleOption(const VirtualQScrollBar* self, QStyleOptionSlider* option);
...
VirtualQScrollBar* QScrollBar_new2(const QScrollBar_VTable* vtbl, size_t vdata, int param1) {
	void* _mem_ = ::operator new(seaqt_aligned_sizeof<VirtualQScrollBar>() + vdata, std::nothrow);
	return _mem_ ? new (_mem_)VirtualQScrollBar(vtbl, static_cast<Qt::Orientation>(param1)) : nullptr;
}

VirtualQScrollBar* QScrollBar_new3(const QScrollBar_VTable* vtbl, size_t vdata, QWidget* parent) {
	void* _mem_ = ::operator new(seaqt_aligned_sizeof<VirtualQScrollBar>() + vdata, std::nothrow);
...
void QScrollBar_virtualbase_enterEvent(VirtualQScrollBar* self, QEvent* event) {
...
bool QScrollBar_virtualbase_nativeEvent(VirtualQScrollBar* self, struct seaqt_string eventType, void* message, long* result) {
	QByteArray eventType_QByteArray(eventType.data, eventType.len);

	return self->QScrollBar::nativeEvent(eventType_QByteArray, message, static_cast<long*>(result));
}
