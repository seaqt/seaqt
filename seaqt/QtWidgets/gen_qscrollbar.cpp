...
bool miqt_exec_callback_QScrollBar_nativeEvent(QScrollBar*, intptr_t, struct seaqt_string, void*, long*);
...
public:
	...
	friend void QScrollBar_virtualbase_enterEvent(void* self, QEvent* event);
	...
	friend bool QScrollBar_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, long* result);
...
bool QScrollBar_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, long* result) {
	QByteArray eventType_QByteArray(eventType.data, eventType.len);
	return static_cast<VirtualQScrollBar*>(self)->QScrollBar::nativeEvent(eventType_QByteArray, message, static_cast<long*>(result));
}
