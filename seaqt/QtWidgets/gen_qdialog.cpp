...
bool miqt_exec_callback_QDialog_nativeEvent(QDialog*, intptr_t, struct seaqt_string, void*, long*);
...
public:
	...
	friend bool QDialog_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, long* result);
...
bool QDialog_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, long* result) {
	QByteArray eventType_QByteArray(eventType.data, eventType.len);
	return static_cast<VirtualQDialog*>(self)->QDialog::nativeEvent(eventType_QByteArray, message, static_cast<long*>(result));
}
