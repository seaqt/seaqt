...
typedef struct QTextBrowser_VTable{
	...
	void (*setSource)(VirtualQTextBrowser* self, QUrl* name);
	...
	void (*enterEvent)(VirtualQTextBrowser* self, QEvent* event);
	...
	bool (*nativeEvent)(VirtualQTextBrowser* self, struct seaqt_string eventType, void* message, long* result);
...
void QTextBrowser_connect_highlightedWithQString(QTextBrowser* self, intptr_t slot, void (*callback)(intptr_t, struct seaqt_string), void (*release)(intptr_t));
