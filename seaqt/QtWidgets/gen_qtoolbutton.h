...
struct QToolButton_VTable {
	...
	void (*enterEvent)(struct QToolButton_VTable* vtbl, QToolButton* self, QEnterEvent* param1);
	...
	void (*initStyleOption)(struct QToolButton_VTable* vtbl, const QToolButton* self, QStyleOptionToolButton* option);
	...
	bool (*nativeEvent)(struct QToolButton_VTable* vtbl, QToolButton* self, struct miqt_string eventType, void* message, intptr_t* result);
