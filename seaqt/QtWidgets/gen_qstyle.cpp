...
QRect* miqt_exec_callback_QStyle_itemTextRect(const QStyle*, intptr_t, QFontMetrics*, QRect*, int, bool, struct seaqt_string);
QRect* miqt_exec_callback_QStyle_itemPixmapRect(const QStyle*, intptr_t, QRect*, int, QPixmap*);
void miqt_exec_callback_QStyle_drawItemText(const QStyle*, intptr_t, QPainter*, QRect*, int, QPalette*, bool, struct seaqt_string, int);
...
public:
	...
	virtual ~VirtualQStyle() override = default;
	...
	friend QRect* QStyle_virtualbase_itemTextRect(const void* self, QFontMetrics* fm, QRect* r, int flags, bool enabled, struct seaqt_string text);
	...
	friend void QStyle_virtualbase_drawItemText(const void* self, QPainter* painter, QRect* rect, int flags, QPalette* pal, bool enabled, struct seaqt_string text, int textRole);
...
QStyle* QStyle_new() {
	return new (std::nothrow) VirtualQStyle();
}
...
QMetaObject* QStyle_virtualbase_metaObject(const void* self) {
	return (QMetaObject*) static_cast<const VirtualQStyle*>(self)->QStyle::metaObject();
}
...
void* QStyle_virtualbase_metacast(void* self, const char* param1) {
	return static_cast<VirtualQStyle*>(self)->QStyle::qt_metacast(param1);
}
...
int QStyle_virtualbase_metacall(void* self, int param1, int param2, void** param3) {
	return static_cast<VirtualQStyle*>(self)->QStyle::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
}
...
void QStyle_virtualbase_polish(void* self, QWidget* widget) {
	static_cast<VirtualQStyle*>(self)->QStyle::polish(widget);
}
...
void QStyle_virtualbase_unpolish(void* self, QWidget* widget) {
	static_cast<VirtualQStyle*>(self)->QStyle::unpolish(widget);
}
...
void QStyle_virtualbase_polishWithApplication(void* self, QApplication* application) {
	static_cast<VirtualQStyle*>(self)->QStyle::polish(application);
}
...
void QStyle_virtualbase_unpolishWithApplication(void* self, QApplication* application) {
	static_cast<VirtualQStyle*>(self)->QStyle::unpolish(application);
}
...
void QStyle_virtualbase_polishWithPalette(void* self, QPalette* palette) {
	static_cast<VirtualQStyle*>(self)->QStyle::polish(*palette);
}
...
QRect* QStyle_virtualbase_itemTextRect(const void* self, QFontMetrics* fm, QRect* r, int flags, bool enabled, struct seaqt_string text) {
	QString text_QString = QString::fromUtf8(text.data, text.len);
	return new QRect(static_cast<const VirtualQStyle*>(self)->QStyle::itemTextRect(*fm, *r, static_cast<int>(flags), enabled, text_QString));
}
...
QRect* QStyle_virtualbase_itemPixmapRect(const void* self, QRect* r, int flags, QPixmap* pixmap) {
	return new QRect(static_cast<const VirtualQStyle*>(self)->QStyle::itemPixmapRect(*r, static_cast<int>(flags), *pixmap));
}
...
void QStyle_virtualbase_drawItemText(const void* self, QPainter* painter, QRect* rect, int flags, QPalette* pal, bool enabled, struct seaqt_string text, int textRole) {
	QString text_QString = QString::fromUtf8(text.data, text.len);
	static_cast<const VirtualQStyle*>(self)->QStyle::drawItemText(painter, *rect, static_cast<int>(flags), *pal, enabled, text_QString, static_cast<QPalette::ColorRole>(textRole));
}
...
void QStyle_virtualbase_drawItemPixmap(const void* self, QPainter* painter, QRect* rect, int alignment, QPixmap* pixmap) {
	static_cast<const VirtualQStyle*>(self)->QStyle::drawItemPixmap(painter, *rect, static_cast<int>(alignment), *pixmap);
}
...
QPalette* QStyle_virtualbase_standardPalette(const void* self) {
	return new QPalette(static_cast<const VirtualQStyle*>(self)->QStyle::standardPalette());
}
...
bool QStyle_virtualbase_event(void* self, QEvent* event) {
	return static_cast<VirtualQStyle*>(self)->QStyle::event(event);
}
...
bool QStyle_virtualbase_eventFilter(void* self, QObject* watched, QEvent* event) {
	return static_cast<VirtualQStyle*>(self)->QStyle::eventFilter(watched, event);
}
...
void QStyle_virtualbase_timerEvent(void* self, QTimerEvent* event) {
	static_cast<VirtualQStyle*>(self)->QStyle::timerEvent(event);
}
...
void QStyle_virtualbase_childEvent(void* self, QChildEvent* event) {
	static_cast<VirtualQStyle*>(self)->QStyle::childEvent(event);
}
...
void QStyle_virtualbase_customEvent(void* self, QEvent* event) {
	static_cast<VirtualQStyle*>(self)->QStyle::customEvent(event);
}
...
void QStyle_virtualbase_connectNotify(void* self, QMetaMethod* signal) {
	static_cast<VirtualQStyle*>(self)->QStyle::connectNotify(*signal);
}
...
void QStyle_virtualbase_disconnectNotify(void* self, QMetaMethod* signal) {
	static_cast<VirtualQStyle*>(self)->QStyle::disconnectNotify(*signal);
}
