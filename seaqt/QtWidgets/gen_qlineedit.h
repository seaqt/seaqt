...
typedef struct QLineEdit_VTable{
	...
	QVariant* (*inputMethodQuery_Qt_InputMethodQuery)(const VirtualQLineEdit* self, int param1);
	...
	void (*keyReleaseEvent)(VirtualQLineEdit* self, QKeyEvent* event);
	void (*enterEvent)(VirtualQLineEdit* self, QEvent* event);
	...
	bool (*nativeEvent)(VirtualQLineEdit* self, struct seaqt_string eventType, void* message, long* result);
	...
	void (*timerEvent)(VirtualQLineEdit* self, QTimerEvent* event);
