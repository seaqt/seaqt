...
struct QLineEdit_VTable {
	...
	void (*keyReleaseEvent)(struct QLineEdit_VTable* vtbl, QLineEdit* self, QKeyEvent* event);
	void (*enterEvent)(struct QLineEdit_VTable* vtbl, QLineEdit* self, QEvent* event);
	...
	bool (*nativeEvent)(struct QLineEdit_VTable* vtbl, QLineEdit* self, struct miqt_string eventType, void* message, long* result);
	...
	void (*timerEvent)(struct QLineEdit_VTable* vtbl, QLineEdit* self, QTimerEvent* event);
