...
struct QLCDNumber_VTable {
	...
	void (*initStyleOption)(struct QLCDNumber_VTable* vtbl, const QLCDNumber* self, QStyleOptionFrame* option);
	...
	void (*enterEvent)(struct QLCDNumber_VTable* vtbl, QLCDNumber* self, QEnterEvent* event);
	...
	bool (*nativeEvent)(struct QLCDNumber_VTable* vtbl, QLCDNumber* self, struct miqt_string eventType, void* message, intptr_t* result);
