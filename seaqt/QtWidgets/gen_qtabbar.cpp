...
bool miqt_exec_callback_QTabBar_nativeEvent(QTabBar*, intptr_t, struct seaqt_string, void*, long*);
...
public:
	...
	friend bool QTabBar_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, long* result);
...
void QTabBar_virtualbase_mouseDoubleClickEvent(void* self, QMouseEvent* event) {
	static_cast<VirtualQTabBar*>(self)->QTabBar::mouseDoubleClickEvent(event);
}
...
bool QTabBar_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, long* result) {
	QByteArray eventType_QByteArray(eventType.data, eventType.len);
	return static_cast<VirtualQTabBar*>(self)->QTabBar::nativeEvent(eventType_QByteArray, message, static_cast<long*>(result));
}
