...
bool miqt_exec_callback_QInputDialog_nativeEvent(QInputDialog*, intptr_t, struct seaqt_string, void*, long*);
...
public:
	...
	friend bool QInputDialog_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, long* result);
...
bool QInputDialog_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, long* result) {
	QByteArray eventType_QByteArray(eventType.data, eventType.len);
	return static_cast<VirtualQInputDialog*>(self)->QInputDialog::nativeEvent(eventType_QByteArray, message, static_cast<long*>(result));
}
