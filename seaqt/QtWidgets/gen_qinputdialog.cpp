...
void miqt_exec_callback_QInputDialog_textValueChanged(intptr_t, struct seaqt_string);
void miqt_exec_callback_QInputDialog_textValueSelected(intptr_t, struct seaqt_string);
...
bool miqt_exec_callback_QInputDialog_nativeEvent(QInputDialog*, intptr_t, struct seaqt_string, void*, intptr_t*);
...
public:
	...
	friend bool QInputDialog_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, intptr_t* result);
...
QInputDialog* QInputDialog_new(QWidget* parent) {
	return new (std::nothrow) VirtualQInputDialog(parent);
}

QInputDialog* QInputDialog_new2() {
	return new (std::nothrow) VirtualQInputDialog();
}

QInputDialog* QInputDialog_new3(QWidget* parent, int flags) {
	return new (std::nothrow) VirtualQInputDialog(parent, static_cast<Qt::WindowFlags>(flags));
}
...
QMetaObject* QInputDialog_virtualbase_metaObject(const void* self) {
	return (QMetaObject*) static_cast<const VirtualQInputDialog*>(self)->QInputDialog::metaObject();
}
...
void* QInputDialog_virtualbase_metacast(void* self, const char* param1) {
	return static_cast<VirtualQInputDialog*>(self)->QInputDialog::qt_metacast(param1);
}
...
int QInputDialog_virtualbase_metacall(void* self, int param1, int param2, void** param3) {
	return static_cast<VirtualQInputDialog*>(self)->QInputDialog::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
}
...
QSize* QInputDialog_virtualbase_minimumSizeHint(const void* self) {
	return new QSize(static_cast<const VirtualQInputDialog*>(self)->QInputDialog::minimumSizeHint());
}
...
QSize* QInputDialog_virtualbase_sizeHint(const void* self) {
	return new QSize(static_cast<const VirtualQInputDialog*>(self)->QInputDialog::sizeHint());
}
...
void QInputDialog_virtualbase_setVisible(void* self, bool visible) {
	static_cast<VirtualQInputDialog*>(self)->QInputDialog::setVisible(visible);
}
...
void QInputDialog_virtualbase_done(void* self, int result) {
	static_cast<VirtualQInputDialog*>(self)->QInputDialog::done(static_cast<int>(result));
}
...
void QInputDialog_virtualbase_open(void* self) {
	static_cast<VirtualQInputDialog*>(self)->QInputDialog::open();
}
...
int QInputDialog_virtualbase_exec(void* self) {
	return static_cast<VirtualQInputDialog*>(self)->QInputDialog::exec();
}
...
void QInputDialog_virtualbase_accept(void* self) {
	static_cast<VirtualQInputDialog*>(self)->QInputDialog::accept();
}
...
void QInputDialog_virtualbase_reject(void* self) {
	static_cast<VirtualQInputDialog*>(self)->QInputDialog::reject();
}
...
void QInputDialog_virtualbase_keyPressEvent(void* self, QKeyEvent* param1) {
	static_cast<VirtualQInputDialog*>(self)->QInputDialog::keyPressEvent(param1);
}
...
void QInputDialog_virtualbase_closeEvent(void* self, QCloseEvent* param1) {
	static_cast<VirtualQInputDialog*>(self)->QInputDialog::closeEvent(param1);
}
...
void QInputDialog_virtualbase_showEvent(void* self, QShowEvent* param1) {
	static_cast<VirtualQInputDialog*>(self)->QInputDialog::showEvent(param1);
}
...
void QInputDialog_virtualbase_resizeEvent(void* self, QResizeEvent* param1) {
	static_cast<VirtualQInputDialog*>(self)->QInputDialog::resizeEvent(param1);
}
...
void QInputDialog_virtualbase_contextMenuEvent(void* self, QContextMenuEvent* param1) {
	static_cast<VirtualQInputDialog*>(self)->QInputDialog::contextMenuEvent(param1);
}
...
bool QInputDialog_virtualbase_eventFilter(void* self, QObject* param1, QEvent* param2) {
	return static_cast<VirtualQInputDialog*>(self)->QInputDialog::eventFilter(param1, param2);
}
...
int QInputDialog_virtualbase_devType(const void* self) {
	return static_cast<const VirtualQInputDialog*>(self)->QInputDialog::devType();
}
...
int QInputDialog_virtualbase_heightForWidth(const void* self, int param1) {
	return static_cast<const VirtualQInputDialog*>(self)->QInputDialog::heightForWidth(static_cast<int>(param1));
}
...
bool QInputDialog_virtualbase_hasHeightForWidth(const void* self) {
	return static_cast<const VirtualQInputDialog*>(self)->QInputDialog::hasHeightForWidth();
}
...
QPaintEngine* QInputDialog_virtualbase_paintEngine(const void* self) {
	return static_cast<const VirtualQInputDialog*>(self)->QInputDialog::paintEngine();
}
...
bool QInputDialog_virtualbase_event(void* self, QEvent* event) {
	return static_cast<VirtualQInputDialog*>(self)->QInputDialog::event(event);
}
...
void QInputDialog_virtualbase_mousePressEvent(void* self, QMouseEvent* event) {
	static_cast<VirtualQInputDialog*>(self)->QInputDialog::mousePressEvent(event);
}
...
void QInputDialog_virtualbase_mouseReleaseEvent(void* self, QMouseEvent* event) {
	static_cast<VirtualQInputDialog*>(self)->QInputDialog::mouseReleaseEvent(event);
}
...
void QInputDialog_virtualbase_mouseDoubleClickEvent(void* self, QMouseEvent* event) {
	static_cast<VirtualQInputDialog*>(self)->QInputDialog::mouseDoubleClickEvent(event);
}
...
void QInputDialog_virtualbase_mouseMoveEvent(void* self, QMouseEvent* event) {
	static_cast<VirtualQInputDialog*>(self)->QInputDialog::mouseMoveEvent(event);
}
...
void QInputDialog_virtualbase_wheelEvent(void* self, QWheelEvent* event) {
	static_cast<VirtualQInputDialog*>(self)->QInputDialog::wheelEvent(event);
}
...
void QInputDialog_virtualbase_keyReleaseEvent(void* self, QKeyEvent* event) {
	static_cast<VirtualQInputDialog*>(self)->QInputDialog::keyReleaseEvent(event);
}
...
void QInputDialog_virtualbase_focusInEvent(void* self, QFocusEvent* event) {
	static_cast<VirtualQInputDialog*>(self)->QInputDialog::focusInEvent(event);
}
...
void QInputDialog_virtualbase_focusOutEvent(void* self, QFocusEvent* event) {
	static_cast<VirtualQInputDialog*>(self)->QInputDialog::focusOutEvent(event);
}
...
void QInputDialog_virtualbase_enterEvent(void* self, QEnterEvent* event) {
	static_cast<VirtualQInputDialog*>(self)->QInputDialog::enterEvent(event);
}
...
void QInputDialog_virtualbase_leaveEvent(void* self, QEvent* event) {
	static_cast<VirtualQInputDialog*>(self)->QInputDialog::leaveEvent(event);
}
...
void QInputDialog_virtualbase_paintEvent(void* self, QPaintEvent* event) {
	static_cast<VirtualQInputDialog*>(self)->QInputDialog::paintEvent(event);
}
...
void QInputDialog_virtualbase_moveEvent(void* self, QMoveEvent* event) {
	static_cast<VirtualQInputDialog*>(self)->QInputDialog::moveEvent(event);
}
...
void QInputDialog_virtualbase_tabletEvent(void* self, QTabletEvent* event) {
	static_cast<VirtualQInputDialog*>(self)->QInputDialog::tabletEvent(event);
}
...
void QInputDialog_virtualbase_actionEvent(void* self, QActionEvent* event) {
	static_cast<VirtualQInputDialog*>(self)->QInputDialog::actionEvent(event);
}
...
void QInputDialog_virtualbase_dragEnterEvent(void* self, QDragEnterEvent* event) {
	static_cast<VirtualQInputDialog*>(self)->QInputDialog::dragEnterEvent(event);
}
...
void QInputDialog_virtualbase_dragMoveEvent(void* self, QDragMoveEvent* event) {
	static_cast<VirtualQInputDialog*>(self)->QInputDialog::dragMoveEvent(event);
}
...
void QInputDialog_virtualbase_dragLeaveEvent(void* self, QDragLeaveEvent* event) {
	static_cast<VirtualQInputDialog*>(self)->QInputDialog::dragLeaveEvent(event);
}
...
void QInputDialog_virtualbase_dropEvent(void* self, QDropEvent* event) {
	static_cast<VirtualQInputDialog*>(self)->QInputDialog::dropEvent(event);
}
...
void QInputDialog_virtualbase_hideEvent(void* self, QHideEvent* event) {
	static_cast<VirtualQInputDialog*>(self)->QInputDialog::hideEvent(event);
}
...
bool QInputDialog_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, intptr_t* result) {
	QByteArray eventType_QByteArray(eventType.data, eventType.len);
	return static_cast<VirtualQInputDialog*>(self)->QInputDialog::nativeEvent(eventType_QByteArray, message, (qintptr*)(result));
}
...
void QInputDialog_virtualbase_changeEvent(void* self, QEvent* param1) {
	static_cast<VirtualQInputDialog*>(self)->QInputDialog::changeEvent(param1);
}
...
int QInputDialog_virtualbase_metric(const void* self, int param1) {
	return static_cast<const VirtualQInputDialog*>(self)->QInputDialog::metric(static_cast<VirtualQInputDialog::PaintDeviceMetric>(param1));
}
...
void QInputDialog_virtualbase_initPainter(const void* self, QPainter* painter) {
	static_cast<const VirtualQInputDialog*>(self)->QInputDialog::initPainter(painter);
}
...
QPaintDevice* QInputDialog_virtualbase_redirected(const void* self, QPoint* offset) {
	return static_cast<const VirtualQInputDialog*>(self)->QInputDialog::redirected(offset);
}
...
QPainter* QInputDialog_virtualbase_sharedPainter(const void* self) {
	return static_cast<const VirtualQInputDialog*>(self)->QInputDialog::sharedPainter();
}
...
void QInputDialog_virtualbase_inputMethodEvent(void* self, QInputMethodEvent* param1) {
	static_cast<VirtualQInputDialog*>(self)->QInputDialog::inputMethodEvent(param1);
}
...
QVariant* QInputDialog_virtualbase_inputMethodQuery(const void* self, int param1) {
	return new QVariant(static_cast<const VirtualQInputDialog*>(self)->QInputDialog::inputMethodQuery(static_cast<Qt::InputMethodQuery>(param1)));
}
...
bool QInputDialog_virtualbase_focusNextPrevChild(void* self, bool next) {
	return static_cast<VirtualQInputDialog*>(self)->QInputDialog::focusNextPrevChild(next);
}
...
void QInputDialog_virtualbase_timerEvent(void* self, QTimerEvent* event) {
	static_cast<VirtualQInputDialog*>(self)->QInputDialog::timerEvent(event);
}
...
void QInputDialog_virtualbase_childEvent(void* self, QChildEvent* event) {
	static_cast<VirtualQInputDialog*>(self)->QInputDialog::childEvent(event);
}
...
void QInputDialog_virtualbase_customEvent(void* self, QEvent* event) {
	static_cast<VirtualQInputDialog*>(self)->QInputDialog::customEvent(event);
}
...
void QInputDialog_virtualbase_connectNotify(void* self, QMetaMethod* signal) {
	static_cast<VirtualQInputDialog*>(self)->QInputDialog::connectNotify(*signal);
}
...
void QInputDialog_virtualbase_disconnectNotify(void* self, QMetaMethod* signal) {
	static_cast<VirtualQInputDialog*>(self)->QInputDialog::disconnectNotify(*signal);
}
