...
void QInputDialog_connect_textValueChanged(QInputDialog* self, intptr_t slot) {
	VirtualQInputDialog::connect(self, static_cast<void (QInputDialog::*)(const QString&)>(&QInputDialog::textValueChanged), self, [=](const QString& text) {
...
void QInputDialog_connect_textValueSelected(QInputDialog* self, intptr_t slot) {
	VirtualQInputDialog::connect(self, static_cast<void (QInputDialog::*)(const QString&)>(&QInputDialog::textValueSelected), self, [=](const QString& text) {
		const QString text_ret = text;
		// Convert QString from UTF-16 in C++ RAII memory to UTF-8 in manually-managed C memory
		QByteArray text_b = text_ret.toUtf8();
		struct miqt_string text_ms;
...
void QInputDialog_connect_intValueChanged(QInputDialog* self, intptr_t slot) {
	VirtualQInputDialog::connect(self, static_cast<void (QInputDialog::*)(int)>(&QInputDialog::intValueChanged), self, [=](int value) {
		int sigval1 = value;
...
void QInputDialog_connect_intValueSelected(QInputDialog* self, intptr_t slot) {
	VirtualQInputDialog::connect(self, static_cast<void (QInputDialog::*)(int)>(&QInputDialog::intValueSelected), self, [=](int value) {
		int sigval1 = value;
...
void QInputDialog_connect_doubleValueChanged(QInputDialog* self, intptr_t slot) {
	VirtualQInputDialog::connect(self, static_cast<void (QInputDialog::*)(double)>(&QInputDialog::doubleValueChanged), self, [=](double value) {
...
void QInputDialog_connect_doubleValueSelected(QInputDialog* self, intptr_t slot) {
	VirtualQInputDialog::connect(self, static_cast<void (QInputDialog::*)(double)>(&QInputDialog::doubleValueSelected), self, [=](double value) {
		double sigval1 = value;
...
bool QInputDialog_virtualbase_nativeEvent(void* self, struct miqt_string eventType, void* message, long* result) {
	...
	return ( (VirtualQInputDialog*)(self) )->QInputDialog::nativeEvent(eventType_QByteArray, message, static_cast<long*>(result));
