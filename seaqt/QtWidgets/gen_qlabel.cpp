...
public:
	...
	friend bool QLabel_virtualbase_nativeEvent(VirtualQLabel* self, struct seaqt_string eventType, void* message, intptr_t* result);
	...
	friend double QLabel_protectedbase_getDecodedMetricF(const VirtualQLabel* self, int metricA, int metricB);
};
...
bool QLabel_virtualbase_nativeEvent(VirtualQLabel* self, struct seaqt_string eventType, void* message, intptr_t* result) {
...
double QLabel_protectedbase_getDecodedMetricF(const VirtualQLabel* self, int metricA, int metricB) {
	return self->QLabel::getDecodedMetricF(static_cast<VirtualQLabel::PaintDeviceMetric>(metricA), static_cast<VirtualQLabel::PaintDeviceMetric>(metricB));
}
