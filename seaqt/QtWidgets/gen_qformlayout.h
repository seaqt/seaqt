...
typedef struct QFormLayout_VTable{
	...
	QLayoutItem* (*itemAt_index)(const VirtualQFormLayout* self, int index);
	...
	int (*indexOf_QWidget)(const VirtualQFormLayout* self, QWidget* param1);
...
QFormLayout__TakeRowResult* QFormLayout__TakeRowResult_new_from(QFormLayout__TakeRowResult* from);
