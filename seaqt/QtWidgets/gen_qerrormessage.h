...
typedef struct QErrorMessage_VTable{
	...
	void (*enterEvent)(VirtualQErrorMessage* self, QEnterEvent* event);
	...
	bool (*nativeEvent)(VirtualQErrorMessage* self, struct seaqt_string eventType, void* message, intptr_t* result);
