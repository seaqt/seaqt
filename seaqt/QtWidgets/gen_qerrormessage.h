...
struct QErrorMessage_VTable {
	...
	void (*enterEvent)(struct QErrorMessage_VTable* vtbl, QErrorMessage* self, QEnterEvent* event);
	...
	bool (*nativeEvent)(struct QErrorMessage_VTable* vtbl, QErrorMessage* self, struct miqt_string eventType, void* message, intptr_t* result);
