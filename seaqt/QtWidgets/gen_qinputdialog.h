...
typedef struct QInputDialog_VTable{
	...
	void (*enterEvent)(VirtualQInputDialog* self, QEnterEvent* event);
	...
	bool (*nativeEvent)(VirtualQInputDialog* self, struct seaqt_string eventType, void* message, intptr_t* result);
