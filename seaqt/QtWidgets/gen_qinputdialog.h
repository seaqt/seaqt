...
struct QInputDialog_VTable {
	...
	void (*enterEvent)(struct QInputDialog_VTable* vtbl, QInputDialog* self, QEnterEvent* event);
	...
	bool (*nativeEvent)(struct QInputDialog_VTable* vtbl, QInputDialog* self, struct miqt_string eventType, void* message, intptr_t* result);
