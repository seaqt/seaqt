...
struct QListView_VTable {
	...
	QStyleOptionViewItem* (*viewOptions)(struct QListView_VTable* vtbl, const QListView* self);
	...
	void (*enterEvent)(struct QListView_VTable* vtbl, QListView* self, QEvent* event);
	...
	bool (*nativeEvent)(struct QListView_VTable* vtbl, QListView* self, struct miqt_string eventType, void* message, long* result);
