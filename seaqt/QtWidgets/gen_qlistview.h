...
typedef struct QListView_VTable{
	...
	QStyleOptionViewItem* (*viewOptions)(const VirtualQListView* self);
	...
	void (*enterEvent)(VirtualQListView* self, QEvent* event);
	...
	bool (*nativeEvent)(VirtualQListView* self, struct seaqt_string eventType, void* message, long* result);
