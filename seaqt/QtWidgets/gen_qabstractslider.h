...
struct QAbstractSlider_VTable {
	...
	void (*enterEvent)(struct QAbstractSlider_VTable* vtbl, QAbstractSlider* self, QEvent* event);
	...
	bool (*nativeEvent)(struct QAbstractSlider_VTable* vtbl, QAbstractSlider* self, struct miqt_string eventType, void* message, long* result);
