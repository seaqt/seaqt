...
typedef struct QAbstractSlider_VTable{
	...
	void (*enterEvent)(VirtualQAbstractSlider* self, QEvent* event);
	...
	bool (*nativeEvent)(VirtualQAbstractSlider* self, struct seaqt_string eventType, void* message, long* result);
