...
typedef struct QUndoView_VTable{
	...
	QStyleOptionViewItem* (*viewOptions)(const VirtualQUndoView* self);
	...
	bool (*edit_index_trigger_event)(VirtualQUndoView* self, QModelIndex* index, int trigger, QEvent* event);
	...
	void (*enterEvent)(VirtualQUndoView* self, QEvent* event);
	...
	bool (*nativeEvent)(VirtualQUndoView* self, struct seaqt_string eventType, void* message, long* result);
