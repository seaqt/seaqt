...
public:
	...
	friend void QPushButton_virtualbase_mouseMoveEvent(VirtualQPushButton* self, QMouseEvent* param1);
	...
	friend void QPushButton_virtualbase_initStyleOption(const VirtualQPushButton* self, QStyleOptionButton* option);
	...
	friend void QPushButton_virtualbase_enterEvent(VirtualQPushButton* self, QEnterEvent* event);
	...
	friend bool QPushButton_virtualbase_nativeEvent(VirtualQPushButton* self, struct seaqt_string eventType, void* message, intptr_t* result);
	...
	friend double QPushButton_protectedbase_getDecodedMetricF(const VirtualQPushButton* self, int metricA, int metricB);
};
...
bool QPushButton_virtualbase_nativeEvent(VirtualQPushButton* self, struct seaqt_string eventType, void* message, intptr_t* result) {
	...
	return self->QPushButton::nativeEvent(eventType_QByteArray, message, (qintptr*)(result));
}
...
double QPushButton_protectedbase_getDecodedMetricF(const VirtualQPushButton* self, int metricA, int metricB) {
	return self->QPushButton::getDecodedMetricF(static_cast<VirtualQPushButton::PaintDeviceMetric>(metricA), static_cast<VirtualQPushButton::PaintDeviceMetric>(metricB));
}
