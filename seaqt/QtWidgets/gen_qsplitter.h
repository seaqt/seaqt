...
struct QSplitter_VTable {
	...
	void (*initStyleOption)(struct QSplitter_VTable* vtbl, const QSplitter* self, QStyleOptionFrame* option);
	...
	void (*enterEvent)(struct QSplitter_VTable* vtbl, QSplitter* self, QEnterEvent* event);
	...
	bool (*nativeEvent)(struct QSplitter_VTable* vtbl, QSplitter* self, struct miqt_string eventType, void* message, intptr_t* result);
...
struct QSplitterHandle_VTable {
	...
	void (*enterEvent)(struct QSplitterHandle_VTable* vtbl, QSplitterHandle* self, QEnterEvent* event);
	...
	bool (*nativeEvent)(struct QSplitterHandle_VTable* vtbl, QSplitterHandle* self, struct miqt_string eventType, void* message, intptr_t* result);
