...
typedef struct QSplitter_VTable{
	...
	bool (*nativeEvent)(VirtualQSplitter* self, struct seaqt_string eventType, void* message, long* result);
...
typedef struct QSplitterHandle_VTable{
	...
	bool (*nativeEvent)(VirtualQSplitterHandle* self, struct seaqt_string eventType, void* message, long* result);
