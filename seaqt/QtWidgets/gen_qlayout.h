...
struct QLayout_VTable {
	...
	int (*spacing)(struct QLayout_VTable* vtbl, const QLayout* self);
	void (*setSpacing)(struct QLayout_VTable* vtbl, QLayout* self, int spacing);
	...
	int (*indexOfWithQLayoutItem)(struct QLayout_VTable* vtbl, const QLayout* self, QLayoutItem* param1);
	...
	QLayoutItem* (*replaceWidget)(struct QLayout_VTable* vtbl, QLayout* self, QWidget* from, QWidget* to, int options);
	...
	QWidget* (*widget)(struct QLayout_VTable* vtbl, const QLayout* self);
