...
typedef struct QLayout_VTable{
	...
	int (*indexOfWithQLayoutItem)(const VirtualQLayout* self, QLayoutItem* param1);
...
VirtualQLayout* QLayout_new2(const QLayout_VTable* vtbl, size_t vdata, QWidget* parent);
