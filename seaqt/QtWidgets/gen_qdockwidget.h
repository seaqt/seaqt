...
struct QDockWidget_VTable {
	...
	void (*initStyleOption)(struct QDockWidget_VTable* vtbl, const QDockWidget* self, QStyleOptionDockWidget* option);
	...
	void (*enterEvent)(struct QDockWidget_VTable* vtbl, QDockWidget* self, QEnterEvent* event);
	...
	bool (*nativeEvent)(struct QDockWidget_VTable* vtbl, QDockWidget* self, struct miqt_string eventType, void* message, intptr_t* result);
