...
public:
	...
	friend bool QMenuBar_virtualbase_nativeEvent(void* self, struct miqt_string eventType, void* message, intptr_t* result);
...
void QMenuBar_connect_triggered(QMenuBar* self, intptr_t slot) {
	VirtualQMenuBar::connect(self, static_cast<void (QMenuBar::*)(QAction*)>(&QMenuBar::triggered), self, [=](QAction* action) {
...
void QMenuBar_connect_hovered(QMenuBar* self, intptr_t slot) {
	VirtualQMenuBar::connect(self, static_cast<void (QMenuBar::*)(QAction*)>(&QMenuBar::hovered), self, [=](QAction* action) {
		QAction* sigval1 = action;
...
void QMenuBar_virtualbase_initStyleOption(const void* self, QStyleOptionMenuItem* option, QAction* action) {
	...
	( (const VirtualQMenuBar*)(self) )->QMenuBar::initStyleOption(option, action);
...
bool QMenuBar_virtualbase_nativeEvent(void* self, struct miqt_string eventType, void* message, intptr_t* result) {
	...
	return ( (VirtualQMenuBar*)(self) )->QMenuBar::nativeEvent(eventType_QByteArray, message, (qintptr*)(result));
