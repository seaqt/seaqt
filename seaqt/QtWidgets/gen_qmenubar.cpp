...
public:
	...
	friend double QMenuBar_protectedbase_getDecodedMetricF(const VirtualQMenuBar* self, int metricA, int metricB);
};
...
double QMenuBar_protectedbase_getDecodedMetricF(const VirtualQMenuBar* self, int metricA, int metricB) {
	return self->QMenuBar::getDecodedMetricF(static_cast<VirtualQMenuBar::PaintDeviceMetric>(metricA), static_cast<VirtualQMenuBar::PaintDeviceMetric>(metricB));
}
