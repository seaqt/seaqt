...
bool miqt_exec_callback_QWidget_nativeEvent(QWidget*, intptr_t, struct seaqt_string, void*, intptr_t*);
...
public:
	...
	friend void QWidget_virtualbase_enterEvent(void* self, QEnterEvent* event);
	...
	friend bool QWidget_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, intptr_t* result);
...
bool QWidget_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, intptr_t* result) {
	QByteArray eventType_QByteArray(eventType.data, eventType.len);
	return static_cast<VirtualQWidget*>(self)->QWidget::nativeEvent(eventType_QByteArray, message, (qintptr*)(result));
}
