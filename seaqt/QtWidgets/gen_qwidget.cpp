...
public:
	...
	friend double QWidget_protectedbase_getDecodedMetricF(const VirtualQWidget* self, int metricA, int metricB);
};
...
struct seaqt_string QWidget_accessibleIdentifier(const QWidget* self) {
...
void QWidget_setAccessibleIdentifier(QWidget* self, struct seaqt_string identifier) {
...
void QWidget_setTabOrder_QWidget_QWidget(QWidget* param1, QWidget* param2) {
...
QWidget* QWidget_childAt_int_int(const QWidget* self, int x, int y) {
	return self->childAt(static_cast<int>(x), static_cast<int>(y));
}

QWidget* QWidget_childAt_QPoint(const QWidget* self, QPoint* p) {
	return self->childAt(*p);
}

QWidget* QWidget_childAt_QPointF(const QWidget* self, QPointF* p) {
	return self->childAt(*p);
}
...
double QWidget_protectedbase_getDecodedMetricF(const VirtualQWidget* self, int metricA, int metricB) {
	return self->QWidget::getDecodedMetricF(static_cast<VirtualQWidget::PaintDeviceMetric>(metricA), static_cast<VirtualQWidget::PaintDeviceMetric>(metricB));
}
