...
struct QKeySequenceEdit_VTable {
	...
	void (*focusOutEvent)(struct QKeySequenceEdit_VTable* vtbl, QKeySequenceEdit* self, QFocusEvent* param1);
	...
	void (*enterEvent)(struct QKeySequenceEdit_VTable* vtbl, QKeySequenceEdit* self, QEnterEvent* event);
	...
	bool (*nativeEvent)(struct QKeySequenceEdit_VTable* vtbl, QKeySequenceEdit* self, struct miqt_string eventType, void* message, intptr_t* result);
