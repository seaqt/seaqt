...
struct QSizeGrip_VTable {
	...
	void (*enterEvent)(struct QSizeGrip_VTable* vtbl, QSizeGrip* self, QEnterEvent* event);
	...
	bool (*nativeEvent)(struct QSizeGrip_VTable* vtbl, QSizeGrip* self, struct miqt_string eventType, void* message, intptr_t* result);
