...
bool miqt_exec_callback_QSlider_nativeEvent(QSlider*, intptr_t, struct seaqt_string, void*, intptr_t*);
...
public:
	...
	friend bool QSlider_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, intptr_t* result);
...
QSlider* QSlider_new(QWidget* parent) {
	return new (std::nothrow) VirtualQSlider(parent);
}

QSlider* QSlider_new2() {
	return new (std::nothrow) VirtualQSlider();
}

QSlider* QSlider_new3(int orientation) {
	return new (std::nothrow) VirtualQSlider(static_cast<Qt::Orientation>(orientation));
}

QSlider* QSlider_new4(int orientation, QWidget* parent) {
	return new (std::nothrow) VirtualQSlider(static_cast<Qt::Orientation>(orientation), parent);
}
...
QMetaObject* QSlider_virtualbase_metaObject(const void* self) {
	return (QMetaObject*) static_cast<const VirtualQSlider*>(self)->QSlider::metaObject();
}
...
void* QSlider_virtualbase_metacast(void* self, const char* param1) {
	return static_cast<VirtualQSlider*>(self)->QSlider::qt_metacast(param1);
}
...
int QSlider_virtualbase_metacall(void* self, int param1, int param2, void** param3) {
	return static_cast<VirtualQSlider*>(self)->QSlider::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
}
...
QSize* QSlider_virtualbase_sizeHint(const void* self) {
	return new QSize(static_cast<const VirtualQSlider*>(self)->QSlider::sizeHint());
}
...
QSize* QSlider_virtualbase_minimumSizeHint(const void* self) {
	return new QSize(static_cast<const VirtualQSlider*>(self)->QSlider::minimumSizeHint());
}
...
bool QSlider_virtualbase_event(void* self, QEvent* event) {
	return static_cast<VirtualQSlider*>(self)->QSlider::event(event);
}
...
void QSlider_virtualbase_paintEvent(void* self, QPaintEvent* ev) {
	static_cast<VirtualQSlider*>(self)->QSlider::paintEvent(ev);
}
...
void QSlider_virtualbase_mousePressEvent(void* self, QMouseEvent* ev) {
	static_cast<VirtualQSlider*>(self)->QSlider::mousePressEvent(ev);
}
...
void QSlider_virtualbase_mouseReleaseEvent(void* self, QMouseEvent* ev) {
	static_cast<VirtualQSlider*>(self)->QSlider::mouseReleaseEvent(ev);
}
...
void QSlider_virtualbase_mouseMoveEvent(void* self, QMouseEvent* ev) {
	static_cast<VirtualQSlider*>(self)->QSlider::mouseMoveEvent(ev);
}
...
void QSlider_virtualbase_initStyleOption(const void* self, QStyleOptionSlider* option) {
	static_cast<const VirtualQSlider*>(self)->QSlider::initStyleOption(option);
}
...
void QSlider_virtualbase_sliderChange(void* self, int change) {
	static_cast<VirtualQSlider*>(self)->QSlider::sliderChange(static_cast<VirtualQSlider::SliderChange>(change));
}
...
void QSlider_virtualbase_keyPressEvent(void* self, QKeyEvent* ev) {
	static_cast<VirtualQSlider*>(self)->QSlider::keyPressEvent(ev);
}
...
void QSlider_virtualbase_timerEvent(void* self, QTimerEvent* param1) {
	static_cast<VirtualQSlider*>(self)->QSlider::timerEvent(param1);
}
...
void QSlider_virtualbase_wheelEvent(void* self, QWheelEvent* e) {
	static_cast<VirtualQSlider*>(self)->QSlider::wheelEvent(e);
}
...
void QSlider_virtualbase_changeEvent(void* self, QEvent* e) {
	static_cast<VirtualQSlider*>(self)->QSlider::changeEvent(e);
}
...
int QSlider_virtualbase_devType(const void* self) {
	return static_cast<const VirtualQSlider*>(self)->QSlider::devType();
}
...
void QSlider_virtualbase_setVisible(void* self, bool visible) {
	static_cast<VirtualQSlider*>(self)->QSlider::setVisible(visible);
}
...
int QSlider_virtualbase_heightForWidth(const void* self, int param1) {
	return static_cast<const VirtualQSlider*>(self)->QSlider::heightForWidth(static_cast<int>(param1));
}
...
bool QSlider_virtualbase_hasHeightForWidth(const void* self) {
	return static_cast<const VirtualQSlider*>(self)->QSlider::hasHeightForWidth();
}
...
QPaintEngine* QSlider_virtualbase_paintEngine(const void* self) {
	return static_cast<const VirtualQSlider*>(self)->QSlider::paintEngine();
}
...
void QSlider_virtualbase_mouseDoubleClickEvent(void* self, QMouseEvent* event) {
	static_cast<VirtualQSlider*>(self)->QSlider::mouseDoubleClickEvent(event);
}
...
void QSlider_virtualbase_keyReleaseEvent(void* self, QKeyEvent* event) {
	static_cast<VirtualQSlider*>(self)->QSlider::keyReleaseEvent(event);
}
...
void QSlider_virtualbase_focusInEvent(void* self, QFocusEvent* event) {
	static_cast<VirtualQSlider*>(self)->QSlider::focusInEvent(event);
}
...
void QSlider_virtualbase_focusOutEvent(void* self, QFocusEvent* event) {
	static_cast<VirtualQSlider*>(self)->QSlider::focusOutEvent(event);
}
...
void QSlider_virtualbase_enterEvent(void* self, QEnterEvent* event) {
	static_cast<VirtualQSlider*>(self)->QSlider::enterEvent(event);
}
...
void QSlider_virtualbase_leaveEvent(void* self, QEvent* event) {
	static_cast<VirtualQSlider*>(self)->QSlider::leaveEvent(event);
}
...
void QSlider_virtualbase_moveEvent(void* self, QMoveEvent* event) {
	static_cast<VirtualQSlider*>(self)->QSlider::moveEvent(event);
}
...
void QSlider_virtualbase_resizeEvent(void* self, QResizeEvent* event) {
	static_cast<VirtualQSlider*>(self)->QSlider::resizeEvent(event);
}
...
void QSlider_virtualbase_closeEvent(void* self, QCloseEvent* event) {
	static_cast<VirtualQSlider*>(self)->QSlider::closeEvent(event);
}
...
void QSlider_virtualbase_contextMenuEvent(void* self, QContextMenuEvent* event) {
	static_cast<VirtualQSlider*>(self)->QSlider::contextMenuEvent(event);
}
...
void QSlider_virtualbase_tabletEvent(void* self, QTabletEvent* event) {
	static_cast<VirtualQSlider*>(self)->QSlider::tabletEvent(event);
}
...
void QSlider_virtualbase_actionEvent(void* self, QActionEvent* event) {
	static_cast<VirtualQSlider*>(self)->QSlider::actionEvent(event);
}
...
void QSlider_virtualbase_dragEnterEvent(void* self, QDragEnterEvent* event) {
	static_cast<VirtualQSlider*>(self)->QSlider::dragEnterEvent(event);
}
...
void QSlider_virtualbase_dragMoveEvent(void* self, QDragMoveEvent* event) {
	static_cast<VirtualQSlider*>(self)->QSlider::dragMoveEvent(event);
}
...
void QSlider_virtualbase_dragLeaveEvent(void* self, QDragLeaveEvent* event) {
	static_cast<VirtualQSlider*>(self)->QSlider::dragLeaveEvent(event);
}
...
void QSlider_virtualbase_dropEvent(void* self, QDropEvent* event) {
	static_cast<VirtualQSlider*>(self)->QSlider::dropEvent(event);
}
...
void QSlider_virtualbase_showEvent(void* self, QShowEvent* event) {
	static_cast<VirtualQSlider*>(self)->QSlider::showEvent(event);
}
...
void QSlider_virtualbase_hideEvent(void* self, QHideEvent* event) {
	static_cast<VirtualQSlider*>(self)->QSlider::hideEvent(event);
}
...
bool QSlider_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, intptr_t* result) {
	QByteArray eventType_QByteArray(eventType.data, eventType.len);
	return static_cast<VirtualQSlider*>(self)->QSlider::nativeEvent(eventType_QByteArray, message, (qintptr*)(result));
}
...
int QSlider_virtualbase_metric(const void* self, int param1) {
	return static_cast<const VirtualQSlider*>(self)->QSlider::metric(static_cast<VirtualQSlider::PaintDeviceMetric>(param1));
}
...
void QSlider_virtualbase_initPainter(const void* self, QPainter* painter) {
	static_cast<const VirtualQSlider*>(self)->QSlider::initPainter(painter);
}
...
QPaintDevice* QSlider_virtualbase_redirected(const void* self, QPoint* offset) {
	return static_cast<const VirtualQSlider*>(self)->QSlider::redirected(offset);
}
...
QPainter* QSlider_virtualbase_sharedPainter(const void* self) {
	return static_cast<const VirtualQSlider*>(self)->QSlider::sharedPainter();
}
...
void QSlider_virtualbase_inputMethodEvent(void* self, QInputMethodEvent* param1) {
	static_cast<VirtualQSlider*>(self)->QSlider::inputMethodEvent(param1);
}
...
QVariant* QSlider_virtualbase_inputMethodQuery(const void* self, int param1) {
	return new QVariant(static_cast<const VirtualQSlider*>(self)->QSlider::inputMethodQuery(static_cast<Qt::InputMethodQuery>(param1)));
}
...
bool QSlider_virtualbase_focusNextPrevChild(void* self, bool next) {
	return static_cast<VirtualQSlider*>(self)->QSlider::focusNextPrevChild(next);
}
...
bool QSlider_virtualbase_eventFilter(void* self, QObject* watched, QEvent* event) {
	return static_cast<VirtualQSlider*>(self)->QSlider::eventFilter(watched, event);
}
...
void QSlider_virtualbase_childEvent(void* self, QChildEvent* event) {
	static_cast<VirtualQSlider*>(self)->QSlider::childEvent(event);
}
...
void QSlider_virtualbase_customEvent(void* self, QEvent* event) {
	static_cast<VirtualQSlider*>(self)->QSlider::customEvent(event);
}
...
void QSlider_virtualbase_connectNotify(void* self, QMetaMethod* signal) {
	static_cast<VirtualQSlider*>(self)->QSlider::connectNotify(*signal);
}
...
void QSlider_virtualbase_disconnectNotify(void* self, QMetaMethod* signal) {
	static_cast<VirtualQSlider*>(self)->QSlider::disconnectNotify(*signal);
}
