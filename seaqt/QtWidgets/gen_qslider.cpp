...
public:
	...
	friend double QSlider_protectedbase_getDecodedMetricF(const VirtualQSlider* self, int metricA, int metricB);
};
...
double QSlider_protectedbase_getDecodedMetricF(const VirtualQSlider* self, int metricA, int metricB) {
	return self->QSlider::getDecodedMetricF(static_cast<VirtualQSlider::PaintDeviceMetric>(metricA), static_cast<VirtualQSlider::PaintDeviceMetric>(metricB));
}
