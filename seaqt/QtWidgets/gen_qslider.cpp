...
bool miqt_exec_callback_QSlider_nativeEvent(QSlider*, intptr_t, struct seaqt_string, void*, long*);
...
public:
	...
	friend bool QSlider_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, long* result);
...
bool QSlider_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, long* result) {
	QByteArray eventType_QByteArray(eventType.data, eventType.len);
	return static_cast<VirtualQSlider*>(self)->QSlider::nativeEvent(eventType_QByteArray, message, static_cast<long*>(result));
}
