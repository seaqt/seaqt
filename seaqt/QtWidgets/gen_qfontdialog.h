...
struct QFontDialog_VTable {
	...
	void (*enterEvent)(struct QFontDialog_VTable* vtbl, QFontDialog* self, QEvent* event);
	...
	bool (*nativeEvent)(struct QFontDialog_VTable* vtbl, QFontDialog* self, struct miqt_string eventType, void* message, long* result);
