...
typedef struct QFontDialog_VTable{
	...
	void (*enterEvent)(VirtualQFontDialog* self, QEnterEvent* event);
	...
	bool (*nativeEvent)(VirtualQFontDialog* self, struct seaqt_string eventType, void* message, intptr_t* result);
