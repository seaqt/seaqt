...
QStyleOptionViewItem* QColumnView_virtualbase_viewOptions(const void* self) {
	...
	return new QStyleOptionViewItem(( (const VirtualQColumnView*)(self) )->QColumnView::viewOptions());
...
bool QColumnView_virtualbase_nativeEvent(void* self, struct miqt_string eventType, void* message, long* result) {
	...
	return ( (VirtualQColumnView*)(self) )->QColumnView::nativeEvent(eventType_QByteArray, message, static_cast<long*>(result));
