...
bool miqt_exec_callback_QColumnView_nativeEvent(QColumnView*, intptr_t, struct seaqt_string, void*, long*);
...
public:
	...
	friend bool QColumnView_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, long* result);
...
QStyleOptionViewItem* QColumnView_virtualbase_viewOptions(const void* self) {
	return new QStyleOptionViewItem(static_cast<const VirtualQColumnView*>(self)->QColumnView::viewOptions());
}
...
bool QColumnView_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, long* result) {
	QByteArray eventType_QByteArray(eventType.data, eventType.len);
	return static_cast<VirtualQColumnView*>(self)->QColumnView::nativeEvent(eventType_QByteArray, message, static_cast<long*>(result));
}
