...
public:
	...
	friend QAbstractItemDelegate* QColumnView_virtualbase_itemDelegateForIndex(const VirtualQColumnView* self, QModelIndex* index);
	...
	friend void QColumnView_virtualbase_initViewItemOption(const VirtualQColumnView* self, QStyleOptionViewItem* option);
	...
	friend void QColumnView_virtualbase_initStyleOption(const VirtualQColumnView* self, QStyleOptionFrame* option);
	...
	friend void QColumnView_virtualbase_enterEvent(VirtualQColumnView* self, QEnterEvent* event);
	...
	friend bool QColumnView_virtualbase_nativeEvent(VirtualQColumnView* self, struct seaqt_string eventType, void* message, intptr_t* result);
	...
	friend double QColumnView_protectedbase_getDecodedMetricF(const VirtualQColumnView* self, int metricA, int metricB);
};
...
void QColumnView_setPreviewColumnVisible(QColumnView* self, bool visible) {
	self->setPreviewColumnVisible(visible);
}

bool QColumnView_isPreviewColumnVisible(const QColumnView* self) {
	return self->isPreviewColumnVisible();
}
...
QAbstractItemDelegate* QColumnView_virtualbase_itemDelegateForIndex(const VirtualQColumnView* self, QModelIndex* index) {
...
void QColumnView_virtualbase_initViewItemOption(const VirtualQColumnView* self, QStyleOptionViewItem* option) {
	...
	self->QColumnView::initViewItemOption(option);
}
...
void QColumnView_virtualbase_initStyleOption(const VirtualQColumnView* self, QStyleOptionFrame* option) {

	self->QColumnView::initStyleOption(option);
}
...
void QColumnView_virtualbase_enterEvent(VirtualQColumnView* self, QEnterEvent* event) {
...
bool QColumnView_virtualbase_nativeEvent(VirtualQColumnView* self, struct seaqt_string eventType, void* message, intptr_t* result) {
	QByteArray eventType_QByteArray(eventType.data, eventType.len);

	return self->QColumnView::nativeEvent(eventType_QByteArray, message, (qintptr*)(result));
}
...
double QColumnView_protectedbase_getDecodedMetricF(const VirtualQColumnView* self, int metricA, int metricB) {
	return self->QColumnView::getDecodedMetricF(static_cast<VirtualQColumnView::PaintDeviceMetric>(metricA), static_cast<VirtualQColumnView::PaintDeviceMetric>(metricB));
}
