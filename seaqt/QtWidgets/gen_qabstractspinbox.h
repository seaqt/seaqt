...
struct QAbstractSpinBox_VTable {
	...
	void (*initStyleOption)(struct QAbstractSpinBox_VTable* vtbl, const QAbstractSpinBox* self, QStyleOptionSpinBox* option);
	...
	void (*enterEvent)(struct QAbstractSpinBox_VTable* vtbl, QAbstractSpinBox* self, QEnterEvent* event);
	...
	bool (*nativeEvent)(struct QAbstractSpinBox_VTable* vtbl, QAbstractSpinBox* self, struct miqt_string eventType, void* message, intptr_t* result);
