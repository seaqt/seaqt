...
typedef struct QAbstractSpinBox_VTable{
	...
	void (*enterEvent)(VirtualQAbstractSpinBox* self, QEvent* event);
	...
	bool (*nativeEvent)(VirtualQAbstractSpinBox* self, struct seaqt_string eventType, void* message, long* result);
...
VirtualQAbstractSpinBox* QAbstractSpinBox_new(const QAbstractSpinBox_VTable* vtbl, size_t vdata, QWidget* parent);
VirtualQAbstractSpinBox* QAbstractSpinBox_new2(const QAbstractSpinBox_VTable* vtbl, size_t vdata);
...
bool QAbstractSpinBox_virtualbase_nativeEvent(VirtualQAbstractSpinBox* self, struct seaqt_string eventType, void* message, long* result);
