...
struct QMenuBar_VTable {
	...
	void (*enterEvent)(struct QMenuBar_VTable* vtbl, QMenuBar* self, QEvent* event);
	...
	bool (*nativeEvent)(struct QMenuBar_VTable* vtbl, QMenuBar* self, struct miqt_string eventType, void* message, long* result);
