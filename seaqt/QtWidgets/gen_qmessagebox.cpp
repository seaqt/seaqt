...
public:
	...
	friend double QMessageBox_protectedbase_getDecodedMetricF(const VirtualQMessageBox* self, int metricA, int metricB);
};
...
int QMessageBox_options(const QMessageBox* self) {
	QMessageBox::Options _ret = self->options();
	return static_cast<int>(_ret);
}
...
double QMessageBox_protectedbase_getDecodedMetricF(const VirtualQMessageBox* self, int metricA, int metricB) {
	return self->QMessageBox::getDecodedMetricF(static_cast<VirtualQMessageBox::PaintDeviceMetric>(metricA), static_cast<VirtualQMessageBox::PaintDeviceMetric>(metricB));
}
