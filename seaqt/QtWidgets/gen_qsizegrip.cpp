...
public:
	...
	friend bool QSizeGrip_virtualbase_nativeEvent(VirtualQSizeGrip* self, struct seaqt_string eventType, void* message, intptr_t* result);
	...
	friend double QSizeGrip_protectedbase_getDecodedMetricF(const VirtualQSizeGrip* self, int metricA, int metricB);
};
...
double QSizeGrip_protectedbase_getDecodedMetricF(const VirtualQSizeGrip* self, int metricA, int metricB) {
	return self->QSizeGrip::getDecodedMetricF(static_cast<VirtualQSizeGrip::PaintDeviceMetric>(metricA), static_cast<VirtualQSizeGrip::PaintDeviceMetric>(metricB));
}
