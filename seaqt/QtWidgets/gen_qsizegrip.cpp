...
bool miqt_exec_callback_QSizeGrip_nativeEvent(QSizeGrip*, intptr_t, struct seaqt_string, void*, long*);
...
public:
	...
	friend bool QSizeGrip_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, long* result);
...
bool QSizeGrip_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, long* result) {
	QByteArray eventType_QByteArray(eventType.data, eventType.len);
	return static_cast<VirtualQSizeGrip*>(self)->QSizeGrip::nativeEvent(eventType_QByteArray, message, static_cast<long*>(result));
}
