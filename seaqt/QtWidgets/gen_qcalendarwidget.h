...
typedef struct QCalendarWidget_VTable{
	...
	void (*enterEvent)(VirtualQCalendarWidget* self, QEvent* event);
	...
	bool (*nativeEvent)(VirtualQCalendarWidget* self, struct seaqt_string eventType, void* message, long* result);
...
struct seaqt_string QCalendarWidget_trUtf8_s(const char* s);
...
struct seaqt_string QCalendarWidget_trUtf8_s_c(const char* s, const char* c);
struct seaqt_string QCalendarWidget_trUtf8_s_c_n(const char* s, const char* c, int n);
...
bool QCalendarWidget_virtualbase_nativeEvent(VirtualQCalendarWidget* self, struct seaqt_string eventType, void* message, long* result);
