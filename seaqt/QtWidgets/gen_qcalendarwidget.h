...
struct QCalendarWidget_VTable {
	...
	void (*enterEvent)(struct QCalendarWidget_VTable* vtbl, QCalendarWidget* self, QEvent* event);
	...
	bool (*nativeEvent)(struct QCalendarWidget_VTable* vtbl, QCalendarWidget* self, struct miqt_string eventType, void* message, long* result);
