...
struct QScrollArea_VTable {
	...
	void (*enterEvent)(struct QScrollArea_VTable* vtbl, QScrollArea* self, QEvent* event);
	...
	bool (*nativeEvent)(struct QScrollArea_VTable* vtbl, QScrollArea* self, struct miqt_string eventType, void* message, long* result);
