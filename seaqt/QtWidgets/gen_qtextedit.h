...
typedef struct QTextEdit_VTable{
	...
	QVariant* (*inputMethodQuery)(const VirtualQTextEdit* self, int property);
	...
	void (*initStyleOption)(const VirtualQTextEdit* self, QStyleOptionFrame* option);
	...
	void (*enterEvent)(VirtualQTextEdit* self, QEnterEvent* event);
	...
	bool (*nativeEvent)(VirtualQTextEdit* self, struct seaqt_string eventType, void* message, intptr_t* result);
