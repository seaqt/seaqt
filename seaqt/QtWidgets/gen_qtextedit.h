...
struct QTextEdit_VTable {
	...
	void (*initStyleOption)(struct QTextEdit_VTable* vtbl, const QTextEdit* self, QStyleOptionFrame* option);
	...
	void (*enterEvent)(struct QTextEdit_VTable* vtbl, QTextEdit* self, QEnterEvent* event);
	...
	bool (*nativeEvent)(struct QTextEdit_VTable* vtbl, QTextEdit* self, struct miqt_string eventType, void* message, intptr_t* result);
