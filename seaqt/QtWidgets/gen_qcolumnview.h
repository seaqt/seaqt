...
typedef struct QColumnView_VTable{
	...
	QAbstractItemDelegate* (*itemDelegateForIndex)(const VirtualQColumnView* self, QModelIndex* index);
	...
	void (*initStyleOption)(const VirtualQColumnView* self, QStyleOptionFrame* option);
	...
	void (*enterEvent)(VirtualQColumnView* self, QEnterEvent* event);
	...
	bool (*nativeEvent)(VirtualQColumnView* self, struct seaqt_string eventType, void* message, intptr_t* result);
