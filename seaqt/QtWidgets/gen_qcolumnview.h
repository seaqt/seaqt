...
struct QColumnView_VTable {
	...
	QAbstractItemDelegate* (*itemDelegateForIndex)(struct QColumnView_VTable* vtbl, const QColumnView* self, QModelIndex* index);
	...
	void (*initViewItemOption)(struct QColumnView_VTable* vtbl, const QColumnView* self, QStyleOptionViewItem* option);
	...
	void (*initStyleOption)(struct QColumnView_VTable* vtbl, const QColumnView* self, QStyleOptionFrame* option);
	...
	void (*enterEvent)(struct QColumnView_VTable* vtbl, QColumnView* self, QEnterEvent* event);
	...
	bool (*nativeEvent)(struct QColumnView_VTable* vtbl, QColumnView* self, struct miqt_string eventType, void* message, intptr_t* result);
