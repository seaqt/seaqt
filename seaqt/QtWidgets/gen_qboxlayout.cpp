...
public:
	...
	friend int QBoxLayout_virtualbase_spacing(const VirtualQBoxLayout* self);
	...
	friend void QBoxLayout_virtualbase_setSpacing(VirtualQBoxLayout* self, int spacing);
	...
	friend QLayoutItem* QBoxLayout_virtualbase_replaceWidget(VirtualQBoxLayout* self, QWidget* from, QWidget* to, int options);
	...
	friend QWidget* QBoxLayout_virtualbase_widget(const VirtualQBoxLayout* self);
...
public:
	...
	friend int QHBoxLayout_virtualbase_spacing(const VirtualQHBoxLayout* self);
	...
	friend void QHBoxLayout_virtualbase_setSpacing(VirtualQHBoxLayout* self, int spacing);
	...
	friend QLayoutItem* QHBoxLayout_virtualbase_replaceWidget(VirtualQHBoxLayout* self, QWidget* from, QWidget* to, int options);
	...
	friend QWidget* QHBoxLayout_virtualbase_widget(const VirtualQHBoxLayout* self);
...
public:
	...
	friend int QVBoxLayout_virtualbase_spacing(const VirtualQVBoxLayout* self);
	...
	friend void QVBoxLayout_virtualbase_setSpacing(VirtualQVBoxLayout* self, int spacing);
	...
	friend QLayoutItem* QVBoxLayout_virtualbase_replaceWidget(VirtualQVBoxLayout* self, QWidget* from, QWidget* to, int options);
	...
	friend QWidget* QVBoxLayout_virtualbase_widget(const VirtualQVBoxLayout* self);
