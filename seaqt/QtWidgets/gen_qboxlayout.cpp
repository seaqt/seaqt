...
QWidget* QBoxLayout_virtualbase_widget(void* self) {
	return static_cast<VirtualQBoxLayout*>(self)->QBoxLayout::widget();
}
...
QWidget* QHBoxLayout_virtualbase_widget(void* self) {
	return static_cast<VirtualQHBoxLayout*>(self)->QHBoxLayout::widget();
}
...
QWidget* QVBoxLayout_virtualbase_widget(void* self) {
	return static_cast<VirtualQVBoxLayout*>(self)->QVBoxLayout::widget();
}
