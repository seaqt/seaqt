...
struct QColorDialog_VTable {
	...
	void (*enterEvent)(struct QColorDialog_VTable* vtbl, QColorDialog* self, QEnterEvent* event);
	...
	bool (*nativeEvent)(struct QColorDialog_VTable* vtbl, QColorDialog* self, struct miqt_string eventType, void* message, intptr_t* result);
