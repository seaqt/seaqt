...
struct QStackedLayout_VTable {
	...
	int (*spacing)(struct QStackedLayout_VTable* vtbl, const QStackedLayout* self);
	void (*setSpacing)(struct QStackedLayout_VTable* vtbl, QStackedLayout* self, int spacing);
	...
	QLayoutItem* (*replaceWidget)(struct QStackedLayout_VTable* vtbl, QStackedLayout* self, QWidget* from, QWidget* to, int options);
	...
	QWidget* (*widget)(struct QStackedLayout_VTable* vtbl, const QStackedLayout* self);
