...
struct QSplashScreen_VTable {
	...
	void (*enterEvent)(struct QSplashScreen_VTable* vtbl, QSplashScreen* self, QEvent* event);
	...
	bool (*nativeEvent)(struct QSplashScreen_VTable* vtbl, QSplashScreen* self, struct miqt_string eventType, void* message, long* result);
