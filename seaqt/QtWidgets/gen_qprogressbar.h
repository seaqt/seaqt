...
struct QProgressBar_VTable {
	...
	void (*enterEvent)(struct QProgressBar_VTable* vtbl, QProgressBar* self, QEvent* event);
	...
	bool (*nativeEvent)(struct QProgressBar_VTable* vtbl, QProgressBar* self, struct miqt_string eventType, void* message, long* result);
