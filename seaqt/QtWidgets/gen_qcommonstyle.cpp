...
QMetaObject* miqt_exec_callback_QCommonStyle_metaObject(const QCommonStyle*, intptr_t);
void* miqt_exec_callback_QCommonStyle_metacast(QCommonStyle*, intptr_t, const char*);
int miqt_exec_callback_QCommonStyle_metacall(QCommonStyle*, intptr_t, int, int, void**);
...
QRect* miqt_exec_callback_QCommonStyle_itemTextRect(const QCommonStyle*, intptr_t, QFontMetrics*, QRect*, int, bool, struct seaqt_string);
QRect* miqt_exec_callback_QCommonStyle_itemPixmapRect(const QCommonStyle*, intptr_t, QRect*, int, QPixmap*);
void miqt_exec_callback_QCommonStyle_drawItemText(const QCommonStyle*, intptr_t, QPainter*, QRect*, int, QPalette*, bool, struct seaqt_string, int);
...
public:
	...
	virtual ~VirtualQCommonStyle() override = default;
	...
	virtual const QMetaObject* metaObject() const override {
		...
		QMetaObject* callback_return_value = miqt_exec_callback_QCommonStyle_metaObject(this, handle__metaObject);
	...
	virtual int qt_metacall(QMetaObject::Call param1, int param2, void** param3) override {
		...
		int sigval2 = param2;
		void** sigval3 = param3;
		int callback_return_value = miqt_exec_callback_QCommonStyle_metacall(this, handle__metacall, sigval1, sigval2, sigval3);
	...
	friend QRect* QCommonStyle_virtualbase_itemTextRect(const void* self, QFontMetrics* fm, QRect* r, int flags, bool enabled, struct seaqt_string text);
	...
	friend void QCommonStyle_virtualbase_drawItemText(const void* self, QPainter* painter, QRect* rect, int flags, QPalette* pal, bool enabled, struct seaqt_string text, int textRole);
...
QCommonStyle* QCommonStyle_new() {
	return new (std::nothrow) VirtualQCommonStyle();
}
...
QMetaObject* QCommonStyle_virtualbase_metaObject(const void* self) {
	return (QMetaObject*) static_cast<const VirtualQCommonStyle*>(self)->QCommonStyle::metaObject();
}
...
void* QCommonStyle_virtualbase_metacast(void* self, const char* param1) {
	return static_cast<VirtualQCommonStyle*>(self)->QCommonStyle::qt_metacast(param1);
}
...
int QCommonStyle_virtualbase_metacall(void* self, int param1, int param2, void** param3) {
	return static_cast<VirtualQCommonStyle*>(self)->QCommonStyle::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
}
...
void QCommonStyle_virtualbase_drawPrimitive(const void* self, int pe, QStyleOption* opt, QPainter* p, QWidget* w) {
	static_cast<const VirtualQCommonStyle*>(self)->QCommonStyle::drawPrimitive(static_cast<VirtualQCommonStyle::PrimitiveElement>(pe), opt, p, w);
}
...
void QCommonStyle_virtualbase_drawControl(const void* self, int element, QStyleOption* opt, QPainter* p, QWidget* w) {
	static_cast<const VirtualQCommonStyle*>(self)->QCommonStyle::drawControl(static_cast<VirtualQCommonStyle::ControlElement>(element), opt, p, w);
}
...
QRect* QCommonStyle_virtualbase_subElementRect(const void* self, int r, QStyleOption* opt, QWidget* widget) {
	return new QRect(static_cast<const VirtualQCommonStyle*>(self)->QCommonStyle::subElementRect(static_cast<VirtualQCommonStyle::SubElement>(r), opt, widget));
}
...
void QCommonStyle_virtualbase_drawComplexControl(const void* self, int cc, QStyleOptionComplex* opt, QPainter* p, QWidget* w) {
	static_cast<const VirtualQCommonStyle*>(self)->QCommonStyle::drawComplexControl(static_cast<VirtualQCommonStyle::ComplexControl>(cc), opt, p, w);
}
...
int QCommonStyle_virtualbase_hitTestComplexControl(const void* self, int cc, QStyleOptionComplex* opt, QPoint* pt, QWidget* w) {
	VirtualQCommonStyle::SubControl _ret = static_cast<const VirtualQCommonStyle*>(self)->QCommonStyle::hitTestComplexControl(static_cast<VirtualQCommonStyle::ComplexControl>(cc), opt, *pt, w);
	return static_cast<int>(_ret);
}
...
QRect* QCommonStyle_virtualbase_subControlRect(const void* self, int cc, QStyleOptionComplex* opt, int sc, QWidget* w) {
	return new QRect(static_cast<const VirtualQCommonStyle*>(self)->QCommonStyle::subControlRect(static_cast<VirtualQCommonStyle::ComplexControl>(cc), opt, static_cast<VirtualQCommonStyle::SubControl>(sc), w));
}
...
QSize* QCommonStyle_virtualbase_sizeFromContents(const void* self, int ct, QStyleOption* opt, QSize* contentsSize, QWidget* widget) {
	return new QSize(static_cast<const VirtualQCommonStyle*>(self)->QCommonStyle::sizeFromContents(static_cast<VirtualQCommonStyle::ContentsType>(ct), opt, *contentsSize, widget));
}
...
int QCommonStyle_virtualbase_pixelMetric(const void* self, int m, QStyleOption* opt, QWidget* widget) {
	return static_cast<const VirtualQCommonStyle*>(self)->QCommonStyle::pixelMetric(static_cast<VirtualQCommonStyle::PixelMetric>(m), opt, widget);
}
...
int QCommonStyle_virtualbase_styleHint(const void* self, int sh, QStyleOption* opt, QWidget* w, QStyleHintReturn* shret) {
	return static_cast<const VirtualQCommonStyle*>(self)->QCommonStyle::styleHint(static_cast<VirtualQCommonStyle::StyleHint>(sh), opt, w, shret);
}
...
QIcon* QCommonStyle_virtualbase_standardIcon(const void* self, int standardIcon, QStyleOption* opt, QWidget* widget) {
	return new QIcon(static_cast<const VirtualQCommonStyle*>(self)->QCommonStyle::standardIcon(static_cast<VirtualQCommonStyle::StandardPixmap>(standardIcon), opt, widget));
}
...
QPixmap* QCommonStyle_virtualbase_standardPixmap(const void* self, int sp, QStyleOption* opt, QWidget* widget) {
	return new QPixmap(static_cast<const VirtualQCommonStyle*>(self)->QCommonStyle::standardPixmap(static_cast<VirtualQCommonStyle::StandardPixmap>(sp), opt, widget));
}
...
QPixmap* QCommonStyle_virtualbase_generatedIconPixmap(const void* self, int iconMode, QPixmap* pixmap, QStyleOption* opt) {
	return new QPixmap(static_cast<const VirtualQCommonStyle*>(self)->QCommonStyle::generatedIconPixmap(static_cast<QIcon::Mode>(iconMode), *pixmap, opt));
}
...
int QCommonStyle_virtualbase_layoutSpacing(const void* self, int control1, int control2, int orientation, QStyleOption* option, QWidget* widget) {
	return static_cast<const VirtualQCommonStyle*>(self)->QCommonStyle::layoutSpacing(static_cast<QSizePolicy::ControlType>(control1), static_cast<QSizePolicy::ControlType>(control2), static_cast<Qt::Orientation>(orientation), option, widget);
}
...
void QCommonStyle_virtualbase_polish(void* self, QPalette* param1) {
	static_cast<VirtualQCommonStyle*>(self)->QCommonStyle::polish(*param1);
}
...
void QCommonStyle_virtualbase_polishWithApp(void* self, QApplication* app) {
	static_cast<VirtualQCommonStyle*>(self)->QCommonStyle::polish(app);
}
...
void QCommonStyle_virtualbase_polishWithWidget(void* self, QWidget* widget) {
	static_cast<VirtualQCommonStyle*>(self)->QCommonStyle::polish(widget);
}
...
void QCommonStyle_virtualbase_unpolish(void* self, QWidget* widget) {
	static_cast<VirtualQCommonStyle*>(self)->QCommonStyle::unpolish(widget);
}
...
void QCommonStyle_virtualbase_unpolishWithApplication(void* self, QApplication* application) {
	static_cast<VirtualQCommonStyle*>(self)->QCommonStyle::unpolish(application);
}
...
QRect* QCommonStyle_virtualbase_itemTextRect(const void* self, QFontMetrics* fm, QRect* r, int flags, bool enabled, struct seaqt_string text) {
	QString text_QString = QString::fromUtf8(text.data, text.len);
	return new QRect(static_cast<const VirtualQCommonStyle*>(self)->QCommonStyle::itemTextRect(*fm, *r, static_cast<int>(flags), enabled, text_QString));
}
...
QRect* QCommonStyle_virtualbase_itemPixmapRect(const void* self, QRect* r, int flags, QPixmap* pixmap) {
	return new QRect(static_cast<const VirtualQCommonStyle*>(self)->QCommonStyle::itemPixmapRect(*r, static_cast<int>(flags), *pixmap));
}
...
void QCommonStyle_virtualbase_drawItemText(const void* self, QPainter* painter, QRect* rect, int flags, QPalette* pal, bool enabled, struct seaqt_string text, int textRole) {
	QString text_QString = QString::fromUtf8(text.data, text.len);
	static_cast<const VirtualQCommonStyle*>(self)->QCommonStyle::drawItemText(painter, *rect, static_cast<int>(flags), *pal, enabled, text_QString, static_cast<QPalette::ColorRole>(textRole));
}
...
void QCommonStyle_virtualbase_drawItemPixmap(const void* self, QPainter* painter, QRect* rect, int alignment, QPixmap* pixmap) {
	static_cast<const VirtualQCommonStyle*>(self)->QCommonStyle::drawItemPixmap(painter, *rect, static_cast<int>(alignment), *pixmap);
}
...
QPalette* QCommonStyle_virtualbase_standardPalette(const void* self) {
	return new QPalette(static_cast<const VirtualQCommonStyle*>(self)->QCommonStyle::standardPalette());
}
...
bool QCommonStyle_virtualbase_event(void* self, QEvent* event) {
	return static_cast<VirtualQCommonStyle*>(self)->QCommonStyle::event(event);
}
...
bool QCommonStyle_virtualbase_eventFilter(void* self, QObject* watched, QEvent* event) {
	return static_cast<VirtualQCommonStyle*>(self)->QCommonStyle::eventFilter(watched, event);
}
...
void QCommonStyle_virtualbase_timerEvent(void* self, QTimerEvent* event) {
	static_cast<VirtualQCommonStyle*>(self)->QCommonStyle::timerEvent(event);
}
...
void QCommonStyle_virtualbase_childEvent(void* self, QChildEvent* event) {
	static_cast<VirtualQCommonStyle*>(self)->QCommonStyle::childEvent(event);
}
...
void QCommonStyle_virtualbase_customEvent(void* self, QEvent* event) {
	static_cast<VirtualQCommonStyle*>(self)->QCommonStyle::customEvent(event);
}
...
void QCommonStyle_virtualbase_connectNotify(void* self, QMetaMethod* signal) {
	static_cast<VirtualQCommonStyle*>(self)->QCommonStyle::connectNotify(*signal);
}
...
void QCommonStyle_virtualbase_disconnectNotify(void* self, QMetaMethod* signal) {
	static_cast<VirtualQCommonStyle*>(self)->QCommonStyle::disconnectNotify(*signal);
}
