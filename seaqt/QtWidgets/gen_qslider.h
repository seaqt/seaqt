...
typedef struct QSlider_VTable{
	...
	void (*enterEvent)(VirtualQSlider* self, QEvent* event);
	...
	bool (*nativeEvent)(VirtualQSlider* self, struct seaqt_string eventType, void* message, long* result);
...
VirtualQSlider* QSlider_new(const QSlider_VTable* vtbl, size_t vdata, QWidget* parent);
VirtualQSlider* QSlider_new2(const QSlider_VTable* vtbl, size_t vdata);
VirtualQSlider* QSlider_new3(const QSlider_VTable* vtbl, size_t vdata, int orientation);
...
bool QSlider_virtualbase_nativeEvent(VirtualQSlider* self, struct seaqt_string eventType, void* message, long* result);
