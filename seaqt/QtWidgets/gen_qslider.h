...
struct QSlider_VTable {
	...
	void (*initStyleOption)(struct QSlider_VTable* vtbl, const QSlider* self, QStyleOptionSlider* option);
	...
	void (*enterEvent)(struct QSlider_VTable* vtbl, QSlider* self, QEnterEvent* event);
	...
	bool (*nativeEvent)(struct QSlider_VTable* vtbl, QSlider* self, struct miqt_string eventType, void* message, intptr_t* result);
