...
struct QStackedWidget_VTable {
	...
	void (*initStyleOption)(struct QStackedWidget_VTable* vtbl, const QStackedWidget* self, QStyleOptionFrame* option);
	...
	void (*enterEvent)(struct QStackedWidget_VTable* vtbl, QStackedWidget* self, QEnterEvent* event);
	...
	bool (*nativeEvent)(struct QStackedWidget_VTable* vtbl, QStackedWidget* self, struct miqt_string eventType, void* message, intptr_t* result);
