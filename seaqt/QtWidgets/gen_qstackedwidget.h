...
VirtualQStackedWidget* QStackedWidget_new(const QStackedWidget_VTable* vtbl, size_t vdata, QWidget* parent);
VirtualQStackedWidget* QStackedWidget_new2(const QStackedWidget_VTable* vtbl, size_t vdata);
