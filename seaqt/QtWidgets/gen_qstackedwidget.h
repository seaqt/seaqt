...
typedef struct QStackedWidget_VTable{
	...
	void (*initStyleOption)(const VirtualQStackedWidget* self, QStyleOptionFrame* option);
	...
	void (*enterEvent)(VirtualQStackedWidget* self, QEnterEvent* event);
	...
	bool (*nativeEvent)(VirtualQStackedWidget* self, struct seaqt_string eventType, void* message, intptr_t* result);
