...
bool miqt_exec_callback_QScrollArea_nativeEvent(QScrollArea*, intptr_t, struct seaqt_string, void*, long*);
...
public:
	...
	friend bool QScrollArea_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, long* result);
...
bool QScrollArea_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, long* result) {
	QByteArray eventType_QByteArray(eventType.data, eventType.len);
	return static_cast<VirtualQScrollArea*>(self)->QScrollArea::nativeEvent(eventType_QByteArray, message, static_cast<long*>(result));
}
