...
public:
	...
	friend void QScrollArea_virtualbase_initStyleOption(const VirtualQScrollArea* self, QStyleOptionFrame* option);
	...
	friend void QScrollArea_virtualbase_enterEvent(VirtualQScrollArea* self, QEnterEvent* event);
	...
	friend bool QScrollArea_virtualbase_nativeEvent(VirtualQScrollArea* self, struct seaqt_string eventType, void* message, intptr_t* result);
	...
	friend double QScrollArea_protectedbase_getDecodedMetricF(const VirtualQScrollArea* self, int metricA, int metricB);
};
...
bool QScrollArea_virtualbase_nativeEvent(VirtualQScrollArea* self, struct seaqt_string eventType, void* message, intptr_t* result) {
	...
	return self->QScrollArea::nativeEvent(eventType_QByteArray, message, (qintptr*)(result));
}
...
double QScrollArea_protectedbase_getDecodedMetricF(const VirtualQScrollArea* self, int metricA, int metricB) {
	return self->QScrollArea::getDecodedMetricF(static_cast<VirtualQScrollArea::PaintDeviceMetric>(metricA), static_cast<VirtualQScrollArea::PaintDeviceMetric>(metricB));
}
