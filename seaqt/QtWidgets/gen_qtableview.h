...
struct QTableView_VTable {
	...
	QStyleOptionViewItem* (*viewOptions)(struct QTableView_VTable* vtbl, const QTableView* self);
	...
	void (*enterEvent)(struct QTableView_VTable* vtbl, QTableView* self, QEvent* event);
	...
	bool (*nativeEvent)(struct QTableView_VTable* vtbl, QTableView* self, struct miqt_string eventType, void* message, long* result);
