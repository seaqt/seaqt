...
typedef struct QTableView_VTable{
	...
	void (*initViewItemOption)(const VirtualQTableView* self, QStyleOptionViewItem* option);
	...
	QAbstractItemDelegate* (*itemDelegateForIndex)(const VirtualQTableView* self, QModelIndex* index);
	...
	void (*initStyleOption)(const VirtualQTableView* self, QStyleOptionFrame* option);
	...
	void (*enterEvent)(VirtualQTableView* self, QEnterEvent* event);
	...
	bool (*nativeEvent)(VirtualQTableView* self, struct seaqt_string eventType, void* message, intptr_t* result);
