...
bool miqt_exec_callback_QDialogButtonBox_nativeEvent(QDialogButtonBox*, intptr_t, struct seaqt_string, void*, intptr_t*);
...
public:
	...
	friend bool QDialogButtonBox_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, intptr_t* result);
...
bool QDialogButtonBox_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, intptr_t* result) {
	QByteArray eventType_QByteArray(eventType.data, eventType.len);
	return static_cast<VirtualQDialogButtonBox*>(self)->QDialogButtonBox::nativeEvent(eventType_QByteArray, message, (qintptr*)(result));
}
