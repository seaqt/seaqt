...
public:
	...
	friend bool QAbstractScrollArea_virtualbase_nativeEvent(VirtualQAbstractScrollArea* self, struct seaqt_string eventType, void* message, intptr_t* result);
	...
	friend double QAbstractScrollArea_protectedbase_getDecodedMetricF(const VirtualQAbstractScrollArea* self, int metricA, int metricB);
};
...
bool QAbstractScrollArea_virtualbase_nativeEvent(VirtualQAbstractScrollArea* self, struct seaqt_string eventType, void* message, intptr_t* result) {
...
double QAbstractScrollArea_protectedbase_getDecodedMetricF(const VirtualQAbstractScrollArea* self, int metricA, int metricB) {
	return self->QAbstractScrollArea::getDecodedMetricF(static_cast<VirtualQAbstractScrollArea::PaintDeviceMetric>(metricA), static_cast<VirtualQAbstractScrollArea::PaintDeviceMetric>(metricB));
}
