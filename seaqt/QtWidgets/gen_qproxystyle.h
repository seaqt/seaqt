...
struct QProxyStyle_VTable {
	void (*destructor)(struct QProxyStyle_VTable* vtbl, QProxyStyle* self);
	QMetaObject* (*metaObject)(struct QProxyStyle_VTable* vtbl, const QProxyStyle* self);
	void* (*metacast)(struct QProxyStyle_VTable* vtbl, QProxyStyle* self, const char* param1);
	int (*metacall)(struct QProxyStyle_VTable* vtbl, QProxyStyle* self, int param1, int param2, void** param3);
	void (*drawPrimitive)(struct QProxyStyle_VTable* vtbl, const QProxyStyle* self, int element, QStyleOption* option, QPainter* painter, QWidget* widget);
	void (*drawControl)(struct QProxyStyle_VTable* vtbl, const QProxyStyle* self, int element, QStyleOption* option, QPainter* painter, QWidget* widget);
	void (*drawComplexControl)(struct QProxyStyle_VTable* vtbl, const QProxyStyle* self, int control, QStyleOptionComplex* option, QPainter* painter, QWidget* widget);
	void (*drawItemText)(struct QProxyStyle_VTable* vtbl, const QProxyStyle* self, QPainter* painter, QRect* rect, int flags, QPalette* pal, bool enabled, struct miqt_string text, int textRole);
	void (*drawItemPixmap)(struct QProxyStyle_VTable* vtbl, const QProxyStyle* self, QPainter* painter, QRect* rect, int alignment, QPixmap* pixmap);
	QSize* (*sizeFromContents)(struct QProxyStyle_VTable* vtbl, const QProxyStyle* self, int type, QStyleOption* option, QSize* size, QWidget* widget);
	QRect* (*subElementRect)(struct QProxyStyle_VTable* vtbl, const QProxyStyle* self, int element, QStyleOption* option, QWidget* widget);
	QRect* (*subControlRect)(struct QProxyStyle_VTable* vtbl, const QProxyStyle* self, int cc, QStyleOptionComplex* opt, int sc, QWidget* widget);
	QRect* (*itemTextRect)(struct QProxyStyle_VTable* vtbl, const QProxyStyle* self, QFontMetrics* fm, QRect* r, int flags, bool enabled, struct miqt_string text);
	QRect* (*itemPixmapRect)(struct QProxyStyle_VTable* vtbl, const QProxyStyle* self, QRect* r, int flags, QPixmap* pixmap);
	int (*hitTestComplexControl)(struct QProxyStyle_VTable* vtbl, const QProxyStyle* self, int control, QStyleOptionComplex* option, QPoint* pos, QWidget* widget);
	int (*styleHint)(struct QProxyStyle_VTable* vtbl, const QProxyStyle* self, int hint, QStyleOption* option, QWidget* widget, QStyleHintReturn* returnData);
	int (*pixelMetric)(struct QProxyStyle_VTable* vtbl, const QProxyStyle* self, int metric, QStyleOption* option, QWidget* widget);
	int (*layoutSpacing)(struct QProxyStyle_VTable* vtbl, const QProxyStyle* self, int control1, int control2, int orientation, QStyleOption* option, QWidget* widget);
	QIcon* (*standardIcon)(struct QProxyStyle_VTable* vtbl, const QProxyStyle* self, int standardIcon, QStyleOption* option, QWidget* widget);
	QPixmap* (*standardPixmap)(struct QProxyStyle_VTable* vtbl, const QProxyStyle* self, int standardPixmap, QStyleOption* opt, QWidget* widget);
	QPixmap* (*generatedIconPixmap)(struct QProxyStyle_VTable* vtbl, const QProxyStyle* self, int iconMode, QPixmap* pixmap, QStyleOption* opt);
	QPalette* (*standardPalette)(struct QProxyStyle_VTable* vtbl, const QProxyStyle* self);
	void (*polish)(struct QProxyStyle_VTable* vtbl, QProxyStyle* self, QWidget* widget);
	void (*polishWithPal)(struct QProxyStyle_VTable* vtbl, QProxyStyle* self, QPalette* pal);
	void (*polishWithApp)(struct QProxyStyle_VTable* vtbl, QProxyStyle* self, QApplication* app);
	void (*unpolish)(struct QProxyStyle_VTable* vtbl, QProxyStyle* self, QWidget* widget);
	void (*unpolishWithApp)(struct QProxyStyle_VTable* vtbl, QProxyStyle* self, QApplication* app);
	bool (*event)(struct QProxyStyle_VTable* vtbl, QProxyStyle* self, QEvent* e);
	bool (*eventFilter)(struct QProxyStyle_VTable* vtbl, QProxyStyle* self, QObject* watched, QEvent* event);
	void (*timerEvent)(struct QProxyStyle_VTable* vtbl, QProxyStyle* self, QTimerEvent* event);
	void (*childEvent)(struct QProxyStyle_VTable* vtbl, QProxyStyle* self, QChildEvent* event);
	void (*customEvent)(struct QProxyStyle_VTable* vtbl, QProxyStyle* self, QEvent* event);
	void (*connectNotify)(struct QProxyStyle_VTable* vtbl, QProxyStyle* self, QMetaMethod* signal);
	void (*disconnectNotify)(struct QProxyStyle_VTable* vtbl, QProxyStyle* self, QMetaMethod* signal);
};
