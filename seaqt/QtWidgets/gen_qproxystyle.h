...
typedef struct QProxyStyle_VTable{
	...
	void (*polish_widget)(VirtualQProxyStyle* self, QWidget* widget);
	void (*polish_pal)(VirtualQProxyStyle* self, QPalette* pal);
	void (*polish_app)(VirtualQProxyStyle* self, QApplication* app);
	void (*unpolish_widget)(VirtualQProxyStyle* self, QWidget* widget);
	void (*unpolish_app)(VirtualQProxyStyle* self, QApplication* app);
