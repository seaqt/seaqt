...
typedef struct QDateTimeEdit_VTable{
	...
	void (*initStyleOption)(const VirtualQDateTimeEdit* self, QStyleOptionSpinBox* option);
	...
	void (*enterEvent)(VirtualQDateTimeEdit* self, QEnterEvent* event);
	...
	bool (*nativeEvent)(VirtualQDateTimeEdit* self, struct seaqt_string eventType, void* message, intptr_t* result);
...
typedef struct QTimeEdit_VTable{
	...
	void (*initStyleOption)(const VirtualQTimeEdit* self, QStyleOptionSpinBox* option);
	...
	void (*enterEvent)(VirtualQTimeEdit* self, QEnterEvent* event);
	...
	bool (*nativeEvent)(VirtualQTimeEdit* self, struct seaqt_string eventType, void* message, intptr_t* result);
...
typedef struct QDateEdit_VTable{
	...
	void (*initStyleOption)(const VirtualQDateEdit* self, QStyleOptionSpinBox* option);
	...
	void (*enterEvent)(VirtualQDateEdit* self, QEnterEvent* event);
	...
	bool (*nativeEvent)(VirtualQDateEdit* self, struct seaqt_string eventType, void* message, intptr_t* result);
