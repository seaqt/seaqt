...
struct QDateTimeEdit_VTable {
	...
	void (*enterEvent)(struct QDateTimeEdit_VTable* vtbl, QDateTimeEdit* self, QEvent* event);
	...
	bool (*nativeEvent)(struct QDateTimeEdit_VTable* vtbl, QDateTimeEdit* self, struct miqt_string eventType, void* message, long* result);
...
struct QTimeEdit_VTable {
	...
	void (*enterEvent)(struct QTimeEdit_VTable* vtbl, QTimeEdit* self, QEvent* event);
	...
	bool (*nativeEvent)(struct QTimeEdit_VTable* vtbl, QTimeEdit* self, struct miqt_string eventType, void* message, long* result);
...
struct QDateEdit_VTable {
	...
	void (*enterEvent)(struct QDateEdit_VTable* vtbl, QDateEdit* self, QEvent* event);
	...
	bool (*nativeEvent)(struct QDateEdit_VTable* vtbl, QDateEdit* self, struct miqt_string eventType, void* message, long* result);
