...
bool miqt_exec_callback_QTableWidget_nativeEvent(QTableWidget*, intptr_t, struct seaqt_string, void*, intptr_t*);
...
public:
	...
	friend bool QTableWidget_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, intptr_t* result);
...
void QTableWidget_virtualbase_initViewItemOption(const void* self, QStyleOptionViewItem* option) {
	static_cast<const VirtualQTableWidget*>(self)->QTableWidget::initViewItemOption(option);
}
...
QAbstractItemDelegate* QTableWidget_virtualbase_itemDelegateForIndex(const void* self, QModelIndex* index) {
	return static_cast<const VirtualQTableWidget*>(self)->QTableWidget::itemDelegateForIndex(*index);
}
...
void QTableWidget_virtualbase_initStyleOption(const void* self, QStyleOptionFrame* option) {
	static_cast<const VirtualQTableWidget*>(self)->QTableWidget::initStyleOption(option);
}
...
bool QTableWidget_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, intptr_t* result) {
	QByteArray eventType_QByteArray(eventType.data, eventType.len);
	return static_cast<VirtualQTableWidget*>(self)->QTableWidget::nativeEvent(eventType_QByteArray, message, (qintptr*)(result));
}
