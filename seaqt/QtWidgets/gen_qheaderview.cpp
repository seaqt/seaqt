...
bool miqt_exec_callback_QHeaderView_nativeEvent(QHeaderView*, intptr_t, struct seaqt_string, void*, long*);
...
public:
	...
	friend bool QHeaderView_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, long* result);
...
struct seaqt_string QHeaderView_trUtf8(const char* s) {
...
struct seaqt_string QHeaderView_trUtf82(const char* s, const char* c) {
...
struct seaqt_string QHeaderView_trUtf83(const char* s, const char* c, int n) {
...
QStyleOptionViewItem* QHeaderView_virtualbase_viewOptions(const void* self) {
	return new QStyleOptionViewItem(static_cast<const VirtualQHeaderView*>(self)->QHeaderView::viewOptions());
}
...
bool QHeaderView_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, long* result) {
	QByteArray eventType_QByteArray(eventType.data, eventType.len);
	return static_cast<VirtualQHeaderView*>(self)->QHeaderView::nativeEvent(eventType_QByteArray, message, static_cast<long*>(result));
}
