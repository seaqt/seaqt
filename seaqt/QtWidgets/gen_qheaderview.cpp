...
public:
	...
	friend double QHeaderView_protectedbase_getDecodedMetricF(const VirtualQHeaderView* self, int metricA, int metricB);
};
...
double QHeaderView_protectedbase_getDecodedMetricF(const VirtualQHeaderView* self, int metricA, int metricB) {
	return self->QHeaderView::getDecodedMetricF(static_cast<VirtualQHeaderView::PaintDeviceMetric>(metricA), static_cast<VirtualQHeaderView::PaintDeviceMetric>(metricB));
}
