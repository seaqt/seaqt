...
public:
	...
	friend void QHeaderView_protectedbase_initStyleOption(const void* self, QStyleOptionHeader* option);
	friend void QHeaderView_protectedbase_setHorizontalStepsPerItem(void* self, int steps);
	friend int QHeaderView_protectedbase_horizontalStepsPerItem(const void* self);
	friend void QHeaderView_protectedbase_setVerticalStepsPerItem(void* self, int steps);
	friend int QHeaderView_protectedbase_verticalStepsPerItem(const void* self);
