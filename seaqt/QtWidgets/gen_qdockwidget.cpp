...
QDockWidget* QDockWidget_new(struct seaqt_string title) {
...
QDockWidget* QDockWidget_new3(struct seaqt_string title, QWidget* parent) {
	QString title_QString = QString::fromUtf8(title.data, title.len);
	return new (std::nothrow) VirtualQDockWidget(title_QString, parent);
}

QDockWidget* QDockWidget_new4(struct seaqt_string title, QWidget* parent, int flags) {
	QString title_QString = QString::fromUtf8(title.data, title.len);
