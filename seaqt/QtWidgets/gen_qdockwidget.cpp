...
public:
	...
	friend double QDockWidget_protectedbase_getDecodedMetricF(const VirtualQDockWidget* self, int metricA, int metricB);
};
...
double QDockWidget_protectedbase_getDecodedMetricF(const VirtualQDockWidget* self, int metricA, int metricB) {
	return self->QDockWidget::getDecodedMetricF(static_cast<VirtualQDockWidget::PaintDeviceMetric>(metricA), static_cast<VirtualQDockWidget::PaintDeviceMetric>(metricB));
}
