...
bool miqt_exec_callback_QDockWidget_nativeEvent(QDockWidget*, intptr_t, struct seaqt_string, void*, long*);
...
public:
	...
	friend bool QDockWidget_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, long* result);
...
bool QDockWidget_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, long* result) {
	QByteArray eventType_QByteArray(eventType.data, eventType.len);
	return static_cast<VirtualQDockWidget*>(self)->QDockWidget::nativeEvent(eventType_QByteArray, message, static_cast<long*>(result));
}
