...
struct QPushButton_VTable {
	...
	void (*mouseMoveEvent)(struct QPushButton_VTable* vtbl, QPushButton* self, QMouseEvent* e);
	...
	void (*enterEvent)(struct QPushButton_VTable* vtbl, QPushButton* self, QEvent* event);
	...
	bool (*nativeEvent)(struct QPushButton_VTable* vtbl, QPushButton* self, struct miqt_string eventType, void* message, long* result);
