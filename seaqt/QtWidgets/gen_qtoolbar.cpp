...
public:
	...
	friend double QToolBar_protectedbase_getDecodedMetricF(const VirtualQToolBar* self, int metricA, int metricB);
};
...
double QToolBar_protectedbase_getDecodedMetricF(const VirtualQToolBar* self, int metricA, int metricB) {
	return self->QToolBar::getDecodedMetricF(static_cast<VirtualQToolBar::PaintDeviceMetric>(metricA), static_cast<VirtualQToolBar::PaintDeviceMetric>(metricB));
}
