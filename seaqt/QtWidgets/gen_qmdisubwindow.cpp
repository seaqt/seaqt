...
bool miqt_exec_callback_QMdiSubWindow_nativeEvent(QMdiSubWindow*, intptr_t, struct seaqt_string, void*, long*);
...
public:
	...
	friend bool QMdiSubWindow_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, long* result);
...
bool QMdiSubWindow_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, long* result) {
	QByteArray eventType_QByteArray(eventType.data, eventType.len);
	return static_cast<VirtualQMdiSubWindow*>(self)->QMdiSubWindow::nativeEvent(eventType_QByteArray, message, static_cast<long*>(result));
}
