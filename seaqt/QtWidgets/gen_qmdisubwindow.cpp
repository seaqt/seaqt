...
void QMdiSubWindow_connect_windowStateChanged(QMdiSubWindow* self, intptr_t slot) {
	VirtualQMdiSubWindow::connect(self, static_cast<void (QMdiSubWindow::*)(Qt::WindowStates, Qt::WindowStates)>(&QMdiSubWindow::windowStateChanged), self, [=](Qt::WindowStates oldState, Qt::WindowStates newState) {
...
void QMdiSubWindow_connect_aboutToActivate(QMdiSubWindow* self, intptr_t slot) {
	VirtualQMdiSubWindow::connect(self, static_cast<void (QMdiSubWindow::*)()>(&QMdiSubWindow::aboutToActivate), self, [=]() {
...
bool QMdiSubWindow_virtualbase_nativeEvent(void* self, struct miqt_string eventType, void* message, long* result) {
	...
	return ( (VirtualQMdiSubWindow*)(self) )->QMdiSubWindow::nativeEvent(eventType_QByteArray, message, static_cast<long*>(result));
