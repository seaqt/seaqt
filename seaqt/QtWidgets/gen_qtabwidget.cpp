...
QMetaObject* miqt_exec_callback_QTabWidget_metaObject(const QTabWidget*, intptr_t);
void* miqt_exec_callback_QTabWidget_metacast(QTabWidget*, intptr_t, const char*);
...
bool miqt_exec_callback_QTabWidget_nativeEvent(QTabWidget*, intptr_t, struct seaqt_string, void*, long*);
...
public:
	...
	virtual ~VirtualQTabWidget() override = default;
	...
	virtual const QMetaObject* metaObject() const override {
		...
		QMetaObject* callback_return_value = miqt_exec_callback_QTabWidget_metaObject(this, handle__metaObject);
	...
	friend bool QTabWidget_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, long* result);
...
QTabWidget* QTabWidget_new() {
	return new (std::nothrow) VirtualQTabWidget();
}

QTabWidget* QTabWidget_new2(QWidget* parent) {
	return new (std::nothrow) VirtualQTabWidget(parent);
}
...
struct seaqt_string QTabWidget_tr(const char* s) {
...
struct seaqt_string QTabWidget_trUtf8(const char* s) {
...
int QTabWidget_addTab(QTabWidget* self, QWidget* widget, struct seaqt_string param2) {
	QString param2_QString = QString::fromUtf8(param2.data, param2.len);
	return self->addTab(widget, param2_QString);
}

int QTabWidget_addTab2(QTabWidget* self, QWidget* widget, QIcon* icon, struct seaqt_string label) {
	QString label_QString = QString::fromUtf8(label.data, label.len);
	return self->addTab(widget, *icon, label_QString);
}

int QTabWidget_insertTab(QTabWidget* self, int index, QWidget* widget, struct seaqt_string param3) {
...
int QTabWidget_insertTab2(QTabWidget* self, int index, QWidget* widget, QIcon* icon, struct seaqt_string label) {
	QString label_QString = QString::fromUtf8(label.data, label.len);
...
struct seaqt_string QTabWidget_tr3(const char* s, const char* c, int n) {
...
struct seaqt_string QTabWidget_trUtf82(const char* s, const char* c) {
...
struct seaqt_string QTabWidget_trUtf83(const char* s, const char* c, int n) {
...
QMetaObject* QTabWidget_virtualbase_metaObject(const void* self) {
	return (QMetaObject*) static_cast<const VirtualQTabWidget*>(self)->QTabWidget::metaObject();
}
...
void* QTabWidget_virtualbase_metacast(void* self, const char* param1) {
	return static_cast<VirtualQTabWidget*>(self)->QTabWidget::qt_metacast(param1);
}
...
int QTabWidget_virtualbase_metacall(void* self, int param1, int param2, void** param3) {
	return static_cast<VirtualQTabWidget*>(self)->QTabWidget::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
}
...
QSize* QTabWidget_virtualbase_sizeHint(const void* self) {
	return new QSize(static_cast<const VirtualQTabWidget*>(self)->QTabWidget::sizeHint());
}
...
QSize* QTabWidget_virtualbase_minimumSizeHint(const void* self) {
	return new QSize(static_cast<const VirtualQTabWidget*>(self)->QTabWidget::minimumSizeHint());
}
...
int QTabWidget_virtualbase_heightForWidth(const void* self, int width) {
	return static_cast<const VirtualQTabWidget*>(self)->QTabWidget::heightForWidth(static_cast<int>(width));
}
...
bool QTabWidget_virtualbase_hasHeightForWidth(const void* self) {
	return static_cast<const VirtualQTabWidget*>(self)->QTabWidget::hasHeightForWidth();
}
...
void QTabWidget_virtualbase_tabInserted(void* self, int index) {
	static_cast<VirtualQTabWidget*>(self)->QTabWidget::tabInserted(static_cast<int>(index));
}
...
void QTabWidget_virtualbase_tabRemoved(void* self, int index) {
	static_cast<VirtualQTabWidget*>(self)->QTabWidget::tabRemoved(static_cast<int>(index));
}
...
void QTabWidget_virtualbase_showEvent(void* self, QShowEvent* param1) {
	static_cast<VirtualQTabWidget*>(self)->QTabWidget::showEvent(param1);
}
...
void QTabWidget_virtualbase_resizeEvent(void* self, QResizeEvent* param1) {
	static_cast<VirtualQTabWidget*>(self)->QTabWidget::resizeEvent(param1);
}
...
void QTabWidget_virtualbase_keyPressEvent(void* self, QKeyEvent* param1) {
	static_cast<VirtualQTabWidget*>(self)->QTabWidget::keyPressEvent(param1);
}
...
void QTabWidget_virtualbase_paintEvent(void* self, QPaintEvent* param1) {
	static_cast<VirtualQTabWidget*>(self)->QTabWidget::paintEvent(param1);
}
...
void QTabWidget_virtualbase_changeEvent(void* self, QEvent* param1) {
	static_cast<VirtualQTabWidget*>(self)->QTabWidget::changeEvent(param1);
}
...
bool QTabWidget_virtualbase_event(void* self, QEvent* param1) {
	return static_cast<VirtualQTabWidget*>(self)->QTabWidget::event(param1);
}
...
int QTabWidget_virtualbase_devType(const void* self) {
	return static_cast<const VirtualQTabWidget*>(self)->QTabWidget::devType();
}
...
void QTabWidget_virtualbase_setVisible(void* self, bool visible) {
	static_cast<VirtualQTabWidget*>(self)->QTabWidget::setVisible(visible);
}
...
QPaintEngine* QTabWidget_virtualbase_paintEngine(const void* self) {
	return static_cast<const VirtualQTabWidget*>(self)->QTabWidget::paintEngine();
}
...
void QTabWidget_virtualbase_mousePressEvent(void* self, QMouseEvent* event) {
	static_cast<VirtualQTabWidget*>(self)->QTabWidget::mousePressEvent(event);
}
...
void QTabWidget_virtualbase_mouseReleaseEvent(void* self, QMouseEvent* event) {
	static_cast<VirtualQTabWidget*>(self)->QTabWidget::mouseReleaseEvent(event);
}
...
void QTabWidget_virtualbase_mouseDoubleClickEvent(void* self, QMouseEvent* event) {
	static_cast<VirtualQTabWidget*>(self)->QTabWidget::mouseDoubleClickEvent(event);
}
...
void QTabWidget_virtualbase_mouseMoveEvent(void* self, QMouseEvent* event) {
	static_cast<VirtualQTabWidget*>(self)->QTabWidget::mouseMoveEvent(event);
}
...
void QTabWidget_virtualbase_wheelEvent(void* self, QWheelEvent* event) {
	static_cast<VirtualQTabWidget*>(self)->QTabWidget::wheelEvent(event);
}
...
void QTabWidget_virtualbase_keyReleaseEvent(void* self, QKeyEvent* event) {
	static_cast<VirtualQTabWidget*>(self)->QTabWidget::keyReleaseEvent(event);
}
...
void QTabWidget_virtualbase_focusInEvent(void* self, QFocusEvent* event) {
	static_cast<VirtualQTabWidget*>(self)->QTabWidget::focusInEvent(event);
}
...
void QTabWidget_virtualbase_focusOutEvent(void* self, QFocusEvent* event) {
	static_cast<VirtualQTabWidget*>(self)->QTabWidget::focusOutEvent(event);
}
...
void QTabWidget_virtualbase_enterEvent(void* self, QEvent* event) {
	static_cast<VirtualQTabWidget*>(self)->QTabWidget::enterEvent(event);
}
...
void QTabWidget_virtualbase_leaveEvent(void* self, QEvent* event) {
	static_cast<VirtualQTabWidget*>(self)->QTabWidget::leaveEvent(event);
}
...
void QTabWidget_virtualbase_moveEvent(void* self, QMoveEvent* event) {
	static_cast<VirtualQTabWidget*>(self)->QTabWidget::moveEvent(event);
}
...
void QTabWidget_virtualbase_closeEvent(void* self, QCloseEvent* event) {
	static_cast<VirtualQTabWidget*>(self)->QTabWidget::closeEvent(event);
}
...
void QTabWidget_virtualbase_contextMenuEvent(void* self, QContextMenuEvent* event) {
	static_cast<VirtualQTabWidget*>(self)->QTabWidget::contextMenuEvent(event);
}
...
void QTabWidget_virtualbase_tabletEvent(void* self, QTabletEvent* event) {
	static_cast<VirtualQTabWidget*>(self)->QTabWidget::tabletEvent(event);
}
...
void QTabWidget_virtualbase_actionEvent(void* self, QActionEvent* event) {
	static_cast<VirtualQTabWidget*>(self)->QTabWidget::actionEvent(event);
}
...
void QTabWidget_virtualbase_dragEnterEvent(void* self, QDragEnterEvent* event) {
	static_cast<VirtualQTabWidget*>(self)->QTabWidget::dragEnterEvent(event);
}
...
void QTabWidget_virtualbase_dragMoveEvent(void* self, QDragMoveEvent* event) {
	static_cast<VirtualQTabWidget*>(self)->QTabWidget::dragMoveEvent(event);
}
...
void QTabWidget_virtualbase_dragLeaveEvent(void* self, QDragLeaveEvent* event) {
	static_cast<VirtualQTabWidget*>(self)->QTabWidget::dragLeaveEvent(event);
}
...
void QTabWidget_virtualbase_dropEvent(void* self, QDropEvent* event) {
	static_cast<VirtualQTabWidget*>(self)->QTabWidget::dropEvent(event);
}
...
void QTabWidget_virtualbase_hideEvent(void* self, QHideEvent* event) {
	static_cast<VirtualQTabWidget*>(self)->QTabWidget::hideEvent(event);
}
...
bool QTabWidget_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, long* result) {
	QByteArray eventType_QByteArray(eventType.data, eventType.len);
	return static_cast<VirtualQTabWidget*>(self)->QTabWidget::nativeEvent(eventType_QByteArray, message, static_cast<long*>(result));
}
...
int QTabWidget_virtualbase_metric(const void* self, int param1) {
	return static_cast<const VirtualQTabWidget*>(self)->QTabWidget::metric(static_cast<VirtualQTabWidget::PaintDeviceMetric>(param1));
}
...
void QTabWidget_virtualbase_initPainter(const void* self, QPainter* painter) {
	static_cast<const VirtualQTabWidget*>(self)->QTabWidget::initPainter(painter);
}
...
QPaintDevice* QTabWidget_virtualbase_redirected(const void* self, QPoint* offset) {
	return static_cast<const VirtualQTabWidget*>(self)->QTabWidget::redirected(offset);
}
...
QPainter* QTabWidget_virtualbase_sharedPainter(const void* self) {
	return static_cast<const VirtualQTabWidget*>(self)->QTabWidget::sharedPainter();
}
...
void QTabWidget_virtualbase_inputMethodEvent(void* self, QInputMethodEvent* param1) {
	static_cast<VirtualQTabWidget*>(self)->QTabWidget::inputMethodEvent(param1);
}
...
QVariant* QTabWidget_virtualbase_inputMethodQuery(const void* self, int param1) {
	return new QVariant(static_cast<const VirtualQTabWidget*>(self)->QTabWidget::inputMethodQuery(static_cast<Qt::InputMethodQuery>(param1)));
}
...
bool QTabWidget_virtualbase_focusNextPrevChild(void* self, bool next) {
	return static_cast<VirtualQTabWidget*>(self)->QTabWidget::focusNextPrevChild(next);
}
...
bool QTabWidget_virtualbase_eventFilter(void* self, QObject* watched, QEvent* event) {
	return static_cast<VirtualQTabWidget*>(self)->QTabWidget::eventFilter(watched, event);
}
...
void QTabWidget_virtualbase_timerEvent(void* self, QTimerEvent* event) {
	static_cast<VirtualQTabWidget*>(self)->QTabWidget::timerEvent(event);
}
...
void QTabWidget_virtualbase_childEvent(void* self, QChildEvent* event) {
	static_cast<VirtualQTabWidget*>(self)->QTabWidget::childEvent(event);
}
...
void QTabWidget_virtualbase_customEvent(void* self, QEvent* event) {
	static_cast<VirtualQTabWidget*>(self)->QTabWidget::customEvent(event);
}
...
void QTabWidget_virtualbase_connectNotify(void* self, QMetaMethod* signal) {
	static_cast<VirtualQTabWidget*>(self)->QTabWidget::connectNotify(*signal);
}
...
void QTabWidget_virtualbase_disconnectNotify(void* self, QMetaMethod* signal) {
	static_cast<VirtualQTabWidget*>(self)->QTabWidget::disconnectNotify(*signal);
}
