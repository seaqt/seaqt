...
bool miqt_exec_callback_QTabWidget_nativeEvent(QTabWidget*, intptr_t, struct seaqt_string, void*, intptr_t*);
...
public:
	...
	friend bool QTabWidget_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, intptr_t* result);
...
void QTabWidget_virtualbase_initStyleOption(const void* self, QStyleOptionTabWidgetFrame* option) {
	static_cast<const VirtualQTabWidget*>(self)->QTabWidget::initStyleOption(option);
}
...
bool QTabWidget_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, intptr_t* result) {
	QByteArray eventType_QByteArray(eventType.data, eventType.len);
	return static_cast<VirtualQTabWidget*>(self)->QTabWidget::nativeEvent(eventType_QByteArray, message, (qintptr*)(result));
}
