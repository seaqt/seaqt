...
public:
	...
	friend double QTabWidget_protectedbase_getDecodedMetricF(const VirtualQTabWidget* self, int metricA, int metricB);
};
...
double QTabWidget_protectedbase_getDecodedMetricF(const VirtualQTabWidget* self, int metricA, int metricB) {
	return self->QTabWidget::getDecodedMetricF(static_cast<VirtualQTabWidget::PaintDeviceMetric>(metricA), static_cast<VirtualQTabWidget::PaintDeviceMetric>(metricB));
}
