...
struct QTabWidget_VTable {
	void (*destructor)(struct QTabWidget_VTable* vtbl, QTabWidget* self);
	QMetaObject* (*metaObject)(struct QTabWidget_VTable* vtbl, const QTabWidget* self);
	void* (*metacast)(struct QTabWidget_VTable* vtbl, QTabWidget* self, const char* param1);
	int (*metacall)(struct QTabWidget_VTable* vtbl, QTabWidget* self, int param1, int param2, void** param3);
	QSize* (*sizeHint)(struct QTabWidget_VTable* vtbl, const QTabWidget* self);
	QSize* (*minimumSizeHint)(struct QTabWidget_VTable* vtbl, const QTabWidget* self);
	int (*heightForWidth)(struct QTabWidget_VTable* vtbl, const QTabWidget* self, int width);
	bool (*hasHeightForWidth)(struct QTabWidget_VTable* vtbl, const QTabWidget* self);
	void (*tabInserted)(struct QTabWidget_VTable* vtbl, QTabWidget* self, int index);
	void (*tabRemoved)(struct QTabWidget_VTable* vtbl, QTabWidget* self, int index);
	void (*showEvent)(struct QTabWidget_VTable* vtbl, QTabWidget* self, QShowEvent* param1);
	void (*resizeEvent)(struct QTabWidget_VTable* vtbl, QTabWidget* self, QResizeEvent* param1);
	void (*keyPressEvent)(struct QTabWidget_VTable* vtbl, QTabWidget* self, QKeyEvent* param1);
	void (*paintEvent)(struct QTabWidget_VTable* vtbl, QTabWidget* self, QPaintEvent* param1);
	void (*changeEvent)(struct QTabWidget_VTable* vtbl, QTabWidget* self, QEvent* param1);
	bool (*event)(struct QTabWidget_VTable* vtbl, QTabWidget* self, QEvent* param1);
	void (*initStyleOption)(struct QTabWidget_VTable* vtbl, const QTabWidget* self, QStyleOptionTabWidgetFrame* option);
	int (*devType)(struct QTabWidget_VTable* vtbl, const QTabWidget* self);
	void (*setVisible)(struct QTabWidget_VTable* vtbl, QTabWidget* self, bool visible);
	QPaintEngine* (*paintEngine)(struct QTabWidget_VTable* vtbl, const QTabWidget* self);
	void (*mousePressEvent)(struct QTabWidget_VTable* vtbl, QTabWidget* self, QMouseEvent* event);
	void (*mouseReleaseEvent)(struct QTabWidget_VTable* vtbl, QTabWidget* self, QMouseEvent* event);
	void (*mouseDoubleClickEvent)(struct QTabWidget_VTable* vtbl, QTabWidget* self, QMouseEvent* event);
	void (*mouseMoveEvent)(struct QTabWidget_VTable* vtbl, QTabWidget* self, QMouseEvent* event);
	void (*wheelEvent)(struct QTabWidget_VTable* vtbl, QTabWidget* self, QWheelEvent* event);
	void (*keyReleaseEvent)(struct QTabWidget_VTable* vtbl, QTabWidget* self, QKeyEvent* event);
	void (*focusInEvent)(struct QTabWidget_VTable* vtbl, QTabWidget* self, QFocusEvent* event);
	void (*focusOutEvent)(struct QTabWidget_VTable* vtbl, QTabWidget* self, QFocusEvent* event);
	void (*enterEvent)(struct QTabWidget_VTable* vtbl, QTabWidget* self, QEnterEvent* event);
	void (*leaveEvent)(struct QTabWidget_VTable* vtbl, QTabWidget* self, QEvent* event);
	void (*moveEvent)(struct QTabWidget_VTable* vtbl, QTabWidget* self, QMoveEvent* event);
	void (*closeEvent)(struct QTabWidget_VTable* vtbl, QTabWidget* self, QCloseEvent* event);
	void (*contextMenuEvent)(struct QTabWidget_VTable* vtbl, QTabWidget* self, QContextMenuEvent* event);
	void (*tabletEvent)(struct QTabWidget_VTable* vtbl, QTabWidget* self, QTabletEvent* event);
	void (*actionEvent)(struct QTabWidget_VTable* vtbl, QTabWidget* self, QActionEvent* event);
	void (*dragEnterEvent)(struct QTabWidget_VTable* vtbl, QTabWidget* self, QDragEnterEvent* event);
	void (*dragMoveEvent)(struct QTabWidget_VTable* vtbl, QTabWidget* self, QDragMoveEvent* event);
	void (*dragLeaveEvent)(struct QTabWidget_VTable* vtbl, QTabWidget* self, QDragLeaveEvent* event);
	void (*dropEvent)(struct QTabWidget_VTable* vtbl, QTabWidget* self, QDropEvent* event);
	void (*hideEvent)(struct QTabWidget_VTable* vtbl, QTabWidget* self, QHideEvent* event);
	bool (*nativeEvent)(struct QTabWidget_VTable* vtbl, QTabWidget* self, struct miqt_string eventType, void* message, intptr_t* result);
	int (*metric)(struct QTabWidget_VTable* vtbl, const QTabWidget* self, int param1);
	void (*initPainter)(struct QTabWidget_VTable* vtbl, const QTabWidget* self, QPainter* painter);
	QPaintDevice* (*redirected)(struct QTabWidget_VTable* vtbl, const QTabWidget* self, QPoint* offset);
	QPainter* (*sharedPainter)(struct QTabWidget_VTable* vtbl, const QTabWidget* self);
	void (*inputMethodEvent)(struct QTabWidget_VTable* vtbl, QTabWidget* self, QInputMethodEvent* param1);
	QVariant* (*inputMethodQuery)(struct QTabWidget_VTable* vtbl, const QTabWidget* self, int param1);
	bool (*focusNextPrevChild)(struct QTabWidget_VTable* vtbl, QTabWidget* self, bool next);
	bool (*eventFilter)(struct QTabWidget_VTable* vtbl, QTabWidget* self, QObject* watched, QEvent* event);
	void (*timerEvent)(struct QTabWidget_VTable* vtbl, QTabWidget* self, QTimerEvent* event);
	void (*childEvent)(struct QTabWidget_VTable* vtbl, QTabWidget* self, QChildEvent* event);
	void (*customEvent)(struct QTabWidget_VTable* vtbl, QTabWidget* self, QEvent* event);
	void (*connectNotify)(struct QTabWidget_VTable* vtbl, QTabWidget* self, QMetaMethod* signal);
	void (*disconnectNotify)(struct QTabWidget_VTable* vtbl, QTabWidget* self, QMetaMethod* signal);
};
