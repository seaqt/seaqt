...
typedef struct QTabWidget_VTable{
	...
	void (*enterEvent)(VirtualQTabWidget* self, QEvent* event);
	...
	bool (*nativeEvent)(VirtualQTabWidget* self, struct seaqt_string eventType, void* message, long* result);
...
VirtualQTabWidget* QTabWidget_new(const QTabWidget_VTable* vtbl, size_t vdata, QWidget* parent);
VirtualQTabWidget* QTabWidget_new2(const QTabWidget_VTable* vtbl, size_t vdata);
...
bool QTabWidget_virtualbase_nativeEvent(VirtualQTabWidget* self, struct seaqt_string eventType, void* message, long* result);
