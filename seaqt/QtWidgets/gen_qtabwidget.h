...
struct QTabWidget_VTable {
	...
	void (*enterEvent)(struct QTabWidget_VTable* vtbl, QTabWidget* self, QEvent* event);
	...
	bool (*nativeEvent)(struct QTabWidget_VTable* vtbl, QTabWidget* self, struct miqt_string eventType, void* message, long* result);
