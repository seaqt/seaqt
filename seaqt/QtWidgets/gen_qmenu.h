...
VirtualQMenu* QMenu_new2(const QMenu_VTable* vtbl, size_t vdata, struct seaqt_string title);
VirtualQMenu* QMenu_new3(const QMenu_VTable* vtbl, size_t vdata, QWidget* parent);
