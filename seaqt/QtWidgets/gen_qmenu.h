...
typedef struct QMenu_VTable{
	...
	void (*enterEvent)(VirtualQMenu* self, QEnterEvent* param1);
	...
	void (*initStyleOption)(const VirtualQMenu* self, QStyleOptionMenuItem* option, QAction* action);
	...
	bool (*nativeEvent)(VirtualQMenu* self, struct seaqt_string eventType, void* message, intptr_t* result);
