...
struct QComboBox_VTable {
	...
	void (*enterEvent)(struct QComboBox_VTable* vtbl, QComboBox* self, QEvent* event);
	...
	bool (*nativeEvent)(struct QComboBox_VTable* vtbl, QComboBox* self, struct miqt_string eventType, void* message, long* result);
