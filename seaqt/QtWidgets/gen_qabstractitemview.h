...
typedef struct QAbstractItemView_VTable{
	...
	QAbstractItemDelegate* (*itemDelegateForIndex)(const VirtualQAbstractItemView* self, QModelIndex* index);
	...
	void (*initStyleOption)(const VirtualQAbstractItemView* self, QStyleOptionFrame* option);
	...
	void (*enterEvent)(VirtualQAbstractItemView* self, QEnterEvent* event);
	...
	bool (*nativeEvent)(VirtualQAbstractItemView* self, struct seaqt_string eventType, void* message, intptr_t* result);
