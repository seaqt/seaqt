...
struct QAbstractItemView_VTable {
	...
	QStyleOptionViewItem* (*viewOptions)(struct QAbstractItemView_VTable* vtbl, const QAbstractItemView* self);
	...
	void (*enterEvent)(struct QAbstractItemView_VTable* vtbl, QAbstractItemView* self, QEvent* event);
	...
	bool (*nativeEvent)(struct QAbstractItemView_VTable* vtbl, QAbstractItemView* self, struct miqt_string eventType, void* message, long* result);
