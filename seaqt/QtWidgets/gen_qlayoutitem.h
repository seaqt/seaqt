...
typedef struct QLayoutItem_VTable{
	...
	QWidget* (*widget)(VirtualQLayoutItem* self);
...
typedef struct QSpacerItem_VTable{
	...
	QWidget* (*widget)(VirtualQSpacerItem* self);
...
typedef struct QWidgetItem_VTable{
	...
	QWidget* (*widget)(VirtualQWidgetItem* self);
...
typedef struct QWidgetItemV2_VTable{
	...
	QWidget* (*widget)(VirtualQWidgetItemV2* self);
