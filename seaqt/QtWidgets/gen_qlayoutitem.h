...
struct QLayoutItem_VTable {
	...
	QWidget* (*widget)(struct QLayoutItem_VTable* vtbl, const QLayoutItem* self);
...
struct QSpacerItem_VTable {
	...
	QWidget* (*widget)(struct QSpacerItem_VTable* vtbl, const QSpacerItem* self);
...
struct QWidgetItem_VTable {
	...
	QWidget* (*widget)(struct QWidgetItem_VTable* vtbl, const QWidgetItem* self);
...
struct QWidgetItemV2_VTable {
	...
	QWidget* (*widget)(struct QWidgetItemV2_VTable* vtbl, const QWidgetItemV2* self);
