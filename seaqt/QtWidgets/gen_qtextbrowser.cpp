...
bool miqt_exec_callback_QTextBrowser_nativeEvent(QTextBrowser*, intptr_t, struct seaqt_string, void*, intptr_t*);
...
public:
	...
	friend bool QTextBrowser_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, intptr_t* result);
...
void QTextBrowser_virtualbase_doSetSource(void* self, QUrl* name, int type) {
	static_cast<VirtualQTextBrowser*>(self)->QTextBrowser::doSetSource(*name, static_cast<QTextDocument::ResourceType>(type));
}
...
void QTextBrowser_virtualbase_initStyleOption(const void* self, QStyleOptionFrame* option) {
	static_cast<const VirtualQTextBrowser*>(self)->QTextBrowser::initStyleOption(option);
}
...
bool QTextBrowser_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, intptr_t* result) {
	QByteArray eventType_QByteArray(eventType.data, eventType.len);
	return static_cast<VirtualQTextBrowser*>(self)->QTextBrowser::nativeEvent(eventType_QByteArray, message, (qintptr*)(result));
}
