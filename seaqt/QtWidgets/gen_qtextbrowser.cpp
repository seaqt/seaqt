...
public:
	...
	virtual void doSetSource(const QUrl& name, QTextDocument::ResourceType type) override {
		...
		vtbl->doSetSource(this, sigval1, sigval2);
	}
	...
	friend void QTextBrowser_virtualbase_initStyleOption(const VirtualQTextBrowser* self, QStyleOptionFrame* option);
	...
	friend void QTextBrowser_virtualbase_enterEvent(VirtualQTextBrowser* self, QEnterEvent* event);
	...
	friend bool QTextBrowser_virtualbase_nativeEvent(VirtualQTextBrowser* self, struct seaqt_string eventType, void* message, intptr_t* result);
	...
	friend double QTextBrowser_protectedbase_getDecodedMetricF(const VirtualQTextBrowser* self, int metricA, int metricB);
};
...
bool QTextBrowser_virtualbase_nativeEvent(VirtualQTextBrowser* self, struct seaqt_string eventType, void* message, intptr_t* result) {
	...
	return self->QTextBrowser::nativeEvent(eventType_QByteArray, message, (qintptr*)(result));
}
...
double QTextBrowser_protectedbase_getDecodedMetricF(const VirtualQTextBrowser* self, int metricA, int metricB) {
	return self->QTextBrowser::getDecodedMetricF(static_cast<VirtualQTextBrowser::PaintDeviceMetric>(metricA), static_cast<VirtualQTextBrowser::PaintDeviceMetric>(metricB));
}
