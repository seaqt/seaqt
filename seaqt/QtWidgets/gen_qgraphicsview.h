...
struct QGraphicsView_VTable {
	...
	void (*initStyleOption)(struct QGraphicsView_VTable* vtbl, const QGraphicsView* self, QStyleOptionFrame* option);
	...
	void (*enterEvent)(struct QGraphicsView_VTable* vtbl, QGraphicsView* self, QEnterEvent* event);
	...
	bool (*nativeEvent)(struct QGraphicsView_VTable* vtbl, QGraphicsView* self, struct miqt_string eventType, void* message, intptr_t* result);
