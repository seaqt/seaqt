...
typedef struct QGraphicsView_VTable{
	...
	void (*enterEvent)(VirtualQGraphicsView* self, QEvent* event);
	...
	bool (*nativeEvent)(VirtualQGraphicsView* self, struct seaqt_string eventType, void* message, long* result);
