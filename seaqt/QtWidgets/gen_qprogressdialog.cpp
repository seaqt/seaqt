...
bool miqt_exec_callback_QProgressDialog_nativeEvent(QProgressDialog*, intptr_t, struct seaqt_string, void*, long*);
...
public:
	...
	friend bool QProgressDialog_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, long* result);
...
bool QProgressDialog_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, long* result) {
	QByteArray eventType_QByteArray(eventType.data, eventType.len);
	return static_cast<VirtualQProgressDialog*>(self)->QProgressDialog::nativeEvent(eventType_QByteArray, message, static_cast<long*>(result));
}
