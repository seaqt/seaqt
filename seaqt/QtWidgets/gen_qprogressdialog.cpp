...
public:
	...
	friend bool QProgressDialog_virtualbase_nativeEvent(VirtualQProgressDialog* self, struct seaqt_string eventType, void* message, intptr_t* result);
	...
	friend double QProgressDialog_protectedbase_getDecodedMetricF(const VirtualQProgressDialog* self, int metricA, int metricB);
};
...
double QProgressDialog_protectedbase_getDecodedMetricF(const VirtualQProgressDialog* self, int metricA, int metricB) {
	return self->QProgressDialog::getDecodedMetricF(static_cast<VirtualQProgressDialog::PaintDeviceMetric>(metricA), static_cast<VirtualQProgressDialog::PaintDeviceMetric>(metricB));
}
