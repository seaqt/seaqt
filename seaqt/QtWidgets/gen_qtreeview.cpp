...
public:
	...
	friend void QTreeView_protectedbase_setHorizontalStepsPerItem(void* self, int steps);
	friend int QTreeView_protectedbase_horizontalStepsPerItem(const void* self);
	friend void QTreeView_protectedbase_setVerticalStepsPerItem(void* self, int steps);
	friend int QTreeView_protectedbase_verticalStepsPerItem(const void* self);
	...
	friend void QTreeView_protectedbase_initStyleOption(const void* self, QStyleOptionFrame* option);
...
QStyleOptionViewItem* QTreeView_virtualbase_viewOptions(const void* self) {
	...
	return new QStyleOptionViewItem(( (const VirtualQTreeView*)(self) )->QTreeView::viewOptions());
...
void QTreeView_virtualbase_changeEvent(void* self, QEvent* param1) {
	...
	( (VirtualQTreeView*)(self) )->QTreeView::changeEvent(param1);
...
bool QTreeView_virtualbase_nativeEvent(void* self, struct miqt_string eventType, void* message, long* result) {
	...
	return ( (VirtualQTreeView*)(self) )->QTreeView::nativeEvent(eventType_QByteArray, message, static_cast<long*>(result));
...
void QTreeView_protectedbase_setHorizontalStepsPerItem(void* self, int steps) {
	VirtualQTreeView* self_cast = static_cast<VirtualQTreeView*>( (QTreeView*)(self) );
...
int QTreeView_protectedbase_horizontalStepsPerItem(const void* self) {
	VirtualQTreeView* self_cast = static_cast<VirtualQTreeView*>( (QTreeView*)(self) );
...
void QTreeView_protectedbase_setVerticalStepsPerItem(void* self, int steps) {
	VirtualQTreeView* self_cast = static_cast<VirtualQTreeView*>( (QTreeView*)(self) );
...
int QTreeView_protectedbase_verticalStepsPerItem(const void* self) {
	VirtualQTreeView* self_cast = static_cast<VirtualQTreeView*>( (QTreeView*)(self) );
...
void QTreeView_protectedbase_initStyleOption(const void* self, QStyleOptionFrame* option) {
	VirtualQTreeView* self_cast = static_cast<VirtualQTreeView*>( (QTreeView*)(self) );
