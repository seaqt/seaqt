...
public:
	...
	friend QStyleOptionViewItem* QTreeView_virtualbase_viewOptions(const VirtualQTreeView* self);
	...
	friend void QTreeView_virtualbase_changeEvent(VirtualQTreeView* self, QEvent* param1);
	...
	friend void QTreeView_virtualbase_enterEvent(VirtualQTreeView* self, QEvent* event);
	...
	friend bool QTreeView_virtualbase_nativeEvent(VirtualQTreeView* self, struct seaqt_string eventType, void* message, long* result);
	...
	friend void QTreeView_protectedbase_setHorizontalStepsPerItem(VirtualQTreeView* self, int steps);
	friend int QTreeView_protectedbase_horizontalStepsPerItem(const VirtualQTreeView* self);
	friend void QTreeView_protectedbase_setVerticalStepsPerItem(VirtualQTreeView* self, int steps);
	friend int QTreeView_protectedbase_verticalStepsPerItem(const VirtualQTreeView* self);
	...
	friend void QTreeView_protectedbase_initStyleOption(const VirtualQTreeView* self, QStyleOptionFrame* option);
...
void QTreeView_connect_expanded(QTreeView* self, intptr_t slot, void (*callback)(intptr_t, QModelIndex*), void (*release)(intptr_t)) {
	QTreeView::connect(self, static_cast<void (QTreeView::*)(const QModelIndex&)>(&QTreeView::expanded), self, [callback, release = seaqt::release_callback{slot,release}](const QModelIndex& index) {
			const QModelIndex& index_ret = index;
			// Cast returned reference into pointer
			QModelIndex* sigval1 = const_cast<QModelIndex*>(&index_ret);
...
void QTreeView_connect_collapsed(QTreeView* self, intptr_t slot, void (*callback)(intptr_t, QModelIndex*), void (*release)(intptr_t)) {
	QTreeView::connect(self, static_cast<void (QTreeView::*)(const QModelIndex&)>(&QTreeView::collapsed), self, [callback, release = seaqt::release_callback{slot,release}](const QModelIndex& index) {
			const QModelIndex& index_ret = index;
			// Cast returned reference into pointer
			QModelIndex* sigval1 = const_cast<QModelIndex*>(&index_ret);
			callback(release.slot, sigval1);
...
QStyleOptionViewItem* QTreeView_virtualbase_viewOptions(const VirtualQTreeView* self) {
	...
	return new QStyleOptionViewItem(self->QTreeView::viewOptions());
}
...
void QTreeView_virtualbase_changeEvent(VirtualQTreeView* self, QEvent* param1) {
	...
	self->QTreeView::changeEvent(param1);
}
...
bool QTreeView_virtualbase_nativeEvent(VirtualQTreeView* self, struct seaqt_string eventType, void* message, long* result) {
	...
	return self->QTreeView::nativeEvent(eventType_QByteArray, message, static_cast<long*>(result));
}
