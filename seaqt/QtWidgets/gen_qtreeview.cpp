...
bool miqt_exec_callback_QTreeView_nativeEvent(QTreeView*, intptr_t, struct seaqt_string, void*, intptr_t*);
...
public:
	...
	friend bool QTreeView_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, intptr_t* result);
...
void QTreeView_virtualbase_changeEvent(void* self, QEvent* event) {
	static_cast<VirtualQTreeView*>(self)->QTreeView::changeEvent(event);
}
...
QAbstractItemDelegate* QTreeView_virtualbase_itemDelegateForIndex(const void* self, QModelIndex* index) {
	return static_cast<const VirtualQTreeView*>(self)->QTreeView::itemDelegateForIndex(*index);
}
...
void QTreeView_virtualbase_initViewItemOption(const void* self, QStyleOptionViewItem* option) {
	static_cast<const VirtualQTreeView*>(self)->QTreeView::initViewItemOption(option);
}
...
void QTreeView_virtualbase_initStyleOption(const void* self, QStyleOptionFrame* option) {
	static_cast<const VirtualQTreeView*>(self)->QTreeView::initStyleOption(option);
}
...
bool QTreeView_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, intptr_t* result) {
	QByteArray eventType_QByteArray(eventType.data, eventType.len);
	return static_cast<VirtualQTreeView*>(self)->QTreeView::nativeEvent(eventType_QByteArray, message, (qintptr*)(result));
}
