...
public:
	...
	friend double QTreeView_protectedbase_getDecodedMetricF(const VirtualQTreeView* self, int metricA, int metricB);
};
...
double QTreeView_protectedbase_getDecodedMetricF(const VirtualQTreeView* self, int metricA, int metricB) {
	return self->QTreeView::getDecodedMetricF(static_cast<VirtualQTreeView::PaintDeviceMetric>(metricA), static_cast<VirtualQTreeView::PaintDeviceMetric>(metricB));
}
