...
struct QGroupBox_VTable {
	...
	void (*initStyleOption)(struct QGroupBox_VTable* vtbl, const QGroupBox* self, QStyleOptionGroupBox* option);
	...
	void (*enterEvent)(struct QGroupBox_VTable* vtbl, QGroupBox* self, QEnterEvent* event);
	...
	bool (*nativeEvent)(struct QGroupBox_VTable* vtbl, QGroupBox* self, struct miqt_string eventType, void* message, intptr_t* result);
