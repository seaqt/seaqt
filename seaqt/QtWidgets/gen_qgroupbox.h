...
typedef struct QGroupBox_VTable{
	...
	void (*initStyleOption)(const VirtualQGroupBox* self, QStyleOptionGroupBox* option);
	...
	void (*enterEvent)(VirtualQGroupBox* self, QEnterEvent* event);
	...
	bool (*nativeEvent)(VirtualQGroupBox* self, struct seaqt_string eventType, void* message, intptr_t* result);
