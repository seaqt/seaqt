...
public:
	...
	friend double QComboBox_protectedbase_getDecodedMetricF(const VirtualQComboBox* self, int metricA, int metricB);
};
...
int QComboBox_labelDrawingMode(const QComboBox* self) {
	QComboBox::LabelDrawingMode _ret = self->labelDrawingMode();
	return static_cast<int>(_ret);
}

void QComboBox_setLabelDrawingMode(QComboBox* self, int labelDrawing) {
	self->setLabelDrawingMode(static_cast<QComboBox::LabelDrawingMode>(labelDrawing));
}
...
double QComboBox_protectedbase_getDecodedMetricF(const VirtualQComboBox* self, int metricA, int metricB) {
	return self->QComboBox::getDecodedMetricF(static_cast<VirtualQComboBox::PaintDeviceMetric>(metricA), static_cast<VirtualQComboBox::PaintDeviceMetric>(metricB));
}
