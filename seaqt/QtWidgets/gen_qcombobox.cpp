...
bool miqt_exec_callback_QComboBox_nativeEvent(QComboBox*, intptr_t, struct seaqt_string, void*, intptr_t*);
...
public:
	...
	friend bool QComboBox_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, intptr_t* result);
...
void QComboBox_virtualbase_setModel(void* self, QAbstractItemModel* model) {
	static_cast<VirtualQComboBox*>(self)->QComboBox::setModel(model);
}
...
void QComboBox_virtualbase_initStyleOption(const void* self, QStyleOptionComboBox* option) {
	static_cast<const VirtualQComboBox*>(self)->QComboBox::initStyleOption(option);
}
...
bool QComboBox_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, intptr_t* result) {
	QByteArray eventType_QByteArray(eventType.data, eventType.len);
	return static_cast<VirtualQComboBox*>(self)->QComboBox::nativeEvent(eventType_QByteArray, message, (qintptr*)(result));
}
