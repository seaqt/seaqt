...
typedef struct QMdiSubWindow_VTable{
	...
	void (*enterEvent)(VirtualQMdiSubWindow* self, QEnterEvent* event);
	...
	bool (*nativeEvent)(VirtualQMdiSubWindow* self, struct seaqt_string eventType, void* message, intptr_t* result);
