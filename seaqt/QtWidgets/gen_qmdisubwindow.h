...
struct QMdiSubWindow_VTable {
	...
	void (*enterEvent)(struct QMdiSubWindow_VTable* vtbl, QMdiSubWindow* self, QEnterEvent* event);
	...
	bool (*nativeEvent)(struct QMdiSubWindow_VTable* vtbl, QMdiSubWindow* self, struct miqt_string eventType, void* message, intptr_t* result);
