...
public:
	...
	friend void QRadioButton_virtualbase_enterEvent(VirtualQRadioButton* self, QEvent* event);
	...
	friend bool QRadioButton_virtualbase_nativeEvent(VirtualQRadioButton* self, struct seaqt_string eventType, void* message, long* result);
	...
	friend void QRadioButton_protectedbase_initStyleOption(const VirtualQRadioButton* self, QStyleOptionButton* button);
...
struct seaqt_string QRadioButton_trUtf8_s(const char* s) {
...
struct seaqt_string QRadioButton_trUtf8_s_c(const char* s, const char* c) {
...
struct seaqt_string QRadioButton_trUtf8_s_c_n(const char* s, const char* c, int n) {
...
bool QRadioButton_virtualbase_nativeEvent(VirtualQRadioButton* self, struct seaqt_string eventType, void* message, long* result) {
	...
	return self->QRadioButton::nativeEvent(eventType_QByteArray, message, static_cast<long*>(result));
}
