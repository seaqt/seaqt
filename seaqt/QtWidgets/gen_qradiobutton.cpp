...
bool miqt_exec_callback_QRadioButton_nativeEvent(QRadioButton*, intptr_t, struct seaqt_string, void*, long*);
...
public:
	...
	friend bool QRadioButton_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, long* result);
...
bool QRadioButton_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, long* result) {
	QByteArray eventType_QByteArray(eventType.data, eventType.len);
	return static_cast<VirtualQRadioButton*>(self)->QRadioButton::nativeEvent(eventType_QByteArray, message, static_cast<long*>(result));
}
