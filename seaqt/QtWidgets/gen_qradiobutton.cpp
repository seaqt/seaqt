...
public:
	...
	friend double QRadioButton_protectedbase_getDecodedMetricF(const VirtualQRadioButton* self, int metricA, int metricB);
};
...
double QRadioButton_protectedbase_getDecodedMetricF(const VirtualQRadioButton* self, int metricA, int metricB) {
	return self->QRadioButton::getDecodedMetricF(static_cast<VirtualQRadioButton::PaintDeviceMetric>(metricA), static_cast<VirtualQRadioButton::PaintDeviceMetric>(metricB));
}
