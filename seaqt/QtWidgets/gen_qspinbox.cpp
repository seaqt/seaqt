...
public:
	...
	friend void QSpinBox_virtualbase_initStyleOption(const VirtualQSpinBox* self, QStyleOptionSpinBox* option);
	...
	friend void QSpinBox_virtualbase_enterEvent(VirtualQSpinBox* self, QEnterEvent* event);
	...
	friend bool QSpinBox_virtualbase_nativeEvent(VirtualQSpinBox* self, struct seaqt_string eventType, void* message, intptr_t* result);
	...
	friend double QSpinBox_protectedbase_getDecodedMetricF(const VirtualQSpinBox* self, int metricA, int metricB);
};
...
void QSpinBox_connect_valueChanged(QSpinBox* self, intptr_t slot, void (*callback)(intptr_t, int), void (*release)(intptr_t)) {
	QSpinBox::connect(self, static_cast<void (QSpinBox::*)(int)>(&QSpinBox::valueChanged), self, [callback, release = seaqt::release_callback{slot,release}](int param1) {
			int sigval1 = param1;
...
void QSpinBox_connect_textChanged(QSpinBox* self, intptr_t slot, void (*callback)(intptr_t, struct seaqt_string), void (*release)(intptr_t)) {
	QSpinBox::connect(self, static_cast<void (QSpinBox::*)(const QString&)>(&QSpinBox::textChanged), self, [callback, release = seaqt::release_callback{slot,release}](const QString& param1) {
...
bool QSpinBox_virtualbase_nativeEvent(VirtualQSpinBox* self, struct seaqt_string eventType, void* message, intptr_t* result) {
	...
	return self->QSpinBox::nativeEvent(eventType_QByteArray, message, (qintptr*)(result));
}
...
double QSpinBox_protectedbase_getDecodedMetricF(const VirtualQSpinBox* self, int metricA, int metricB) {
	return self->QSpinBox::getDecodedMetricF(static_cast<VirtualQSpinBox::PaintDeviceMetric>(metricA), static_cast<VirtualQSpinBox::PaintDeviceMetric>(metricB));
}
...
public:
	...
	friend void QDoubleSpinBox_virtualbase_initStyleOption(const VirtualQDoubleSpinBox* self, QStyleOptionSpinBox* option);
	...
	friend void QDoubleSpinBox_virtualbase_enterEvent(VirtualQDoubleSpinBox* self, QEnterEvent* event);
	...
	friend bool QDoubleSpinBox_virtualbase_nativeEvent(VirtualQDoubleSpinBox* self, struct seaqt_string eventType, void* message, intptr_t* result);
	...
	friend double QDoubleSpinBox_protectedbase_getDecodedMetricF(const VirtualQDoubleSpinBox* self, int metricA, int metricB);
};
...
void QDoubleSpinBox_connect_valueChanged(QDoubleSpinBox* self, intptr_t slot, void (*callback)(intptr_t, double), void (*release)(intptr_t)) {
	QDoubleSpinBox::connect(self, static_cast<void (QDoubleSpinBox::*)(double)>(&QDoubleSpinBox::valueChanged), self, [callback, release = seaqt::release_callback{slot,release}](double param1) {
...
void QDoubleSpinBox_connect_textChanged(QDoubleSpinBox* self, intptr_t slot, void (*callback)(intptr_t, struct seaqt_string), void (*release)(intptr_t)) {
	QDoubleSpinBox::connect(self, static_cast<void (QDoubleSpinBox::*)(const QString&)>(&QDoubleSpinBox::textChanged), self, [callback, release = seaqt::release_callback{slot,release}](const QString& param1) {
			const QString param1_ret = param1;
			// Convert QString from UTF-16 in C++ RAII memory to UTF-8 in manually-managed C memory
			QByteArray param1_b = param1_ret.toUtf8();
			struct seaqt_string param1_ms;
...
bool QDoubleSpinBox_virtualbase_nativeEvent(VirtualQDoubleSpinBox* self, struct seaqt_string eventType, void* message, intptr_t* result) {
	...
	return self->QDoubleSpinBox::nativeEvent(eventType_QByteArray, message, (qintptr*)(result));
}
...
double QDoubleSpinBox_protectedbase_getDecodedMetricF(const VirtualQDoubleSpinBox* self, int metricA, int metricB) {
	return self->QDoubleSpinBox::getDecodedMetricF(static_cast<VirtualQDoubleSpinBox::PaintDeviceMetric>(metricA), static_cast<VirtualQDoubleSpinBox::PaintDeviceMetric>(metricB));
}
