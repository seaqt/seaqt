...
QStyleOptionHeaderV2* QStyleOptionHeaderV2_new_from(QStyleOptionHeaderV2* from) {
	return new (std::nothrow) QStyleOptionHeaderV2(*from);
}
...
void QStyleOptionHeaderV2_operatorAssign(QStyleOptionHeaderV2* self, QStyleOptionHeaderV2* from) {
	self->operator=(*from);
}
...
QStyleOptionMenuItemV2* QStyleOptionMenuItemV2_new_from(QStyleOptionMenuItemV2* from) {
	return new (std::nothrow) QStyleOptionMenuItemV2(*from);
}
...
void QStyleOptionMenuItemV2_operatorAssign(QStyleOptionMenuItemV2* self, QStyleOptionMenuItemV2* from) {
	self->operator=(*from);
}
