...
struct QProgressDialog_VTable {
	...
	void (*enterEvent)(struct QProgressDialog_VTable* vtbl, QProgressDialog* self, QEvent* event);
	...
	bool (*nativeEvent)(struct QProgressDialog_VTable* vtbl, QProgressDialog* self, struct miqt_string eventType, void* message, long* result);
