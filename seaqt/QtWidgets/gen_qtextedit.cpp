...
public:
	...
	friend bool QTextEdit_virtualbase_nativeEvent(VirtualQTextEdit* self, struct seaqt_string eventType, void* message, intptr_t* result);
	...
	friend double QTextEdit_protectedbase_getDecodedMetricF(const VirtualQTextEdit* self, int metricA, int metricB);
};
...
bool QTextEdit_virtualbase_nativeEvent(VirtualQTextEdit* self, struct seaqt_string eventType, void* message, intptr_t* result) {
...
double QTextEdit_protectedbase_getDecodedMetricF(const VirtualQTextEdit* self, int metricA, int metricB) {
	return self->QTextEdit::getDecodedMetricF(static_cast<VirtualQTextEdit::PaintDeviceMetric>(metricA), static_cast<VirtualQTextEdit::PaintDeviceMetric>(metricB));
}
