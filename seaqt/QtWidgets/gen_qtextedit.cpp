...
public:
	...
	friend void QTextEdit_protectedbase_initStyleOption(const void* self, QStyleOptionFrame* option);
...
void QTextEdit_protectedbase_initStyleOption(const void* self, QStyleOptionFrame* option) {
	VirtualQTextEdit* self_cast = static_cast<VirtualQTextEdit*>( (QTextEdit*)(self) );
