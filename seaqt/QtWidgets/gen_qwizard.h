...
struct QWizard_VTable {
	...
	void (*enterEvent)(struct QWizard_VTable* vtbl, QWizard* self, QEnterEvent* event);
	...
	bool (*nativeEvent)(struct QWizard_VTable* vtbl, QWizard* self, struct miqt_string eventType, void* message, intptr_t* result);
...
struct QWizardPage_VTable {
	...
	void (*enterEvent)(struct QWizardPage_VTable* vtbl, QWizardPage* self, QEnterEvent* event);
	...
	bool (*nativeEvent)(struct QWizardPage_VTable* vtbl, QWizardPage* self, struct miqt_string eventType, void* message, intptr_t* result);
