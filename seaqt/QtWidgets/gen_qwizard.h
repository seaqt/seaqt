...
typedef struct QWizard_VTable{
	...
	bool (*nativeEvent)(VirtualQWizard* self, struct seaqt_string eventType, void* message, intptr_t* result);
...
typedef struct QWizardPage_VTable{
	...
	bool (*nativeEvent)(VirtualQWizardPage* self, struct seaqt_string eventType, void* message, intptr_t* result);
