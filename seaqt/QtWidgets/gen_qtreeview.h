...
struct QTreeView_VTable {
	...
	QStyleOptionViewItem* (*viewOptions)(struct QTreeView_VTable* vtbl, const QTreeView* self);
	...
	void (*changeEvent)(struct QTreeView_VTable* vtbl, QTreeView* self, QEvent* param1);
	...
	void (*enterEvent)(struct QTreeView_VTable* vtbl, QTreeView* self, QEvent* event);
	...
	bool (*nativeEvent)(struct QTreeView_VTable* vtbl, QTreeView* self, struct miqt_string eventType, void* message, long* result);
