...
typedef struct QTreeView_VTable{
	...
	void (*changeEvent)(VirtualQTreeView* self, QEvent* event);
	...
	QAbstractItemDelegate* (*itemDelegateForIndex)(const VirtualQTreeView* self, QModelIndex* index);
	...
	void (*initStyleOption)(const VirtualQTreeView* self, QStyleOptionFrame* option);
	...
	void (*enterEvent)(VirtualQTreeView* self, QEnterEvent* event);
	...
	bool (*nativeEvent)(VirtualQTreeView* self, struct seaqt_string eventType, void* message, intptr_t* result);
