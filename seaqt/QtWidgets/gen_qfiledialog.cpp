...
bool miqt_exec_callback_QFileDialog_nativeEvent(QFileDialog*, intptr_t, struct seaqt_string, void*, intptr_t*);
...
public:
	...
	friend bool QFileDialog_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, intptr_t* result);
...
bool QFileDialog_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, intptr_t* result) {
	QByteArray eventType_QByteArray(eventType.data, eventType.len);
	return static_cast<VirtualQFileDialog*>(self)->QFileDialog::nativeEvent(eventType_QByteArray, message, (qintptr*)(result));
}
