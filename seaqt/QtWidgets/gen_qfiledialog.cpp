...
public:
	...
	friend bool QFileDialog_virtualbase_nativeEvent(VirtualQFileDialog* self, struct seaqt_string eventType, void* message, intptr_t* result);
	...
	friend double QFileDialog_protectedbase_getDecodedMetricF(const VirtualQFileDialog* self, int metricA, int metricB);
};
...
void QFileDialog_saveFileContent_fileContent_fileNameHint(struct seaqt_string fileContent, struct seaqt_string fileNameHint) {
...
void QFileDialog_saveFileContent_fileContent_fileNameHint_parent(struct seaqt_string fileContent, struct seaqt_string fileNameHint, QWidget* parent) {
	QByteArray fileContent_QByteArray(fileContent.data, fileContent.len);
	QString fileNameHint_QString = QString::fromUtf8(fileNameHint.data, fileNameHint.len);
...
double QFileDialog_protectedbase_getDecodedMetricF(const VirtualQFileDialog* self, int metricA, int metricB) {
	return self->QFileDialog::getDecodedMetricF(static_cast<VirtualQFileDialog::PaintDeviceMetric>(metricA), static_cast<VirtualQFileDialog::PaintDeviceMetric>(metricB));
}
