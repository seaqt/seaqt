...
VirtualQFileDialog* QFileDialog_new(const QFileDialog_VTable* vtbl, size_t vdata, QWidget* parent) {
...
VirtualQFileDialog* QFileDialog_new2(const QFileDialog_VTable* vtbl, size_t vdata, QWidget* parent, int f) {
	void* _mem_ = ::operator new(seaqt_aligned_sizeof<VirtualQFileDialog>() + vdata, std::nothrow);
	return _mem_ ? new (_mem_)VirtualQFileDialog(vtbl, parent, static_cast<Qt::WindowFlags>(f)) : nullptr;
}

VirtualQFileDialog* QFileDialog_new3(const QFileDialog_VTable* vtbl, size_t vdata) {
	void* _mem_ = ::operator new(seaqt_aligned_sizeof<VirtualQFileDialog>() + vdata, std::nothrow);
