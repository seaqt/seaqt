...
bool miqt_exec_callback_QGraphicsView_nativeEvent(QGraphicsView*, intptr_t, struct seaqt_string, void*, intptr_t*);
...
public:
	...
	friend bool QGraphicsView_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, intptr_t* result);
...
void QGraphicsView_virtualbase_initStyleOption(const void* self, QStyleOptionFrame* option) {
	static_cast<const VirtualQGraphicsView*>(self)->QGraphicsView::initStyleOption(option);
}
...
bool QGraphicsView_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, intptr_t* result) {
	QByteArray eventType_QByteArray(eventType.data, eventType.len);
	return static_cast<VirtualQGraphicsView*>(self)->QGraphicsView::nativeEvent(eventType_QByteArray, message, (qintptr*)(result));
}
