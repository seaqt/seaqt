...
public:
	...
	friend double QGraphicsView_protectedbase_getDecodedMetricF(const VirtualQGraphicsView* self, int metricA, int metricB);
};
...
double QGraphicsView_protectedbase_getDecodedMetricF(const VirtualQGraphicsView* self, int metricA, int metricB) {
	return self->QGraphicsView::getDecodedMetricF(static_cast<VirtualQGraphicsView::PaintDeviceMetric>(metricA), static_cast<VirtualQGraphicsView::PaintDeviceMetric>(metricB));
}
