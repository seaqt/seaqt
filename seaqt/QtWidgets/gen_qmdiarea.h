...
struct QMdiArea_VTable {
	...
	void (*enterEvent)(struct QMdiArea_VTable* vtbl, QMdiArea* self, QEvent* event);
	...
	bool (*nativeEvent)(struct QMdiArea_VTable* vtbl, QMdiArea* self, struct miqt_string eventType, void* message, long* result);
