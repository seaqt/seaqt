...
struct QTabBar_VTable {
	...
	void (*mouseDoubleClickEvent)(struct QTabBar_VTable* vtbl, QTabBar* self, QMouseEvent* event);
	...
	void (*enterEvent)(struct QTabBar_VTable* vtbl, QTabBar* self, QEvent* event);
	...
	bool (*nativeEvent)(struct QTabBar_VTable* vtbl, QTabBar* self, struct miqt_string eventType, void* message, long* result);
