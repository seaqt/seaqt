...
public:
	...
	friend double QFontDialog_protectedbase_getDecodedMetricF(const VirtualQFontDialog* self, int metricA, int metricB);
};
...
double QFontDialog_protectedbase_getDecodedMetricF(const VirtualQFontDialog* self, int metricA, int metricB) {
	return self->QFontDialog::getDecodedMetricF(static_cast<VirtualQFontDialog::PaintDeviceMetric>(metricA), static_cast<VirtualQFontDialog::PaintDeviceMetric>(metricB));
}
