...
void QSplitter_connect_splitterMoved(QSplitter* self, intptr_t slot) {
	VirtualQSplitter::connect(self, static_cast<void (QSplitter::*)(int, int)>(&QSplitter::splitterMoved), self, [=](int pos, int index) {
		int sigval1 = pos;
		int sigval2 = index;
...
bool QSplitter_virtualbase_nativeEvent(void* self, struct miqt_string eventType, void* message, long* result) {
	...
	return ( (VirtualQSplitter*)(self) )->QSplitter::nativeEvent(eventType_QByteArray, message, static_cast<long*>(result));
...
bool QSplitterHandle_virtualbase_nativeEvent(void* self, struct miqt_string eventType, void* message, long* result) {
	...
	return ( (VirtualQSplitterHandle*)(self) )->QSplitterHandle::nativeEvent(eventType_QByteArray, message, static_cast<long*>(result));
