...
public:
	...
	friend bool QSplitter_virtualbase_nativeEvent(VirtualQSplitter* self, struct seaqt_string eventType, void* message, intptr_t* result);
	...
	friend double QSplitter_protectedbase_getDecodedMetricF(const VirtualQSplitter* self, int metricA, int metricB);
};
...
double QSplitter_protectedbase_getDecodedMetricF(const VirtualQSplitter* self, int metricA, int metricB) {
	return self->QSplitter::getDecodedMetricF(static_cast<VirtualQSplitter::PaintDeviceMetric>(metricA), static_cast<VirtualQSplitter::PaintDeviceMetric>(metricB));
}
...
public:
	...
	friend bool QSplitterHandle_virtualbase_nativeEvent(VirtualQSplitterHandle* self, struct seaqt_string eventType, void* message, intptr_t* result);
	...
	friend double QSplitterHandle_protectedbase_getDecodedMetricF(const VirtualQSplitterHandle* self, int metricA, int metricB);
};
...
double QSplitterHandle_protectedbase_getDecodedMetricF(const VirtualQSplitterHandle* self, int metricA, int metricB) {
	return self->QSplitterHandle::getDecodedMetricF(static_cast<VirtualQSplitterHandle::PaintDeviceMetric>(metricA), static_cast<VirtualQSplitterHandle::PaintDeviceMetric>(metricB));
}
