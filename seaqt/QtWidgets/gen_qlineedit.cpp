...
bool miqt_exec_callback_QLineEdit_nativeEvent(QLineEdit*, intptr_t, struct seaqt_string, void*, long*);
...
public:
	...
	friend bool QLineEdit_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, long* result);
...
QLineEdit* QLineEdit_new2(struct seaqt_string param1) {
...
void QLineEdit_virtualbase_keyReleaseEvent(void* self, QKeyEvent* event) {
	static_cast<VirtualQLineEdit*>(self)->QLineEdit::keyReleaseEvent(event);
}
...
bool QLineEdit_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, long* result) {
	QByteArray eventType_QByteArray(eventType.data, eventType.len);
	return static_cast<VirtualQLineEdit*>(self)->QLineEdit::nativeEvent(eventType_QByteArray, message, static_cast<long*>(result));
}
...
void QLineEdit_virtualbase_timerEvent(void* self, QTimerEvent* event) {
	static_cast<VirtualQLineEdit*>(self)->QLineEdit::timerEvent(event);
}
