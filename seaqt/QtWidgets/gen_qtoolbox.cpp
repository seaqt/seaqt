...
public:
	...
	friend void QToolBox_virtualbase_enterEvent(VirtualQToolBox* self, QEvent* event);
	...
	friend bool QToolBox_virtualbase_nativeEvent(VirtualQToolBox* self, struct seaqt_string eventType, void* message, long* result);
	...
	friend void QToolBox_protectedbase_initStyleOption(const VirtualQToolBox* self, QStyleOptionFrame* option);
...
VirtualQToolBox* QToolBox_new2(const QToolBox_VTable* vtbl, size_t vdata, QWidget* parent) {
	void* _mem_ = ::operator new(seaqt_aligned_sizeof<VirtualQToolBox>() + vdata, std::nothrow);
...
bool QToolBox_virtualbase_nativeEvent(VirtualQToolBox* self, struct seaqt_string eventType, void* message, long* result) {
	...
	return self->QToolBox::nativeEvent(eventType_QByteArray, message, static_cast<long*>(result));
}
