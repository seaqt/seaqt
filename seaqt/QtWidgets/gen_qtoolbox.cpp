...
bool miqt_exec_callback_QToolBox_nativeEvent(QToolBox*, intptr_t, struct seaqt_string, void*, long*);
...
public:
	...
	friend bool QToolBox_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, long* result);
...
bool QToolBox_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, long* result) {
	QByteArray eventType_QByteArray(eventType.data, eventType.len);
	return static_cast<VirtualQToolBox*>(self)->QToolBox::nativeEvent(eventType_QByteArray, message, static_cast<long*>(result));
}
