...
struct QAbstractButton_VTable {
	...
	void (*enterEvent)(struct QAbstractButton_VTable* vtbl, QAbstractButton* self, QEnterEvent* event);
	...
	bool (*nativeEvent)(struct QAbstractButton_VTable* vtbl, QAbstractButton* self, struct miqt_string eventType, void* message, intptr_t* result);
