...
typedef struct QAbstractButton_VTable{
	...
	void (*enterEvent)(VirtualQAbstractButton* self, QEvent* event);
	...
	bool (*nativeEvent)(VirtualQAbstractButton* self, struct seaqt_string eventType, void* message, long* result);
