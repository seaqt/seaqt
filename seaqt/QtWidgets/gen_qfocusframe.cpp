...
public:
	...
	friend double QFocusFrame_protectedbase_getDecodedMetricF(const VirtualQFocusFrame* self, int metricA, int metricB);
};
...
double QFocusFrame_protectedbase_getDecodedMetricF(const VirtualQFocusFrame* self, int metricA, int metricB) {
	return self->QFocusFrame::getDecodedMetricF(static_cast<VirtualQFocusFrame::PaintDeviceMetric>(metricA), static_cast<VirtualQFocusFrame::PaintDeviceMetric>(metricB));
}
