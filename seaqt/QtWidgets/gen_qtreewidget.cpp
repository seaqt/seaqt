...
public:
	...
	friend double QTreeWidget_protectedbase_getDecodedMetricF(const VirtualQTreeWidget* self, int metricA, int metricB);
};
...
double QTreeWidget_protectedbase_getDecodedMetricF(const VirtualQTreeWidget* self, int metricA, int metricB) {
	return self->QTreeWidget::getDecodedMetricF(static_cast<VirtualQTreeWidget::PaintDeviceMetric>(metricA), static_cast<VirtualQTreeWidget::PaintDeviceMetric>(metricB));
}
