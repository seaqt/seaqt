...
bool miqt_exec_callback_QTreeWidget_nativeEvent(QTreeWidget*, intptr_t, struct seaqt_string, void*, intptr_t*);
...
public:
	...
	friend bool QTreeWidget_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, intptr_t* result);
...
void QTreeWidget_virtualbase_changeEvent(void* self, QEvent* event) {
	static_cast<VirtualQTreeWidget*>(self)->QTreeWidget::changeEvent(event);
}
...
QAbstractItemDelegate* QTreeWidget_virtualbase_itemDelegateForIndex(const void* self, QModelIndex* index) {
	return static_cast<const VirtualQTreeWidget*>(self)->QTreeWidget::itemDelegateForIndex(*index);
}
...
void QTreeWidget_virtualbase_initViewItemOption(const void* self, QStyleOptionViewItem* option) {
	static_cast<const VirtualQTreeWidget*>(self)->QTreeWidget::initViewItemOption(option);
}
...
void QTreeWidget_virtualbase_initStyleOption(const void* self, QStyleOptionFrame* option) {
	static_cast<const VirtualQTreeWidget*>(self)->QTreeWidget::initStyleOption(option);
}
...
bool QTreeWidget_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, intptr_t* result) {
	QByteArray eventType_QByteArray(eventType.data, eventType.len);
	return static_cast<VirtualQTreeWidget*>(self)->QTreeWidget::nativeEvent(eventType_QByteArray, message, (qintptr*)(result));
}
