...
public:
	...
	friend double QProgressBar_protectedbase_getDecodedMetricF(const VirtualQProgressBar* self, int metricA, int metricB);
};
...
double QProgressBar_protectedbase_getDecodedMetricF(const VirtualQProgressBar* self, int metricA, int metricB) {
	return self->QProgressBar::getDecodedMetricF(static_cast<VirtualQProgressBar::PaintDeviceMetric>(metricA), static_cast<VirtualQProgressBar::PaintDeviceMetric>(metricB));
}
