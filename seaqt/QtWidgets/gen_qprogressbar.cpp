...
struct seaqt_string miqt_exec_callback_QProgressBar_text(const QProgressBar*, intptr_t);
...
bool miqt_exec_callback_QProgressBar_nativeEvent(QProgressBar*, intptr_t, struct seaqt_string, void*, intptr_t*);
...
public:
	...
	virtual ~VirtualQProgressBar() override = default;
	...
	virtual int qt_metacall(QMetaObject::Call param1, int param2, void** param3) override {
		...
		int sigval2 = param2;
		void** sigval3 = param3;
		int callback_return_value = miqt_exec_callback_QProgressBar_metacall(this, handle__metacall, sigval1, sigval2, sigval3);
	...
	virtual QString text() const override {
		...
		struct seaqt_string callback_return_value = miqt_exec_callback_QProgressBar_text(this, handle__text);
		QString callback_return_value_QString = QString::fromUtf8(callback_return_value.data, callback_return_value.len);
		return callback_return_value_QString;
	}

	friend struct seaqt_string QProgressBar_virtualbase_text(const void* self);
	...
	friend bool QProgressBar_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, intptr_t* result);
...
QProgressBar* QProgressBar_new() {
	return new (std::nothrow) VirtualQProgressBar();
}

QProgressBar* QProgressBar_new2(QWidget* parent) {
	return new (std::nothrow) VirtualQProgressBar(parent);
}
...
QMetaObject* QProgressBar_virtualbase_metaObject(const void* self) {
	return (QMetaObject*) static_cast<const VirtualQProgressBar*>(self)->QProgressBar::metaObject();
}
...
void* QProgressBar_virtualbase_metacast(void* self, const char* param1) {
	return static_cast<VirtualQProgressBar*>(self)->QProgressBar::qt_metacast(param1);
}
...
int QProgressBar_virtualbase_metacall(void* self, int param1, int param2, void** param3) {
	return static_cast<VirtualQProgressBar*>(self)->QProgressBar::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
}
...
struct seaqt_string QProgressBar_virtualbase_text(const void* self) {
	QString _ret = static_cast<const VirtualQProgressBar*>(self)->QProgressBar::text();
	// Convert QString from UTF-16 in C++ RAII memory to UTF-8 in manually-managed C memory
	QByteArray _b = _ret.toUtf8();
	struct seaqt_string _ms;
	_ms.len = _b.length();
...
QSize* QProgressBar_virtualbase_sizeHint(const void* self) {
	return new QSize(static_cast<const VirtualQProgressBar*>(self)->QProgressBar::sizeHint());
}
...
QSize* QProgressBar_virtualbase_minimumSizeHint(const void* self) {
	return new QSize(static_cast<const VirtualQProgressBar*>(self)->QProgressBar::minimumSizeHint());
}
...
bool QProgressBar_virtualbase_event(void* self, QEvent* e) {
	return static_cast<VirtualQProgressBar*>(self)->QProgressBar::event(e);
}
...
void QProgressBar_virtualbase_paintEvent(void* self, QPaintEvent* param1) {
	static_cast<VirtualQProgressBar*>(self)->QProgressBar::paintEvent(param1);
}
...
void QProgressBar_virtualbase_initStyleOption(const void* self, QStyleOptionProgressBar* option) {
	static_cast<const VirtualQProgressBar*>(self)->QProgressBar::initStyleOption(option);
}
...
int QProgressBar_virtualbase_devType(const void* self) {
	return static_cast<const VirtualQProgressBar*>(self)->QProgressBar::devType();
}
...
void QProgressBar_virtualbase_setVisible(void* self, bool visible) {
	static_cast<VirtualQProgressBar*>(self)->QProgressBar::setVisible(visible);
}
...
int QProgressBar_virtualbase_heightForWidth(const void* self, int param1) {
	return static_cast<const VirtualQProgressBar*>(self)->QProgressBar::heightForWidth(static_cast<int>(param1));
}
...
bool QProgressBar_virtualbase_hasHeightForWidth(const void* self) {
	return static_cast<const VirtualQProgressBar*>(self)->QProgressBar::hasHeightForWidth();
}
...
QPaintEngine* QProgressBar_virtualbase_paintEngine(const void* self) {
	return static_cast<const VirtualQProgressBar*>(self)->QProgressBar::paintEngine();
}
...
void QProgressBar_virtualbase_mousePressEvent(void* self, QMouseEvent* event) {
	static_cast<VirtualQProgressBar*>(self)->QProgressBar::mousePressEvent(event);
}
...
void QProgressBar_virtualbase_mouseReleaseEvent(void* self, QMouseEvent* event) {
	static_cast<VirtualQProgressBar*>(self)->QProgressBar::mouseReleaseEvent(event);
}
...
void QProgressBar_virtualbase_mouseDoubleClickEvent(void* self, QMouseEvent* event) {
	static_cast<VirtualQProgressBar*>(self)->QProgressBar::mouseDoubleClickEvent(event);
}
...
void QProgressBar_virtualbase_mouseMoveEvent(void* self, QMouseEvent* event) {
	static_cast<VirtualQProgressBar*>(self)->QProgressBar::mouseMoveEvent(event);
}
...
void QProgressBar_virtualbase_wheelEvent(void* self, QWheelEvent* event) {
	static_cast<VirtualQProgressBar*>(self)->QProgressBar::wheelEvent(event);
}
...
void QProgressBar_virtualbase_keyPressEvent(void* self, QKeyEvent* event) {
	static_cast<VirtualQProgressBar*>(self)->QProgressBar::keyPressEvent(event);
}
...
void QProgressBar_virtualbase_keyReleaseEvent(void* self, QKeyEvent* event) {
	static_cast<VirtualQProgressBar*>(self)->QProgressBar::keyReleaseEvent(event);
}
...
void QProgressBar_virtualbase_focusInEvent(void* self, QFocusEvent* event) {
	static_cast<VirtualQProgressBar*>(self)->QProgressBar::focusInEvent(event);
}
...
void QProgressBar_virtualbase_focusOutEvent(void* self, QFocusEvent* event) {
	static_cast<VirtualQProgressBar*>(self)->QProgressBar::focusOutEvent(event);
}
...
void QProgressBar_virtualbase_enterEvent(void* self, QEnterEvent* event) {
	static_cast<VirtualQProgressBar*>(self)->QProgressBar::enterEvent(event);
}
...
void QProgressBar_virtualbase_leaveEvent(void* self, QEvent* event) {
	static_cast<VirtualQProgressBar*>(self)->QProgressBar::leaveEvent(event);
}
...
void QProgressBar_virtualbase_moveEvent(void* self, QMoveEvent* event) {
	static_cast<VirtualQProgressBar*>(self)->QProgressBar::moveEvent(event);
}
...
void QProgressBar_virtualbase_resizeEvent(void* self, QResizeEvent* event) {
	static_cast<VirtualQProgressBar*>(self)->QProgressBar::resizeEvent(event);
}
...
void QProgressBar_virtualbase_closeEvent(void* self, QCloseEvent* event) {
	static_cast<VirtualQProgressBar*>(self)->QProgressBar::closeEvent(event);
}
...
void QProgressBar_virtualbase_contextMenuEvent(void* self, QContextMenuEvent* event) {
	static_cast<VirtualQProgressBar*>(self)->QProgressBar::contextMenuEvent(event);
}
...
void QProgressBar_virtualbase_tabletEvent(void* self, QTabletEvent* event) {
	static_cast<VirtualQProgressBar*>(self)->QProgressBar::tabletEvent(event);
}
...
void QProgressBar_virtualbase_actionEvent(void* self, QActionEvent* event) {
	static_cast<VirtualQProgressBar*>(self)->QProgressBar::actionEvent(event);
}
...
void QProgressBar_virtualbase_dragEnterEvent(void* self, QDragEnterEvent* event) {
	static_cast<VirtualQProgressBar*>(self)->QProgressBar::dragEnterEvent(event);
}
...
void QProgressBar_virtualbase_dragMoveEvent(void* self, QDragMoveEvent* event) {
	static_cast<VirtualQProgressBar*>(self)->QProgressBar::dragMoveEvent(event);
}
...
void QProgressBar_virtualbase_dragLeaveEvent(void* self, QDragLeaveEvent* event) {
	static_cast<VirtualQProgressBar*>(self)->QProgressBar::dragLeaveEvent(event);
}
...
void QProgressBar_virtualbase_dropEvent(void* self, QDropEvent* event) {
	static_cast<VirtualQProgressBar*>(self)->QProgressBar::dropEvent(event);
}
...
void QProgressBar_virtualbase_showEvent(void* self, QShowEvent* event) {
	static_cast<VirtualQProgressBar*>(self)->QProgressBar::showEvent(event);
}
...
void QProgressBar_virtualbase_hideEvent(void* self, QHideEvent* event) {
	static_cast<VirtualQProgressBar*>(self)->QProgressBar::hideEvent(event);
}
...
bool QProgressBar_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, intptr_t* result) {
	QByteArray eventType_QByteArray(eventType.data, eventType.len);
	return static_cast<VirtualQProgressBar*>(self)->QProgressBar::nativeEvent(eventType_QByteArray, message, (qintptr*)(result));
}
...
void QProgressBar_virtualbase_changeEvent(void* self, QEvent* param1) {
	static_cast<VirtualQProgressBar*>(self)->QProgressBar::changeEvent(param1);
}
...
int QProgressBar_virtualbase_metric(const void* self, int param1) {
	return static_cast<const VirtualQProgressBar*>(self)->QProgressBar::metric(static_cast<VirtualQProgressBar::PaintDeviceMetric>(param1));
}
...
void QProgressBar_virtualbase_initPainter(const void* self, QPainter* painter) {
	static_cast<const VirtualQProgressBar*>(self)->QProgressBar::initPainter(painter);
}
...
QPaintDevice* QProgressBar_virtualbase_redirected(const void* self, QPoint* offset) {
	return static_cast<const VirtualQProgressBar*>(self)->QProgressBar::redirected(offset);
}
...
QPainter* QProgressBar_virtualbase_sharedPainter(const void* self) {
	return static_cast<const VirtualQProgressBar*>(self)->QProgressBar::sharedPainter();
}
...
void QProgressBar_virtualbase_inputMethodEvent(void* self, QInputMethodEvent* param1) {
	static_cast<VirtualQProgressBar*>(self)->QProgressBar::inputMethodEvent(param1);
}
...
QVariant* QProgressBar_virtualbase_inputMethodQuery(const void* self, int param1) {
	return new QVariant(static_cast<const VirtualQProgressBar*>(self)->QProgressBar::inputMethodQuery(static_cast<Qt::InputMethodQuery>(param1)));
}
...
bool QProgressBar_virtualbase_focusNextPrevChild(void* self, bool next) {
	return static_cast<VirtualQProgressBar*>(self)->QProgressBar::focusNextPrevChild(next);
}
...
bool QProgressBar_virtualbase_eventFilter(void* self, QObject* watched, QEvent* event) {
	return static_cast<VirtualQProgressBar*>(self)->QProgressBar::eventFilter(watched, event);
}
...
void QProgressBar_virtualbase_timerEvent(void* self, QTimerEvent* event) {
	static_cast<VirtualQProgressBar*>(self)->QProgressBar::timerEvent(event);
}
...
void QProgressBar_virtualbase_childEvent(void* self, QChildEvent* event) {
	static_cast<VirtualQProgressBar*>(self)->QProgressBar::childEvent(event);
}
...
void QProgressBar_virtualbase_customEvent(void* self, QEvent* event) {
	static_cast<VirtualQProgressBar*>(self)->QProgressBar::customEvent(event);
}
...
void QProgressBar_virtualbase_connectNotify(void* self, QMetaMethod* signal) {
	static_cast<VirtualQProgressBar*>(self)->QProgressBar::connectNotify(*signal);
}
...
void QProgressBar_virtualbase_disconnectNotify(void* self, QMetaMethod* signal) {
	static_cast<VirtualQProgressBar*>(self)->QProgressBar::disconnectNotify(*signal);
}
