...
bool miqt_exec_callback_QProgressBar_nativeEvent(QProgressBar*, intptr_t, struct seaqt_string, void*, long*);
...
public:
	...
	friend bool QProgressBar_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, long* result);
...
bool QProgressBar_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, long* result) {
	QByteArray eventType_QByteArray(eventType.data, eventType.len);
	return static_cast<VirtualQProgressBar*>(self)->QProgressBar::nativeEvent(eventType_QByteArray, message, static_cast<long*>(result));
}
