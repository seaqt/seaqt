...
public:
	...
	friend double QColorDialog_protectedbase_getDecodedMetricF(const VirtualQColorDialog* self, int metricA, int metricB);
};
...
double QColorDialog_protectedbase_getDecodedMetricF(const VirtualQColorDialog* self, int metricA, int metricB) {
	return self->QColorDialog::getDecodedMetricF(static_cast<VirtualQColorDialog::PaintDeviceMetric>(metricA), static_cast<VirtualQColorDialog::PaintDeviceMetric>(metricB));
}
