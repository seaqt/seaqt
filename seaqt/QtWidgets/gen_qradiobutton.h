...
struct QRadioButton_VTable {
	...
	void (*enterEvent)(struct QRadioButton_VTable* vtbl, QRadioButton* self, QEvent* event);
	...
	bool (*nativeEvent)(struct QRadioButton_VTable* vtbl, QRadioButton* self, struct miqt_string eventType, void* message, long* result);
