...
struct QDial_VTable {
	...
	void (*initStyleOption)(struct QDial_VTable* vtbl, const QDial* self, QStyleOptionSlider* option);
	...
	void (*enterEvent)(struct QDial_VTable* vtbl, QDial* self, QEnterEvent* event);
	...
	bool (*nativeEvent)(struct QDial_VTable* vtbl, QDial* self, struct miqt_string eventType, void* message, intptr_t* result);
