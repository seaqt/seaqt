...
bool miqt_exec_callback_QUndoView_nativeEvent(QUndoView*, intptr_t, struct seaqt_string, void*, long*);
...
public:
	...
	friend bool QUndoView_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, long* result);
...
QStyleOptionViewItem* QUndoView_virtualbase_viewOptions(const void* self) {
	return new QStyleOptionViewItem(static_cast<const VirtualQUndoView*>(self)->QUndoView::viewOptions());
}
...
bool QUndoView_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, long* result) {
	QByteArray eventType_QByteArray(eventType.data, eventType.len);
	return static_cast<VirtualQUndoView*>(self)->QUndoView::nativeEvent(eventType_QByteArray, message, static_cast<long*>(result));
}
