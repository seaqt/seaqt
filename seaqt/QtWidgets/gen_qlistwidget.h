...
typedef struct QListWidget_VTable{
	...
	void (*initViewItemOption)(const VirtualQListWidget* self, QStyleOptionViewItem* option);
	...
	QAbstractItemDelegate* (*itemDelegateForIndex)(const VirtualQListWidget* self, QModelIndex* index);
	...
	bool (*edit_index_trigger_event)(VirtualQListWidget* self, QModelIndex* index, int trigger, QEvent* event);
	...
	void (*initStyleOption)(const VirtualQListWidget* self, QStyleOptionFrame* option);
	...
	void (*enterEvent)(VirtualQListWidget* self, QEnterEvent* event);
	...
	bool (*nativeEvent)(VirtualQListWidget* self, struct seaqt_string eventType, void* message, intptr_t* result);
