...
public:
	...
	friend void QFontComboBox_virtualbase_setModel(VirtualQFontComboBox* self, QAbstractItemModel* model);
	...
	friend void QFontComboBox_virtualbase_initStyleOption(const VirtualQFontComboBox* self, QStyleOptionComboBox* option);
	...
	friend void QFontComboBox_virtualbase_enterEvent(VirtualQFontComboBox* self, QEnterEvent* event);
	...
	friend bool QFontComboBox_virtualbase_nativeEvent(VirtualQFontComboBox* self, struct seaqt_string eventType, void* message, intptr_t* result);
	...
	friend double QFontComboBox_protectedbase_getDecodedMetricF(const VirtualQFontComboBox* self, int metricA, int metricB);
};
...
bool QFontComboBox_virtualbase_nativeEvent(VirtualQFontComboBox* self, struct seaqt_string eventType, void* message, intptr_t* result) {
	...
	return self->QFontComboBox::nativeEvent(eventType_QByteArray, message, (qintptr*)(result));
}
...
double QFontComboBox_protectedbase_getDecodedMetricF(const VirtualQFontComboBox* self, int metricA, int metricB) {
	return self->QFontComboBox::getDecodedMetricF(static_cast<VirtualQFontComboBox::PaintDeviceMetric>(metricA), static_cast<VirtualQFontComboBox::PaintDeviceMetric>(metricB));
}
