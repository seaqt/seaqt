...
bool miqt_exec_callback_QFontComboBox_nativeEvent(QFontComboBox*, intptr_t, struct seaqt_string, void*, long*);
...
public:
	...
	friend bool QFontComboBox_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, long* result);
	...
	friend void QFontComboBox_protectedbase_initStyleOption(bool* _dynamic_cast_ok, const void* self, QStyleOptionComboBox* option);
...
bool QFontComboBox_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, long* result) {
	QByteArray eventType_QByteArray(eventType.data, eventType.len);
	return static_cast<VirtualQFontComboBox*>(self)->QFontComboBox::nativeEvent(eventType_QByteArray, message, static_cast<long*>(result));
}
