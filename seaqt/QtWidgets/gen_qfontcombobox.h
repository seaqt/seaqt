...
struct QFontComboBox_VTable {
	...
	void (*setModel)(struct QFontComboBox_VTable* vtbl, QFontComboBox* self, QAbstractItemModel* model);
	...
	void (*initStyleOption)(struct QFontComboBox_VTable* vtbl, const QFontComboBox* self, QStyleOptionComboBox* option);
	...
	void (*enterEvent)(struct QFontComboBox_VTable* vtbl, QFontComboBox* self, QEnterEvent* event);
	...
	bool (*nativeEvent)(struct QFontComboBox_VTable* vtbl, QFontComboBox* self, struct miqt_string eventType, void* message, intptr_t* result);
