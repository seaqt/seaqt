...
QCommandLinkButton* QCommandLinkButton_new3(struct seaqt_string text) {
	QString text_QString = QString::fromUtf8(text.data, text.len);
	return new (std::nothrow) VirtualQCommandLinkButton(text_QString);
}

QCommandLinkButton* QCommandLinkButton_new4(struct seaqt_string text, struct seaqt_string description) {
	QString text_QString = QString::fromUtf8(text.data, text.len);
