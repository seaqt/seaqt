...
public:
	...
	friend double QCommandLinkButton_protectedbase_getDecodedMetricF(const VirtualQCommandLinkButton* self, int metricA, int metricB);
};
...
double QCommandLinkButton_protectedbase_getDecodedMetricF(const VirtualQCommandLinkButton* self, int metricA, int metricB) {
	return self->QCommandLinkButton::getDecodedMetricF(static_cast<VirtualQCommandLinkButton::PaintDeviceMetric>(metricA), static_cast<VirtualQCommandLinkButton::PaintDeviceMetric>(metricB));
}
