...
struct QStatusBar_VTable {
	...
	void (*enterEvent)(struct QStatusBar_VTable* vtbl, QStatusBar* self, QEvent* event);
	...
	bool (*nativeEvent)(struct QStatusBar_VTable* vtbl, QStatusBar* self, struct miqt_string eventType, void* message, long* result);
