...
struct QDialogButtonBox_VTable {
	...
	void (*enterEvent)(struct QDialogButtonBox_VTable* vtbl, QDialogButtonBox* self, QEvent* event);
	...
	bool (*nativeEvent)(struct QDialogButtonBox_VTable* vtbl, QDialogButtonBox* self, struct miqt_string eventType, void* message, long* result);
