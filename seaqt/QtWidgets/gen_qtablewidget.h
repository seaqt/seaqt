...
typedef struct QTableWidget_VTable{
	...
	QStyleOptionViewItem* (*viewOptions)(const VirtualQTableWidget* self);
	...
	void (*enterEvent)(VirtualQTableWidget* self, QEvent* event);
	...
	bool (*nativeEvent)(VirtualQTableWidget* self, struct seaqt_string eventType, void* message, long* result);
