...
public:
	...
	friend double QMainWindow_protectedbase_getDecodedMetricF(const VirtualQMainWindow* self, int metricA, int metricB);
};
...
double QMainWindow_protectedbase_getDecodedMetricF(const VirtualQMainWindow* self, int metricA, int metricB) {
	return self->QMainWindow::getDecodedMetricF(static_cast<VirtualQMainWindow::PaintDeviceMetric>(metricA), static_cast<VirtualQMainWindow::PaintDeviceMetric>(metricB));
}
