...
struct QScrollBar_VTable {
	...
	void (*enterEvent)(struct QScrollBar_VTable* vtbl, QScrollBar* self, QEvent* event);
	...
	bool (*nativeEvent)(struct QScrollBar_VTable* vtbl, QScrollBar* self, struct miqt_string eventType, void* message, long* result);
