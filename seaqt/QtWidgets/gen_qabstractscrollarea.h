...
typedef struct QAbstractScrollArea_VTable{
	...
	void (*initStyleOption)(const VirtualQAbstractScrollArea* self, QStyleOptionFrame* option);
	...
	void (*enterEvent)(VirtualQAbstractScrollArea* self, QEnterEvent* event);
	...
	bool (*nativeEvent)(VirtualQAbstractScrollArea* self, struct seaqt_string eventType, void* message, intptr_t* result);
