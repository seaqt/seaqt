...
struct QAbstractScrollArea_VTable {
	...
	void (*initStyleOption)(struct QAbstractScrollArea_VTable* vtbl, const QAbstractScrollArea* self, QStyleOptionFrame* option);
	...
	void (*enterEvent)(struct QAbstractScrollArea_VTable* vtbl, QAbstractScrollArea* self, QEnterEvent* event);
	...
	bool (*nativeEvent)(struct QAbstractScrollArea_VTable* vtbl, QAbstractScrollArea* self, struct miqt_string eventType, void* message, intptr_t* result);
