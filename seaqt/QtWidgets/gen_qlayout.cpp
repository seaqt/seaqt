...
struct seaqt_string QLayout_trUtf8_s(const char* s) {
...
QLayoutItem* QLayout_replaceWidget_from_to(QLayout* self, QWidget* from, QWidget* to) {
...
struct seaqt_string QLayout_trUtf8_s_c(const char* s, const char* c) {
...
struct seaqt_string QLayout_trUtf8_s_c_n(const char* s, const char* c, int n) {
...
QLayoutItem* QLayout_replaceWidget_from_to_options(QLayout* self, QWidget* from, QWidget* to, int options) {
