...
struct QDialog_VTable {
	...
	void (*enterEvent)(struct QDialog_VTable* vtbl, QDialog* self, QEvent* event);
	...
	bool (*nativeEvent)(struct QDialog_VTable* vtbl, QDialog* self, struct miqt_string eventType, void* message, long* result);
