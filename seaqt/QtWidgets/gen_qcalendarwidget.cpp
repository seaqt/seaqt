...
bool miqt_exec_callback_QCalendarWidget_nativeEvent(QCalendarWidget*, intptr_t, struct seaqt_string, void*, intptr_t*);
...
public:
	...
	friend bool QCalendarWidget_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, intptr_t* result);
...
bool QCalendarWidget_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, intptr_t* result) {
	QByteArray eventType_QByteArray(eventType.data, eventType.len);
	return static_cast<VirtualQCalendarWidget*>(self)->QCalendarWidget::nativeEvent(eventType_QByteArray, message, (qintptr*)(result));
}
