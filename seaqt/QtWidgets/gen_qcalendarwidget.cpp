...
void QCalendarWidget_connect_clicked(QCalendarWidget* self, intptr_t slot, void (*callback)(intptr_t, QDate*), void (*release)(intptr_t)) {
	...
	VirtualQCalendarWidget::connect(self, static_cast<void (QCalendarWidget::*)(const QDate&)>(&QCalendarWidget::clicked), self, local_caller{slot, callback, release});
}
...
void QCalendarWidget_connect_activated(QCalendarWidget* self, intptr_t slot, void (*callback)(intptr_t, QDate*), void (*release)(intptr_t)) {
	...
	VirtualQCalendarWidget::connect(self, static_cast<void (QCalendarWidget::*)(const QDate&)>(&QCalendarWidget::activated), self, local_caller{slot, callback, release});
}
