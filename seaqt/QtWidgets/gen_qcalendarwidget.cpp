...
public:
	...
	friend double QCalendarWidget_protectedbase_getDecodedMetricF(const VirtualQCalendarWidget* self, int metricA, int metricB);
};
...
void QCalendarWidget_connect_clicked(QCalendarWidget* self, intptr_t slot, void (*callback)(intptr_t, QDate*), void (*release)(intptr_t)) {
	QCalendarWidget::connect(self, static_cast<void (QCalendarWidget::*)(QDate)>(&QCalendarWidget::clicked), self, [callback, release = seaqt::release_callback{slot,release}](QDate date) {
...
void QCalendarWidget_connect_activated(QCalendarWidget* self, intptr_t slot, void (*callback)(intptr_t, QDate*), void (*release)(intptr_t)) {
	QCalendarWidget::connect(self, static_cast<void (QCalendarWidget::*)(QDate)>(&QCalendarWidget::activated), self, [callback, release = seaqt::release_callback{slot,release}](QDate date) {
			QDate* sigval1 = new QDate(date);
			callback(release.slot, sigval1);
	});
}
...
double QCalendarWidget_protectedbase_getDecodedMetricF(const VirtualQCalendarWidget* self, int metricA, int metricB) {
	return self->QCalendarWidget::getDecodedMetricF(static_cast<VirtualQCalendarWidget::PaintDeviceMetric>(metricA), static_cast<VirtualQCalendarWidget::PaintDeviceMetric>(metricB));
}
