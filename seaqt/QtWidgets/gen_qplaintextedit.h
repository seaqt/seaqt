...
typedef struct QPlainTextEdit_VTable{
	...
	QVariant* (*inputMethodQuery)(const VirtualQPlainTextEdit* self, int property);
	...
	void (*enterEvent)(VirtualQPlainTextEdit* self, QEvent* event);
	...
	bool (*nativeEvent)(VirtualQPlainTextEdit* self, struct seaqt_string eventType, void* message, long* result);
