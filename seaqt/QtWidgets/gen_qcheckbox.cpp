...
bool miqt_exec_callback_QCheckBox_nativeEvent(QCheckBox*, intptr_t, struct seaqt_string, void*, intptr_t*);
...
public:
	...
	friend bool QCheckBox_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, intptr_t* result);
...
QCheckBox* QCheckBox_new3(struct seaqt_string text) {
...
void QCheckBox_virtualbase_initStyleOption(const void* self, QStyleOptionButton* option) {
	static_cast<const VirtualQCheckBox*>(self)->QCheckBox::initStyleOption(option);
}
...
bool QCheckBox_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, intptr_t* result) {
	QByteArray eventType_QByteArray(eventType.data, eventType.len);
	return static_cast<VirtualQCheckBox*>(self)->QCheckBox::nativeEvent(eventType_QByteArray, message, (qintptr*)(result));
}
