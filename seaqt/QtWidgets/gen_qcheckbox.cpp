...
public:
	...
	friend double QCheckBox_protectedbase_getDecodedMetricF(const VirtualQCheckBox* self, int metricA, int metricB);
};
...
void QCheckBox_connect_stateChanged(QCheckBox* self, intptr_t slot, void (*callback)(intptr_t, int), void (*release)(intptr_t)) {
	QCheckBox::connect(self, static_cast<void (QCheckBox::*)(int)>(&QCheckBox::stateChanged), self, [callback, release = seaqt::release_callback{slot,release}](int param1) {
			int sigval1 = param1;
...
void QCheckBox_connect_checkStateChanged(QCheckBox* self, intptr_t slot, void (*callback)(intptr_t, int), void (*release)(intptr_t)) {
	QCheckBox::connect(self, static_cast<void (QCheckBox::*)(Qt::CheckState)>(&QCheckBox::checkStateChanged), self, [callback, release = seaqt::release_callback{slot,release}](Qt::CheckState param1) {
...
double QCheckBox_protectedbase_getDecodedMetricF(const VirtualQCheckBox* self, int metricA, int metricB) {
	return self->QCheckBox::getDecodedMetricF(static_cast<VirtualQCheckBox::PaintDeviceMetric>(metricA), static_cast<VirtualQCheckBox::PaintDeviceMetric>(metricB));
}
