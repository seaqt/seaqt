...
public:
	...
	VirtualQDateTimeEdit(const QDateTimeEdit_VTable* vtbl, QDate d): QDateTimeEdit(d), vtbl(vtbl) {}
	VirtualQDateTimeEdit(const QDateTimeEdit_VTable* vtbl, QTime t): QDateTimeEdit(t), vtbl(vtbl) {}
	...
	VirtualQDateTimeEdit(const QDateTimeEdit_VTable* vtbl, QDate d, QWidget* parent): QDateTimeEdit(d, parent), vtbl(vtbl) {}
	VirtualQDateTimeEdit(const QDateTimeEdit_VTable* vtbl, QTime t, QWidget* parent): QDateTimeEdit(t, parent), vtbl(vtbl) {}
	...
	friend bool QDateTimeEdit_virtualbase_nativeEvent(VirtualQDateTimeEdit* self, struct seaqt_string eventType, void* message, intptr_t* result);
	...
	friend double QDateTimeEdit_protectedbase_getDecodedMetricF(const VirtualQDateTimeEdit* self, int metricA, int metricB);
};
...
void QDateTimeEdit_connect_dateTimeChanged(QDateTimeEdit* self, intptr_t slot, void (*callback)(intptr_t, QDateTime*), void (*release)(intptr_t)) {
	QDateTimeEdit::connect(self, static_cast<void (QDateTimeEdit::*)(const QDateTime&)>(&QDateTimeEdit::dateTimeChanged), self, [callback, release = seaqt::release_callback{slot,release}](const QDateTime& dateTime) {
...
void QDateTimeEdit_connect_timeChanged(QDateTimeEdit* self, intptr_t slot, void (*callback)(intptr_t, QTime*), void (*release)(intptr_t)) {
	QDateTimeEdit::connect(self, static_cast<void (QDateTimeEdit::*)(QTime)>(&QDateTimeEdit::timeChanged), self, [callback, release = seaqt::release_callback{slot,release}](QTime time) {
...
void QDateTimeEdit_connect_dateChanged(QDateTimeEdit* self, intptr_t slot, void (*callback)(intptr_t, QDate*), void (*release)(intptr_t)) {
	QDateTimeEdit::connect(self, static_cast<void (QDateTimeEdit::*)(QDate)>(&QDateTimeEdit::dateChanged), self, [callback, release = seaqt::release_callback{slot,release}](QDate date) {
...
bool QDateTimeEdit_virtualbase_nativeEvent(VirtualQDateTimeEdit* self, struct seaqt_string eventType, void* message, intptr_t* result) {
...
double QDateTimeEdit_protectedbase_getDecodedMetricF(const VirtualQDateTimeEdit* self, int metricA, int metricB) {
	return self->QDateTimeEdit::getDecodedMetricF(static_cast<VirtualQDateTimeEdit::PaintDeviceMetric>(metricA), static_cast<VirtualQDateTimeEdit::PaintDeviceMetric>(metricB));
}
...
public:
	...
	VirtualQTimeEdit(const QTimeEdit_VTable* vtbl, QTime time): QTimeEdit(time), vtbl(vtbl) {}
	VirtualQTimeEdit(const QTimeEdit_VTable* vtbl, QWidget* parent): QTimeEdit(parent), vtbl(vtbl) {}
	VirtualQTimeEdit(const QTimeEdit_VTable* vtbl, QTime time, QWidget* parent): QTimeEdit(time, parent), vtbl(vtbl) {}
	...
	friend bool QTimeEdit_virtualbase_nativeEvent(VirtualQTimeEdit* self, struct seaqt_string eventType, void* message, intptr_t* result);
	...
	friend double QTimeEdit_protectedbase_getDecodedMetricF(const VirtualQTimeEdit* self, int metricA, int metricB);
};
...
void QTimeEdit_connect_userTimeChanged(QTimeEdit* self, intptr_t slot, void (*callback)(intptr_t, QTime*), void (*release)(intptr_t)) {
	QTimeEdit::connect(self, static_cast<void (QTimeEdit::*)(QTime)>(&QTimeEdit::userTimeChanged), self, [callback, release = seaqt::release_callback{slot,release}](QTime time) {
			QTime* sigval1 = new QTime(time);
			callback(release.slot, sigval1);
	});
}
...
bool QTimeEdit_virtualbase_nativeEvent(VirtualQTimeEdit* self, struct seaqt_string eventType, void* message, intptr_t* result) {
	QByteArray eventType_QByteArray(eventType.data, eventType.len);
...
double QTimeEdit_protectedbase_getDecodedMetricF(const VirtualQTimeEdit* self, int metricA, int metricB) {
	return self->QTimeEdit::getDecodedMetricF(static_cast<VirtualQTimeEdit::PaintDeviceMetric>(metricA), static_cast<VirtualQTimeEdit::PaintDeviceMetric>(metricB));
}
...
public:
	...
	VirtualQDateEdit(const QDateEdit_VTable* vtbl, QDate date): QDateEdit(date), vtbl(vtbl) {}
	VirtualQDateEdit(const QDateEdit_VTable* vtbl, QWidget* parent): QDateEdit(parent), vtbl(vtbl) {}
	VirtualQDateEdit(const QDateEdit_VTable* vtbl, QDate date, QWidget* parent): QDateEdit(date, parent), vtbl(vtbl) {}
	...
	friend bool QDateEdit_virtualbase_nativeEvent(VirtualQDateEdit* self, struct seaqt_string eventType, void* message, intptr_t* result);
	...
	friend double QDateEdit_protectedbase_getDecodedMetricF(const VirtualQDateEdit* self, int metricA, int metricB);
};
...
void QDateEdit_connect_userDateChanged(QDateEdit* self, intptr_t slot, void (*callback)(intptr_t, QDate*), void (*release)(intptr_t)) {
	QDateEdit::connect(self, static_cast<void (QDateEdit::*)(QDate)>(&QDateEdit::userDateChanged), self, [callback, release = seaqt::release_callback{slot,release}](QDate date) {
			QDate* sigval1 = new QDate(date);
			callback(release.slot, sigval1);
	});
}
...
bool QDateEdit_virtualbase_nativeEvent(VirtualQDateEdit* self, struct seaqt_string eventType, void* message, intptr_t* result) {
	QByteArray eventType_QByteArray(eventType.data, eventType.len);
...
double QDateEdit_protectedbase_getDecodedMetricF(const VirtualQDateEdit* self, int metricA, int metricB) {
	return self->QDateEdit::getDecodedMetricF(static_cast<VirtualQDateEdit::PaintDeviceMetric>(metricA), static_cast<VirtualQDateEdit::PaintDeviceMetric>(metricB));
}
