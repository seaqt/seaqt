...
void QDateTimeEdit_connect_timeChanged(QDateTimeEdit* self, intptr_t slot) {
	VirtualQDateTimeEdit::connect(self, static_cast<void (QDateTimeEdit::*)(QTime)>(&QDateTimeEdit::timeChanged), self, [=](QTime time) {
...
void QDateTimeEdit_connect_dateChanged(QDateTimeEdit* self, intptr_t slot) {
	VirtualQDateTimeEdit::connect(self, static_cast<void (QDateTimeEdit::*)(QDate)>(&QDateTimeEdit::dateChanged), self, [=](QDate date) {
...
void QTimeEdit_connect_userTimeChanged(QTimeEdit* self, intptr_t slot) {
	VirtualQTimeEdit::connect(self, static_cast<void (QTimeEdit::*)(QTime)>(&QTimeEdit::userTimeChanged), self, [=](QTime time) {
		QTime* sigval1 = new QTime(time);
...
void QDateEdit_connect_userDateChanged(QDateEdit* self, intptr_t slot) {
	VirtualQDateEdit::connect(self, static_cast<void (QDateEdit::*)(QDate)>(&QDateEdit::userDateChanged), self, [=](QDate date) {
		QDate* sigval1 = new QDate(date);
