...
void QDateTimeEdit_connect_timeChanged(QDateTimeEdit* self, intptr_t slot, void (*callback)(intptr_t, QTime*), void (*release)(intptr_t)) {
	QDateTimeEdit::connect(self, static_cast<void (QDateTimeEdit::*)(const QTime&)>(&QDateTimeEdit::timeChanged), self, [callback, release = seaqt::release_callback{slot,release}](const QTime& time) {
...
void QDateTimeEdit_connect_dateChanged(QDateTimeEdit* self, intptr_t slot, void (*callback)(intptr_t, QDate*), void (*release)(intptr_t)) {
	QDateTimeEdit::connect(self, static_cast<void (QDateTimeEdit::*)(const QDate&)>(&QDateTimeEdit::dateChanged), self, [callback, release = seaqt::release_callback{slot,release}](const QDate& date) {
...
void QTimeEdit_connect_userTimeChanged(QTimeEdit* self, intptr_t slot, void (*callback)(intptr_t, QTime*), void (*release)(intptr_t)) {
	QTimeEdit::connect(self, static_cast<void (QTimeEdit::*)(const QTime&)>(&QTimeEdit::userTimeChanged), self, [callback, release = seaqt::release_callback{slot,release}](const QTime& time) {
			const QTime& time_ret = time;
			// Cast returned reference into pointer
			QTime* sigval1 = const_cast<QTime*>(&time_ret);
			callback(release.slot, sigval1);
...
void QDateEdit_connect_userDateChanged(QDateEdit* self, intptr_t slot, void (*callback)(intptr_t, QDate*), void (*release)(intptr_t)) {
	QDateEdit::connect(self, static_cast<void (QDateEdit::*)(const QDate&)>(&QDateEdit::userDateChanged), self, [callback, release = seaqt::release_callback{slot,release}](const QDate& date) {
			const QDate& date_ret = date;
			// Cast returned reference into pointer
			QDate* sigval1 = const_cast<QDate*>(&date_ret);
			callback(release.slot, sigval1);
