...
public:
	...
	VirtualQDateTimeEdit(struct QDateTimeEdit_VTable* vtbl, const QDate& d): QDateTimeEdit(d), vtbl(vtbl) {};
	VirtualQDateTimeEdit(struct QDateTimeEdit_VTable* vtbl, const QTime& t): QDateTimeEdit(t), vtbl(vtbl) {};
	...
	VirtualQDateTimeEdit(struct QDateTimeEdit_VTable* vtbl, const QDate& d, QWidget* parent): QDateTimeEdit(d, parent), vtbl(vtbl) {};
	VirtualQDateTimeEdit(struct QDateTimeEdit_VTable* vtbl, const QTime& t, QWidget* parent): QDateTimeEdit(t, parent), vtbl(vtbl) {};
...
void QDateTimeEdit_connect_dateTimeChanged(QDateTimeEdit* self, intptr_t slot) {
	VirtualQDateTimeEdit::connect(self, static_cast<void (QDateTimeEdit::*)(const QDateTime&)>(&QDateTimeEdit::dateTimeChanged), self, [=](const QDateTime& dateTime) {
...
void QDateTimeEdit_connect_timeChanged(QDateTimeEdit* self, intptr_t slot) {
	VirtualQDateTimeEdit::connect(self, static_cast<void (QDateTimeEdit::*)(const QTime&)>(&QDateTimeEdit::timeChanged), self, [=](const QTime& time) {
...
void QDateTimeEdit_connect_dateChanged(QDateTimeEdit* self, intptr_t slot) {
	VirtualQDateTimeEdit::connect(self, static_cast<void (QDateTimeEdit::*)(const QDate&)>(&QDateTimeEdit::dateChanged), self, [=](const QDate& date) {
...
bool QDateTimeEdit_virtualbase_nativeEvent(void* self, struct miqt_string eventType, void* message, long* result) {
	...
	return ( (VirtualQDateTimeEdit*)(self) )->QDateTimeEdit::nativeEvent(eventType_QByteArray, message, static_cast<long*>(result));
...
public:
	...
	VirtualQTimeEdit(struct QTimeEdit_VTable* vtbl, const QTime& time): QTimeEdit(time), vtbl(vtbl) {};
	VirtualQTimeEdit(struct QTimeEdit_VTable* vtbl, const QTime& time, QWidget* parent): QTimeEdit(time, parent), vtbl(vtbl) {};
...
void QTimeEdit_connect_userTimeChanged(QTimeEdit* self, intptr_t slot) {
	VirtualQTimeEdit::connect(self, static_cast<void (QTimeEdit::*)(const QTime&)>(&QTimeEdit::userTimeChanged), self, [=](const QTime& time) {
		const QTime& time_ret = time;
		// Cast returned reference into pointer
		QTime* sigval1 = const_cast<QTime*>(&time_ret);
...
bool QTimeEdit_virtualbase_nativeEvent(void* self, struct miqt_string eventType, void* message, long* result) {
	...
	return ( (VirtualQTimeEdit*)(self) )->QTimeEdit::nativeEvent(eventType_QByteArray, message, static_cast<long*>(result));
...
public:
	...
	VirtualQDateEdit(struct QDateEdit_VTable* vtbl, const QDate& date): QDateEdit(date), vtbl(vtbl) {};
	VirtualQDateEdit(struct QDateEdit_VTable* vtbl, const QDate& date, QWidget* parent): QDateEdit(date, parent), vtbl(vtbl) {};
...
void QDateEdit_connect_userDateChanged(QDateEdit* self, intptr_t slot) {
	VirtualQDateEdit::connect(self, static_cast<void (QDateEdit::*)(const QDate&)>(&QDateEdit::userDateChanged), self, [=](const QDate& date) {
		const QDate& date_ret = date;
		// Cast returned reference into pointer
		QDate* sigval1 = const_cast<QDate*>(&date_ret);
...
bool QDateEdit_virtualbase_nativeEvent(void* self, struct miqt_string eventType, void* message, long* result) {
	...
	return ( (VirtualQDateEdit*)(self) )->QDateEdit::nativeEvent(eventType_QByteArray, message, static_cast<long*>(result));
