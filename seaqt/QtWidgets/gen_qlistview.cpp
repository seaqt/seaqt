...
public:
	...
	friend double QListView_protectedbase_getDecodedMetricF(const VirtualQListView* self, int metricA, int metricB);
};
...
double QListView_protectedbase_getDecodedMetricF(const VirtualQListView* self, int metricA, int metricB) {
	return self->QListView::getDecodedMetricF(static_cast<VirtualQListView::PaintDeviceMetric>(metricA), static_cast<VirtualQListView::PaintDeviceMetric>(metricB));
}
