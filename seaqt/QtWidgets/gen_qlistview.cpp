...
bool miqt_exec_callback_QListView_nativeEvent(QListView*, intptr_t, struct seaqt_string, void*, intptr_t*);
...
public:
	...
	friend bool QListView_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, intptr_t* result);
...
void QListView_virtualbase_initViewItemOption(const void* self, QStyleOptionViewItem* option) {
	static_cast<const VirtualQListView*>(self)->QListView::initViewItemOption(option);
}
...
QAbstractItemDelegate* QListView_virtualbase_itemDelegateForIndex(const void* self, QModelIndex* index) {
	return static_cast<const VirtualQListView*>(self)->QListView::itemDelegateForIndex(*index);
}
...
void QListView_virtualbase_initStyleOption(const void* self, QStyleOptionFrame* option) {
	static_cast<const VirtualQListView*>(self)->QListView::initStyleOption(option);
}
...
bool QListView_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, intptr_t* result) {
	QByteArray eventType_QByteArray(eventType.data, eventType.len);
	return static_cast<VirtualQListView*>(self)->QListView::nativeEvent(eventType_QByteArray, message, (qintptr*)(result));
}
