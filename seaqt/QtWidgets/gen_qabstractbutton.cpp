...
bool miqt_exec_callback_QAbstractButton_nativeEvent(QAbstractButton*, intptr_t, struct seaqt_string, void*, long*);
...
public:
	...
	friend bool QAbstractButton_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, long* result);
...
bool QAbstractButton_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, long* result) {
	QByteArray eventType_QByteArray(eventType.data, eventType.len);
	return static_cast<VirtualQAbstractButton*>(self)->QAbstractButton::nativeEvent(eventType_QByteArray, message, static_cast<long*>(result));
}
