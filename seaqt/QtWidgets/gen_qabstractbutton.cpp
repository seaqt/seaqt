...
public:
	...
	friend double QAbstractButton_protectedbase_getDecodedMetricF(const VirtualQAbstractButton* self, int metricA, int metricB);
};
...
double QAbstractButton_protectedbase_getDecodedMetricF(const VirtualQAbstractButton* self, int metricA, int metricB) {
	return self->QAbstractButton::getDecodedMetricF(static_cast<VirtualQAbstractButton::PaintDeviceMetric>(metricA), static_cast<VirtualQAbstractButton::PaintDeviceMetric>(metricB));
}
