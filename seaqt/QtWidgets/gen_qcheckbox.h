...
struct QCheckBox_VTable {
	...
	void (*initStyleOption)(struct QCheckBox_VTable* vtbl, const QCheckBox* self, QStyleOptionButton* option);
	...
	void (*enterEvent)(struct QCheckBox_VTable* vtbl, QCheckBox* self, QEnterEvent* event);
	...
	bool (*nativeEvent)(struct QCheckBox_VTable* vtbl, QCheckBox* self, struct miqt_string eventType, void* message, intptr_t* result);
