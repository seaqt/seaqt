...
public:
	...
	friend bool QTableView_virtualbase_nativeEvent(VirtualQTableView* self, struct seaqt_string eventType, void* message, intptr_t* result);
	...
	friend double QTableView_protectedbase_getDecodedMetricF(const VirtualQTableView* self, int metricA, int metricB);
};
...
bool QTableView_virtualbase_nativeEvent(VirtualQTableView* self, struct seaqt_string eventType, void* message, intptr_t* result) {
...
double QTableView_protectedbase_getDecodedMetricF(const VirtualQTableView* self, int metricA, int metricB) {
	return self->QTableView::getDecodedMetricF(static_cast<VirtualQTableView::PaintDeviceMetric>(metricA), static_cast<VirtualQTableView::PaintDeviceMetric>(metricB));
}
