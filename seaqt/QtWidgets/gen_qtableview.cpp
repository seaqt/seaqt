...
bool miqt_exec_callback_QTableView_nativeEvent(QTableView*, intptr_t, struct seaqt_string, void*, long*);
...
public:
	...
	friend bool QTableView_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, long* result);
...
QStyleOptionViewItem* QTableView_virtualbase_viewOptions(const void* self) {
	return new QStyleOptionViewItem(static_cast<const VirtualQTableView*>(self)->QTableView::viewOptions());
}
...
bool QTableView_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, long* result) {
	QByteArray eventType_QByteArray(eventType.data, eventType.len);
	return static_cast<VirtualQTableView*>(self)->QTableView::nativeEvent(eventType_QByteArray, message, static_cast<long*>(result));
}
