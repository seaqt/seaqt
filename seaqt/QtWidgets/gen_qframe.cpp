...
public:
	...
	friend bool QFrame_virtualbase_nativeEvent(VirtualQFrame* self, struct seaqt_string eventType, void* message, intptr_t* result);
	...
	friend double QFrame_protectedbase_getDecodedMetricF(const VirtualQFrame* self, int metricA, int metricB);
};
...
bool QFrame_virtualbase_nativeEvent(VirtualQFrame* self, struct seaqt_string eventType, void* message, intptr_t* result) {
...
double QFrame_protectedbase_getDecodedMetricF(const VirtualQFrame* self, int metricA, int metricB) {
	return self->QFrame::getDecodedMetricF(static_cast<VirtualQFrame::PaintDeviceMetric>(metricA), static_cast<VirtualQFrame::PaintDeviceMetric>(metricB));
}
