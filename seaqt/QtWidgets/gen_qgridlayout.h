...
struct QGridLayout_VTable {
	...
	void (*setSpacing)(struct QGridLayout_VTable* vtbl, QGridLayout* self, int spacing);
	int (*spacing)(struct QGridLayout_VTable* vtbl, const QGridLayout* self);
	...
	QLayoutItem* (*replaceWidget)(struct QGridLayout_VTable* vtbl, QGridLayout* self, QWidget* from, QWidget* to, int options);
	...
	QWidget* (*widget)(struct QGridLayout_VTable* vtbl, const QGridLayout* self);
