...
public:
	...
	virtual ~VirtualQLayoutItem() override = default;
...
QLayoutItem* QLayoutItem_new() {
	return new (std::nothrow) VirtualQLayoutItem();
}

QLayoutItem* QLayoutItem_new2(QLayoutItem* param1) {
	return new (std::nothrow) VirtualQLayoutItem(*param1);
}

QLayoutItem* QLayoutItem_new3(int alignment) {
	return new (std::nothrow) VirtualQLayoutItem(static_cast<Qt::Alignment>(alignment));
}
...
bool QLayoutItem_override_virtual_sizeHint(void* self, intptr_t slot) {
	VirtualQLayoutItem* self_cast = dynamic_cast<VirtualQLayoutItem*>( (QLayoutItem*)(self) );
...
bool QLayoutItem_virtualbase_hasHeightForWidth(const void* self) {
	return static_cast<const VirtualQLayoutItem*>(self)->QLayoutItem::hasHeightForWidth();
}
...
int QLayoutItem_virtualbase_heightForWidth(const void* self, int param1) {
	return static_cast<const VirtualQLayoutItem*>(self)->QLayoutItem::heightForWidth(static_cast<int>(param1));
}
...
int QLayoutItem_virtualbase_minimumHeightForWidth(const void* self, int param1) {
	return static_cast<const VirtualQLayoutItem*>(self)->QLayoutItem::minimumHeightForWidth(static_cast<int>(param1));
}
...
void QLayoutItem_virtualbase_invalidate(void* self) {
	static_cast<VirtualQLayoutItem*>(self)->QLayoutItem::invalidate();
}
...
QWidget* QLayoutItem_virtualbase_widget(const void* self) {
	return static_cast<const VirtualQLayoutItem*>(self)->QLayoutItem::widget();
}
...
QLayout* QLayoutItem_virtualbase_layout(void* self) {
	return static_cast<VirtualQLayoutItem*>(self)->QLayoutItem::layout();
}
...
QSpacerItem* QLayoutItem_virtualbase_spacerItem(void* self) {
	return static_cast<VirtualQLayoutItem*>(self)->QLayoutItem::spacerItem();
}
...
int QLayoutItem_virtualbase_controlTypes(const void* self) {
	QSizePolicy::ControlTypes _ret = static_cast<const VirtualQLayoutItem*>(self)->QLayoutItem::controlTypes();
	return static_cast<int>(_ret);
}
...
public:
	...
	virtual ~VirtualQSpacerItem() override = default;
...
QSpacerItem* QSpacerItem_new(int w, int h) {
	return new (std::nothrow) VirtualQSpacerItem(static_cast<int>(w), static_cast<int>(h));
}

QSpacerItem* QSpacerItem_new2(QSpacerItem* param1) {
	return new (std::nothrow) VirtualQSpacerItem(*param1);
}

QSpacerItem* QSpacerItem_new3(int w, int h, int hData) {
	return new (std::nothrow) VirtualQSpacerItem(static_cast<int>(w), static_cast<int>(h), static_cast<QSizePolicy::Policy>(hData));
}

QSpacerItem* QSpacerItem_new4(int w, int h, int hData, int vData) {
	return new (std::nothrow) VirtualQSpacerItem(static_cast<int>(w), static_cast<int>(h), static_cast<QSizePolicy::Policy>(hData), static_cast<QSizePolicy::Policy>(vData));
}
...
bool QSpacerItem_override_virtual_sizeHint(void* self, intptr_t slot) {
	VirtualQSpacerItem* self_cast = dynamic_cast<VirtualQSpacerItem*>( (QSpacerItem*)(self) );
	if (self_cast == nullptr) {
		return false;
	}
...
QSize* QSpacerItem_virtualbase_sizeHint(const void* self) {
	return new QSize(static_cast<const VirtualQSpacerItem*>(self)->QSpacerItem::sizeHint());
}
...
QSize* QSpacerItem_virtualbase_minimumSize(const void* self) {
	return new QSize(static_cast<const VirtualQSpacerItem*>(self)->QSpacerItem::minimumSize());
}
...
QSize* QSpacerItem_virtualbase_maximumSize(const void* self) {
	return new QSize(static_cast<const VirtualQSpacerItem*>(self)->QSpacerItem::maximumSize());
}
...
int QSpacerItem_virtualbase_expandingDirections(const void* self) {
	Qt::Orientations _ret = static_cast<const VirtualQSpacerItem*>(self)->QSpacerItem::expandingDirections();
	return static_cast<int>(_ret);
}
...
bool QSpacerItem_virtualbase_isEmpty(const void* self) {
	return static_cast<const VirtualQSpacerItem*>(self)->QSpacerItem::isEmpty();
}
...
void QSpacerItem_virtualbase_setGeometry(void* self, QRect* geometry) {
	static_cast<VirtualQSpacerItem*>(self)->QSpacerItem::setGeometry(*geometry);
}
...
QRect* QSpacerItem_virtualbase_geometry(const void* self) {
	return new QRect(static_cast<const VirtualQSpacerItem*>(self)->QSpacerItem::geometry());
}
...
QSpacerItem* QSpacerItem_virtualbase_spacerItem(void* self) {
	return static_cast<VirtualQSpacerItem*>(self)->QSpacerItem::spacerItem();
}
...
bool QSpacerItem_virtualbase_hasHeightForWidth(const void* self) {
	return static_cast<const VirtualQSpacerItem*>(self)->QSpacerItem::hasHeightForWidth();
}
...
int QSpacerItem_virtualbase_heightForWidth(const void* self, int param1) {
	return static_cast<const VirtualQSpacerItem*>(self)->QSpacerItem::heightForWidth(static_cast<int>(param1));
}
...
int QSpacerItem_virtualbase_minimumHeightForWidth(const void* self, int param1) {
	return static_cast<const VirtualQSpacerItem*>(self)->QSpacerItem::minimumHeightForWidth(static_cast<int>(param1));
}
...
void QSpacerItem_virtualbase_invalidate(void* self) {
	static_cast<VirtualQSpacerItem*>(self)->QSpacerItem::invalidate();
}
...
QWidget* QSpacerItem_virtualbase_widget(const void* self) {
	return static_cast<const VirtualQSpacerItem*>(self)->QSpacerItem::widget();
}
...
QLayout* QSpacerItem_virtualbase_layout(void* self) {
	return static_cast<VirtualQSpacerItem*>(self)->QSpacerItem::layout();
}
...
int QSpacerItem_virtualbase_controlTypes(const void* self) {
	QSizePolicy::ControlTypes _ret = static_cast<const VirtualQSpacerItem*>(self)->QSpacerItem::controlTypes();
	return static_cast<int>(_ret);
}
...
public:
	...
	virtual ~VirtualQWidgetItem() override = default;
...
QWidgetItem* QWidgetItem_new(QWidget* w) {
	return new (std::nothrow) VirtualQWidgetItem(w);
}
...
bool QWidgetItem_override_virtual_sizeHint(void* self, intptr_t slot) {
	VirtualQWidgetItem* self_cast = dynamic_cast<VirtualQWidgetItem*>( (QWidgetItem*)(self) );
	if (self_cast == nullptr) {
		return false;
	}
...
QSize* QWidgetItem_virtualbase_sizeHint(const void* self) {
	return new QSize(static_cast<const VirtualQWidgetItem*>(self)->QWidgetItem::sizeHint());
}
...
QSize* QWidgetItem_virtualbase_minimumSize(const void* self) {
	return new QSize(static_cast<const VirtualQWidgetItem*>(self)->QWidgetItem::minimumSize());
}
...
QSize* QWidgetItem_virtualbase_maximumSize(const void* self) {
	return new QSize(static_cast<const VirtualQWidgetItem*>(self)->QWidgetItem::maximumSize());
}
...
int QWidgetItem_virtualbase_expandingDirections(const void* self) {
	Qt::Orientations _ret = static_cast<const VirtualQWidgetItem*>(self)->QWidgetItem::expandingDirections();
	return static_cast<int>(_ret);
}
...
bool QWidgetItem_virtualbase_isEmpty(const void* self) {
	return static_cast<const VirtualQWidgetItem*>(self)->QWidgetItem::isEmpty();
}
...
void QWidgetItem_virtualbase_setGeometry(void* self, QRect* geometry) {
	static_cast<VirtualQWidgetItem*>(self)->QWidgetItem::setGeometry(*geometry);
}
...
QRect* QWidgetItem_virtualbase_geometry(const void* self) {
	return new QRect(static_cast<const VirtualQWidgetItem*>(self)->QWidgetItem::geometry());
}
...
QWidget* QWidgetItem_virtualbase_widget(const void* self) {
	return static_cast<const VirtualQWidgetItem*>(self)->QWidgetItem::widget();
}
...
bool QWidgetItem_virtualbase_hasHeightForWidth(const void* self) {
	return static_cast<const VirtualQWidgetItem*>(self)->QWidgetItem::hasHeightForWidth();
}
...
int QWidgetItem_virtualbase_heightForWidth(const void* self, int param1) {
	return static_cast<const VirtualQWidgetItem*>(self)->QWidgetItem::heightForWidth(static_cast<int>(param1));
}
...
int QWidgetItem_virtualbase_minimumHeightForWidth(const void* self, int param1) {
	return static_cast<const VirtualQWidgetItem*>(self)->QWidgetItem::minimumHeightForWidth(static_cast<int>(param1));
}
...
int QWidgetItem_virtualbase_controlTypes(const void* self) {
	QSizePolicy::ControlTypes _ret = static_cast<const VirtualQWidgetItem*>(self)->QWidgetItem::controlTypes();
	return static_cast<int>(_ret);
}
...
void QWidgetItem_virtualbase_invalidate(void* self) {
	static_cast<VirtualQWidgetItem*>(self)->QWidgetItem::invalidate();
}
...
QLayout* QWidgetItem_virtualbase_layout(void* self) {
	return static_cast<VirtualQWidgetItem*>(self)->QWidgetItem::layout();
}
...
QSpacerItem* QWidgetItem_virtualbase_spacerItem(void* self) {
	return static_cast<VirtualQWidgetItem*>(self)->QWidgetItem::spacerItem();
}
...
public:
	...
	virtual ~VirtualQWidgetItemV2() override = default;
...
QWidgetItemV2* QWidgetItemV2_new(QWidget* widget) {
	return new (std::nothrow) VirtualQWidgetItemV2(widget);
}
...
bool QWidgetItemV2_override_virtual_sizeHint(void* self, intptr_t slot) {
	VirtualQWidgetItemV2* self_cast = dynamic_cast<VirtualQWidgetItemV2*>( (QWidgetItemV2*)(self) );
	if (self_cast == nullptr) {
		return false;
	}
...
QSize* QWidgetItemV2_virtualbase_sizeHint(const void* self) {
	return new QSize(static_cast<const VirtualQWidgetItemV2*>(self)->QWidgetItemV2::sizeHint());
}
...
QSize* QWidgetItemV2_virtualbase_minimumSize(const void* self) {
	return new QSize(static_cast<const VirtualQWidgetItemV2*>(self)->QWidgetItemV2::minimumSize());
}
...
QSize* QWidgetItemV2_virtualbase_maximumSize(const void* self) {
	return new QSize(static_cast<const VirtualQWidgetItemV2*>(self)->QWidgetItemV2::maximumSize());
}
...
int QWidgetItemV2_virtualbase_heightForWidth(const void* self, int width) {
	return static_cast<const VirtualQWidgetItemV2*>(self)->QWidgetItemV2::heightForWidth(static_cast<int>(width));
}
...
int QWidgetItemV2_virtualbase_expandingDirections(const void* self) {
	Qt::Orientations _ret = static_cast<const VirtualQWidgetItemV2*>(self)->QWidgetItemV2::expandingDirections();
	return static_cast<int>(_ret);
}
...
bool QWidgetItemV2_virtualbase_isEmpty(const void* self) {
	return static_cast<const VirtualQWidgetItemV2*>(self)->QWidgetItemV2::isEmpty();
}
...
void QWidgetItemV2_virtualbase_setGeometry(void* self, QRect* geometry) {
	static_cast<VirtualQWidgetItemV2*>(self)->QWidgetItemV2::setGeometry(*geometry);
}
...
QRect* QWidgetItemV2_virtualbase_geometry(const void* self) {
	return new QRect(static_cast<const VirtualQWidgetItemV2*>(self)->QWidgetItemV2::geometry());
}
...
QWidget* QWidgetItemV2_virtualbase_widget(const void* self) {
	return static_cast<const VirtualQWidgetItemV2*>(self)->QWidgetItemV2::widget();
}
...
bool QWidgetItemV2_virtualbase_hasHeightForWidth(const void* self) {
	return static_cast<const VirtualQWidgetItemV2*>(self)->QWidgetItemV2::hasHeightForWidth();
}
...
int QWidgetItemV2_virtualbase_minimumHeightForWidth(const void* self, int param1) {
	return static_cast<const VirtualQWidgetItemV2*>(self)->QWidgetItemV2::minimumHeightForWidth(static_cast<int>(param1));
}
...
int QWidgetItemV2_virtualbase_controlTypes(const void* self) {
	QSizePolicy::ControlTypes _ret = static_cast<const VirtualQWidgetItemV2*>(self)->QWidgetItemV2::controlTypes();
	return static_cast<int>(_ret);
}
...
void QWidgetItemV2_virtualbase_invalidate(void* self) {
	static_cast<VirtualQWidgetItemV2*>(self)->QWidgetItemV2::invalidate();
}
...
QLayout* QWidgetItemV2_virtualbase_layout(void* self) {
	return static_cast<VirtualQWidgetItemV2*>(self)->QWidgetItemV2::layout();
}
...
QSpacerItem* QWidgetItemV2_virtualbase_spacerItem(void* self) {
	return static_cast<VirtualQWidgetItemV2*>(self)->QWidgetItemV2::spacerItem();
}
