...
QWidget* QLayoutItem_virtualbase_widget(void* self) {
	return static_cast<VirtualQLayoutItem*>(self)->QLayoutItem::widget();
}
...
QWidget* QSpacerItem_virtualbase_widget(void* self) {
	return static_cast<VirtualQSpacerItem*>(self)->QSpacerItem::widget();
}
...
QWidget* QWidgetItem_virtualbase_widget(void* self) {
	return static_cast<VirtualQWidgetItem*>(self)->QWidgetItem::widget();
}
...
QWidget* QWidgetItemV2_virtualbase_widget(void* self) {
	return static_cast<VirtualQWidgetItemV2*>(self)->QWidgetItemV2::widget();
}
