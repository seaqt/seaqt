...
QWidget* QLayoutItem_virtualbase_widget(void* self) {
	...
	return ( (VirtualQLayoutItem*)(self) )->QLayoutItem::widget();
...
QWidget* QSpacerItem_virtualbase_widget(void* self) {
	...
	return ( (VirtualQSpacerItem*)(self) )->QSpacerItem::widget();
...
QWidget* QWidgetItem_virtualbase_widget(void* self) {
	...
	return ( (VirtualQWidgetItem*)(self) )->QWidgetItem::widget();
...
QWidget* QWidgetItemV2_virtualbase_widget(void* self) {
	...
	return ( (VirtualQWidgetItemV2*)(self) )->QWidgetItemV2::widget();
