...
struct QSpinBox_VTable {
	...
	void (*enterEvent)(struct QSpinBox_VTable* vtbl, QSpinBox* self, QEvent* event);
	...
	bool (*nativeEvent)(struct QSpinBox_VTable* vtbl, QSpinBox* self, struct miqt_string eventType, void* message, long* result);
...
struct QDoubleSpinBox_VTable {
	...
	void (*enterEvent)(struct QDoubleSpinBox_VTable* vtbl, QDoubleSpinBox* self, QEvent* event);
	...
	bool (*nativeEvent)(struct QDoubleSpinBox_VTable* vtbl, QDoubleSpinBox* self, struct miqt_string eventType, void* message, long* result);
