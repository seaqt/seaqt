...
typedef struct QSpinBox_VTable{
	...
	void (*enterEvent)(VirtualQSpinBox* self, QEvent* event);
	...
	bool (*nativeEvent)(VirtualQSpinBox* self, struct seaqt_string eventType, void* message, long* result);
...
typedef struct QDoubleSpinBox_VTable{
	...
	void (*enterEvent)(VirtualQDoubleSpinBox* self, QEvent* event);
	...
	bool (*nativeEvent)(VirtualQDoubleSpinBox* self, struct seaqt_string eventType, void* message, long* result);
