...
struct QRubberBand_VTable {
	...
	void (*enterEvent)(struct QRubberBand_VTable* vtbl, QRubberBand* self, QEvent* event);
	...
	bool (*nativeEvent)(struct QRubberBand_VTable* vtbl, QRubberBand* self, struct miqt_string eventType, void* message, long* result);
