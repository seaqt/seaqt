...
public:
	...
	friend void QToolButton_virtualbase_enterEvent(VirtualQToolButton* self, QEnterEvent* param1);
	...
	friend void QToolButton_virtualbase_initStyleOption(const VirtualQToolButton* self, QStyleOptionToolButton* option);
	...
	friend bool QToolButton_virtualbase_nativeEvent(VirtualQToolButton* self, struct seaqt_string eventType, void* message, intptr_t* result);
	...
	friend double QToolButton_protectedbase_getDecodedMetricF(const VirtualQToolButton* self, int metricA, int metricB);
};
...
bool QToolButton_virtualbase_nativeEvent(VirtualQToolButton* self, struct seaqt_string eventType, void* message, intptr_t* result) {
	QByteArray eventType_QByteArray(eventType.data, eventType.len);

	return self->QToolButton::nativeEvent(eventType_QByteArray, message, (qintptr*)(result));
}
...
double QToolButton_protectedbase_getDecodedMetricF(const VirtualQToolButton* self, int metricA, int metricB) {
	return self->QToolButton::getDecodedMetricF(static_cast<VirtualQToolButton::PaintDeviceMetric>(metricA), static_cast<VirtualQToolButton::PaintDeviceMetric>(metricB));
}
