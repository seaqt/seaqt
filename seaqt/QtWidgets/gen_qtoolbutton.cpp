...
bool miqt_exec_callback_QToolButton_nativeEvent(QToolButton*, intptr_t, struct seaqt_string, void*, long*);
...
public:
	...
	friend bool QToolButton_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, long* result);
...
bool QToolButton_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, long* result) {
	QByteArray eventType_QByteArray(eventType.data, eventType.len);
	return static_cast<VirtualQToolButton*>(self)->QToolButton::nativeEvent(eventType_QByteArray, message, static_cast<long*>(result));
}
