...
public:
	...
	friend bool QToolButton_virtualbase_nativeEvent(void* self, struct miqt_string eventType, void* message, intptr_t* result);
...
void QToolButton_virtualbase_initStyleOption(const void* self, QStyleOptionToolButton* option) {
	...
	( (const VirtualQToolButton*)(self) )->QToolButton::initStyleOption(option);
...
bool QToolButton_virtualbase_nativeEvent(void* self, struct miqt_string eventType, void* message, intptr_t* result) {
	...
	return ( (VirtualQToolButton*)(self) )->QToolButton::nativeEvent(eventType_QByteArray, message, (qintptr*)(result));
