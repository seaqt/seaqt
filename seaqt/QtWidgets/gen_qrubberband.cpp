...
public:
	...
	friend bool QRubberBand_virtualbase_nativeEvent(VirtualQRubberBand* self, struct seaqt_string eventType, void* message, intptr_t* result);
	...
	friend double QRubberBand_protectedbase_getDecodedMetricF(const VirtualQRubberBand* self, int metricA, int metricB);
};
...
bool QRubberBand_virtualbase_nativeEvent(VirtualQRubberBand* self, struct seaqt_string eventType, void* message, intptr_t* result) {
...
double QRubberBand_protectedbase_getDecodedMetricF(const VirtualQRubberBand* self, int metricA, int metricB) {
	return self->QRubberBand::getDecodedMetricF(static_cast<VirtualQRubberBand::PaintDeviceMetric>(metricA), static_cast<VirtualQRubberBand::PaintDeviceMetric>(metricB));
}
