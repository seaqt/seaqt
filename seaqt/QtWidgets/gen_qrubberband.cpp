...
bool miqt_exec_callback_QRubberBand_nativeEvent(QRubberBand*, intptr_t, struct seaqt_string, void*, long*);
...
public:
	...
	friend bool QRubberBand_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, long* result);
...
bool QRubberBand_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, long* result) {
	QByteArray eventType_QByteArray(eventType.data, eventType.len);
	return static_cast<VirtualQRubberBand*>(self)->QRubberBand::nativeEvent(eventType_QByteArray, message, static_cast<long*>(result));
}
