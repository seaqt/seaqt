...
public:
	...
	friend void QGroupBox_virtualbase_initStyleOption(const VirtualQGroupBox* self, QStyleOptionGroupBox* option);
	...
	friend void QGroupBox_virtualbase_enterEvent(VirtualQGroupBox* self, QEnterEvent* event);
	...
	friend bool QGroupBox_virtualbase_nativeEvent(VirtualQGroupBox* self, struct seaqt_string eventType, void* message, intptr_t* result);
	...
	friend double QGroupBox_protectedbase_getDecodedMetricF(const VirtualQGroupBox* self, int metricA, int metricB);
};
...
void QGroupBox_virtualbase_initStyleOption(const VirtualQGroupBox* self, QStyleOptionGroupBox* option) {
...
void QGroupBox_virtualbase_enterEvent(VirtualQGroupBox* self, QEnterEvent* event) {
...
bool QGroupBox_virtualbase_nativeEvent(VirtualQGroupBox* self, struct seaqt_string eventType, void* message, intptr_t* result) {
	QByteArray eventType_QByteArray(eventType.data, eventType.len);

	return self->QGroupBox::nativeEvent(eventType_QByteArray, message, (qintptr*)(result));
}
...
double QGroupBox_protectedbase_getDecodedMetricF(const VirtualQGroupBox* self, int metricA, int metricB) {
	return self->QGroupBox::getDecodedMetricF(static_cast<VirtualQGroupBox::PaintDeviceMetric>(metricA), static_cast<VirtualQGroupBox::PaintDeviceMetric>(metricB));
}
