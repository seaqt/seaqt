...
bool miqt_exec_callback_QGroupBox_nativeEvent(QGroupBox*, intptr_t, struct seaqt_string, void*, long*);
...
public:
	...
	friend bool QGroupBox_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, long* result);
...
bool QGroupBox_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, long* result) {
	QByteArray eventType_QByteArray(eventType.data, eventType.len);
	return static_cast<VirtualQGroupBox*>(self)->QGroupBox::nativeEvent(eventType_QByteArray, message, static_cast<long*>(result));
}
