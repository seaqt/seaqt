...
struct QFocusFrame_VTable {
	...
	void (*initStyleOption)(struct QFocusFrame_VTable* vtbl, const QFocusFrame* self, QStyleOption* option);
	...
	void (*enterEvent)(struct QFocusFrame_VTable* vtbl, QFocusFrame* self, QEnterEvent* event);
	...
	bool (*nativeEvent)(struct QFocusFrame_VTable* vtbl, QFocusFrame* self, struct miqt_string eventType, void* message, intptr_t* result);
