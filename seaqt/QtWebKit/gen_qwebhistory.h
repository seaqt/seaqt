#pragma once
#ifndef SEAQT_QTWEBKIT_GEN_QWEBHISTORY_H
#define SEAQT_QTWEBKIT_GEN_QWEBHISTORY_H
...
struct seaqt_string QWebHistoryItem_title(const QWebHistoryItem* self);
...
struct seaqt_map /* of struct seaqt_string to QVariant* */  QWebHistoryItem_toMap(const QWebHistoryItem* self);
void QWebHistoryItem_loadFromMap(QWebHistoryItem* self, struct seaqt_map /* of struct seaqt_string to QVariant* */  map);

void QWebHistoryItem_delete(QWebHistoryItem* self);

void QWebHistory_clear(QWebHistory* self);
struct seaqt_array /* of QWebHistoryItem* */  QWebHistory_items(const QWebHistory* self);
struct seaqt_array /* of QWebHistoryItem* */  QWebHistory_backItems(const QWebHistory* self, int maxItems);
struct seaqt_array /* of QWebHistoryItem* */  QWebHistory_forwardItems(const QWebHistory* self, int maxItems);
...
struct seaqt_map /* of struct seaqt_string to QVariant* */  QWebHistory_toMap(const QWebHistory* self);
void QWebHistory_loadFromMap(QWebHistory* self, struct seaqt_map /* of struct seaqt_string to QVariant* */  map);
