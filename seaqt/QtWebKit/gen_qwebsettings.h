#pragma once
#ifndef SEAQT_QTWEBKIT_GEN_QWEBSETTINGS_H
#define SEAQT_QTWEBKIT_GEN_QWEBSETTINGS_H
...
void QWebSettings_setFontFamily(QWebSettings* self, int which, struct seaqt_string family);
struct seaqt_string QWebSettings_fontFamily(const QWebSettings* self, int which);
...
void QWebSettings_setDefaultTextEncoding(QWebSettings* self, struct seaqt_string encoding);
struct seaqt_string QWebSettings_defaultTextEncoding(const QWebSettings* self);
void QWebSettings_setIconDatabasePath(struct seaqt_string location);
struct seaqt_string QWebSettings_iconDatabasePath();
void QWebSettings_clearIconDatabase();
QIcon* QWebSettings_iconForUrl(QUrl* url);
void QWebSettings_setPluginSearchPaths(struct seaqt_array /* of struct seaqt_string */  paths);
struct seaqt_array /* of struct seaqt_string */  QWebSettings_pluginSearchPaths();
...
void QWebSettings_setOfflineStoragePath(struct seaqt_string path);
struct seaqt_string QWebSettings_offlineStoragePath();
void QWebSettings_setOfflineStorageDefaultQuota(long long maximumSize);
long long QWebSettings_offlineStorageDefaultQuota();
void QWebSettings_setOfflineWebApplicationCachePath(struct seaqt_string path);
struct seaqt_string QWebSettings_offlineWebApplicationCachePath();
...
void QWebSettings_setLocalStoragePath(QWebSettings* self, struct seaqt_string path);
struct seaqt_string QWebSettings_localStoragePath(const QWebSettings* self);
...
void QWebSettings_setCSSMediaType(QWebSettings* self, struct seaqt_string cSSMediaType);
struct seaqt_string QWebSettings_cssMediaType(const QWebSettings* self);
void QWebSettings_enablePersistentStorageWithPath(struct seaqt_string path);
