...
QMetaObject* miqt_exec_callback_QWebChannel_metaObject(const QWebChannel*, intptr_t);
void* miqt_exec_callback_QWebChannel_metacast(QWebChannel*, intptr_t, const char*);
...
public:
	...
	virtual ~VirtualQWebChannel() override = default;
	...
	virtual const QMetaObject* metaObject() const override {
		...
		QMetaObject* callback_return_value = miqt_exec_callback_QWebChannel_metaObject(this, handle__metaObject);
...
QWebChannel* QWebChannel_new() {
	return new (std::nothrow) VirtualQWebChannel();
}

QWebChannel* QWebChannel_new2(QObject* parent) {
	return new (std::nothrow) VirtualQWebChannel(parent);
}
...
bool QWebChannel_override_virtual_metaObject(void* self, intptr_t slot) {
	VirtualQWebChannel* self_cast = dynamic_cast<VirtualQWebChannel*>( (QWebChannel*)(self) );
...
QMetaObject* QWebChannel_virtualbase_metaObject(const void* self) {
	return (QMetaObject*) static_cast<const VirtualQWebChannel*>(self)->QWebChannel::metaObject();
}
...
void* QWebChannel_virtualbase_metacast(void* self, const char* param1) {
	return static_cast<VirtualQWebChannel*>(self)->QWebChannel::qt_metacast(param1);
}
...
int QWebChannel_virtualbase_metacall(void* self, int param1, int param2, void** param3) {
	return static_cast<VirtualQWebChannel*>(self)->QWebChannel::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
}
...
bool QWebChannel_virtualbase_event(void* self, QEvent* event) {
	return static_cast<VirtualQWebChannel*>(self)->QWebChannel::event(event);
}
...
bool QWebChannel_virtualbase_eventFilter(void* self, QObject* watched, QEvent* event) {
	return static_cast<VirtualQWebChannel*>(self)->QWebChannel::eventFilter(watched, event);
}
...
void QWebChannel_virtualbase_timerEvent(void* self, QTimerEvent* event) {
	static_cast<VirtualQWebChannel*>(self)->QWebChannel::timerEvent(event);
}
...
void QWebChannel_virtualbase_childEvent(void* self, QChildEvent* event) {
	static_cast<VirtualQWebChannel*>(self)->QWebChannel::childEvent(event);
}
...
void QWebChannel_virtualbase_customEvent(void* self, QEvent* event) {
	static_cast<VirtualQWebChannel*>(self)->QWebChannel::customEvent(event);
}
...
void QWebChannel_virtualbase_connectNotify(void* self, QMetaMethod* signal) {
	static_cast<VirtualQWebChannel*>(self)->QWebChannel::connectNotify(*signal);
}
...
void QWebChannel_virtualbase_disconnectNotify(void* self, QMetaMethod* signal) {
	static_cast<VirtualQWebChannel*>(self)->QWebChannel::disconnectNotify(*signal);
}
