...
struct seaqt_string QFileDevice_tr(const char* s) {
...
struct seaqt_string QFileDevice_trUtf8(const char* s) {
...
struct seaqt_string QFileDevice_tr2(const char* s, const char* c) {
...
struct seaqt_string QFileDevice_tr3(const char* s, const char* c, int n) {
...
struct seaqt_string QFileDevice_trUtf82(const char* s, const char* c) {
...
struct seaqt_string QFileDevice_trUtf83(const char* s, const char* c, int n) {
