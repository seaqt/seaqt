...
QState* QState_new() {
	return new (std::nothrow) VirtualQState();
}

QState* QState_new2(int childMode) {
	return new (std::nothrow) VirtualQState(static_cast<QState::ChildMode>(childMode));
}

QState* QState_new3(QState* parent) {
	return new (std::nothrow) VirtualQState(parent);
}

QState* QState_new4(int childMode, QState* parent) {
	return new (std::nothrow) VirtualQState(static_cast<QState::ChildMode>(childMode), parent);
}
...
QMetaObject* QState_virtualbase_metaObject(const void* self) {
	return (QMetaObject*) static_cast<const VirtualQState*>(self)->QState::metaObject();
}
...
void* QState_virtualbase_metacast(void* self, const char* param1) {
	return static_cast<VirtualQState*>(self)->QState::qt_metacast(param1);
}
...
int QState_virtualbase_metacall(void* self, int param1, int param2, void** param3) {
	return static_cast<VirtualQState*>(self)->QState::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
}
...
void QState_virtualbase_onEntry(void* self, QEvent* event) {
	static_cast<VirtualQState*>(self)->QState::onEntry(event);
}
...
void QState_virtualbase_onExit(void* self, QEvent* event) {
	static_cast<VirtualQState*>(self)->QState::onExit(event);
}
...
bool QState_virtualbase_event(void* self, QEvent* e) {
	return static_cast<VirtualQState*>(self)->QState::event(e);
}
...
bool QState_virtualbase_eventFilter(void* self, QObject* watched, QEvent* event) {
	return static_cast<VirtualQState*>(self)->QState::eventFilter(watched, event);
}
...
void QState_virtualbase_timerEvent(void* self, QTimerEvent* event) {
	static_cast<VirtualQState*>(self)->QState::timerEvent(event);
}
...
void QState_virtualbase_childEvent(void* self, QChildEvent* event) {
	static_cast<VirtualQState*>(self)->QState::childEvent(event);
}
...
void QState_virtualbase_customEvent(void* self, QEvent* event) {
	static_cast<VirtualQState*>(self)->QState::customEvent(event);
}
...
void QState_virtualbase_connectNotify(void* self, QMetaMethod* signal) {
	static_cast<VirtualQState*>(self)->QState::connectNotify(*signal);
}
...
void QState_virtualbase_disconnectNotify(void* self, QMetaMethod* signal) {
	static_cast<VirtualQState*>(self)->QState::disconnectNotify(*signal);
}
