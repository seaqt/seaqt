...
typedef struct QTemporaryFile_VTable{
	...
	bool (*open_flags)(VirtualQTemporaryFile* self, int flags);
	long long (*size)(const VirtualQTemporaryFile* self);
	bool (*resize_sz)(VirtualQTemporaryFile* self, long long sz);
	int (*permissions)(const VirtualQTemporaryFile* self);
	bool (*setPermissions_permissionSpec)(VirtualQTemporaryFile* self, int permissionSpec);
	...
	long long (*skipData)(VirtualQTemporaryFile* self, long long maxSize);
...
bool QTemporaryFile_open_flags(QTemporaryFile* self, int flags);
