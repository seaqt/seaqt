...
void QUrlQuery_setQueryItems(QUrlQuery* self, struct seaqt_array /* of struct seaqt_map  tuple of struct seaqt_string and struct seaqt_string   */  query) {
	...
	struct seaqt_map /* tuple of struct seaqt_string and struct seaqt_string */ * query_arr = static_cast<struct seaqt_map /* tuple of struct seaqt_string and struct seaqt_string */ *>(query.data);
	for(size_t i = 0; i < query.len; ++i) {
		QPair<QString, QString> query_arr_i_QPair;
		struct seaqt_string* query_arr_i_first_arr = static_cast<struct seaqt_string*>(query_arr[i].keys);
		struct seaqt_string* query_arr_i_second_arr = static_cast<struct seaqt_string*>(query_arr[i].values);
...
struct seaqt_string QUrlQuery_query_encoding(const QUrlQuery* self, int encoding) {
...
struct seaqt_string QUrlQuery_toString_encoding(const QUrlQuery* self, int encoding) {
...
struct seaqt_array /* of struct seaqt_map  tuple of struct seaqt_string and struct seaqt_string   */  QUrlQuery_queryItems_encoding(const QUrlQuery* self, int encoding) {
...
struct seaqt_string QUrlQuery_queryItemValue_key_encoding(const QUrlQuery* self, struct seaqt_string key, int encoding) {
	QString key_QString = QString::fromUtf8(key.data, key.len);
...
struct seaqt_array /* of struct seaqt_string */  QUrlQuery_allQueryItemValues_key_encoding(const QUrlQuery* self, struct seaqt_string key, int encoding) {
	QString key_QString = QString::fromUtf8(key.data, key.len);
