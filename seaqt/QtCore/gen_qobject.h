...
bool QObject_moveToThread_QThread(QObject* self, QThread* thread);
int QObject_startTimer_interval(QObject* self, int interval);
void QObject_killTimer_int(QObject* self, int id);
void QObject_killTimer_Qt_TimerId(QObject* self, int id);
...
QBindingStorage* QObject_bindingStorage_const(const QObject* self);
