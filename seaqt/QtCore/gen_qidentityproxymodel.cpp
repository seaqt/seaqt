...
public:
	...
	friend void QIdentityProxyModel_protectedbase_setHandleSourceLayoutChanges(VirtualQIdentityProxyModel* self, bool handleSourceLayoutChanges);
	friend void QIdentityProxyModel_protectedbase_setHandleSourceDataChanges(VirtualQIdentityProxyModel* self, bool handleSourceDataChanges);
	...
	friend QModelIndex* QIdentityProxyModel_protectedbase_createIndex_row_column(const VirtualQIdentityProxyModel* self, int row, int column);
...
QModelIndex* QIdentityProxyModel_protectedbase_createSourceIndex(const VirtualQIdentityProxyModel* self, int row, int col, void* internalPtr) {
	return new QModelIndex(self->QIdentityProxyModel::createSourceIndex(static_cast<int>(row), static_cast<int>(col), internalPtr));
}
