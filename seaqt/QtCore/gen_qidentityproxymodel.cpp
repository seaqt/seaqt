...
bool QIdentityProxyModel_virtualbase_clearItemData(void* self, QModelIndex* index) {
	return static_cast<VirtualQIdentityProxyModel*>(self)->QIdentityProxyModel::clearItemData(*index);
}
...
void QIdentityProxyModel_virtualbase_multiData(const void* self, QModelIndex* index, QModelRoleDataSpan* roleDataSpan) {
	static_cast<const VirtualQIdentityProxyModel*>(self)->QIdentityProxyModel::multiData(*index, *roleDataSpan);
}
...
void QIdentityProxyModel_virtualbase_resetInternalData(void* self) {
	static_cast<VirtualQIdentityProxyModel*>(self)->QIdentityProxyModel::resetInternalData();
}
