#pragma once
#ifndef SEAQT_QTCORE_GEN_QMETACONTAINER_H
#define SEAQT_QTCORE_GEN_QMETACONTAINER_H
...
const void* QMetaSequence_iface(const QMetaSequence* self);
...
const void* QMetaAssociation_iface(const QMetaAssociation* self);
