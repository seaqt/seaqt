...
public:
	...
	virtual ~VirtualQAnimationGroup() override = default;
	...
	virtual int qt_metacall(QMetaObject::Call param1, int param2, void** param3) override {
		...
		int sigval2 = param2;
		void** sigval3 = param3;
		int callback_return_value = miqt_exec_callback_QAnimationGroup_metacall(this, handle__metacall, sigval1, sigval2, sigval3);
...
QAnimationGroup* QAnimationGroup_new() {
	return new (std::nothrow) VirtualQAnimationGroup();
}

QAnimationGroup* QAnimationGroup_new2(QObject* parent) {
	return new (std::nothrow) VirtualQAnimationGroup(parent);
}
...
QMetaObject* QAnimationGroup_virtualbase_metaObject(const void* self) {
	return (QMetaObject*) static_cast<const VirtualQAnimationGroup*>(self)->QAnimationGroup::metaObject();
}
...
void* QAnimationGroup_virtualbase_metacast(void* self, const char* param1) {
	return static_cast<VirtualQAnimationGroup*>(self)->QAnimationGroup::qt_metacast(param1);
}
...
int QAnimationGroup_virtualbase_metacall(void* self, int param1, int param2, void** param3) {
	return static_cast<VirtualQAnimationGroup*>(self)->QAnimationGroup::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
}
...
bool QAnimationGroup_virtualbase_event(void* self, QEvent* event) {
	return static_cast<VirtualQAnimationGroup*>(self)->QAnimationGroup::event(event);
}
...
void QAnimationGroup_virtualbase_updateState(void* self, int newState, int oldState) {
	static_cast<VirtualQAnimationGroup*>(self)->QAnimationGroup::updateState(static_cast<VirtualQAnimationGroup::State>(newState), static_cast<VirtualQAnimationGroup::State>(oldState));
}
...
void QAnimationGroup_virtualbase_updateDirection(void* self, int direction) {
	static_cast<VirtualQAnimationGroup*>(self)->QAnimationGroup::updateDirection(static_cast<VirtualQAnimationGroup::Direction>(direction));
}
...
bool QAnimationGroup_virtualbase_eventFilter(void* self, QObject* watched, QEvent* event) {
	return static_cast<VirtualQAnimationGroup*>(self)->QAnimationGroup::eventFilter(watched, event);
}
...
void QAnimationGroup_virtualbase_timerEvent(void* self, QTimerEvent* event) {
	static_cast<VirtualQAnimationGroup*>(self)->QAnimationGroup::timerEvent(event);
}
...
void QAnimationGroup_virtualbase_childEvent(void* self, QChildEvent* event) {
	static_cast<VirtualQAnimationGroup*>(self)->QAnimationGroup::childEvent(event);
}
...
void QAnimationGroup_virtualbase_customEvent(void* self, QEvent* event) {
	static_cast<VirtualQAnimationGroup*>(self)->QAnimationGroup::customEvent(event);
}
...
void QAnimationGroup_virtualbase_connectNotify(void* self, QMetaMethod* signal) {
	static_cast<VirtualQAnimationGroup*>(self)->QAnimationGroup::connectNotify(*signal);
}
...
void QAnimationGroup_virtualbase_disconnectNotify(void* self, QMetaMethod* signal) {
	static_cast<VirtualQAnimationGroup*>(self)->QAnimationGroup::disconnectNotify(*signal);
}
