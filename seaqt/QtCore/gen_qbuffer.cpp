...
public:
	...
	friend long long QBuffer_virtualbase_skipData(VirtualQBuffer* self, long long maxSize);
...
void QBuffer_setData_data_len(QBuffer* self, const char* data, ptrdiff_t len) {
...
long long QBuffer_virtualbase_skipData(VirtualQBuffer* self, long long maxSize) {
	...
	qint64 _ret = self->QBuffer::skipData(static_cast<qint64>(maxSize));
	return static_cast<long long>(_ret);
}
