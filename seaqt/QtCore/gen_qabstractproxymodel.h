...
struct QAbstractProxyModel_VTable {
	...
	bool (*clearItemData)(struct QAbstractProxyModel_VTable* vtbl, QAbstractProxyModel* self, QModelIndex* index);
	...
	void (*multiData)(struct QAbstractProxyModel_VTable* vtbl, const QAbstractProxyModel* self, QModelIndex* index, QModelRoleDataSpan* roleDataSpan);
	void (*resetInternalData)(struct QAbstractProxyModel_VTable* vtbl, QAbstractProxyModel* self);
