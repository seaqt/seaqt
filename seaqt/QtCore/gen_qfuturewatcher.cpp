...
struct seaqt_string QFutureWatcherBase_progressText(const QFutureWatcherBase* self) {
...
void QFutureWatcherBase_connect_suspending(QFutureWatcherBase* self, intptr_t slot, void (*callback)(intptr_t), void (*release)(intptr_t)) {
	QFutureWatcherBase::connect(self, static_cast<void (QFutureWatcherBase::*)()>(&QFutureWatcherBase::suspending), self, [callback, release = seaqt::release_callback{slot,release}]() {
			callback(release.slot);
	});
}
...
void QFutureWatcherBase_connect_suspended(QFutureWatcherBase* self, intptr_t slot, void (*callback)(intptr_t), void (*release)(intptr_t)) {
	QFutureWatcherBase::connect(self, static_cast<void (QFutureWatcherBase::*)()>(&QFutureWatcherBase::suspended), self, [callback, release = seaqt::release_callback{slot,release}]() {
			callback(release.slot);
	});
}
...
void QFutureWatcherBase_connect_progressTextChanged(QFutureWatcherBase* self, intptr_t slot, void (*callback)(intptr_t, struct seaqt_string), void (*release)(intptr_t)) {
	QFutureWatcherBase::connect(self, static_cast<void (QFutureWatcherBase::*)(const QString&)>(&QFutureWatcherBase::progressTextChanged), self, [callback, release = seaqt::release_callback{slot,release}](const QString& progressText) {
			...
			struct seaqt_string progressText_ms;
