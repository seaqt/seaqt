...
void QProcess_connect_finished_exitCode(QProcess* self, intptr_t slot, void (*callback)(intptr_t, int), void (*release)(intptr_t)) {
	QProcess::connect(self, static_cast<void (QProcess::*)(int)>(&QProcess::finished), self, [callback, release = seaqt::release_callback{slot,release}](int exitCode) {
...
void QProcess_connect_error_error(QProcess* self, intptr_t slot, void (*callback)(intptr_t, int), void (*release)(intptr_t)) {
	QProcess::connect(self, static_cast<void (QProcess::*)(QProcess::ProcessError)>(&QProcess::error), self, [callback, release = seaqt::release_callback{slot,release}](QProcess::ProcessError error) {
