...
public:
	...
	friend QModelIndex* QAbstractProxyModel_protectedbase_createSourceIndex(const void* self, int row, int col, void* internalPtr);
...
bool QAbstractProxyModel_virtualbase_clearItemData(void* self, QModelIndex* index) {
	...
	return ( (VirtualQAbstractProxyModel*)(self) )->QAbstractProxyModel::clearItemData(*index);
...
void QAbstractProxyModel_virtualbase_multiData(const void* self, QModelIndex* index, QModelRoleDataSpan* roleDataSpan) {
	...
	( (const VirtualQAbstractProxyModel*)(self) )->QAbstractProxyModel::multiData(*index, *roleDataSpan);

}

void QAbstractProxyModel_virtualbase_resetInternalData(void* self) {

	( (VirtualQAbstractProxyModel*)(self) )->QAbstractProxyModel::resetInternalData();
...
QModelIndex* QAbstractProxyModel_protectedbase_createSourceIndex(const void* self, int row, int col, void* internalPtr) {
