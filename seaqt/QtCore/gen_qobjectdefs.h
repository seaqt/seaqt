...
bool QMetaObject_invokeMethod_QObject_char_Qt_ConnectionType(QObject* obj, const char* member, int type);
bool QMetaObject_invokeMethod_QObject_char(QObject* obj, const char* member);
