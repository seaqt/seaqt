...
void QStringList_operatorAssign(QStringList* self, struct seaqt_array /* of struct seaqt_string */  other) {
	...
	struct seaqt_string* other_arr = static_cast<struct seaqt_string*>(other.data);
...
struct seaqt_array /* of struct seaqt_string */  QStringList_operatorPlus(const QStringList* self, struct seaqt_array /* of struct seaqt_string */  other) {
...
struct seaqt_array /* of struct seaqt_string */  QStringList_operatorShiftLeft(QStringList* self, struct seaqt_string str) {
	QString str_QString = QString::fromUtf8(str.data, str.len);
...
struct seaqt_array /* of struct seaqt_string */  QStringList_operatorShiftLeftWithQStringList(QStringList* self, struct seaqt_array /* of struct seaqt_string */  l) {
	QStringList l_QList;
	l_QList.reserve(l.len);
	struct seaqt_string* l_arr = static_cast<struct seaqt_string*>(l.data);
	for(size_t i = 0; i < l.len; ++i) {
...
struct seaqt_array /* of struct seaqt_string */  QStringList_operatorShiftLeftWithQListLesserQStringGreater(QStringList* self, struct seaqt_array /* of struct seaqt_string */  l) {
	QList<QString> l_QList;
	l_QList.reserve(l.len);
	struct seaqt_string* l_arr = static_cast<struct seaqt_string*>(l.data);
	for(size_t i = 0; i < l.len; ++i) {
...
void QStringList_operatorAssignWithQStringList(QStringList* self, struct seaqt_array /* of struct seaqt_string */  param1) {
...
bool QStringList_contains3(const QStringList* self, struct seaqt_string str, int cs) {
	QString str_QString = QString::fromUtf8(str.data, str.len);
