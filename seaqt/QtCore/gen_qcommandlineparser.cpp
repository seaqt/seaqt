...
void QCommandLineParser_showMessageAndExit_type_message(int type, struct seaqt_string message) {
	QString message_QString = QString::fromUtf8(message.data, message.len);
	QCommandLineParser::showMessageAndExit(static_cast<QCommandLineParser::MessageType>(type), message_QString);
}
...
void QCommandLineParser_showMessageAndExit_type_message_exitCode(int type, struct seaqt_string message, int exitCode) {
	QString message_QString = QString::fromUtf8(message.data, message.len);
	QCommandLineParser::showMessageAndExit(static_cast<QCommandLineParser::MessageType>(type), message_QString, static_cast<int>(exitCode));
}
