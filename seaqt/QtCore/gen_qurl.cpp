...
struct seaqt_string QUrl_authorityWithOptions(const QUrl* self, int options) {
...
struct seaqt_string QUrl_userInfoWithOptions(const QUrl* self, int options) {
...
struct seaqt_string QUrl_userNameWithOptions(const QUrl* self, int options) {
...
struct seaqt_string QUrl_passwordWithQUrlComponentFormattingOptions(const QUrl* self, int param1) {
...
struct seaqt_string QUrl_hostWithQUrlComponentFormattingOptions(const QUrl* self, int param1) {
...
struct seaqt_string QUrl_topLevelDomainWithOptions(const QUrl* self, int options) {
...
struct seaqt_string QUrl_pathWithOptions(const QUrl* self, int options) {
...
struct seaqt_string QUrl_fileNameWithOptions(const QUrl* self, int options) {
...
struct seaqt_string QUrl_queryWithQUrlComponentFormattingOptions(const QUrl* self, int param1) {
...
struct seaqt_string QUrl_fragmentWithOptions(const QUrl* self, int options) {
