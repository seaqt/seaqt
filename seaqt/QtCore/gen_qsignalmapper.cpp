...
struct seaqt_string QSignalMapper_trUtf8_s(const char* s) {
...
void QSignalMapper_mapped_int(QSignalMapper* self, int param1) {
	self->mapped(static_cast<int>(param1));
}

void QSignalMapper_connect_mapped_int(QSignalMapper* self, intptr_t slot, void (*callback)(intptr_t, int), void (*release)(intptr_t)) {
	QSignalMapper::connect(self, static_cast<void (QSignalMapper::*)(int)>(&QSignalMapper::mapped), self, [callback, release = seaqt::release_callback{slot,release}](int param1) {
			int sigval1 = param1;
			callback(release.slot, sigval1);
	});
}

void QSignalMapper_mapped_QString(QSignalMapper* self, struct seaqt_string param1) {
	QString param1_QString = QString::fromUtf8(param1.data, param1.len);
	self->mapped(param1_QString);
}

void QSignalMapper_connect_mapped_QString(QSignalMapper* self, intptr_t slot, void (*callback)(intptr_t, struct seaqt_string), void (*release)(intptr_t)) {
	QSignalMapper::connect(self, static_cast<void (QSignalMapper::*)(const QString&)>(&QSignalMapper::mapped), self, [callback, release = seaqt::release_callback{slot,release}](const QString& param1) {
...
void QSignalMapper_mapped_QObject(QSignalMapper* self, QObject* param1) {
	self->mapped(param1);
}

void QSignalMapper_connect_mapped_QObject(QSignalMapper* self, intptr_t slot, void (*callback)(intptr_t, QObject*), void (*release)(intptr_t)) {
	QSignalMapper::connect(self, static_cast<void (QSignalMapper::*)(QObject*)>(&QSignalMapper::mapped), self, [callback, release = seaqt::release_callback{slot,release}](QObject* param1) {
...
void QSignalMapper_connect_mappedInt(QSignalMapper* self, intptr_t slot, void (*callback)(intptr_t, int), void (*release)(intptr_t)) {
	QSignalMapper::connect(self, static_cast<void (QSignalMapper::*)(int)>(&QSignalMapper::mappedInt), self, [callback, release = seaqt::release_callback{slot,release}](int param1) {
			int sigval1 = param1;
			callback(release.slot, sigval1);
	});
}
...
void QSignalMapper_connect_mappedString(QSignalMapper* self, intptr_t slot, void (*callback)(intptr_t, struct seaqt_string), void (*release)(intptr_t)) {
	QSignalMapper::connect(self, static_cast<void (QSignalMapper::*)(const QString&)>(&QSignalMapper::mappedString), self, [callback, release = seaqt::release_callback{slot,release}](const QString& param1) {
			const QString param1_ret = param1;
			// Convert QString from UTF-16 in C++ RAII memory to UTF-8 in manually-managed C memory
			QByteArray param1_b = param1_ret.toUtf8();
			struct seaqt_string param1_ms;
...
void QSignalMapper_connect_mappedObject(QSignalMapper* self, intptr_t slot, void (*callback)(intptr_t, QObject*), void (*release)(intptr_t)) {
	QSignalMapper::connect(self, static_cast<void (QSignalMapper::*)(QObject*)>(&QSignalMapper::mappedObject), self, [callback, release = seaqt::release_callback{slot,release}](QObject* param1) {
			QObject* sigval1 = param1;
			callback(release.slot, sigval1);
	});
}
...
struct seaqt_string QSignalMapper_trUtf8_s_c(const char* s, const char* c) {
...
struct seaqt_string QSignalMapper_trUtf8_s_c_n(const char* s, const char* c, int n) {
