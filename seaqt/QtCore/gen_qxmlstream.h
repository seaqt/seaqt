...
typedef struct VirtualQXmlStreamEntityResolver VirtualQXmlStreamEntityResolver;
typedef struct QXmlStreamEntityResolver_VTable{
	void (*destructor)(VirtualQXmlStreamEntityResolver* self);
	struct seaqt_string (*resolveEntity)(VirtualQXmlStreamEntityResolver* self, struct seaqt_string publicId, struct seaqt_string systemId);
	struct seaqt_string (*resolveUndeclaredEntity)(VirtualQXmlStreamEntityResolver* self, struct seaqt_string name);
}QXmlStreamEntityResolver_VTable;

void* QXmlStreamEntityResolver_vdata(VirtualQXmlStreamEntityResolver* self);
VirtualQXmlStreamEntityResolver* vdata_QXmlStreamEntityResolver(void* vdata);
...
struct seaqt_string QXmlStreamReader_readRawInnerData(QXmlStreamReader* self);
...
void QXmlStreamWriter_raiseError(QXmlStreamWriter* self, struct seaqt_string message);
struct seaqt_string QXmlStreamWriter_errorString(const QXmlStreamWriter* self);
int QXmlStreamWriter_error(const QXmlStreamWriter* self);
