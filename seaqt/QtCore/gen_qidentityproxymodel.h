...
struct QIdentityProxyModel_VTable {
	...
	bool (*clearItemData)(struct QIdentityProxyModel_VTable* vtbl, QIdentityProxyModel* self, QModelIndex* index);
	...
	void (*multiData)(struct QIdentityProxyModel_VTable* vtbl, const QIdentityProxyModel* self, QModelIndex* index, QModelRoleDataSpan* roleDataSpan);
	void (*resetInternalData)(struct QIdentityProxyModel_VTable* vtbl, QIdentityProxyModel* self);
