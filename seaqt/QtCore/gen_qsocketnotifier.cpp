...
public:
	...
	VirtualQSocketNotifier(struct QSocketNotifier_VTable* vtbl, QSocketNotifier::Type param1): QSocketNotifier(param1), vtbl(vtbl) {};
	...
	VirtualQSocketNotifier(struct QSocketNotifier_VTable* vtbl, QSocketNotifier::Type param1, QObject* parent): QSocketNotifier(param1, parent), vtbl(vtbl) {};
...
QSocketNotifier* QSocketNotifier_new(struct QSocketNotifier_VTable* vtbl, int param1) {
	return new VirtualQSocketNotifier(vtbl, static_cast<QSocketNotifier::Type>(param1));
}

QSocketNotifier* QSocketNotifier_new2(struct QSocketNotifier_VTable* vtbl, intptr_t socket, int param2) {
	return new VirtualQSocketNotifier(vtbl, (qintptr)(socket), static_cast<QSocketNotifier::Type>(param2));
}

QSocketNotifier* QSocketNotifier_new3(struct QSocketNotifier_VTable* vtbl, int param1, QObject* parent) {
	return new VirtualQSocketNotifier(vtbl, static_cast<QSocketNotifier::Type>(param1), parent);
}

QSocketNotifier* QSocketNotifier_new4(struct QSocketNotifier_VTable* vtbl, intptr_t socket, int param2, QObject* parent) {
