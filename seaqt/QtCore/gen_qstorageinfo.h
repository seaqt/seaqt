#pragma once
#ifndef SEAQT_QTCORE_GEN_QSTORAGEINFO_H
#define SEAQT_QTCORE_GEN_QSTORAGEINFO_H
...
struct seaqt_string QStorageInfo_device(const QStorageInfo* self);
struct seaqt_string QStorageInfo_subvolume(const QStorageInfo* self);
struct seaqt_string QStorageInfo_fileSystemType(const QStorageInfo* self);
struct seaqt_string QStorageInfo_name(const QStorageInfo* self);
struct seaqt_string QStorageInfo_displayName(const QStorageInfo* self);
...
struct seaqt_array /* of QStorageInfo* */  QStorageInfo_mountedVolumes();
