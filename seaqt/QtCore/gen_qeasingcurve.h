#pragma once
#ifndef SEAQT_QTCORE_GEN_QEASINGCURVE_H
#define SEAQT_QTCORE_GEN_QEASINGCURVE_H
...
struct seaqt_array /* of QPointF* */  QEasingCurve_toCubicSpline(const QEasingCurve* self);
