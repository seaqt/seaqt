...
public:
	friend void* QConcatenateTablesProxyModel_vdata(VirtualQConcatenateTablesProxyModel* self);
	friend VirtualQConcatenateTablesProxyModel* vdata_QConcatenateTablesProxyModel(void* vdata);

	VirtualQConcatenateTablesProxyModel(const QConcatenateTablesProxyModel_VTable* vtbl): QConcatenateTablesProxyModel(), vtbl(vtbl) {}
	VirtualQConcatenateTablesProxyModel(const QConcatenateTablesProxyModel_VTable* vtbl, QObject* parent): QConcatenateTablesProxyModel(parent), vtbl(vtbl) {}
	...
	friend struct seaqt_map /* of int to QVariant* */  QConcatenateTablesProxyModel_virtualbase_itemData(const VirtualQConcatenateTablesProxyModel* self, QModelIndex* proxyIndex);
	...
	friend bool QConcatenateTablesProxyModel_virtualbase_setItemData(VirtualQConcatenateTablesProxyModel* self, QModelIndex* index, struct seaqt_map /* of int to QVariant* */  roles);
	...
	friend struct seaqt_array /* of struct seaqt_string */  QConcatenateTablesProxyModel_virtualbase_mimeTypes(const VirtualQConcatenateTablesProxyModel* self);
	...
	friend QMimeData* QConcatenateTablesProxyModel_virtualbase_mimeData(const VirtualQConcatenateTablesProxyModel* self, struct seaqt_array /* of QModelIndex* */  indexes);
	...
	friend struct seaqt_map /* of int to struct seaqt_string */  QConcatenateTablesProxyModel_virtualbase_roleNames(const VirtualQConcatenateTablesProxyModel* self);
	...
	friend bool QConcatenateTablesProxyModel_virtualbase_clearItemData(VirtualQConcatenateTablesProxyModel* self, QModelIndex* index);
	...
	friend struct seaqt_array /* of QModelIndex* */  QConcatenateTablesProxyModel_virtualbase_match(const VirtualQConcatenateTablesProxyModel* self, QModelIndex* start, int role, QVariant* value, int hits, int flags);
	...
	friend void QConcatenateTablesProxyModel_virtualbase_multiData(const VirtualQConcatenateTablesProxyModel* self, QModelIndex* index, QModelRoleDataSpan* roleDataSpan);
	...
	friend void QConcatenateTablesProxyModel_virtualbase_resetInternalData(VirtualQConcatenateTablesProxyModel* self);
	...
	friend void QConcatenateTablesProxyModel_protectedbase_changePersistentIndexList(VirtualQConcatenateTablesProxyModel* self, struct seaqt_array /* of QModelIndex* */  from, struct seaqt_array /* of QModelIndex* */  to);
	friend struct seaqt_array /* of QModelIndex* */  QConcatenateTablesProxyModel_protectedbase_persistentIndexList(const VirtualQConcatenateTablesProxyModel* self);
...
struct seaqt_map /* of int to struct seaqt_string */  QConcatenateTablesProxyModel_roleNames(const QConcatenateTablesProxyModel* self) {
...
void* QConcatenateTablesProxyModel_vdata(VirtualQConcatenateTablesProxyModel* self) { return reinterpret_cast<void*>(reinterpret_cast<char*>(self) + seaqt_aligned_sizeof<VirtualQConcatenateTablesProxyModel>()); }
VirtualQConcatenateTablesProxyModel* vdata_QConcatenateTablesProxyModel(void* vdata) { return reinterpret_cast<VirtualQConcatenateTablesProxyModel*>(reinterpret_cast<char*>(vdata) - seaqt_aligned_sizeof<VirtualQConcatenateTablesProxyModel>()); }
...
void QConcatenateTablesProxyModel_virtualbase_resetInternalData(VirtualQConcatenateTablesProxyModel* self) {
	...
	self->QConcatenateTablesProxyModel::resetInternalData();
}
