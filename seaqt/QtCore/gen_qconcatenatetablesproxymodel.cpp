...
bool QConcatenateTablesProxyModel_virtualbase_clearItemData(void* self, QModelIndex* index) {
	...
	return ( (VirtualQConcatenateTablesProxyModel*)(self) )->QConcatenateTablesProxyModel::clearItemData(*index);
...
void QConcatenateTablesProxyModel_virtualbase_multiData(const void* self, QModelIndex* index, QModelRoleDataSpan* roleDataSpan) {
	...
	( (const VirtualQConcatenateTablesProxyModel*)(self) )->QConcatenateTablesProxyModel::multiData(*index, *roleDataSpan);
...
void QConcatenateTablesProxyModel_virtualbase_resetInternalData(void* self) {
	...
	( (VirtualQConcatenateTablesProxyModel*)(self) )->QConcatenateTablesProxyModel::resetInternalData();
