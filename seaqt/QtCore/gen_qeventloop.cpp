...
QEventLoop* QEventLoop_new() {
	return new (std::nothrow) VirtualQEventLoop();
}

QEventLoop* QEventLoop_new2(QObject* parent) {
	return new (std::nothrow) VirtualQEventLoop(parent);
}
...
QMetaObject* QEventLoop_virtualbase_metaObject(const void* self) {
	return (QMetaObject*) static_cast<const VirtualQEventLoop*>(self)->QEventLoop::metaObject();
}
...
void* QEventLoop_virtualbase_metacast(void* self, const char* param1) {
	return static_cast<VirtualQEventLoop*>(self)->QEventLoop::qt_metacast(param1);
}
...
int QEventLoop_virtualbase_metacall(void* self, int param1, int param2, void** param3) {
	return static_cast<VirtualQEventLoop*>(self)->QEventLoop::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
}
...
bool QEventLoop_virtualbase_event(void* self, QEvent* event) {
	return static_cast<VirtualQEventLoop*>(self)->QEventLoop::event(event);
}
...
bool QEventLoop_virtualbase_eventFilter(void* self, QObject* watched, QEvent* event) {
	return static_cast<VirtualQEventLoop*>(self)->QEventLoop::eventFilter(watched, event);
}
...
void QEventLoop_virtualbase_timerEvent(void* self, QTimerEvent* event) {
	static_cast<VirtualQEventLoop*>(self)->QEventLoop::timerEvent(event);
}
...
void QEventLoop_virtualbase_childEvent(void* self, QChildEvent* event) {
	static_cast<VirtualQEventLoop*>(self)->QEventLoop::childEvent(event);
}
...
void QEventLoop_virtualbase_customEvent(void* self, QEvent* event) {
	static_cast<VirtualQEventLoop*>(self)->QEventLoop::customEvent(event);
}
...
void QEventLoop_virtualbase_connectNotify(void* self, QMetaMethod* signal) {
	static_cast<VirtualQEventLoop*>(self)->QEventLoop::connectNotify(*signal);
}
...
void QEventLoop_virtualbase_disconnectNotify(void* self, QMetaMethod* signal) {
	static_cast<VirtualQEventLoop*>(self)->QEventLoop::disconnectNotify(*signal);
}
