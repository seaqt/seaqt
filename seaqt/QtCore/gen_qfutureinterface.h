#pragma once
#ifndef SEAQT_QTCORE_GEN_QFUTUREINTERFACE_H
#define SEAQT_QTCORE_GEN_QFUTUREINTERFACE_H
...
void QFutureInterfaceBase_setProgressValueAndText(QFutureInterfaceBase* self, int progressValue, struct seaqt_string progressText);
struct seaqt_string QFutureInterfaceBase_progressText(const QFutureInterfaceBase* self);
