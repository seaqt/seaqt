...
QCborValue* QCborValue_new_QCborValue(QCborValue* from) {
	return new (std::nothrow) QCborValue(*from);
}
...
struct seaqt_string QCborValue_toStringView(const QCborValue* self) {
...
struct seaqt_string QCborValue_toStringView_defaultValue(const QCborValue* self, struct seaqt_string defaultValue) {
...
QCborValueConstRef* QCborValueConstRef_new(QCborValueConstRef* from) {
	return new (std::nothrow) QCborValueConstRef(*from);
}
...
struct seaqt_string QCborValueConstRef_toStringView(const QCborValueConstRef* self) {
	QString _ret = (self->toStringView()).toString();
	// Convert QString from UTF-16 in C++ RAII memory to UTF-8 in manually-managed C memory
	QByteArray _b = _ret.toUtf8();
	struct seaqt_string _ms;
...
struct seaqt_string QCborValueConstRef_toStringView_defaultValue(const QCborValueConstRef* self, struct seaqt_string defaultValue) {
	QAnyStringView defaultValue_QString = QAnyStringView(defaultValue.data, defaultValue.len);
	QString _ret = (self->toStringView(defaultValue_QString)).toString();
	// Convert QString from UTF-16 in C++ RAII memory to UTF-8 in manually-managed C memory
	QByteArray _b = _ret.toUtf8();
...
QCborValueRef* QCborValueRef_new(QCborValueRef* from) {
	return new (std::nothrow) QCborValueRef(*from);
}
