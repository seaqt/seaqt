...
struct seaqt_string miqt_exec_callback_QTranslator_translate(const QTranslator*, intptr_t, const char*, const char*, const char*, int);
...
public:
	...
	virtual ~VirtualQTranslator() override = default;
	...
	virtual int qt_metacall(QMetaObject::Call param1, int param2, void** param3) override {
		...
		int sigval2 = param2;
		void** sigval3 = param3;
		int callback_return_value = miqt_exec_callback_QTranslator_metacall(this, handle__metacall, sigval1, sigval2, sigval3);
	...
	virtual QString translate(const char* context, const char* sourceText, const char* disambiguation, int n) const override {
		...
		int sigval4 = n;
		struct seaqt_string callback_return_value = miqt_exec_callback_QTranslator_translate(this, handle__translate, sigval1, sigval2, sigval3, sigval4);
		QString callback_return_value_QString = QString::fromUtf8(callback_return_value.data, callback_return_value.len);
		return callback_return_value_QString;
	}

	friend struct seaqt_string QTranslator_virtualbase_translate(const void* self, const char* context, const char* sourceText, const char* disambiguation, int n);
...
QTranslator* QTranslator_new() {
	return new (std::nothrow) VirtualQTranslator();
}

QTranslator* QTranslator_new2(QObject* parent) {
	return new (std::nothrow) VirtualQTranslator(parent);
}
...
struct seaqt_string QTranslator_trUtf8(const char* s) {
...
struct seaqt_string QTranslator_trUtf82(const char* s, const char* c) {
...
struct seaqt_string QTranslator_trUtf83(const char* s, const char* c, int n) {
...
QMetaObject* QTranslator_virtualbase_metaObject(const void* self) {
	return (QMetaObject*) static_cast<const VirtualQTranslator*>(self)->QTranslator::metaObject();
}
...
void* QTranslator_virtualbase_metacast(void* self, const char* param1) {
	return static_cast<VirtualQTranslator*>(self)->QTranslator::qt_metacast(param1);
}
...
int QTranslator_virtualbase_metacall(void* self, int param1, int param2, void** param3) {
	return static_cast<VirtualQTranslator*>(self)->QTranslator::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
}
...
struct seaqt_string QTranslator_virtualbase_translate(const void* self, const char* context, const char* sourceText, const char* disambiguation, int n) {
	QString _ret = static_cast<const VirtualQTranslator*>(self)->QTranslator::translate(context, sourceText, disambiguation, static_cast<int>(n));
	// Convert QString from UTF-16 in C++ RAII memory to UTF-8 in manually-managed C memory
	QByteArray _b = _ret.toUtf8();
	struct seaqt_string _ms;
	_ms.len = _b.length();
...
bool QTranslator_virtualbase_isEmpty(const void* self) {
	return static_cast<const VirtualQTranslator*>(self)->QTranslator::isEmpty();
}
...
bool QTranslator_virtualbase_event(void* self, QEvent* event) {
	return static_cast<VirtualQTranslator*>(self)->QTranslator::event(event);
}
...
bool QTranslator_virtualbase_eventFilter(void* self, QObject* watched, QEvent* event) {
	return static_cast<VirtualQTranslator*>(self)->QTranslator::eventFilter(watched, event);
}
...
void QTranslator_virtualbase_timerEvent(void* self, QTimerEvent* event) {
	static_cast<VirtualQTranslator*>(self)->QTranslator::timerEvent(event);
}
...
void QTranslator_virtualbase_childEvent(void* self, QChildEvent* event) {
	static_cast<VirtualQTranslator*>(self)->QTranslator::childEvent(event);
}
...
void QTranslator_virtualbase_customEvent(void* self, QEvent* event) {
	static_cast<VirtualQTranslator*>(self)->QTranslator::customEvent(event);
}
...
void QTranslator_virtualbase_connectNotify(void* self, QMetaMethod* signal) {
	static_cast<VirtualQTranslator*>(self)->QTranslator::connectNotify(*signal);
}
...
void QTranslator_virtualbase_disconnectNotify(void* self, QMetaMethod* signal) {
	static_cast<VirtualQTranslator*>(self)->QTranslator::disconnectNotify(*signal);
}
