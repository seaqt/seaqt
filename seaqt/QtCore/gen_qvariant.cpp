...
QVariantConstPointer* QVariantConstPointer_new_variant(QVariant* variant) {
	return new (std::nothrow) QVariantConstPointer(*variant);
}

QVariantConstPointer* QVariantConstPointer_new_from(QVariantConstPointer* from) {
	return new (std::nothrow) QVariantConstPointer(*from);
}
...
void QVariantConstPointer_operatorAssign(QVariantConstPointer* self, QVariantConstPointer* from) {
	self->operator=(*from);
}
