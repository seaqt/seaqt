...
QVariant* QVariant_new15(struct seaqt_string bytearray) {
...
QVariant* QVariant_new17(struct seaqt_string string) {
	QString string_QString = QString::fromUtf8(string.data, string.len);
	return new (std::nothrow) QVariant(string_QString);
}

QVariant* QVariant_new18(struct seaqt_array /* of struct seaqt_string */  stringlist) {
...
QVariant* QVariant_new23(struct seaqt_array /* of QVariant* */  list) {
...
QVariant* QVariant_new24(struct seaqt_map /* of struct seaqt_string to QVariant* */  map) {
...
QVariant* QVariant_new25(struct seaqt_map /* of struct seaqt_string to QVariant* */  hash) {
...
QVariant* QVariant_new27(QSizeF* size) {
	return new (std::nothrow) QVariant(*size);
}
...
QVariant* QVariant_new29(QPointF* pt) {
	return new (std::nothrow) QVariant(*pt);
}

QVariant* QVariant_new30(QLine* line) {
	return new (std::nothrow) QVariant(*line);
}

QVariant* QVariant_new31(QLineF* line) {
	return new (std::nothrow) QVariant(*line);
}

QVariant* QVariant_new32(QRect* rect) {
	return new (std::nothrow) QVariant(*rect);
}

QVariant* QVariant_new33(QRectF* rect) {
	return new (std::nothrow) QVariant(*rect);
}

QVariant* QVariant_new34(QLocale* locale) {
	return new (std::nothrow) QVariant(*locale);
}

QVariant* QVariant_new35(QRegExp* regExp) {
	return new (std::nothrow) QVariant(*regExp);
}

QVariant* QVariant_new36(QRegularExpression* re) {
...
QVariant* QVariant_new38(QUuid* uuid) {
	return new (std::nothrow) QVariant(*uuid);
}

QVariant* QVariant_new39(QUrl* url) {
	return new (std::nothrow) QVariant(*url);
}

QVariant* QVariant_new40(QJsonValue* jsonValue) {
	return new (std::nothrow) QVariant(*jsonValue);
}

QVariant* QVariant_new41(QJsonObject* jsonObject) {
	return new (std::nothrow) QVariant(*jsonObject);
}

QVariant* QVariant_new42(QJsonArray* jsonArray) {
	return new (std::nothrow) QVariant(*jsonArray);
}

QVariant* QVariant_new43(QJsonDocument* jsonDocument) {
	return new (std::nothrow) QVariant(*jsonDocument);
}

QVariant* QVariant_new44(QModelIndex* modelIndex) {
	return new (std::nothrow) QVariant(*modelIndex);
}

QVariant* QVariant_new45(QPersistentModelIndex* modelIndex) {
	return new (std::nothrow) QVariant(*modelIndex);
}
...
QVariantComparisonHelper* QVariantComparisonHelper_new2(QVariantComparisonHelper* param1) {
	return new (std::nothrow) QVariantComparisonHelper(*param1);
}
