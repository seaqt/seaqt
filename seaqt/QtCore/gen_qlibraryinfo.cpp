...
struct seaqt_string QLibraryInfo_path(int p) {
...
struct seaqt_array /* of struct seaqt_string */  QLibraryInfo_paths(int p) {
	QStringList _ret = QLibraryInfo::paths(static_cast<QLibraryInfo::LibraryPath>(p));
...
struct seaqt_string QLibraryInfo_location(int location) {
