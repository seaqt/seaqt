...
QJsonValue* QJsonValue_fromJson_json(struct seaqt_string json) {
	QByteArrayView json_QByteArray(json.data, json.len);
	return new QJsonValue(QJsonValue::fromJson(json_QByteArray));
}

struct seaqt_string QJsonValue_toJson(const QJsonValue* self) {
...
struct seaqt_string QJsonValue_toStringView(const QJsonValue* self) {
	QString _ret = (self->toStringView()).toString();
	// Convert QString from UTF-16 in C++ RAII memory to UTF-8 in manually-managed C memory
	QByteArray _b = _ret.toUtf8();
	struct seaqt_string _ms;
	_ms.len = _b.length();
...
QJsonValue* QJsonValue_fromJson_json_error(struct seaqt_string json, QJsonParseError* error) {
	QByteArrayView json_QByteArray(json.data, json.len);
	return new QJsonValue(QJsonValue::fromJson(json_QByteArray, error));
}

struct seaqt_string QJsonValue_toJson_format(const QJsonValue* self, int format) {
	QByteArray _qb = self->toJson(static_cast<QJsonValue::JsonFormat>(format));
	struct seaqt_string _ms;
	_ms.len = _qb.length();
	_ms.data = static_cast<char*>(malloc(_ms.len));
	memcpy(_ms.data, _qb.data(), _ms.len);
...
struct seaqt_string QJsonValue_toStringView_defaultValue(const QJsonValue* self, struct seaqt_string defaultValue) {
	QAnyStringView defaultValue_QString = QAnyStringView(defaultValue.data, defaultValue.len);
	QString _ret = (self->toStringView(defaultValue_QString)).toString();
	// Convert QString from UTF-16 in C++ RAII memory to UTF-8 in manually-managed C memory
	QByteArray _b = _ret.toUtf8();
	struct seaqt_string _ms;
	_ms.len = _b.length();
...
struct seaqt_string QJsonValueConstRef_toStringView(const QJsonValueConstRef* self) {
	QString _ret = (self->toStringView()).toString();
	// Convert QString from UTF-16 in C++ RAII memory to UTF-8 in manually-managed C memory
	QByteArray _b = _ret.toUtf8();
	struct seaqt_string _ms;
...
struct seaqt_string QJsonValueConstRef_toStringView_defaultValue(const QJsonValueConstRef* self, struct seaqt_string defaultValue) {
	QAnyStringView defaultValue_QString = QAnyStringView(defaultValue.data, defaultValue.len);
	QString _ret = (self->toStringView(defaultValue_QString)).toString();
	// Convert QString from UTF-16 in C++ RAII memory to UTF-8 in manually-managed C memory
	QByteArray _b = _ret.toUtf8();
...
struct seaqt_string QJsonValueRef_toStringView(const QJsonValueRef* self) {
	QString _ret = (self->toStringView()).toString();
	// Convert QString from UTF-16 in C++ RAII memory to UTF-8 in manually-managed C memory
	QByteArray _b = _ret.toUtf8();
	struct seaqt_string _ms;
...
struct seaqt_string QJsonValueRef_toStringView_defaultValue(const QJsonValueRef* self, struct seaqt_string defaultValue) {
	QAnyStringView defaultValue_QString = QAnyStringView(defaultValue.data, defaultValue.len);
	QString _ret = (self->toStringView(defaultValue_QString)).toString();
	// Convert QString from UTF-16 in C++ RAII memory to UTF-8 in manually-managed C memory
	QByteArray _b = _ret.toUtf8();
