...
struct seaqt_string miqt_exec_callback_QTemporaryFile_fileName(const QTemporaryFile*, intptr_t);
...
public:
	...
	virtual QString fileName() const override {
		...
		struct seaqt_string callback_return_value = miqt_exec_callback_QTemporaryFile_fileName(this, handle__fileName);
		QString callback_return_value_QString = QString::fromUtf8(callback_return_value.data, callback_return_value.len);
		return callback_return_value_QString;
	}

	friend struct seaqt_string QTemporaryFile_virtualbase_fileName(const void* self);
	...
	friend void QTemporaryFile_protectedbase_setErrorString(bool* _dynamic_cast_ok, void* self, struct seaqt_string errorString);
...
QTemporaryFile* QTemporaryFile_new() {
	return new (std::nothrow) VirtualQTemporaryFile();
}

QTemporaryFile* QTemporaryFile_new2(struct seaqt_string templateName) {
	QString templateName_QString = QString::fromUtf8(templateName.data, templateName.len);
	return new (std::nothrow) VirtualQTemporaryFile(templateName_QString);
}

QTemporaryFile* QTemporaryFile_new3(QObject* parent) {
	return new (std::nothrow) VirtualQTemporaryFile(parent);
}

QTemporaryFile* QTemporaryFile_new4(struct seaqt_string templateName, QObject* parent) {
	QString templateName_QString = QString::fromUtf8(templateName.data, templateName.len);
	return new (std::nothrow) VirtualQTemporaryFile(templateName_QString, parent);
}
...
QMetaObject* QTemporaryFile_virtualbase_metaObject(const void* self) {
	return (QMetaObject*) static_cast<const VirtualQTemporaryFile*>(self)->QTemporaryFile::metaObject();
}
...
void* QTemporaryFile_virtualbase_metacast(void* self, const char* param1) {
	return static_cast<VirtualQTemporaryFile*>(self)->QTemporaryFile::qt_metacast(param1);
}
...
int QTemporaryFile_virtualbase_metacall(void* self, int param1, int param2, void** param3) {
	return static_cast<VirtualQTemporaryFile*>(self)->QTemporaryFile::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
}
...
struct seaqt_string QTemporaryFile_virtualbase_fileName(const void* self) {
	QString _ret = static_cast<const VirtualQTemporaryFile*>(self)->QTemporaryFile::fileName();
	// Convert QString from UTF-16 in C++ RAII memory to UTF-8 in manually-managed C memory
	QByteArray _b = _ret.toUtf8();
	struct seaqt_string _ms;
	_ms.len = _b.length();
...
bool QTemporaryFile_virtualbase_openWithFlags(void* self, int flags) {
	return static_cast<VirtualQTemporaryFile*>(self)->QTemporaryFile::open(static_cast<VirtualQTemporaryFile::OpenMode>(flags));
}
...
long long QTemporaryFile_virtualbase_size(const void* self) {
	qint64 _ret = static_cast<const VirtualQTemporaryFile*>(self)->QTemporaryFile::size();
...
bool QTemporaryFile_virtualbase_resize(void* self, long long sz) {
	return static_cast<VirtualQTemporaryFile*>(self)->QTemporaryFile::resize(static_cast<qint64>(sz));
}
...
int QTemporaryFile_virtualbase_permissions(const void* self) {
	VirtualQTemporaryFile::Permissions _ret = static_cast<const VirtualQTemporaryFile*>(self)->QTemporaryFile::permissions();
...
bool QTemporaryFile_virtualbase_setPermissions(void* self, int permissionSpec) {
	return static_cast<VirtualQTemporaryFile*>(self)->QTemporaryFile::setPermissions(static_cast<VirtualQTemporaryFile::Permissions>(permissionSpec));
}
...
void QTemporaryFile_virtualbase_close(void* self) {
	static_cast<VirtualQTemporaryFile*>(self)->QTemporaryFile::close();
}
...
bool QTemporaryFile_virtualbase_isSequential(const void* self) {
	return static_cast<const VirtualQTemporaryFile*>(self)->QTemporaryFile::isSequential();
}
...
long long QTemporaryFile_virtualbase_pos(const void* self) {
	qint64 _ret = static_cast<const VirtualQTemporaryFile*>(self)->QTemporaryFile::pos();
	return static_cast<long long>(_ret);
}
...
bool QTemporaryFile_virtualbase_seek(void* self, long long offset) {
	return static_cast<VirtualQTemporaryFile*>(self)->QTemporaryFile::seek(static_cast<qint64>(offset));
}
...
bool QTemporaryFile_virtualbase_atEnd(const void* self) {
	return static_cast<const VirtualQTemporaryFile*>(self)->QTemporaryFile::atEnd();
}
...
long long QTemporaryFile_virtualbase_readData(void* self, char* data, long long maxlen) {
	qint64 _ret = static_cast<VirtualQTemporaryFile*>(self)->QTemporaryFile::readData(data, static_cast<qint64>(maxlen));
	return static_cast<long long>(_ret);
}
...
long long QTemporaryFile_virtualbase_writeData(void* self, const char* data, long long len) {
	qint64 _ret = static_cast<VirtualQTemporaryFile*>(self)->QTemporaryFile::writeData(data, static_cast<qint64>(len));
	return static_cast<long long>(_ret);
}
...
long long QTemporaryFile_virtualbase_readLineData(void* self, char* data, long long maxlen) {
	qint64 _ret = static_cast<VirtualQTemporaryFile*>(self)->QTemporaryFile::readLineData(data, static_cast<qint64>(maxlen));
	return static_cast<long long>(_ret);
}
...
bool QTemporaryFile_virtualbase_reset(void* self) {
	return static_cast<VirtualQTemporaryFile*>(self)->QTemporaryFile::reset();
}
...
long long QTemporaryFile_virtualbase_bytesAvailable(const void* self) {
	qint64 _ret = static_cast<const VirtualQTemporaryFile*>(self)->QTemporaryFile::bytesAvailable();
	return static_cast<long long>(_ret);
}
...
long long QTemporaryFile_virtualbase_bytesToWrite(const void* self) {
	qint64 _ret = static_cast<const VirtualQTemporaryFile*>(self)->QTemporaryFile::bytesToWrite();
	return static_cast<long long>(_ret);
}
...
bool QTemporaryFile_virtualbase_canReadLine(const void* self) {
	return static_cast<const VirtualQTemporaryFile*>(self)->QTemporaryFile::canReadLine();
}
...
bool QTemporaryFile_virtualbase_waitForReadyRead(void* self, int msecs) {
	return static_cast<VirtualQTemporaryFile*>(self)->QTemporaryFile::waitForReadyRead(static_cast<int>(msecs));
}
...
bool QTemporaryFile_virtualbase_waitForBytesWritten(void* self, int msecs) {
	return static_cast<VirtualQTemporaryFile*>(self)->QTemporaryFile::waitForBytesWritten(static_cast<int>(msecs));
}
...
long long QTemporaryFile_virtualbase_skipData(void* self, long long maxSize) {
	qint64 _ret = static_cast<VirtualQTemporaryFile*>(self)->QTemporaryFile::skipData(static_cast<qint64>(maxSize));
	return static_cast<long long>(_ret);
}
...
bool QTemporaryFile_virtualbase_event(void* self, QEvent* event) {
	return static_cast<VirtualQTemporaryFile*>(self)->QTemporaryFile::event(event);
}
...
bool QTemporaryFile_virtualbase_eventFilter(void* self, QObject* watched, QEvent* event) {
	return static_cast<VirtualQTemporaryFile*>(self)->QTemporaryFile::eventFilter(watched, event);
}
...
void QTemporaryFile_virtualbase_timerEvent(void* self, QTimerEvent* event) {
	static_cast<VirtualQTemporaryFile*>(self)->QTemporaryFile::timerEvent(event);
}
...
void QTemporaryFile_virtualbase_childEvent(void* self, QChildEvent* event) {
	static_cast<VirtualQTemporaryFile*>(self)->QTemporaryFile::childEvent(event);
}
...
void QTemporaryFile_virtualbase_customEvent(void* self, QEvent* event) {
	static_cast<VirtualQTemporaryFile*>(self)->QTemporaryFile::customEvent(event);
}
...
void QTemporaryFile_virtualbase_connectNotify(void* self, QMetaMethod* signal) {
	static_cast<VirtualQTemporaryFile*>(self)->QTemporaryFile::connectNotify(*signal);
}
...
void QTemporaryFile_virtualbase_disconnectNotify(void* self, QMetaMethod* signal) {
	static_cast<VirtualQTemporaryFile*>(self)->QTemporaryFile::disconnectNotify(*signal);
}
...
void QTemporaryFile_protectedbase_setErrorString(bool* _dynamic_cast_ok, void* self, struct seaqt_string errorString) {
	VirtualQTemporaryFile* self_cast = dynamic_cast<VirtualQTemporaryFile*>( (QTemporaryFile*)(self) );
	if (self_cast == nullptr) {
		*_dynamic_cast_ok = false;
		return ;
