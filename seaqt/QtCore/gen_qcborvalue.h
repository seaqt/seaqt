...
struct seaqt_string QCborValue_toCborWithOpt(QCborValue* self, int opt);
...
QCborValue* QCborValueRef_operatorSubscript(const QCborValueRef* self, struct seaqt_string key);
...
QCborValueRef* QCborValueRef_operatorSubscript5(QCborValueRef* self, struct seaqt_string key);
