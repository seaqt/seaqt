...
struct QTransposeProxyModel_VTable {
	...
	bool (*clearItemData)(struct QTransposeProxyModel_VTable* vtbl, QTransposeProxyModel* self, QModelIndex* index);
	...
	void (*multiData)(struct QTransposeProxyModel_VTable* vtbl, const QTransposeProxyModel* self, QModelIndex* index, QModelRoleDataSpan* roleDataSpan);
	void (*resetInternalData)(struct QTransposeProxyModel_VTable* vtbl, QTransposeProxyModel* self);
