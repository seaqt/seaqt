#pragma once
#ifndef SEAQT_QTSCRIPT_GEN_QSCRIPTCONTEXT_H
#define SEAQT_QTSCRIPT_GEN_QSCRIPTCONTEXT_H
...
struct seaqt_array /* of QScriptValue* */  QScriptContext_scopeChain(const QScriptContext* self);
