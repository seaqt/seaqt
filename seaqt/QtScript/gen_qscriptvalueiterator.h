#pragma once
#ifndef SEAQT_QTSCRIPT_GEN_QSCRIPTVALUEITERATOR_H
#define SEAQT_QTSCRIPT_GEN_QSCRIPTVALUEITERATOR_H
...
struct seaqt_string QScriptValueIterator_name(const QScriptValueIterator* self);
