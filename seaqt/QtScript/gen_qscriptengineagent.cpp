...
void miqt_exec_callback_QScriptEngineAgent_scriptLoad(QScriptEngineAgent*, intptr_t, long long, struct seaqt_string, struct seaqt_string, int);
...
public:
	...
	VirtualQScriptEngineAgent(QScriptEngine* engine): QScriptEngineAgent(engine) {}

	virtual ~VirtualQScriptEngineAgent() override = default;
	...
	friend void QScriptEngineAgent_virtualbase_scriptLoad(void* self, long long id, struct seaqt_string program, struct seaqt_string fileName, int baseLineNumber);
...
QScriptEngineAgent* QScriptEngineAgent_new(QScriptEngine* engine) {
	return new (std::nothrow) VirtualQScriptEngineAgent(engine);
}
...
bool QScriptEngineAgent_override_virtual_scriptLoad(void* self, intptr_t slot) {
	VirtualQScriptEngineAgent* self_cast = dynamic_cast<VirtualQScriptEngineAgent*>( (QScriptEngineAgent*)(self) );
...
void QScriptEngineAgent_virtualbase_scriptLoad(void* self, long long id, struct seaqt_string program, struct seaqt_string fileName, int baseLineNumber) {
	QString program_QString = QString::fromUtf8(program.data, program.len);
	QString fileName_QString = QString::fromUtf8(fileName.data, fileName.len);
	static_cast<VirtualQScriptEngineAgent*>(self)->QScriptEngineAgent::scriptLoad(static_cast<qint64>(id), program_QString, fileName_QString, static_cast<int>(baseLineNumber));
}
...
void QScriptEngineAgent_virtualbase_scriptUnload(void* self, long long id) {
	static_cast<VirtualQScriptEngineAgent*>(self)->QScriptEngineAgent::scriptUnload(static_cast<qint64>(id));
}
...
void QScriptEngineAgent_virtualbase_contextPush(void* self) {
	static_cast<VirtualQScriptEngineAgent*>(self)->QScriptEngineAgent::contextPush();
}
...
void QScriptEngineAgent_virtualbase_contextPop(void* self) {
	static_cast<VirtualQScriptEngineAgent*>(self)->QScriptEngineAgent::contextPop();
}
...
void QScriptEngineAgent_virtualbase_functionEntry(void* self, long long scriptId) {
	static_cast<VirtualQScriptEngineAgent*>(self)->QScriptEngineAgent::functionEntry(static_cast<qint64>(scriptId));
}
...
void QScriptEngineAgent_virtualbase_functionExit(void* self, long long scriptId, QScriptValue* returnValue) {
	static_cast<VirtualQScriptEngineAgent*>(self)->QScriptEngineAgent::functionExit(static_cast<qint64>(scriptId), *returnValue);
}
...
void QScriptEngineAgent_virtualbase_positionChange(void* self, long long scriptId, int lineNumber, int columnNumber) {
	static_cast<VirtualQScriptEngineAgent*>(self)->QScriptEngineAgent::positionChange(static_cast<qint64>(scriptId), static_cast<int>(lineNumber), static_cast<int>(columnNumber));
}
...
void QScriptEngineAgent_virtualbase_exceptionThrow(void* self, long long scriptId, QScriptValue* exception, bool hasHandler) {
	static_cast<VirtualQScriptEngineAgent*>(self)->QScriptEngineAgent::exceptionThrow(static_cast<qint64>(scriptId), *exception, hasHandler);
}
...
void QScriptEngineAgent_virtualbase_exceptionCatch(void* self, long long scriptId, QScriptValue* exception) {
	static_cast<VirtualQScriptEngineAgent*>(self)->QScriptEngineAgent::exceptionCatch(static_cast<qint64>(scriptId), *exception);
}
...
bool QScriptEngineAgent_virtualbase_supportsExtension(const void* self, int extension) {
	return static_cast<const VirtualQScriptEngineAgent*>(self)->QScriptEngineAgent::supportsExtension(static_cast<VirtualQScriptEngineAgent::Extension>(extension));
}
...
QVariant* QScriptEngineAgent_virtualbase_extension(void* self, int extension, QVariant* argument) {
	return new QVariant(static_cast<VirtualQScriptEngineAgent*>(self)->QScriptEngineAgent::extension(static_cast<VirtualQScriptEngineAgent::Extension>(extension), *argument));
}
