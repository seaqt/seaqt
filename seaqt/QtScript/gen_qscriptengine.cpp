...
class VirtualQScriptEngine final : public QScriptEngine {
	struct QScriptEngine_VTable* vtbl;
public:

	VirtualQScriptEngine(struct QScriptEngine_VTable* vtbl): QScriptEngine(), vtbl(vtbl) {};
	VirtualQScriptEngine(struct QScriptEngine_VTable* vtbl, QObject* parent): QScriptEngine(parent), vtbl(vtbl) {};

	virtual ~VirtualQScriptEngine() override { if(vtbl->destructor) vtbl->destructor(vtbl, this); }
...
QMetaObject* QScriptEngine_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const VirtualQScriptEngine*)(self) )->QScriptEngine::metaObject();

}

void* QScriptEngine_virtualbase_metacast(void* self, const char* param1) {

	return ( (VirtualQScriptEngine*)(self) )->QScriptEngine::qt_metacast(param1);

}

int QScriptEngine_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (VirtualQScriptEngine*)(self) )->QScriptEngine::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);

}

bool QScriptEngine_virtualbase_event(void* self, QEvent* event) {

	return ( (VirtualQScriptEngine*)(self) )->QScriptEngine::event(event);

}

bool QScriptEngine_virtualbase_eventFilter(void* self, QObject* watched, QEvent* event) {

	return ( (VirtualQScriptEngine*)(self) )->QScriptEngine::eventFilter(watched, event);

}

void QScriptEngine_virtualbase_timerEvent(void* self, QTimerEvent* event) {

	( (VirtualQScriptEngine*)(self) )->QScriptEngine::timerEvent(event);

}

void QScriptEngine_virtualbase_childEvent(void* self, QChildEvent* event) {

	( (VirtualQScriptEngine*)(self) )->QScriptEngine::childEvent(event);

}

void QScriptEngine_virtualbase_customEvent(void* self, QEvent* event) {

	( (VirtualQScriptEngine*)(self) )->QScriptEngine::customEvent(event);

}

void QScriptEngine_virtualbase_connectNotify(void* self, QMetaMethod* signal) {

	( (VirtualQScriptEngine*)(self) )->QScriptEngine::connectNotify(*signal);

}

void QScriptEngine_virtualbase_disconnectNotify(void* self, QMetaMethod* signal) {

	( (VirtualQScriptEngine*)(self) )->QScriptEngine::disconnectNotify(*signal);
...
QObject* QScriptEngine_protectedbase_sender(const void* self) {
	VirtualQScriptEngine* self_cast = static_cast<VirtualQScriptEngine*>( (QScriptEngine*)(self) );
