...
QKeyEventTransition* QKeyEventTransition_new() {
	return new (std::nothrow) VirtualQKeyEventTransition();
}

QKeyEventTransition* QKeyEventTransition_new2(QObject* object, int type, int key) {
	return new (std::nothrow) VirtualQKeyEventTransition(object, static_cast<QEvent::Type>(type), static_cast<int>(key));
}

QKeyEventTransition* QKeyEventTransition_new3(QState* sourceState) {
	return new (std::nothrow) VirtualQKeyEventTransition(sourceState);
}

QKeyEventTransition* QKeyEventTransition_new4(QObject* object, int type, int key, QState* sourceState) {
	return new (std::nothrow) VirtualQKeyEventTransition(object, static_cast<QEvent::Type>(type), static_cast<int>(key), sourceState);
}
...
QMetaObject* QKeyEventTransition_virtualbase_metaObject(const void* self) {
	return (QMetaObject*) static_cast<const VirtualQKeyEventTransition*>(self)->QKeyEventTransition::metaObject();
}
...
void* QKeyEventTransition_virtualbase_metacast(void* self, const char* param1) {
	return static_cast<VirtualQKeyEventTransition*>(self)->QKeyEventTransition::qt_metacast(param1);
}
...
int QKeyEventTransition_virtualbase_metacall(void* self, int param1, int param2, void** param3) {
	return static_cast<VirtualQKeyEventTransition*>(self)->QKeyEventTransition::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
}
...
void QKeyEventTransition_virtualbase_onTransition(void* self, QEvent* event) {
	static_cast<VirtualQKeyEventTransition*>(self)->QKeyEventTransition::onTransition(event);
}
...
bool QKeyEventTransition_virtualbase_eventTest(void* self, QEvent* event) {
	return static_cast<VirtualQKeyEventTransition*>(self)->QKeyEventTransition::eventTest(event);
}
...
bool QKeyEventTransition_virtualbase_event(void* self, QEvent* e) {
	return static_cast<VirtualQKeyEventTransition*>(self)->QKeyEventTransition::event(e);
}
...
bool QKeyEventTransition_virtualbase_eventFilter(void* self, QObject* watched, QEvent* event) {
	return static_cast<VirtualQKeyEventTransition*>(self)->QKeyEventTransition::eventFilter(watched, event);
}
...
void QKeyEventTransition_virtualbase_timerEvent(void* self, QTimerEvent* event) {
	static_cast<VirtualQKeyEventTransition*>(self)->QKeyEventTransition::timerEvent(event);
}
...
void QKeyEventTransition_virtualbase_childEvent(void* self, QChildEvent* event) {
	static_cast<VirtualQKeyEventTransition*>(self)->QKeyEventTransition::childEvent(event);
}
...
void QKeyEventTransition_virtualbase_customEvent(void* self, QEvent* event) {
	static_cast<VirtualQKeyEventTransition*>(self)->QKeyEventTransition::customEvent(event);
}
...
void QKeyEventTransition_virtualbase_connectNotify(void* self, QMetaMethod* signal) {
	static_cast<VirtualQKeyEventTransition*>(self)->QKeyEventTransition::connectNotify(*signal);
}
...
void QKeyEventTransition_virtualbase_disconnectNotify(void* self, QMetaMethod* signal) {
	static_cast<VirtualQKeyEventTransition*>(self)->QKeyEventTransition::disconnectNotify(*signal);
}
