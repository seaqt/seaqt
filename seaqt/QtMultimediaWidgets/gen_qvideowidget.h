...
typedef struct QVideoWidget_VTable{
	...
	void (*enterEvent)(VirtualQVideoWidget* self, QEnterEvent* event);
	...
	bool (*nativeEvent)(VirtualQVideoWidget* self, struct seaqt_string eventType, void* message, intptr_t* result);
