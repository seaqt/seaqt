...
bool miqt_exec_callback_QVideoWidget_nativeEvent(QVideoWidget*, intptr_t, struct seaqt_string, void*, intptr_t*);
...
public:
	...
	friend bool QVideoWidget_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, intptr_t* result);
...
bool QVideoWidget_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, intptr_t* result) {
	QByteArray eventType_QByteArray(eventType.data, eventType.len);
	return static_cast<VirtualQVideoWidget*>(self)->QVideoWidget::nativeEvent(eventType_QByteArray, message, (qintptr*)(result));
}
