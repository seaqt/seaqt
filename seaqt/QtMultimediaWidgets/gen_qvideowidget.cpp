...
public:
	...
	friend double QVideoWidget_protectedbase_getDecodedMetricF(const VirtualQVideoWidget* self, int metricA, int metricB);
};
...
double QVideoWidget_protectedbase_getDecodedMetricF(const VirtualQVideoWidget* self, int metricA, int metricB) {
	return self->QVideoWidget::getDecodedMetricF(static_cast<VirtualQVideoWidget::PaintDeviceMetric>(metricA), static_cast<VirtualQVideoWidget::PaintDeviceMetric>(metricB));
}
