...
struct QSvgWidget_VTable {
	...
	void (*enterEvent)(struct QSvgWidget_VTable* vtbl, QSvgWidget* self, QEnterEvent* event);
	...
	bool (*nativeEvent)(struct QSvgWidget_VTable* vtbl, QSvgWidget* self, struct miqt_string eventType, void* message, intptr_t* result);
