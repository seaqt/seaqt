...
bool miqt_exec_callback_QSvgWidget_nativeEvent(QSvgWidget*, intptr_t, struct seaqt_string, void*, intptr_t*);
...
public:
	...
	friend bool QSvgWidget_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, intptr_t* result);
...
QSvgWidget* QSvgWidget_new() {
	return new (std::nothrow) VirtualQSvgWidget();
}

QSvgWidget* QSvgWidget_new2(struct seaqt_string file) {
	QString file_QString = QString::fromUtf8(file.data, file.len);
	return new (std::nothrow) VirtualQSvgWidget(file_QString);
}

QSvgWidget* QSvgWidget_new3(QWidget* parent) {
	return new (std::nothrow) VirtualQSvgWidget(parent);
}

QSvgWidget* QSvgWidget_new4(struct seaqt_string file, QWidget* parent) {
	QString file_QString = QString::fromUtf8(file.data, file.len);
	return new (std::nothrow) VirtualQSvgWidget(file_QString, parent);
}
...
QMetaObject* QSvgWidget_virtualbase_metaObject(const void* self) {
	return (QMetaObject*) static_cast<const VirtualQSvgWidget*>(self)->QSvgWidget::metaObject();
}
...
void* QSvgWidget_virtualbase_metacast(void* self, const char* param1) {
	return static_cast<VirtualQSvgWidget*>(self)->QSvgWidget::qt_metacast(param1);
}
...
int QSvgWidget_virtualbase_metacall(void* self, int param1, int param2, void** param3) {
	return static_cast<VirtualQSvgWidget*>(self)->QSvgWidget::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
}
...
QSize* QSvgWidget_virtualbase_sizeHint(const void* self) {
	return new QSize(static_cast<const VirtualQSvgWidget*>(self)->QSvgWidget::sizeHint());
}
...
void QSvgWidget_virtualbase_paintEvent(void* self, QPaintEvent* event) {
	static_cast<VirtualQSvgWidget*>(self)->QSvgWidget::paintEvent(event);
}
...
int QSvgWidget_virtualbase_devType(const void* self) {
	return static_cast<const VirtualQSvgWidget*>(self)->QSvgWidget::devType();
}
...
void QSvgWidget_virtualbase_setVisible(void* self, bool visible) {
	static_cast<VirtualQSvgWidget*>(self)->QSvgWidget::setVisible(visible);
}
...
QSize* QSvgWidget_virtualbase_minimumSizeHint(const void* self) {
	return new QSize(static_cast<const VirtualQSvgWidget*>(self)->QSvgWidget::minimumSizeHint());
}
...
int QSvgWidget_virtualbase_heightForWidth(const void* self, int param1) {
	return static_cast<const VirtualQSvgWidget*>(self)->QSvgWidget::heightForWidth(static_cast<int>(param1));
}
...
bool QSvgWidget_virtualbase_hasHeightForWidth(const void* self) {
	return static_cast<const VirtualQSvgWidget*>(self)->QSvgWidget::hasHeightForWidth();
}
...
QPaintEngine* QSvgWidget_virtualbase_paintEngine(const void* self) {
	return static_cast<const VirtualQSvgWidget*>(self)->QSvgWidget::paintEngine();
}
...
bool QSvgWidget_virtualbase_event(void* self, QEvent* event) {
	return static_cast<VirtualQSvgWidget*>(self)->QSvgWidget::event(event);
}
...
void QSvgWidget_virtualbase_mousePressEvent(void* self, QMouseEvent* event) {
	static_cast<VirtualQSvgWidget*>(self)->QSvgWidget::mousePressEvent(event);
}
...
void QSvgWidget_virtualbase_mouseReleaseEvent(void* self, QMouseEvent* event) {
	static_cast<VirtualQSvgWidget*>(self)->QSvgWidget::mouseReleaseEvent(event);
}
...
void QSvgWidget_virtualbase_mouseDoubleClickEvent(void* self, QMouseEvent* event) {
	static_cast<VirtualQSvgWidget*>(self)->QSvgWidget::mouseDoubleClickEvent(event);
}
...
void QSvgWidget_virtualbase_mouseMoveEvent(void* self, QMouseEvent* event) {
	static_cast<VirtualQSvgWidget*>(self)->QSvgWidget::mouseMoveEvent(event);
}
...
void QSvgWidget_virtualbase_wheelEvent(void* self, QWheelEvent* event) {
	static_cast<VirtualQSvgWidget*>(self)->QSvgWidget::wheelEvent(event);
}
...
void QSvgWidget_virtualbase_keyPressEvent(void* self, QKeyEvent* event) {
	static_cast<VirtualQSvgWidget*>(self)->QSvgWidget::keyPressEvent(event);
}
...
void QSvgWidget_virtualbase_keyReleaseEvent(void* self, QKeyEvent* event) {
	static_cast<VirtualQSvgWidget*>(self)->QSvgWidget::keyReleaseEvent(event);
}
...
void QSvgWidget_virtualbase_focusInEvent(void* self, QFocusEvent* event) {
	static_cast<VirtualQSvgWidget*>(self)->QSvgWidget::focusInEvent(event);
}
...
void QSvgWidget_virtualbase_focusOutEvent(void* self, QFocusEvent* event) {
	static_cast<VirtualQSvgWidget*>(self)->QSvgWidget::focusOutEvent(event);
}
...
void QSvgWidget_virtualbase_enterEvent(void* self, QEnterEvent* event) {
	static_cast<VirtualQSvgWidget*>(self)->QSvgWidget::enterEvent(event);
}
...
void QSvgWidget_virtualbase_leaveEvent(void* self, QEvent* event) {
	static_cast<VirtualQSvgWidget*>(self)->QSvgWidget::leaveEvent(event);
}
...
void QSvgWidget_virtualbase_moveEvent(void* self, QMoveEvent* event) {
	static_cast<VirtualQSvgWidget*>(self)->QSvgWidget::moveEvent(event);
}
...
void QSvgWidget_virtualbase_resizeEvent(void* self, QResizeEvent* event) {
	static_cast<VirtualQSvgWidget*>(self)->QSvgWidget::resizeEvent(event);
}
...
void QSvgWidget_virtualbase_closeEvent(void* self, QCloseEvent* event) {
	static_cast<VirtualQSvgWidget*>(self)->QSvgWidget::closeEvent(event);
}
...
void QSvgWidget_virtualbase_contextMenuEvent(void* self, QContextMenuEvent* event) {
	static_cast<VirtualQSvgWidget*>(self)->QSvgWidget::contextMenuEvent(event);
}
...
void QSvgWidget_virtualbase_tabletEvent(void* self, QTabletEvent* event) {
	static_cast<VirtualQSvgWidget*>(self)->QSvgWidget::tabletEvent(event);
}
...
void QSvgWidget_virtualbase_actionEvent(void* self, QActionEvent* event) {
	static_cast<VirtualQSvgWidget*>(self)->QSvgWidget::actionEvent(event);
}
...
void QSvgWidget_virtualbase_dragEnterEvent(void* self, QDragEnterEvent* event) {
	static_cast<VirtualQSvgWidget*>(self)->QSvgWidget::dragEnterEvent(event);
}
...
void QSvgWidget_virtualbase_dragMoveEvent(void* self, QDragMoveEvent* event) {
	static_cast<VirtualQSvgWidget*>(self)->QSvgWidget::dragMoveEvent(event);
}
...
void QSvgWidget_virtualbase_dragLeaveEvent(void* self, QDragLeaveEvent* event) {
	static_cast<VirtualQSvgWidget*>(self)->QSvgWidget::dragLeaveEvent(event);
}
...
void QSvgWidget_virtualbase_dropEvent(void* self, QDropEvent* event) {
	static_cast<VirtualQSvgWidget*>(self)->QSvgWidget::dropEvent(event);
}
...
void QSvgWidget_virtualbase_showEvent(void* self, QShowEvent* event) {
	static_cast<VirtualQSvgWidget*>(self)->QSvgWidget::showEvent(event);
}
...
void QSvgWidget_virtualbase_hideEvent(void* self, QHideEvent* event) {
	static_cast<VirtualQSvgWidget*>(self)->QSvgWidget::hideEvent(event);
}
...
bool QSvgWidget_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, intptr_t* result) {
	QByteArray eventType_QByteArray(eventType.data, eventType.len);
	return static_cast<VirtualQSvgWidget*>(self)->QSvgWidget::nativeEvent(eventType_QByteArray, message, (qintptr*)(result));
}
...
void QSvgWidget_virtualbase_changeEvent(void* self, QEvent* param1) {
	static_cast<VirtualQSvgWidget*>(self)->QSvgWidget::changeEvent(param1);
}
...
int QSvgWidget_virtualbase_metric(const void* self, int param1) {
	return static_cast<const VirtualQSvgWidget*>(self)->QSvgWidget::metric(static_cast<VirtualQSvgWidget::PaintDeviceMetric>(param1));
}
...
void QSvgWidget_virtualbase_initPainter(const void* self, QPainter* painter) {
	static_cast<const VirtualQSvgWidget*>(self)->QSvgWidget::initPainter(painter);
}
...
QPaintDevice* QSvgWidget_virtualbase_redirected(const void* self, QPoint* offset) {
	return static_cast<const VirtualQSvgWidget*>(self)->QSvgWidget::redirected(offset);
}
...
QPainter* QSvgWidget_virtualbase_sharedPainter(const void* self) {
	return static_cast<const VirtualQSvgWidget*>(self)->QSvgWidget::sharedPainter();
}
...
void QSvgWidget_virtualbase_inputMethodEvent(void* self, QInputMethodEvent* param1) {
	static_cast<VirtualQSvgWidget*>(self)->QSvgWidget::inputMethodEvent(param1);
}
...
QVariant* QSvgWidget_virtualbase_inputMethodQuery(const void* self, int param1) {
	return new QVariant(static_cast<const VirtualQSvgWidget*>(self)->QSvgWidget::inputMethodQuery(static_cast<Qt::InputMethodQuery>(param1)));
}
...
bool QSvgWidget_virtualbase_focusNextPrevChild(void* self, bool next) {
	return static_cast<VirtualQSvgWidget*>(self)->QSvgWidget::focusNextPrevChild(next);
}
...
bool QSvgWidget_virtualbase_eventFilter(void* self, QObject* watched, QEvent* event) {
	return static_cast<VirtualQSvgWidget*>(self)->QSvgWidget::eventFilter(watched, event);
}
...
void QSvgWidget_virtualbase_timerEvent(void* self, QTimerEvent* event) {
	static_cast<VirtualQSvgWidget*>(self)->QSvgWidget::timerEvent(event);
}
...
void QSvgWidget_virtualbase_childEvent(void* self, QChildEvent* event) {
	static_cast<VirtualQSvgWidget*>(self)->QSvgWidget::childEvent(event);
}
...
void QSvgWidget_virtualbase_customEvent(void* self, QEvent* event) {
	static_cast<VirtualQSvgWidget*>(self)->QSvgWidget::customEvent(event);
}
...
void QSvgWidget_virtualbase_connectNotify(void* self, QMetaMethod* signal) {
	static_cast<VirtualQSvgWidget*>(self)->QSvgWidget::connectNotify(*signal);
}
...
void QSvgWidget_virtualbase_disconnectNotify(void* self, QMetaMethod* signal) {
	static_cast<VirtualQSvgWidget*>(self)->QSvgWidget::disconnectNotify(*signal);
}
