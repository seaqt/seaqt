...
public:
	...
	friend double QSvgWidget_protectedbase_getDecodedMetricF(const VirtualQSvgWidget* self, int metricA, int metricB);
};
...
double QSvgWidget_protectedbase_getDecodedMetricF(const VirtualQSvgWidget* self, int metricA, int metricB) {
	return self->QSvgWidget::getDecodedMetricF(static_cast<VirtualQSvgWidget::PaintDeviceMetric>(metricA), static_cast<VirtualQSvgWidget::PaintDeviceMetric>(metricB));
}
