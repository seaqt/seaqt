#pragma once
#ifndef SEAQT_QTGUI_GEN_QSTYLEHINTS_H
#define SEAQT_QTGUI_GEN_QSTYLEHINTS_H
...
struct seaqt_string QStyleHints_tr(const char* s);
struct seaqt_string QStyleHints_trUtf8(const char* s);
...
struct seaqt_string QStyleHints_tr2(const char* s, const char* c);
struct seaqt_string QStyleHints_tr3(const char* s, const char* c, int n);
struct seaqt_string QStyleHints_trUtf82(const char* s, const char* c);
struct seaqt_string QStyleHints_trUtf83(const char* s, const char* c, int n);
