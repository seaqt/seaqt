...
struct seaqt_string QStyleHints_trUtf8_s(const char* s);
...
struct seaqt_string QStyleHints_trUtf8_s_c(const char* s, const char* c);
struct seaqt_string QStyleHints_trUtf8_s_c_n(const char* s, const char* c, int n);
