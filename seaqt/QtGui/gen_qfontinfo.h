#pragma once
#ifndef SEAQT_QTGUI_GEN_QFONTINFO_H
#define SEAQT_QTGUI_GEN_QFONTINFO_H
...
struct seaqt_array /* of QFontVariableAxis* */  QFontInfo_variableAxes(const QFontInfo* self);
