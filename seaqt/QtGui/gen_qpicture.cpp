...
public:
	...
	friend double QPicture_protectedbase_getDecodedMetricF(const VirtualQPicture* self, int metricA, int metricB);
};
...
double QPicture_protectedbase_getDecodedMetricF(const VirtualQPicture* self, int metricA, int metricB) {
	return self->QPicture::getDecodedMetricF(static_cast<VirtualQPicture::PaintDeviceMetric>(metricA), static_cast<VirtualQPicture::PaintDeviceMetric>(metricB));
}
