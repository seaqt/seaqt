...
struct seaqt_string QClipboard_tr(const char* s);
struct seaqt_string QClipboard_trUtf8(const char* s);
...
struct seaqt_string QClipboard_textWithSubtype(const QClipboard* self, struct seaqt_string subtype);
void QClipboard_setText(QClipboard* self, struct seaqt_string param1);
...
struct seaqt_string QClipboard_tr2(const char* s, const char* c);
struct seaqt_string QClipboard_tr3(const char* s, const char* c, int n);
struct seaqt_string QClipboard_trUtf82(const char* s, const char* c);
struct seaqt_string QClipboard_trUtf83(const char* s, const char* c, int n);
void QClipboard_clearWithMode(QClipboard* self, int mode);
struct seaqt_string QClipboard_textWithMode(const QClipboard* self, int mode);
struct seaqt_string QClipboard_text2(const QClipboard* self, struct seaqt_string subtype, int mode);
void QClipboard_setText2(QClipboard* self, struct seaqt_string param1, int mode);
