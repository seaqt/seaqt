...
void QMatrix4x4_projectedRotate_angle_x_y_z_distanceToPlane(QMatrix4x4* self, float angle, float x, float y, float z, float distanceToPlane);
void QMatrix4x4_projectedRotate_angle_x_y_z(QMatrix4x4* self, float angle, float x, float y, float z);
