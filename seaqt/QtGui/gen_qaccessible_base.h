#pragma once
#ifndef SEAQT_QTGUI_GEN_QACCESSIBLE_BASE_H
#define SEAQT_QTGUI_GEN_QACCESSIBLE_BASE_H
...
void QAccessible__State_setQt_reserved(QAccessible__State* self, unsigned long long qt_reserved);
