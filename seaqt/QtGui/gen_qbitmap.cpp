...
public:
	...
	friend double QBitmap_protectedbase_getDecodedMetricF(const VirtualQBitmap* self, int metricA, int metricB);
};
...
double QBitmap_protectedbase_getDecodedMetricF(const VirtualQBitmap* self, int metricA, int metricB) {
	return self->QBitmap::getDecodedMetricF(static_cast<VirtualQBitmap::PaintDeviceMetric>(metricA), static_cast<VirtualQBitmap::PaintDeviceMetric>(metricB));
}
