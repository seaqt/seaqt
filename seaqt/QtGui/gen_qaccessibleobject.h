#pragma once
#ifndef SEAQT_QTGUI_GEN_QACCESSIBLEOBJECT_H
#define SEAQT_QTGUI_GEN_QACCESSIBLEOBJECT_H
...
void QAccessibleObject_setText(QAccessibleObject* self, int t, struct seaqt_string text);
...
struct seaqt_string QAccessibleApplication_text(const QAccessibleApplication* self, int t);
