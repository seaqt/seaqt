#pragma once
#ifndef SEAQT_QTGUI_GEN_QTEXTOBJECT_H
#define SEAQT_QTGUI_GEN_QTEXTOBJECT_H
...
void* QTextFrame_vdata(VirtualQTextFrame* self);
VirtualQTextFrame* vdata_QTextFrame(void* vdata);
