...
void QBrush_operatorAssign_QBrush(QBrush* self, QBrush* from) {
	self->operator=(*from);
}
...
void QBrush_operatorAssign_Qt_BrushStyle(QBrush* self, int style) {
	self->operator=(static_cast<Qt::BrushStyle>(style));
}

void QBrush_operatorAssign_QColor(QBrush* self, QColor* color) {
	self->operator=(*color);
}

void QBrush_operatorAssign_Qt_GlobalColor(QBrush* self, int color) {
