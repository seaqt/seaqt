...
typedef struct QStandardItem_VTable{
	...
	void (*multiData)(const VirtualQStandardItem* self, QModelRoleDataSpan* roleDataSpan);
...
void* QStandardItem_vdata(VirtualQStandardItem* self);
VirtualQStandardItem* vdata_QStandardItem(void* vdata);
...
typedef struct QStandardItemModel_VTable{
	...
	struct seaqt_map /* of int to struct seaqt_string */  (*roleNames)(const VirtualQStandardItemModel* self);
	...
	void (*multiData)(const VirtualQStandardItemModel* self, QModelIndex* index, QModelRoleDataSpan* roleDataSpan);
	bool (*setData)(VirtualQStandardItemModel* self, QModelIndex* index, QVariant* value, int role);
	bool (*clearItemData)(VirtualQStandardItemModel* self, QModelIndex* index);
	...
	struct seaqt_map /* of int to QVariant* */  (*itemData)(const VirtualQStandardItemModel* self, QModelIndex* index);
	bool (*setItemData)(VirtualQStandardItemModel* self, QModelIndex* index, struct seaqt_map /* of int to QVariant* */  roles);
	void (*sort)(VirtualQStandardItemModel* self, int column, int order);
	struct seaqt_array /* of struct seaqt_string */  (*mimeTypes)(const VirtualQStandardItemModel* self);
	QMimeData* (*mimeData)(const VirtualQStandardItemModel* self, struct seaqt_array /* of QModelIndex* */  indexes);
	...
	struct seaqt_array /* of QModelIndex* */  (*match)(const VirtualQStandardItemModel* self, QModelIndex* start, int role, QVariant* value, int hits, int flags);
	...
	void (*resetInternalData)(VirtualQStandardItemModel* self);
...
void* QStandardItemModel_vdata(VirtualQStandardItemModel* self);
VirtualQStandardItemModel* vdata_QStandardItemModel(void* vdata);
