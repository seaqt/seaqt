...
struct QStandardItem_VTable {
	void (*destructor)(struct QStandardItem_VTable* vtbl, QStandardItem* self);
	QVariant* (*data)(struct QStandardItem_VTable* vtbl, const QStandardItem* self, int role);
	void (*multiData)(struct QStandardItem_VTable* vtbl, const QStandardItem* self, QModelRoleDataSpan* roleDataSpan);
	void (*setData)(struct QStandardItem_VTable* vtbl, QStandardItem* self, QVariant* value, int role);
	QStandardItem* (*clone)(struct QStandardItem_VTable* vtbl, const QStandardItem* self);
	int (*type)(struct QStandardItem_VTable* vtbl, const QStandardItem* self);
	void (*read)(struct QStandardItem_VTable* vtbl, QStandardItem* self, QDataStream* in);
	void (*write)(struct QStandardItem_VTable* vtbl, const QStandardItem* self, QDataStream* out);
	bool (*operatorLesser)(struct QStandardItem_VTable* vtbl, const QStandardItem* self, QStandardItem* other);
};
...
struct QStandardItemModel_VTable {
	void (*destructor)(struct QStandardItemModel_VTable* vtbl, QStandardItemModel* self);
	QMetaObject* (*metaObject)(struct QStandardItemModel_VTable* vtbl, const QStandardItemModel* self);
	void* (*metacast)(struct QStandardItemModel_VTable* vtbl, QStandardItemModel* self, const char* param1);
	int (*metacall)(struct QStandardItemModel_VTable* vtbl, QStandardItemModel* self, int param1, int param2, void** param3);
	struct miqt_map /* of int to struct miqt_string */  (*roleNames)(struct QStandardItemModel_VTable* vtbl, const QStandardItemModel* self);
	QModelIndex* (*index)(struct QStandardItemModel_VTable* vtbl, const QStandardItemModel* self, int row, int column, QModelIndex* parent);
	QModelIndex* (*parent)(struct QStandardItemModel_VTable* vtbl, const QStandardItemModel* self, QModelIndex* child);
	int (*rowCount)(struct QStandardItemModel_VTable* vtbl, const QStandardItemModel* self, QModelIndex* parent);
	int (*columnCount)(struct QStandardItemModel_VTable* vtbl, const QStandardItemModel* self, QModelIndex* parent);
	bool (*hasChildren)(struct QStandardItemModel_VTable* vtbl, const QStandardItemModel* self, QModelIndex* parent);
	QVariant* (*data)(struct QStandardItemModel_VTable* vtbl, const QStandardItemModel* self, QModelIndex* index, int role);
	void (*multiData)(struct QStandardItemModel_VTable* vtbl, const QStandardItemModel* self, QModelIndex* index, QModelRoleDataSpan* roleDataSpan);
	bool (*setData)(struct QStandardItemModel_VTable* vtbl, QStandardItemModel* self, QModelIndex* index, QVariant* value, int role);
	bool (*clearItemData)(struct QStandardItemModel_VTable* vtbl, QStandardItemModel* self, QModelIndex* index);
	QVariant* (*headerData)(struct QStandardItemModel_VTable* vtbl, const QStandardItemModel* self, int section, int orientation, int role);
	bool (*setHeaderData)(struct QStandardItemModel_VTable* vtbl, QStandardItemModel* self, int section, int orientation, QVariant* value, int role);
	bool (*insertRows)(struct QStandardItemModel_VTable* vtbl, QStandardItemModel* self, int row, int count, QModelIndex* parent);
	bool (*insertColumns)(struct QStandardItemModel_VTable* vtbl, QStandardItemModel* self, int column, int count, QModelIndex* parent);
	bool (*removeRows)(struct QStandardItemModel_VTable* vtbl, QStandardItemModel* self, int row, int count, QModelIndex* parent);
	bool (*removeColumns)(struct QStandardItemModel_VTable* vtbl, QStandardItemModel* self, int column, int count, QModelIndex* parent);
	int (*flags)(struct QStandardItemModel_VTable* vtbl, const QStandardItemModel* self, QModelIndex* index);
	int (*supportedDropActions)(struct QStandardItemModel_VTable* vtbl, const QStandardItemModel* self);
	struct miqt_map /* of int to QVariant* */  (*itemData)(struct QStandardItemModel_VTable* vtbl, const QStandardItemModel* self, QModelIndex* index);
	bool (*setItemData)(struct QStandardItemModel_VTable* vtbl, QStandardItemModel* self, QModelIndex* index, struct miqt_map /* of int to QVariant* */  roles);
	void (*sort)(struct QStandardItemModel_VTable* vtbl, QStandardItemModel* self, int column, int order);
	struct miqt_array /* of struct miqt_string */  (*mimeTypes)(struct QStandardItemModel_VTable* vtbl, const QStandardItemModel* self);
	QMimeData* (*mimeData)(struct QStandardItemModel_VTable* vtbl, const QStandardItemModel* self, struct miqt_array /* of QModelIndex* */  indexes);
	bool (*dropMimeData)(struct QStandardItemModel_VTable* vtbl, QStandardItemModel* self, QMimeData* data, int action, int row, int column, QModelIndex* parent);
	QModelIndex* (*sibling)(struct QStandardItemModel_VTable* vtbl, const QStandardItemModel* self, int row, int column, QModelIndex* idx);
	bool (*canDropMimeData)(struct QStandardItemModel_VTable* vtbl, const QStandardItemModel* self, QMimeData* data, int action, int row, int column, QModelIndex* parent);
	int (*supportedDragActions)(struct QStandardItemModel_VTable* vtbl, const QStandardItemModel* self);
	bool (*moveRows)(struct QStandardItemModel_VTable* vtbl, QStandardItemModel* self, QModelIndex* sourceParent, int sourceRow, int count, QModelIndex* destinationParent, int destinationChild);
	bool (*moveColumns)(struct QStandardItemModel_VTable* vtbl, QStandardItemModel* self, QModelIndex* sourceParent, int sourceColumn, int count, QModelIndex* destinationParent, int destinationChild);
	void (*fetchMore)(struct QStandardItemModel_VTable* vtbl, QStandardItemModel* self, QModelIndex* parent);
	bool (*canFetchMore)(struct QStandardItemModel_VTable* vtbl, const QStandardItemModel* self, QModelIndex* parent);
	QModelIndex* (*buddy)(struct QStandardItemModel_VTable* vtbl, const QStandardItemModel* self, QModelIndex* index);
	struct miqt_array /* of QModelIndex* */  (*match)(struct QStandardItemModel_VTable* vtbl, const QStandardItemModel* self, QModelIndex* start, int role, QVariant* value, int hits, int flags);
	QSize* (*span)(struct QStandardItemModel_VTable* vtbl, const QStandardItemModel* self, QModelIndex* index);
	bool (*submit)(struct QStandardItemModel_VTable* vtbl, QStandardItemModel* self);
	void (*revert)(struct QStandardItemModel_VTable* vtbl, QStandardItemModel* self);
	void (*resetInternalData)(struct QStandardItemModel_VTable* vtbl, QStandardItemModel* self);
	bool (*event)(struct QStandardItemModel_VTable* vtbl, QStandardItemModel* self, QEvent* event);
	bool (*eventFilter)(struct QStandardItemModel_VTable* vtbl, QStandardItemModel* self, QObject* watched, QEvent* event);
	void (*timerEvent)(struct QStandardItemModel_VTable* vtbl, QStandardItemModel* self, QTimerEvent* event);
	void (*childEvent)(struct QStandardItemModel_VTable* vtbl, QStandardItemModel* self, QChildEvent* event);
	void (*customEvent)(struct QStandardItemModel_VTable* vtbl, QStandardItemModel* self, QEvent* event);
	void (*connectNotify)(struct QStandardItemModel_VTable* vtbl, QStandardItemModel* self, QMetaMethod* signal);
	void (*disconnectNotify)(struct QStandardItemModel_VTable* vtbl, QStandardItemModel* self, QMetaMethod* signal);
};
