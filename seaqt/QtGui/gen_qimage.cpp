...
public:
	...
	friend void QImage_protectedbase_detachMetadata_invalidateCache(VirtualQImage* self, bool invalidateCache);
	friend double QImage_protectedbase_getDecodedMetricF(const VirtualQImage* self, int metricA, int metricB);
};
...
double QImage_protectedbase_getDecodedMetricF(const VirtualQImage* self, int metricA, int metricB) {
	return self->QImage::getDecodedMetricF(static_cast<VirtualQImage::PaintDeviceMetric>(metricA), static_cast<VirtualQImage::PaintDeviceMetric>(metricB));
}
