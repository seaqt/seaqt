...
QTextFrame* QTextFrame_new(QTextDocument* doc) {
	return new (std::nothrow) VirtualQTextFrame(doc);
}
...
QMetaObject* QTextFrame_virtualbase_metaObject(const void* self) {
	return (QMetaObject*) static_cast<const VirtualQTextFrame*>(self)->QTextFrame::metaObject();
}
...
void* QTextFrame_virtualbase_metacast(void* self, const char* param1) {
	return static_cast<VirtualQTextFrame*>(self)->QTextFrame::qt_metacast(param1);
}
...
int QTextFrame_virtualbase_metacall(void* self, int param1, int param2, void** param3) {
	return static_cast<VirtualQTextFrame*>(self)->QTextFrame::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
}
...
bool QTextFrame_virtualbase_event(void* self, QEvent* event) {
	return static_cast<VirtualQTextFrame*>(self)->QTextFrame::event(event);
}
...
bool QTextFrame_virtualbase_eventFilter(void* self, QObject* watched, QEvent* event) {
	return static_cast<VirtualQTextFrame*>(self)->QTextFrame::eventFilter(watched, event);
}
...
void QTextFrame_virtualbase_timerEvent(void* self, QTimerEvent* event) {
	static_cast<VirtualQTextFrame*>(self)->QTextFrame::timerEvent(event);
}
...
void QTextFrame_virtualbase_childEvent(void* self, QChildEvent* event) {
	static_cast<VirtualQTextFrame*>(self)->QTextFrame::childEvent(event);
}
...
void QTextFrame_virtualbase_customEvent(void* self, QEvent* event) {
	static_cast<VirtualQTextFrame*>(self)->QTextFrame::customEvent(event);
}
...
void QTextFrame_virtualbase_connectNotify(void* self, QMetaMethod* signal) {
	static_cast<VirtualQTextFrame*>(self)->QTextFrame::connectNotify(*signal);
}
...
void QTextFrame_virtualbase_disconnectNotify(void* self, QMetaMethod* signal) {
	static_cast<VirtualQTextFrame*>(self)->QTextFrame::disconnectNotify(*signal);
}
