...
void QTextFrameLayoutData_operatorAssign(QTextFrameLayoutData* self, QTextFrameLayoutData* from) {
	self->operator=(*from);
}
...
public:
	friend void* QTextFrame_vdata(VirtualQTextFrame* self);
	friend VirtualQTextFrame* vdata_QTextFrame(void* vdata);

	VirtualQTextFrame(const QTextFrame_VTable* vtbl, QTextDocument* doc): QTextFrame(doc), vtbl(vtbl) {}
...
VirtualQTextFrame* QTextFrame_new(const QTextFrame_VTable* vtbl, size_t vdata, QTextDocument* doc) {
	void* _mem_ = ::operator new(seaqt_aligned_sizeof<VirtualQTextFrame>() + vdata, std::nothrow);
	return _mem_ ? new (_mem_)VirtualQTextFrame(vtbl, doc) : nullptr;
}
...
void* QTextFrame_vdata(VirtualQTextFrame* self) { return reinterpret_cast<void*>(reinterpret_cast<char*>(self) + seaqt_aligned_sizeof<VirtualQTextFrame>()); }
VirtualQTextFrame* vdata_QTextFrame(void* vdata) { return reinterpret_cast<VirtualQTextFrame*>(reinterpret_cast<char*>(vdata) - seaqt_aligned_sizeof<VirtualQTextFrame>()); }
...
struct seaqt_string QTextBlock_text(const QTextBlock* self) {
...
struct seaqt_array /* of QTextLayout__FormatRange* */  QTextBlock_textFormats(const QTextBlock* self) {
