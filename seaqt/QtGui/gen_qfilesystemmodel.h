...
struct QFileSystemModel_VTable {
	...
	bool (*clearItemData)(struct QFileSystemModel_VTable* vtbl, QFileSystemModel* self, QModelIndex* index);
	...
	void (*multiData)(struct QFileSystemModel_VTable* vtbl, const QFileSystemModel* self, QModelIndex* index, QModelRoleDataSpan* roleDataSpan);
	...
	void (*resetInternalData)(struct QFileSystemModel_VTable* vtbl, QFileSystemModel* self);
