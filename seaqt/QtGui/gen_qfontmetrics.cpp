...
QFontMetrics* QFontMetrics_new_QFontMetrics(QFontMetrics* from) {
	return new (std::nothrow) QFontMetrics(*from);
}
...
int QFontMetrics_width_QString(const QFontMetrics* self, struct seaqt_string param1) {
	QString param1_QString = QString::fromUtf8(param1.data, param1.len);
	return self->width(param1_QString);
}

int QFontMetrics_width_QString_int_int(const QFontMetrics* self, struct seaqt_string param1, int len, int flags) {
	QString param1_QString = QString::fromUtf8(param1.data, param1.len);
	return self->width(param1_QString, static_cast<int>(len), static_cast<int>(flags));
}

int QFontMetrics_width_QChar(const QFontMetrics* self, QChar* param1) {
...
int QFontMetrics_width_QString_int(const QFontMetrics* self, struct seaqt_string param1, int len) {
	QString param1_QString = QString::fromUtf8(param1.data, param1.len);
...
QFontMetricsF* QFontMetricsF_new_QFontMetricsF(QFontMetricsF* from) {
	return new (std::nothrow) QFontMetricsF(*from);
}
...
double QFontMetricsF_width_QString(const QFontMetricsF* self, struct seaqt_string string) {
	QString string_QString = QString::fromUtf8(string.data, string.len);
	qreal _ret = self->width(string_QString);
	return static_cast<double>(_ret);
}

double QFontMetricsF_width_QChar(const QFontMetricsF* self, QChar* param1) {
