...
int QFontMetrics_width(const QFontMetrics* self, struct seaqt_string param1) {
	QString param1_QString = QString::fromUtf8(param1.data, param1.len);
	return self->width(param1_QString);
}

int QFontMetrics_width2(const QFontMetrics* self, struct seaqt_string param1, int len, int flags) {
	QString param1_QString = QString::fromUtf8(param1.data, param1.len);
	return self->width(param1_QString, static_cast<int>(len), static_cast<int>(flags));
}
...
int QFontMetrics_charWidth(const QFontMetrics* self, struct seaqt_string str, int pos) {
...
QRect* QFontMetrics_boundingRect2(const QFontMetrics* self, QRect* r, int flags, struct seaqt_string text) {
	QString text_QString = QString::fromUtf8(text.data, text.len);
	return new QRect(self->boundingRect(*r, static_cast<int>(flags), text_QString));
}

QRect* QFontMetrics_boundingRect3(const QFontMetrics* self, int x, int y, int w, int h, int flags, struct seaqt_string text) {
	QString text_QString = QString::fromUtf8(text.data, text.len);
...
int QFontMetrics_width3(const QFontMetrics* self, struct seaqt_string param1, int len) {
	QString param1_QString = QString::fromUtf8(param1.data, param1.len);
	return self->width(param1_QString, static_cast<int>(len));
}

int QFontMetrics_horizontalAdvance2(const QFontMetrics* self, struct seaqt_string param1, int len) {
	QString param1_QString = QString::fromUtf8(param1.data, param1.len);
	return self->horizontalAdvance(param1_QString, static_cast<int>(len));
}

QRect* QFontMetrics_boundingRect4(const QFontMetrics* self, QRect* r, int flags, struct seaqt_string text, int tabstops) {
	QString text_QString = QString::fromUtf8(text.data, text.len);
	return new QRect(self->boundingRect(*r, static_cast<int>(flags), text_QString, static_cast<int>(tabstops)));
}

QRect* QFontMetrics_boundingRect5(const QFontMetrics* self, QRect* r, int flags, struct seaqt_string text, int tabstops, int* tabarray) {
	QString text_QString = QString::fromUtf8(text.data, text.len);
...
QRect* QFontMetrics_boundingRect6(const QFontMetrics* self, int x, int y, int w, int h, int flags, struct seaqt_string text, int tabstops) {
	QString text_QString = QString::fromUtf8(text.data, text.len);
...
QRect* QFontMetrics_boundingRect7(const QFontMetrics* self, int x, int y, int w, int h, int flags, struct seaqt_string text, int tabstops, int* tabarray) {
	QString text_QString = QString::fromUtf8(text.data, text.len);
...
double QFontMetricsF_width(const QFontMetricsF* self, struct seaqt_string string) {
	QString string_QString = QString::fromUtf8(string.data, string.len);
	qreal _ret = self->width(string_QString);
	return static_cast<double>(_ret);
}
...
QRectF* QFontMetricsF_boundingRect2(const QFontMetricsF* self, QRectF* r, int flags, struct seaqt_string string) {
	QString string_QString = QString::fromUtf8(string.data, string.len);
...
double QFontMetricsF_horizontalAdvance2(const QFontMetricsF* self, struct seaqt_string string, int length) {
	QString string_QString = QString::fromUtf8(string.data, string.len);
	qreal _ret = self->horizontalAdvance(string_QString, static_cast<int>(length));
	return static_cast<double>(_ret);
}

QRectF* QFontMetricsF_boundingRect3(const QFontMetricsF* self, QRectF* r, int flags, struct seaqt_string string, int tabstops) {
	QString string_QString = QString::fromUtf8(string.data, string.len);
	return new QRectF(self->boundingRect(*r, static_cast<int>(flags), string_QString, static_cast<int>(tabstops)));
}

QRectF* QFontMetricsF_boundingRect4(const QFontMetricsF* self, QRectF* r, int flags, struct seaqt_string string, int tabstops, int* tabarray) {
	QString string_QString = QString::fromUtf8(string.data, string.len);
