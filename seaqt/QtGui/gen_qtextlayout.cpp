...
void QTextLine_draw_p_point(const QTextLine* self, QPainter* p, QPointF* point) {
	self->draw(p, *point);
}
...
void QTextLine_draw_p_point_selection(const QTextLine* self, QPainter* p, QPointF* point, QTextLayout__FormatRange* selection) {
