...
typedef struct QWindow_VTable{
	...
	void (*paintEvent)(VirtualQWindow* self, QPaintEvent* param1);
	...
	void (*closeEvent)(VirtualQWindow* self, QCloseEvent* param1);
	...
	bool (*nativeEvent)(VirtualQWindow* self, struct seaqt_string eventType, void* message, intptr_t* result);
...
bool QWindow_nativeEvent(QWindow* self, struct seaqt_string eventType, void* message, intptr_t* result);
