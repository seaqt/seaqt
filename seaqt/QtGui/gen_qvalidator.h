...
struct seaqt_string QValidator_trUtf8_s(const char* s);
...
struct seaqt_string QValidator_trUtf8_s_c(const char* s, const char* c);
struct seaqt_string QValidator_trUtf8_s_c_n(const char* s, const char* c, int n);
...
typedef struct QIntValidator_VTable{
	...
	void (*setRange)(VirtualQIntValidator* self, int bottom, int top);
...
struct seaqt_string QIntValidator_trUtf8_s(const char* s);
...
struct seaqt_string QIntValidator_trUtf8_s_c(const char* s, const char* c);
struct seaqt_string QIntValidator_trUtf8_s_c_n(const char* s, const char* c, int n);
...
typedef struct QDoubleValidator_VTable{
	...
	void (*setRange)(VirtualQDoubleValidator* self, double bottom, double top, int decimals);
	void (*fixup)(const VirtualQDoubleValidator* self, struct seaqt_string param1);
...
struct seaqt_string QDoubleValidator_trUtf8_s(const char* s);
...
struct seaqt_string QDoubleValidator_trUtf8_s_c(const char* s, const char* c);
struct seaqt_string QDoubleValidator_trUtf8_s_c_n(const char* s, const char* c, int n);
...
typedef struct VirtualQRegExpValidator VirtualQRegExpValidator;
typedef struct QRegExpValidator_VTable{
	void (*destructor)(VirtualQRegExpValidator* self);
	QMetaObject* (*metaObject)(const VirtualQRegExpValidator* self);
	void* (*metacast)(VirtualQRegExpValidator* self, const char* param1);
	int (*metacall)(VirtualQRegExpValidator* self, int param1, int param2, void** param3);
	int (*validate)(const VirtualQRegExpValidator* self, struct seaqt_string input, int* pos);
	void (*fixup)(const VirtualQRegExpValidator* self, struct seaqt_string param1);
	bool (*event)(VirtualQRegExpValidator* self, QEvent* event);
	bool (*eventFilter)(VirtualQRegExpValidator* self, QObject* watched, QEvent* event);
	void (*timerEvent)(VirtualQRegExpValidator* self, QTimerEvent* event);
	void (*childEvent)(VirtualQRegExpValidator* self, QChildEvent* event);
	void (*customEvent)(VirtualQRegExpValidator* self, QEvent* event);
	void (*connectNotify)(VirtualQRegExpValidator* self, QMetaMethod* signal);
	void (*disconnectNotify)(VirtualQRegExpValidator* self, QMetaMethod* signal);
}QRegExpValidator_VTable;

void* QRegExpValidator_vdata(VirtualQRegExpValidator* self);
VirtualQRegExpValidator* vdata_QRegExpValidator(void* vdata);

VirtualQRegExpValidator* QRegExpValidator_new(const QRegExpValidator_VTable* vtbl, size_t vdata);
VirtualQRegExpValidator* QRegExpValidator_new_rx(const QRegExpValidator_VTable* vtbl, size_t vdata, QRegExp* rx);
VirtualQRegExpValidator* QRegExpValidator_new_parent(const QRegExpValidator_VTable* vtbl, size_t vdata, QObject* parent);
VirtualQRegExpValidator* QRegExpValidator_new_rx_parent(const QRegExpValidator_VTable* vtbl, size_t vdata, QRegExp* rx, QObject* parent);
...
struct seaqt_string QRegExpValidator_tr_s(const char* s);
struct seaqt_string QRegExpValidator_trUtf8_s(const char* s);
...
struct seaqt_string QRegExpValidator_tr_s_c(const char* s, const char* c);
struct seaqt_string QRegExpValidator_tr_s_c_n(const char* s, const char* c, int n);
struct seaqt_string QRegExpValidator_trUtf8_s_c(const char* s, const char* c);
struct seaqt_string QRegExpValidator_trUtf8_s_c_n(const char* s, const char* c, int n);
...
struct seaqt_string QRegularExpressionValidator_trUtf8_s(const char* s);
...
struct seaqt_string QRegularExpressionValidator_trUtf8_s_c(const char* s, const char* c);
struct seaqt_string QRegularExpressionValidator_trUtf8_s_c_n(const char* s, const char* c, int n);
