...
QKeySequence* QKeySequence_new2(struct seaqt_string key) {
...
QKeySequence* QKeySequence_new6(struct seaqt_string key, int format) {
	QString key_QString = QString::fromUtf8(key.data, key.len);
...
QKeySequence* QKeySequence_fromString(struct seaqt_string str) {
	QString str_QString = QString::fromUtf8(str.data, str.len);
	return new QKeySequence(QKeySequence::fromString(str_QString));
}

struct seaqt_array /* of QKeySequence* */  QKeySequence_listFromString(struct seaqt_string str) {
	QString str_QString = QString::fromUtf8(str.data, str.len);
...
struct seaqt_string QKeySequence_listToString(struct seaqt_array /* of QKeySequence* */  list) {
...
struct seaqt_string QKeySequence_toStringWithFormat(const QKeySequence* self, int format) {
...
QKeySequence* QKeySequence_fromString2(struct seaqt_string str, int format) {
	QString str_QString = QString::fromUtf8(str.data, str.len);
