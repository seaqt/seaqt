...
public:
	...
	friend double QPixmap_protectedbase_getDecodedMetricF(const VirtualQPixmap* self, int metricA, int metricB);
};
...
double QPixmap_protectedbase_getDecodedMetricF(const VirtualQPixmap* self, int metricA, int metricB) {
	return self->QPixmap::getDecodedMetricF(static_cast<VirtualQPixmap::PaintDeviceMetric>(metricA), static_cast<VirtualQPixmap::PaintDeviceMetric>(metricB));
}
