...
QTextItem* QTextItem_new_from(QTextItem* from);
...
typedef struct QPaintEngine_VTable{
	...
	void (*drawRects_QRect_int)(VirtualQPaintEngine* self, QRect* rects, int rectCount);
	void (*drawRects_QRectF_int)(VirtualQPaintEngine* self, QRectF* rects, int rectCount);
	void (*drawLines_QLine_int)(VirtualQPaintEngine* self, QLine* lines, int lineCount);
	void (*drawLines_QLineF_int)(VirtualQPaintEngine* self, QLineF* lines, int lineCount);
	void (*drawEllipse_QRectF)(VirtualQPaintEngine* self, QRectF* r);
	void (*drawEllipse_QRect)(VirtualQPaintEngine* self, QRect* r);
	void (*drawPath)(VirtualQPaintEngine* self, QPainterPath* path);
	void (*drawPoints_QPointF_int)(VirtualQPaintEngine* self, QPointF* points, int pointCount);
	void (*drawPoints_QPoint_int)(VirtualQPaintEngine* self, QPoint* points, int pointCount);
	void (*drawPolygon_QPointF_int_QPaintEngine_PolygonDrawMode)(VirtualQPaintEngine* self, QPointF* points, int pointCount, int mode);
	void (*drawPolygon_QPoint_int_QPaintEngine_PolygonDrawMode)(VirtualQPaintEngine* self, QPoint* points, int pointCount, int mode);
