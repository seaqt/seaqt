...
const QMetaObject* QPointerEvent_staticMetaObject() { return &QPointerEvent::staticMetaObject; }
...
class VirtualQChildWindowEvent final : public QChildWindowEvent {
	const QChildWindowEvent_VTable* vtbl;
public:
	friend void* QChildWindowEvent_vdata(VirtualQChildWindowEvent* self);
	friend VirtualQChildWindowEvent* vdata_QChildWindowEvent(void* vdata);

	VirtualQChildWindowEvent(const QChildWindowEvent_VTable* vtbl, QEvent::Type type, QWindow* childWindow): QChildWindowEvent(type, childWindow), vtbl(vtbl) {}

	virtual ~VirtualQChildWindowEvent() override { if(vtbl->destructor) vtbl->destructor(this); }
	...
	virtual QChildWindowEvent* clone() const override {
		...
		QChildWindowEvent* callback_return_value = vtbl->clone(this);
		return callback_return_value;
	}

	friend QChildWindowEvent* QChildWindowEvent_virtualbase_clone(const VirtualQChildWindowEvent* self);
	...
	friend void QChildWindowEvent_virtualbase_setAccepted(VirtualQChildWindowEvent* self, bool accepted);

};

VirtualQChildWindowEvent* QChildWindowEvent_new(const QChildWindowEvent_VTable* vtbl, size_t vdata, int type, QWindow* childWindow) {
	void* _mem_ = ::operator new(seaqt_aligned_sizeof<VirtualQChildWindowEvent>() + vdata, std::nothrow);
	return _mem_ ? new (_mem_)VirtualQChildWindowEvent(vtbl, static_cast<QEvent::Type>(type), childWindow) : nullptr;
}

void QChildWindowEvent_virtbase(QChildWindowEvent* src, QEvent** outptr_QEvent) {
	*outptr_QEvent = static_cast<QEvent*>(src);
}
...
void* QChildWindowEvent_vdata(VirtualQChildWindowEvent* self) { return reinterpret_cast<void*>(reinterpret_cast<char*>(self) + seaqt_aligned_sizeof<VirtualQChildWindowEvent>()); }
VirtualQChildWindowEvent* vdata_QChildWindowEvent(void* vdata) { return reinterpret_cast<VirtualQChildWindowEvent*>(reinterpret_cast<char*>(vdata) - seaqt_aligned_sizeof<VirtualQChildWindowEvent>()); }

QChildWindowEvent* QChildWindowEvent_virtualbase_clone(const VirtualQChildWindowEvent* self) {

	return self->QChildWindowEvent::clone();
}

void QChildWindowEvent_virtualbase_setAccepted(VirtualQChildWindowEvent* self, bool accepted) {
