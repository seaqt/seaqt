...
void QTextCursor_insertMarkdown(QTextCursor* self, struct seaqt_string markdown);
...
void QTextCursor_insertMarkdown2(QTextCursor* self, struct seaqt_string markdown, int features);
