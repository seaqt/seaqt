#pragma once
#ifndef SEAQT_QTGUI_GEN_QTEXTCURSOR_H
#define SEAQT_QTGUI_GEN_QTEXTCURSOR_H
...
void QTextCursor_insertMarkdown_markdown(QTextCursor* self, struct seaqt_string markdown);
...
void QTextCursor_insertMarkdown_markdown_features(QTextCursor* self, struct seaqt_string markdown, int features);
