...
public:
	...
	virtual ~VirtualQPaintEngine() override = default;
	...
	// cgo.Handle value for overwritten implementation
	intptr_t handle__createPixmap = 0;

	// Subclass to allow providing a Go implementation
	virtual QPixmap createPixmap(QSize size) override {
		if (handle__createPixmap == 0) {
			return QPaintEngine::createPixmap(size);
		}

		QSize* sigval1 = new QSize(size);
		QPixmap* callback_return_value = miqt_exec_callback_QPaintEngine_createPixmap(this, handle__createPixmap, sigval1);
		return *callback_return_value;
	}
	...
	virtual QPixmap createPixmapFromImage(QImage image, Qt::ImageConversionFlags flags) override {
		...
		QPixmap* callback_return_value = miqt_exec_callback_QPaintEngine_createPixmapFromImage(this, handle__createPixmapFromImage, sigval1, sigval2);
		return *callback_return_value;
	}
...
QPaintEngine* QPaintEngine_new() {
	return new (std::nothrow) VirtualQPaintEngine();
}

QPaintEngine* QPaintEngine_new2(int features) {
	return new (std::nothrow) VirtualQPaintEngine(static_cast<QPaintEngine::PaintEngineFeatures>(features));
}
...
bool QPaintEngine_override_virtual_begin(void* self, intptr_t slot) {
	VirtualQPaintEngine* self_cast = dynamic_cast<VirtualQPaintEngine*>( (QPaintEngine*)(self) );
...
void QPaintEngine_virtualbase_drawRects(void* self, QRect* rects, int rectCount) {
	static_cast<VirtualQPaintEngine*>(self)->QPaintEngine::drawRects(rects, static_cast<int>(rectCount));
}
...
void QPaintEngine_virtualbase_drawLines(void* self, QLine* lines, int lineCount) {
	static_cast<VirtualQPaintEngine*>(self)->QPaintEngine::drawLines(lines, static_cast<int>(lineCount));
}
...
void QPaintEngine_virtualbase_drawEllipse(void* self, QRectF* r) {
	static_cast<VirtualQPaintEngine*>(self)->QPaintEngine::drawEllipse(*r);
}
...
void QPaintEngine_virtualbase_drawPath(void* self, QPainterPath* path) {
	static_cast<VirtualQPaintEngine*>(self)->QPaintEngine::drawPath(*path);
}
...
void QPaintEngine_virtualbase_drawPoints(void* self, QPointF* points, int pointCount) {
	static_cast<VirtualQPaintEngine*>(self)->QPaintEngine::drawPoints(points, static_cast<int>(pointCount));
}
...
void QPaintEngine_virtualbase_drawPolygon(void* self, QPointF* points, int pointCount, int mode) {
	static_cast<VirtualQPaintEngine*>(self)->QPaintEngine::drawPolygon(points, static_cast<int>(pointCount), static_cast<VirtualQPaintEngine::PolygonDrawMode>(mode));
}
...
void QPaintEngine_virtualbase_drawTextItem(void* self, QPointF* p, QTextItem* textItem) {
	static_cast<VirtualQPaintEngine*>(self)->QPaintEngine::drawTextItem(*p, *textItem);
}
...
void QPaintEngine_virtualbase_drawTiledPixmap(void* self, QRectF* r, QPixmap* pixmap, QPointF* s) {
	static_cast<VirtualQPaintEngine*>(self)->QPaintEngine::drawTiledPixmap(*r, *pixmap, *s);
}
...
void QPaintEngine_virtualbase_drawImage(void* self, QRectF* r, QImage* pm, QRectF* sr, int flags) {
	static_cast<VirtualQPaintEngine*>(self)->QPaintEngine::drawImage(*r, *pm, *sr, static_cast<Qt::ImageConversionFlags>(flags));
}
...
QPoint* QPaintEngine_virtualbase_coordinateOffset(const void* self) {
	return new QPoint(static_cast<const VirtualQPaintEngine*>(self)->QPaintEngine::coordinateOffset());
}
...
bool QPaintEngine_override_virtual_createPixmap(void* self, intptr_t slot) {
	...
	self_cast->handle__createPixmap = slot;
	return true;
}

QPixmap* QPaintEngine_virtualbase_createPixmap(void* self, QSize* size) {
	return new QPixmap(static_cast<VirtualQPaintEngine*>(self)->QPaintEngine::createPixmap(*size));
}
...
bool QPaintEngine_override_virtual_createPixmapFromImage(void* self, intptr_t slot) {
	...
	self_cast->handle__createPixmapFromImage = slot;
	return true;
}

QPixmap* QPaintEngine_virtualbase_createPixmapFromImage(void* self, QImage* image, int flags) {
	return new QPixmap(static_cast<VirtualQPaintEngine*>(self)->QPaintEngine::createPixmapFromImage(*image, static_cast<Qt::ImageConversionFlags>(flags)));
}
