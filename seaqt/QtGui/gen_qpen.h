#pragma once
#ifndef SEAQT_QTGUI_GEN_QPEN_H
#define SEAQT_QTGUI_GEN_QPEN_H
...
void QPen_operatorAssign_from(QPen* self, QPen* from);
void QPen_swap(QPen* self, QPen* other);
void QPen_operatorAssign_color(QPen* self, QColor* color);
void QPen_operatorAssign_style(QPen* self, int style);
