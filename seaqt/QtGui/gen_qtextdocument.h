...
struct QTextDocument_VTable {
	void (*destructor)(struct QTextDocument_VTable* vtbl, QTextDocument* self);
	QMetaObject* (*metaObject)(struct QTextDocument_VTable* vtbl, const QTextDocument* self);
	void* (*metacast)(struct QTextDocument_VTable* vtbl, QTextDocument* self, const char* param1);
	int (*metacall)(struct QTextDocument_VTable* vtbl, QTextDocument* self, int param1, int param2, void** param3);
	void (*clear)(struct QTextDocument_VTable* vtbl, QTextDocument* self);
	QTextObject* (*createObject)(struct QTextDocument_VTable* vtbl, QTextDocument* self, QTextFormat* f);
	QVariant* (*loadResource)(struct QTextDocument_VTable* vtbl, QTextDocument* self, int type, QUrl* name);
	bool (*event)(struct QTextDocument_VTable* vtbl, QTextDocument* self, QEvent* event);
	bool (*eventFilter)(struct QTextDocument_VTable* vtbl, QTextDocument* self, QObject* watched, QEvent* event);
	void (*timerEvent)(struct QTextDocument_VTable* vtbl, QTextDocument* self, QTimerEvent* event);
	void (*childEvent)(struct QTextDocument_VTable* vtbl, QTextDocument* self, QChildEvent* event);
	void (*customEvent)(struct QTextDocument_VTable* vtbl, QTextDocument* self, QEvent* event);
	void (*connectNotify)(struct QTextDocument_VTable* vtbl, QTextDocument* self, QMetaMethod* signal);
	void (*disconnectNotify)(struct QTextDocument_VTable* vtbl, QTextDocument* self, QMetaMethod* signal);
};
