...
public:
	...
	friend void QDoubleValidator_virtualbase_fixup(const void* self, struct seaqt_string input);
...
void QDoubleValidator_virtualbase_fixup(const void* self, struct seaqt_string input) {
	QString input_QString = QString::fromUtf8(input.data, input.len);
	static_cast<const VirtualQDoubleValidator*>(self)->QDoubleValidator::fixup(input_QString);
}
