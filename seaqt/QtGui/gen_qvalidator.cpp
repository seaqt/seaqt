...
public:
	...
	VirtualQRegExpValidator(struct QRegExpValidator_VTable* vtbl): QRegExpValidator(), vtbl(vtbl) {};
	VirtualQRegExpValidator(struct QRegExpValidator_VTable* vtbl, const QRegExp& rx): QRegExpValidator(rx), vtbl(vtbl) {};
	VirtualQRegExpValidator(struct QRegExpValidator_VTable* vtbl, QObject* parent): QRegExpValidator(parent), vtbl(vtbl) {};
	VirtualQRegExpValidator(struct QRegExpValidator_VTable* vtbl, const QRegExp& rx, QObject* parent): QRegExpValidator(rx, parent), vtbl(vtbl) {};

	virtual ~VirtualQRegExpValidator() override { if(vtbl->destructor) vtbl->destructor(vtbl, this); }
...
QObject* QRegExpValidator_protectedbase_sender(const void* self) {
	VirtualQRegExpValidator* self_cast = static_cast<VirtualQRegExpValidator*>( (QRegExpValidator*)(self) );
