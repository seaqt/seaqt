...
const QMetaObject* QPointerEvent_staticMetaObject();
...
typedef struct VirtualQChildWindowEvent VirtualQChildWindowEvent;
typedef struct QChildWindowEvent_VTable{
	void (*destructor)(VirtualQChildWindowEvent* self);
	QChildWindowEvent* (*clone)(const VirtualQChildWindowEvent* self);
	void (*setAccepted)(VirtualQChildWindowEvent* self, bool accepted);
}QChildWindowEvent_VTable;

void* QChildWindowEvent_vdata(VirtualQChildWindowEvent* self);
VirtualQChildWindowEvent* vdata_QChildWindowEvent(void* vdata);
