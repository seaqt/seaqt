...
void QPainterPath_addRoundRect_rect_xRnd_yRnd(QPainterPath* self, QRectF* rect, int xRnd, int yRnd) {
	self->addRoundRect(*rect, static_cast<int>(xRnd), static_cast<int>(yRnd));
}

void QPainterPath_addRoundRect_x_y_w_h_xRnd_yRnd(QPainterPath* self, double x, double y, double w, double h, int xRnd, int yRnd) {
...
void QPainterPath_addRoundRect_rect_roundness(QPainterPath* self, QRectF* rect, int roundness) {
	self->addRoundRect(*rect, static_cast<int>(roundness));
}

void QPainterPath_addRoundRect_x_y_w_h_roundness(QPainterPath* self, double x, double y, double w, double h, int roundness) {
...
void QPainterPathStroker_setDashPattern_QVectorOfqreal(QPainterPathStroker* self, struct seaqt_array /* of double */  dashPattern) {
