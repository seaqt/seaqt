...
struct seaqt_array /* of QAccessibleInterface* */  QAccessibleSelectionInterface_selectedItems(const QAccessibleSelectionInterface* self) {
...
void QAccessibleSelectionInterface_operatorAssign(QAccessibleSelectionInterface* self, QAccessibleSelectionInterface* from) {
	self->operator=(*from);
}
...
struct seaqt_array /* of int */  QAccessibleAttributesInterface_attributeKeys(const QAccessibleAttributesInterface* self) {
...
void QAccessibleAttributesInterface_operatorAssign(QAccessibleAttributesInterface* self, QAccessibleAttributesInterface* from) {
	self->operator=(*from);
}
...
class VirtualQAccessibleAnnouncementEvent final : public QAccessibleAnnouncementEvent {
	const QAccessibleAnnouncementEvent_VTable* vtbl;
public:
	friend void* QAccessibleAnnouncementEvent_vdata(VirtualQAccessibleAnnouncementEvent* self);
	friend VirtualQAccessibleAnnouncementEvent* vdata_QAccessibleAnnouncementEvent(void* vdata);

	VirtualQAccessibleAnnouncementEvent(const QAccessibleAnnouncementEvent_VTable* vtbl, QObject* object, const QString& message): QAccessibleAnnouncementEvent(object, message), vtbl(vtbl) {}
	VirtualQAccessibleAnnouncementEvent(const QAccessibleAnnouncementEvent_VTable* vtbl, QAccessibleInterface* iface, const QString& message): QAccessibleAnnouncementEvent(iface, message), vtbl(vtbl) {}

	virtual ~VirtualQAccessibleAnnouncementEvent() override { if(vtbl->destructor) vtbl->destructor(this); }
	...
	friend QAccessibleInterface* QAccessibleAnnouncementEvent_virtualbase_accessibleInterface(const VirtualQAccessibleAnnouncementEvent* self);

};

VirtualQAccessibleAnnouncementEvent* QAccessibleAnnouncementEvent_new_object_message(const QAccessibleAnnouncementEvent_VTable* vtbl, size_t vdata, QObject* object, struct seaqt_string message) {
	QString message_QString = QString::fromUtf8(message.data, message.len);
	void* _mem_ = ::operator new(seaqt_aligned_sizeof<VirtualQAccessibleAnnouncementEvent>() + vdata, std::nothrow);
	return _mem_ ? new (_mem_)VirtualQAccessibleAnnouncementEvent(vtbl, object, message_QString) : nullptr;
}

VirtualQAccessibleAnnouncementEvent* QAccessibleAnnouncementEvent_new_iface_message(const QAccessibleAnnouncementEvent_VTable* vtbl, size_t vdata, QAccessibleInterface* iface, struct seaqt_string message) {
	QString message_QString = QString::fromUtf8(message.data, message.len);
	void* _mem_ = ::operator new(seaqt_aligned_sizeof<VirtualQAccessibleAnnouncementEvent>() + vdata, std::nothrow);
	return _mem_ ? new (_mem_)VirtualQAccessibleAnnouncementEvent(vtbl, iface, message_QString) : nullptr;
}
...
struct seaqt_string QAccessibleAnnouncementEvent_message(const QAccessibleAnnouncementEvent* self) {
...
void* QAccessibleAnnouncementEvent_vdata(VirtualQAccessibleAnnouncementEvent* self) { return reinterpret_cast<void*>(reinterpret_cast<char*>(self) + seaqt_aligned_sizeof<VirtualQAccessibleAnnouncementEvent>()); }
VirtualQAccessibleAnnouncementEvent* vdata_QAccessibleAnnouncementEvent(void* vdata) { return reinterpret_cast<VirtualQAccessibleAnnouncementEvent*>(reinterpret_cast<char*>(vdata) - seaqt_aligned_sizeof<VirtualQAccessibleAnnouncementEvent>()); }

QAccessibleInterface* QAccessibleAnnouncementEvent_virtualbase_accessibleInterface(const VirtualQAccessibleAnnouncementEvent* self) {
