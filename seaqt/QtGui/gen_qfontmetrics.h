...
int QFontMetrics_width2(const QFontMetrics* self, struct miqt_string param1, int len, int flags);
...
int QFontMetrics_width22(const QFontMetrics* self, struct miqt_string param1, int len);
int QFontMetrics_horizontalAdvance2(const QFontMetrics* self, struct miqt_string param1, int len);
...
double QFontMetricsF_width(const QFontMetricsF* self, struct miqt_string string);
...
QRectF* QFontMetricsF_boundingRect2(const QFontMetricsF* self, QRectF* r, int flags, struct miqt_string string);
...
double QFontMetricsF_horizontalAdvance2(const QFontMetricsF* self, struct miqt_string string, int length);
