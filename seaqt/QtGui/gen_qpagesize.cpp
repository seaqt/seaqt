...
QPageSize* QPageSize_new6(QSize* pointSize, struct seaqt_string name) {
...
struct seaqt_string QPageSize_keyWithPageSizeId(int pageSizeId) {
...
struct seaqt_string QPageSize_nameWithPageSizeId(int pageSizeId) {
