...
typedef struct VirtualQAccessibleAnnouncementEvent VirtualQAccessibleAnnouncementEvent;
typedef struct QAccessibleAnnouncementEvent_VTable{
	void (*destructor)(VirtualQAccessibleAnnouncementEvent* self);
	QAccessibleInterface* (*accessibleInterface)(const VirtualQAccessibleAnnouncementEvent* self);
}QAccessibleAnnouncementEvent_VTable;

void* QAccessibleAnnouncementEvent_vdata(VirtualQAccessibleAnnouncementEvent* self);
VirtualQAccessibleAnnouncementEvent* vdata_QAccessibleAnnouncementEvent(void* vdata);
