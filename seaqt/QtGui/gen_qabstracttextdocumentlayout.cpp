...
QAbstractTextDocumentLayout* QAbstractTextDocumentLayout_new(QTextDocument* doc) {
	return new (std::nothrow) VirtualQAbstractTextDocumentLayout(doc);
}
...
struct seaqt_string QAbstractTextDocumentLayout_trUtf8(const char* s) {
...
struct seaqt_string QAbstractTextDocumentLayout_trUtf82(const char* s, const char* c) {
...
struct seaqt_string QAbstractTextDocumentLayout_trUtf83(const char* s, const char* c, int n) {
...
QMetaObject* QAbstractTextDocumentLayout_virtualbase_metaObject(const void* self) {
	return (QMetaObject*) static_cast<const VirtualQAbstractTextDocumentLayout*>(self)->QAbstractTextDocumentLayout::metaObject();
}
...
void* QAbstractTextDocumentLayout_virtualbase_metacast(void* self, const char* param1) {
	return static_cast<VirtualQAbstractTextDocumentLayout*>(self)->QAbstractTextDocumentLayout::qt_metacast(param1);
}
...
int QAbstractTextDocumentLayout_virtualbase_metacall(void* self, int param1, int param2, void** param3) {
	return static_cast<VirtualQAbstractTextDocumentLayout*>(self)->QAbstractTextDocumentLayout::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
}
...
void QAbstractTextDocumentLayout_virtualbase_resizeInlineObject(void* self, QTextInlineObject* item, int posInDocument, QTextFormat* format) {
	static_cast<VirtualQAbstractTextDocumentLayout*>(self)->QAbstractTextDocumentLayout::resizeInlineObject(*item, static_cast<int>(posInDocument), *format);
}
...
void QAbstractTextDocumentLayout_virtualbase_positionInlineObject(void* self, QTextInlineObject* item, int posInDocument, QTextFormat* format) {
	static_cast<VirtualQAbstractTextDocumentLayout*>(self)->QAbstractTextDocumentLayout::positionInlineObject(*item, static_cast<int>(posInDocument), *format);
}
...
void QAbstractTextDocumentLayout_virtualbase_drawInlineObject(void* self, QPainter* painter, QRectF* rect, QTextInlineObject* object, int posInDocument, QTextFormat* format) {
	static_cast<VirtualQAbstractTextDocumentLayout*>(self)->QAbstractTextDocumentLayout::drawInlineObject(painter, *rect, *object, static_cast<int>(posInDocument), *format);
}
...
bool QAbstractTextDocumentLayout_virtualbase_event(void* self, QEvent* event) {
	return static_cast<VirtualQAbstractTextDocumentLayout*>(self)->QAbstractTextDocumentLayout::event(event);
}
...
bool QAbstractTextDocumentLayout_virtualbase_eventFilter(void* self, QObject* watched, QEvent* event) {
	return static_cast<VirtualQAbstractTextDocumentLayout*>(self)->QAbstractTextDocumentLayout::eventFilter(watched, event);
}
...
void QAbstractTextDocumentLayout_virtualbase_timerEvent(void* self, QTimerEvent* event) {
	static_cast<VirtualQAbstractTextDocumentLayout*>(self)->QAbstractTextDocumentLayout::timerEvent(event);
}
...
void QAbstractTextDocumentLayout_virtualbase_childEvent(void* self, QChildEvent* event) {
	static_cast<VirtualQAbstractTextDocumentLayout*>(self)->QAbstractTextDocumentLayout::childEvent(event);
}
...
void QAbstractTextDocumentLayout_virtualbase_customEvent(void* self, QEvent* event) {
	static_cast<VirtualQAbstractTextDocumentLayout*>(self)->QAbstractTextDocumentLayout::customEvent(event);
}
...
void QAbstractTextDocumentLayout_virtualbase_connectNotify(void* self, QMetaMethod* signal) {
	static_cast<VirtualQAbstractTextDocumentLayout*>(self)->QAbstractTextDocumentLayout::connectNotify(*signal);
}
...
void QAbstractTextDocumentLayout_virtualbase_disconnectNotify(void* self, QMetaMethod* signal) {
	static_cast<VirtualQAbstractTextDocumentLayout*>(self)->QAbstractTextDocumentLayout::disconnectNotify(*signal);
}
...
struct seaqt_array /* of QAbstractTextDocumentLayout__Selection* */  QAbstractTextDocumentLayout__PaintContext_selections(const QAbstractTextDocumentLayout__PaintContext* self) {
	QVector<QAbstractTextDocumentLayout::Selection> selections_ret = self->selections;
...
void QAbstractTextDocumentLayout__PaintContext_setSelections(QAbstractTextDocumentLayout__PaintContext* self, struct seaqt_array /* of QAbstractTextDocumentLayout__Selection* */  selections) {
	QVector<QAbstractTextDocumentLayout::Selection> selections_QList;
