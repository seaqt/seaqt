#pragma once
#ifndef SEAQT_QTGUI_GEN_QTRANSFORM_H
#define SEAQT_QTGUI_GEN_QTRANSFORM_H
...
QTransform* QTransform_rotate_a_axis_distanceToPlane(QTransform* self, double a, int axis, double distanceToPlane);
QTransform* QTransform_rotate_a(QTransform* self, double a);
QTransform* QTransform_rotateRadians_a_axis_distanceToPlane(QTransform* self, double a, int axis, double distanceToPlane);
