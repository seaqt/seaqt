...
void QTextCharFormat_setAnchorName(QTextCharFormat* self, struct seaqt_string name) {
	QString name_QString = QString::fromUtf8(name.data, name.len);
	self->setAnchorName(name_QString);
}

struct seaqt_string QTextCharFormat_anchorName(const QTextCharFormat* self) {
