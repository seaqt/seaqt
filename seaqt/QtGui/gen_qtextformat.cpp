...
QTextLength* QTextLength_new_type_value(int type, double value) {
	return new (std::nothrow) QTextLength(static_cast<QTextLength::Type>(type), static_cast<qreal>(value));
}

QTextLength* QTextLength_new_from(QTextLength* from) {
	return new (std::nothrow) QTextLength(*from);
}
...
void QTextLength_operatorAssign(QTextLength* self, QTextLength* from) {
	self->operator=(*from);
}
...
QTextFormat* QTextFormat_new_type(int type) {
	return new (std::nothrow) QTextFormat(static_cast<int>(type));
}

QTextFormat* QTextFormat_new_from(QTextFormat* from) {
	return new (std::nothrow) QTextFormat(*from);
}

void QTextFormat_operatorAssign(QTextFormat* self, QTextFormat* from) {
	self->operator=(*from);
}
...
void QTextFormat_setProperty_propertyId_value(QTextFormat* self, int propertyId, QVariant* value) {
...
struct seaqt_string QTextFormat_stringProperty(const QTextFormat* self, int propertyId) {
...
struct seaqt_array /* of QTextLength* */  QTextFormat_lengthVectorProperty(const QTextFormat* self, int propertyId) {
...
void QTextFormat_setProperty_propertyId_lengths(QTextFormat* self, int propertyId, struct seaqt_array /* of QTextLength* */  lengths) {
...
struct seaqt_map /* of int to QVariant* */  QTextFormat_properties(const QTextFormat* self) {
...
QTextCharFormat* QTextCharFormat_new_from(QTextCharFormat* from) {
	return new (std::nothrow) QTextCharFormat(*from);
}
...
void QTextCharFormat_setFont_font(QTextCharFormat* self, QFont* font) {
	self->setFont(*font);
}
...
void QTextCharFormat_setFontFamily(QTextCharFormat* self, struct seaqt_string family) {
	QString family_QString = QString::fromUtf8(family.data, family.len);
	self->setFontFamily(family_QString);
}

struct seaqt_string QTextCharFormat_fontFamily(const QTextCharFormat* self) {
...
void QTextCharFormat_setFontFamilies(QTextCharFormat* self, struct seaqt_array /* of struct seaqt_string */  families) {
...
void QTextCharFormat_setFontStyleName(QTextCharFormat* self, struct seaqt_string styleName) {
...
void QTextCharFormat_setFontStyleHint_hint(QTextCharFormat* self, int hint) {
...
void QTextCharFormat_setFontFeatures(QTextCharFormat* self, struct seaqt_map /* of QFont__Tag* to unsigned int */  fontFeatures) {
...
struct seaqt_map /* of QFont__Tag* to unsigned int */  QTextCharFormat_fontFeatures(const QTextCharFormat* self) {
...
void QTextCharFormat_setFontVariableAxes(QTextCharFormat* self, struct seaqt_map /* of QFont__Tag* to float */  fontVariableAxes) {
...
struct seaqt_map /* of QFont__Tag* to float */  QTextCharFormat_fontVariableAxes(const QTextCharFormat* self) {
...
void QTextCharFormat_setToolTip(QTextCharFormat* self, struct seaqt_string tip) {
	QString tip_QString = QString::fromUtf8(tip.data, tip.len);
	self->setToolTip(tip_QString);
}

struct seaqt_string QTextCharFormat_toolTip(const QTextCharFormat* self) {
...
void QTextCharFormat_setAnchorHref(QTextCharFormat* self, struct seaqt_string value) {
	QString value_QString = QString::fromUtf8(value.data, value.len);
	self->setAnchorHref(value_QString);
}

struct seaqt_string QTextCharFormat_anchorHref(const QTextCharFormat* self) {
...
void QTextCharFormat_setAnchorNames(QTextCharFormat* self, struct seaqt_array /* of struct seaqt_string */  names) {
...
struct seaqt_array /* of struct seaqt_string */  QTextCharFormat_anchorNames(const QTextCharFormat* self) {
...
void QTextCharFormat_operatorAssign(QTextCharFormat* self, QTextCharFormat* from) {
	self->operator=(*from);
}

void QTextCharFormat_setFont_font_behavior(QTextCharFormat* self, QFont* font, int behavior) {
	self->setFont(*font, static_cast<QTextCharFormat::FontPropertiesInheritanceBehavior>(behavior));
}

void QTextCharFormat_setFontStyleHint_hint_strategy(QTextCharFormat* self, int hint, int strategy) {
...
QTextBlockFormat* QTextBlockFormat_new_from(QTextBlockFormat* from) {
	return new (std::nothrow) QTextBlockFormat(*from);
}
...
double QTextBlockFormat_lineHeight_scriptLineHeight_scaling(const QTextBlockFormat* self, double scriptLineHeight, double scaling) {
	qreal _ret = self->lineHeight(static_cast<qreal>(scriptLineHeight), static_cast<qreal>(scaling));
	return static_cast<double>(_ret);
}

double QTextBlockFormat_lineHeight(const QTextBlockFormat* self) {
...
void QTextBlockFormat_setTabPositions(QTextBlockFormat* self, struct seaqt_array /* of QTextOption__Tab* */  tabs) {
...
struct seaqt_array /* of QTextOption__Tab* */  QTextBlockFormat_tabPositions(const QTextBlockFormat* self) {
...
void QTextBlockFormat_operatorAssign(QTextBlockFormat* self, QTextBlockFormat* from) {
	self->operator=(*from);
}
...
QTextListFormat* QTextListFormat_new_from(QTextListFormat* from) {
	return new (std::nothrow) QTextListFormat(*from);
}
...
void QTextListFormat_setNumberPrefix(QTextListFormat* self, struct seaqt_string numberPrefix) {
...
struct seaqt_string QTextListFormat_numberPrefix(const QTextListFormat* self) {
...
void QTextListFormat_setNumberSuffix(QTextListFormat* self, struct seaqt_string numberSuffix) {
...
struct seaqt_string QTextListFormat_numberSuffix(const QTextListFormat* self) {
...
void QTextListFormat_operatorAssign(QTextListFormat* self, QTextListFormat* from) {
	self->operator=(*from);
}
...
QTextImageFormat* QTextImageFormat_new_from(QTextImageFormat* from) {
	return new (std::nothrow) QTextImageFormat(*from);
}
...
struct seaqt_string QTextImageFormat_name(const QTextImageFormat* self) {
...
void QTextImageFormat_setQuality_quality(QTextImageFormat* self, int quality) {
...
QTextFrameFormat* QTextFrameFormat_new_from(QTextFrameFormat* from) {
	return new (std::nothrow) QTextFrameFormat(*from);
}
...
void QTextFrameFormat_setWidth_width(QTextFrameFormat* self, double width) {
	self->setWidth(static_cast<qreal>(width));
}

void QTextFrameFormat_setWidth_length(QTextFrameFormat* self, QTextLength* length) {
...
void QTextFrameFormat_setHeight_qreal(QTextFrameFormat* self, double height) {
	self->setHeight(static_cast<qreal>(height));
}

void QTextFrameFormat_setHeight_QTextLength(QTextFrameFormat* self, QTextLength* height) {
...
void QTextFrameFormat_operatorAssign(QTextFrameFormat* self, QTextFrameFormat* from) {
	self->operator=(*from);
}
...
QTextTableFormat* QTextTableFormat_new_from(QTextTableFormat* from) {
	return new (std::nothrow) QTextTableFormat(*from);
}
...
void QTextTableFormat_setColumnWidthConstraints(QTextTableFormat* self, struct seaqt_array /* of QTextLength* */  constraints) {
...
struct seaqt_array /* of QTextLength* */  QTextTableFormat_columnWidthConstraints(const QTextTableFormat* self) {
...
QTextTableCellFormat* QTextTableCellFormat_new_from(QTextTableCellFormat* from) {
	return new (std::nothrow) QTextTableCellFormat(*from);
}
