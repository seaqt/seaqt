...
public:
	...
	friend bool QWindow_virtualbase_nativeEvent(VirtualQWindow* self, struct seaqt_string eventType, void* message, long* result);
...
bool QWindow_virtualbase_nativeEvent(VirtualQWindow* self, struct seaqt_string eventType, void* message, long* result) {
	...
	return self->QWindow::nativeEvent(eventType_QByteArray, message, static_cast<long*>(result));
}
