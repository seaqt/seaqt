...
bool miqt_exec_callback_QWindow_nativeEvent(QWindow*, intptr_t, struct seaqt_string, void*, long*);
...
public:
	...
	friend bool QWindow_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, long* result);
...
bool QWindow_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, long* result) {
	QByteArray eventType_QByteArray(eventType.data, eventType.len);
	return static_cast<VirtualQWindow*>(self)->QWindow::nativeEvent(eventType_QByteArray, message, static_cast<long*>(result));
}
