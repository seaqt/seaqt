...
void QWindow_connect_flagsChanged(QWindow* self, intptr_t slot, void (*callback)(intptr_t, int), void (*release)(intptr_t)) {
	QWindow::connect(self, static_cast<void (QWindow::*)(Qt::WindowFlags)>(&QWindow::flagsChanged), self, [callback, release = seaqt::release_callback{slot,release}](Qt::WindowFlags flags) {
...
void QWindow_connect_safeAreaMarginsChanged(QWindow* self, intptr_t slot, void (*callback)(intptr_t, QMargins*), void (*release)(intptr_t)) {
	QWindow::connect(self, static_cast<void (QWindow::*)(QMargins)>(&QWindow::safeAreaMarginsChanged), self, [callback, release = seaqt::release_callback{slot,release}](QMargins arg) {
