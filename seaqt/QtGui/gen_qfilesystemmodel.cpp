...
QDateTime* QFileSystemModel_lastModified_index(const QFileSystemModel* self, QModelIndex* index) {
	return new QDateTime(self->lastModified(*index));
}

QDateTime* QFileSystemModel_lastModified_index_tz(const QFileSystemModel* self, QModelIndex* index, QTimeZone* tz) {
