#pragma once
#ifndef SEAQT_QTGUI_GEN_QSURFACEFORMAT_H
#define SEAQT_QTGUI_GEN_QSURFACEFORMAT_H
...
struct seaqt_map /* tuple of int and int */  QSurfaceFormat_version(const QSurfaceFormat* self);
