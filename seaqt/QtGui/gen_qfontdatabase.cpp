...
void QFontDatabase_setApplicationFallbackFontFamilies(int param1, struct seaqt_array /* of struct seaqt_string */  familyNames) {
	...
	struct seaqt_string* familyNames_arr = static_cast<struct seaqt_string*>(familyNames.data);
...
void QFontDatabase_addApplicationEmojiFontFamily(struct seaqt_string familyName) {
	QString familyName_QString = QString::fromUtf8(familyName.data, familyName.len);
	QFontDatabase::addApplicationEmojiFontFamily(familyName_QString);
}

bool QFontDatabase_removeApplicationEmojiFontFamily(struct seaqt_string familyName) {
	QString familyName_QString = QString::fromUtf8(familyName.data, familyName.len);
	return QFontDatabase::removeApplicationEmojiFontFamily(familyName_QString);
}

void QFontDatabase_setApplicationEmojiFontFamilies(struct seaqt_array /* of struct seaqt_string */  familyNames) {
	QStringList familyNames_QList;
	familyNames_QList.reserve(familyNames.len);
	struct seaqt_string* familyNames_arr = static_cast<struct seaqt_string*>(familyNames.data);
	for(size_t i = 0; i < familyNames.len; ++i) {
...
struct seaqt_array /* of struct seaqt_string */  QFontDatabase_applicationEmojiFontFamilies() {
