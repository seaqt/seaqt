#pragma once
#ifndef SEAQT_QTGUI_GEN_QTEXTOPTION_H
#define SEAQT_QTGUI_GEN_QTEXTOPTION_H
...
void QTextOption_setTabArray(QTextOption* self, struct seaqt_array /* of double */  tabStops);
struct seaqt_array /* of double */  QTextOption_tabArray(const QTextOption* self);
void QTextOption_setTabs(QTextOption* self, struct seaqt_array /* of QTextOption__Tab* */  tabStops);
struct seaqt_array /* of QTextOption__Tab* */  QTextOption_tabs(const QTextOption* self);
