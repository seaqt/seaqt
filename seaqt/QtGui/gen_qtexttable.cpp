...
QTextTableCell* QTextTableCell_new_from(QTextTableCell* from) {
	return new (std::nothrow) QTextTableCell(*from);
}
...
struct seaqt_string QTextTable_trUtf8_s(const char* s) {
...
struct seaqt_string QTextTable_trUtf8_s_c(const char* s, const char* c) {
...
struct seaqt_string QTextTable_trUtf8_s_c_n(const char* s, const char* c, int n) {
