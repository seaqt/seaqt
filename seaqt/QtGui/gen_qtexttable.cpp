...
public:
	...
	virtual ~VirtualQTextTable() override = default;
	...
	virtual int qt_metacall(QMetaObject::Call param1, int param2, void** param3) override {
		...
		int sigval2 = param2;
		void** sigval3 = param3;
		int callback_return_value = miqt_exec_callback_QTextTable_metacall(this, handle__metacall, sigval1, sigval2, sigval3);
...
QTextTable* QTextTable_new(QTextDocument* doc) {
	return new (std::nothrow) VirtualQTextTable(doc);
}
...
struct seaqt_string QTextTable_trUtf8(const char* s) {
...
struct seaqt_string QTextTable_trUtf82(const char* s, const char* c) {
...
struct seaqt_string QTextTable_trUtf83(const char* s, const char* c, int n) {
...
QMetaObject* QTextTable_virtualbase_metaObject(const void* self) {
	return (QMetaObject*) static_cast<const VirtualQTextTable*>(self)->QTextTable::metaObject();
}
...
void* QTextTable_virtualbase_metacast(void* self, const char* param1) {
	return static_cast<VirtualQTextTable*>(self)->QTextTable::qt_metacast(param1);
}
...
int QTextTable_virtualbase_metacall(void* self, int param1, int param2, void** param3) {
	return static_cast<VirtualQTextTable*>(self)->QTextTable::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
}
...
bool QTextTable_virtualbase_event(void* self, QEvent* event) {
	return static_cast<VirtualQTextTable*>(self)->QTextTable::event(event);
}
...
bool QTextTable_virtualbase_eventFilter(void* self, QObject* watched, QEvent* event) {
	return static_cast<VirtualQTextTable*>(self)->QTextTable::eventFilter(watched, event);
}
...
void QTextTable_virtualbase_timerEvent(void* self, QTimerEvent* event) {
	static_cast<VirtualQTextTable*>(self)->QTextTable::timerEvent(event);
}
...
void QTextTable_virtualbase_childEvent(void* self, QChildEvent* event) {
	static_cast<VirtualQTextTable*>(self)->QTextTable::childEvent(event);
}
...
void QTextTable_virtualbase_customEvent(void* self, QEvent* event) {
	static_cast<VirtualQTextTable*>(self)->QTextTable::customEvent(event);
}
...
void QTextTable_virtualbase_connectNotify(void* self, QMetaMethod* signal) {
	static_cast<VirtualQTextTable*>(self)->QTextTable::connectNotify(*signal);
}
...
void QTextTable_virtualbase_disconnectNotify(void* self, QMetaMethod* signal) {
	static_cast<VirtualQTextTable*>(self)->QTextTable::disconnectNotify(*signal);
}
