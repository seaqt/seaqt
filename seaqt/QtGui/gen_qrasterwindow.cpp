...
public:
	...
	friend void QRasterWindow_virtualbase_resizeEvent(VirtualQRasterWindow* self, QResizeEvent* event);
	...
	friend bool QRasterWindow_virtualbase_nativeEvent(VirtualQRasterWindow* self, struct seaqt_string eventType, void* message, intptr_t* result);
	...
	friend double QRasterWindow_protectedbase_getDecodedMetricF(const VirtualQRasterWindow* self, int metricA, int metricB);
};
...
void QRasterWindow_virtualbase_resizeEvent(VirtualQRasterWindow* self, QResizeEvent* event) {
...
double QRasterWindow_protectedbase_getDecodedMetricF(const VirtualQRasterWindow* self, int metricA, int metricB) {
	return self->QRasterWindow::getDecodedMetricF(static_cast<VirtualQRasterWindow::PaintDeviceMetric>(metricA), static_cast<VirtualQRasterWindow::PaintDeviceMetric>(metricB));
}
