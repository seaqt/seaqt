...
bool miqt_exec_callback_QRasterWindow_nativeEvent(QRasterWindow*, intptr_t, struct seaqt_string, void*, long*);
...
public:
	...
	friend bool QRasterWindow_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, long* result);
...
bool QRasterWindow_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, long* result) {
	QByteArray eventType_QByteArray(eventType.data, eventType.len);
	return static_cast<VirtualQRasterWindow*>(self)->QRasterWindow::nativeEvent(eventType_QByteArray, message, static_cast<long*>(result));
}
