...
struct seaqt_string QStandardItemModel_trUtf82(const char* s, const char* c) {
...
struct seaqt_string QStandardItemModel_trUtf83(const char* s, const char* c, int n) {
