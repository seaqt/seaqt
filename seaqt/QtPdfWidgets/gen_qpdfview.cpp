...
bool miqt_exec_callback_QPdfView_nativeEvent(QPdfView*, intptr_t, struct seaqt_string, void*, long*);
...
public:
	...
	friend bool QPdfView_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, long* result);
...
struct seaqt_string QPdfView_trUtf8(const char* s) {
...
struct seaqt_string QPdfView_trUtf82(const char* s, const char* c) {
...
struct seaqt_string QPdfView_trUtf83(const char* s, const char* c, int n) {
...
bool QPdfView_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, long* result) {
	QByteArray eventType_QByteArray(eventType.data, eventType.len);
	return static_cast<VirtualQPdfView*>(self)->QPdfView::nativeEvent(eventType_QByteArray, message, static_cast<long*>(result));
}
