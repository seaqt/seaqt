...
public:
	...
	friend void QPdfView_virtualbase_mousePressEvent(VirtualQPdfView* self, QMouseEvent* event);
	...
	friend void QPdfView_virtualbase_mouseMoveEvent(VirtualQPdfView* self, QMouseEvent* event);
	...
	friend void QPdfView_virtualbase_mouseReleaseEvent(VirtualQPdfView* self, QMouseEvent* event);
	...
	friend double QPdfView_protectedbase_getDecodedMetricF(const VirtualQPdfView* self, int metricA, int metricB);
};
...
void QPdfView_connect_searchModelChanged(QPdfView* self, intptr_t slot, void (*callback)(intptr_t, QPdfSearchModel*), void (*release)(intptr_t)) {
	QPdfView::connect(self, static_cast<void (QPdfView::*)(QPdfSearchModel*)>(&QPdfView::searchModelChanged), self, [callback, release = seaqt::release_callback{slot,release}](QPdfSearchModel* searchModel) {
...
void QPdfView_connect_currentSearchResultIndexChanged(QPdfView* self, intptr_t slot, void (*callback)(intptr_t, int), void (*release)(intptr_t)) {
	QPdfView::connect(self, static_cast<void (QPdfView::*)(int)>(&QPdfView::currentSearchResultIndexChanged), self, [callback, release = seaqt::release_callback{slot,release}](int currentResult) {
...
void QPdfView_virtualbase_mousePressEvent(VirtualQPdfView* self, QMouseEvent* event) {

	self->QPdfView::mousePressEvent(event);
}

void QPdfView_virtualbase_mouseMoveEvent(VirtualQPdfView* self, QMouseEvent* event) {

	self->QPdfView::mouseMoveEvent(event);
}

void QPdfView_virtualbase_mouseReleaseEvent(VirtualQPdfView* self, QMouseEvent* event) {

	self->QPdfView::mouseReleaseEvent(event);
}
...
double QPdfView_protectedbase_getDecodedMetricF(const VirtualQPdfView* self, int metricA, int metricB) {
	return self->QPdfView::getDecodedMetricF(static_cast<VirtualQPdfView::PaintDeviceMetric>(metricA), static_cast<VirtualQPdfView::PaintDeviceMetric>(metricB));
}
