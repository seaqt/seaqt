...
typedef struct QPdfView_VTable{
	...
	void (*mousePressEvent)(VirtualQPdfView* self, QMouseEvent* event);
	void (*mouseMoveEvent)(VirtualQPdfView* self, QMouseEvent* event);
	void (*mouseReleaseEvent)(VirtualQPdfView* self, QMouseEvent* event);
