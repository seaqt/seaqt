...
void miqt_exec_callback_QRadioTuner_stationFound(intptr_t, int, struct seaqt_string);
...
public:
	...
	friend void QRadioTuner_protectedbase_addPropertyWatch(bool* _dynamic_cast_ok, void* self, struct seaqt_string name);
	friend void QRadioTuner_protectedbase_removePropertyWatch(bool* _dynamic_cast_ok, void* self, struct seaqt_string name);
...
QRadioTuner* QRadioTuner_new() {
	return new (std::nothrow) VirtualQRadioTuner();
}

QRadioTuner* QRadioTuner_new2(QObject* parent) {
	return new (std::nothrow) VirtualQRadioTuner(parent);
}
...
QMetaObject* QRadioTuner_virtualbase_metaObject(const void* self) {
	return (QMetaObject*) static_cast<const VirtualQRadioTuner*>(self)->QRadioTuner::metaObject();
}
...
void* QRadioTuner_virtualbase_metacast(void* self, const char* param1) {
	return static_cast<VirtualQRadioTuner*>(self)->QRadioTuner::qt_metacast(param1);
}
...
int QRadioTuner_virtualbase_metacall(void* self, int param1, int param2, void** param3) {
	return static_cast<VirtualQRadioTuner*>(self)->QRadioTuner::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
}
...
int QRadioTuner_virtualbase_availability(const void* self) {
	QMultimedia::AvailabilityStatus _ret = static_cast<const VirtualQRadioTuner*>(self)->QRadioTuner::availability();
	return static_cast<int>(_ret);
}
...
bool QRadioTuner_virtualbase_isAvailable(const void* self) {
	return static_cast<const VirtualQRadioTuner*>(self)->QRadioTuner::isAvailable();
}
...
QMediaService* QRadioTuner_virtualbase_service(const void* self) {
	return static_cast<const VirtualQRadioTuner*>(self)->QRadioTuner::service();
}
...
bool QRadioTuner_virtualbase_bind(void* self, QObject* param1) {
	return static_cast<VirtualQRadioTuner*>(self)->QRadioTuner::bind(param1);
}
...
void QRadioTuner_virtualbase_unbind(void* self, QObject* param1) {
	static_cast<VirtualQRadioTuner*>(self)->QRadioTuner::unbind(param1);
}
...
bool QRadioTuner_virtualbase_event(void* self, QEvent* event) {
	return static_cast<VirtualQRadioTuner*>(self)->QRadioTuner::event(event);
}
...
bool QRadioTuner_virtualbase_eventFilter(void* self, QObject* watched, QEvent* event) {
	return static_cast<VirtualQRadioTuner*>(self)->QRadioTuner::eventFilter(watched, event);
}
...
void QRadioTuner_virtualbase_timerEvent(void* self, QTimerEvent* event) {
	static_cast<VirtualQRadioTuner*>(self)->QRadioTuner::timerEvent(event);
}
...
void QRadioTuner_virtualbase_childEvent(void* self, QChildEvent* event) {
	static_cast<VirtualQRadioTuner*>(self)->QRadioTuner::childEvent(event);
}
...
void QRadioTuner_virtualbase_customEvent(void* self, QEvent* event) {
	static_cast<VirtualQRadioTuner*>(self)->QRadioTuner::customEvent(event);
}
...
void QRadioTuner_virtualbase_connectNotify(void* self, QMetaMethod* signal) {
	static_cast<VirtualQRadioTuner*>(self)->QRadioTuner::connectNotify(*signal);
}
...
void QRadioTuner_virtualbase_disconnectNotify(void* self, QMetaMethod* signal) {
	static_cast<VirtualQRadioTuner*>(self)->QRadioTuner::disconnectNotify(*signal);
}

void QRadioTuner_protectedbase_addPropertyWatch(bool* _dynamic_cast_ok, void* self, struct seaqt_string name) {
	VirtualQRadioTuner* self_cast = dynamic_cast<VirtualQRadioTuner*>( (QRadioTuner*)(self) );
	if (self_cast == nullptr) {
...
void QRadioTuner_protectedbase_removePropertyWatch(bool* _dynamic_cast_ok, void* self, struct seaqt_string name) {
	VirtualQRadioTuner* self_cast = dynamic_cast<VirtualQRadioTuner*>( (QRadioTuner*)(self) );
	if (self_cast == nullptr) {
		*_dynamic_cast_ok = false;
		return ;
