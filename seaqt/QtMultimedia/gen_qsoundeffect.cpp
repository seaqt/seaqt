...
void miqt_exec_callback_QSoundEffect_audioDeviceChanged(intptr_t);
...
public:
	...
	virtual ~VirtualQSoundEffect() override = default;
	...
	virtual int qt_metacall(QMetaObject::Call param1, int param2, void** param3) override {
		...
		int sigval2 = param2;
		void** sigval3 = param3;
		int callback_return_value = miqt_exec_callback_QSoundEffect_metacall(this, handle__metacall, sigval1, sigval2, sigval3);
...
QSoundEffect* QSoundEffect_new() {
	return new (std::nothrow) VirtualQSoundEffect();
}

QSoundEffect* QSoundEffect_new2(QAudioDevice* audioDevice) {
	return new (std::nothrow) VirtualQSoundEffect(*audioDevice);
}

QSoundEffect* QSoundEffect_new3(QObject* parent) {
	return new (std::nothrow) VirtualQSoundEffect(parent);
}

QSoundEffect* QSoundEffect_new4(QAudioDevice* audioDevice, QObject* parent) {
	return new (std::nothrow) VirtualQSoundEffect(*audioDevice, parent);
}
...
void QSoundEffect_connect_audioDeviceChanged(QSoundEffect* self, intptr_t slot) {
	QSoundEffect::connect(self, static_cast<void (QSoundEffect::*)()>(&QSoundEffect::audioDeviceChanged), self, [=]() {
...
QMetaObject* QSoundEffect_virtualbase_metaObject(const void* self) {
	return (QMetaObject*) static_cast<const VirtualQSoundEffect*>(self)->QSoundEffect::metaObject();
}
...
void* QSoundEffect_virtualbase_metacast(void* self, const char* param1) {
	return static_cast<VirtualQSoundEffect*>(self)->QSoundEffect::qt_metacast(param1);
}
...
int QSoundEffect_virtualbase_metacall(void* self, int param1, int param2, void** param3) {
	return static_cast<VirtualQSoundEffect*>(self)->QSoundEffect::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
}
...
bool QSoundEffect_virtualbase_event(void* self, QEvent* event) {
	return static_cast<VirtualQSoundEffect*>(self)->QSoundEffect::event(event);
}
...
bool QSoundEffect_virtualbase_eventFilter(void* self, QObject* watched, QEvent* event) {
	return static_cast<VirtualQSoundEffect*>(self)->QSoundEffect::eventFilter(watched, event);
}
...
void QSoundEffect_virtualbase_timerEvent(void* self, QTimerEvent* event) {
	static_cast<VirtualQSoundEffect*>(self)->QSoundEffect::timerEvent(event);
}
...
void QSoundEffect_virtualbase_childEvent(void* self, QChildEvent* event) {
	static_cast<VirtualQSoundEffect*>(self)->QSoundEffect::childEvent(event);
}
...
void QSoundEffect_virtualbase_customEvent(void* self, QEvent* event) {
	static_cast<VirtualQSoundEffect*>(self)->QSoundEffect::customEvent(event);
}
...
void QSoundEffect_virtualbase_connectNotify(void* self, QMetaMethod* signal) {
	static_cast<VirtualQSoundEffect*>(self)->QSoundEffect::connectNotify(*signal);
}
...
void QSoundEffect_virtualbase_disconnectNotify(void* self, QMetaMethod* signal) {
	static_cast<VirtualQSoundEffect*>(self)->QSoundEffect::disconnectNotify(*signal);
}
