#pragma once
#ifndef SEAQT_QTMULTIMEDIA_GEN_QVIDEOFRAMEFORMAT_H
#define SEAQT_QTMULTIMEDIA_GEN_QVIDEOFRAMEFORMAT_H
...
struct seaqt_string QVideoFrameFormat_vertexShaderFileName(const QVideoFrameFormat* self);
struct seaqt_string QVideoFrameFormat_fragmentShaderFileName(const QVideoFrameFormat* self);
...
struct seaqt_string QVideoFrameFormat_pixelFormatToString(int pixelFormat);

const QMetaObject* QVideoFrameFormat_staticMetaObject();
