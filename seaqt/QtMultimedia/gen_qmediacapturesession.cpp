...
QMediaCaptureSession* QMediaCaptureSession_new() {
	return new (std::nothrow) VirtualQMediaCaptureSession();
}

QMediaCaptureSession* QMediaCaptureSession_new2(QObject* parent) {
	return new (std::nothrow) VirtualQMediaCaptureSession(parent);
}
...
QMetaObject* QMediaCaptureSession_virtualbase_metaObject(const void* self) {
	return (QMetaObject*) static_cast<const VirtualQMediaCaptureSession*>(self)->QMediaCaptureSession::metaObject();
}
...
void* QMediaCaptureSession_virtualbase_metacast(void* self, const char* param1) {
	return static_cast<VirtualQMediaCaptureSession*>(self)->QMediaCaptureSession::qt_metacast(param1);
}
...
int QMediaCaptureSession_virtualbase_metacall(void* self, int param1, int param2, void** param3) {
	return static_cast<VirtualQMediaCaptureSession*>(self)->QMediaCaptureSession::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
}
...
bool QMediaCaptureSession_virtualbase_event(void* self, QEvent* event) {
	return static_cast<VirtualQMediaCaptureSession*>(self)->QMediaCaptureSession::event(event);
}
...
bool QMediaCaptureSession_virtualbase_eventFilter(void* self, QObject* watched, QEvent* event) {
	return static_cast<VirtualQMediaCaptureSession*>(self)->QMediaCaptureSession::eventFilter(watched, event);
}
...
void QMediaCaptureSession_virtualbase_timerEvent(void* self, QTimerEvent* event) {
	static_cast<VirtualQMediaCaptureSession*>(self)->QMediaCaptureSession::timerEvent(event);
}
...
void QMediaCaptureSession_virtualbase_childEvent(void* self, QChildEvent* event) {
	static_cast<VirtualQMediaCaptureSession*>(self)->QMediaCaptureSession::childEvent(event);
}
...
void QMediaCaptureSession_virtualbase_customEvent(void* self, QEvent* event) {
	static_cast<VirtualQMediaCaptureSession*>(self)->QMediaCaptureSession::customEvent(event);
}
...
void QMediaCaptureSession_virtualbase_connectNotify(void* self, QMetaMethod* signal) {
	static_cast<VirtualQMediaCaptureSession*>(self)->QMediaCaptureSession::connectNotify(*signal);
}
...
void QMediaCaptureSession_virtualbase_disconnectNotify(void* self, QMetaMethod* signal) {
	static_cast<VirtualQMediaCaptureSession*>(self)->QMediaCaptureSession::disconnectNotify(*signal);
}
