...
void miqt_exec_callback_QCameraImageCaptureControl_imageMetadataAvailable(intptr_t, int, struct seaqt_string, QVariant*);
void miqt_exec_callback_QCameraImageCaptureControl_imageAvailable(intptr_t, int, QVideoFrame*);
void miqt_exec_callback_QCameraImageCaptureControl_imageSaved(intptr_t, int, struct seaqt_string);
void miqt_exec_callback_QCameraImageCaptureControl_error(intptr_t, int, int, struct seaqt_string);
#ifdef __cplusplus
} /* extern C */
#endif
