#pragma once
#ifndef SEAQT_QTMULTIMEDIA_GEN_QMEDIARESOURCE_H
#define SEAQT_QTMULTIMEDIA_GEN_QMEDIARESOURCE_H
...
struct seaqt_string QMediaResource_mimeType(const QMediaResource* self);
struct seaqt_string QMediaResource_language(const QMediaResource* self);
void QMediaResource_setLanguage(QMediaResource* self, struct seaqt_string language);
struct seaqt_string QMediaResource_audioCodec(const QMediaResource* self);
void QMediaResource_setAudioCodec(QMediaResource* self, struct seaqt_string codec);
struct seaqt_string QMediaResource_videoCodec(const QMediaResource* self);
void QMediaResource_setVideoCodec(QMediaResource* self, struct seaqt_string codec);
