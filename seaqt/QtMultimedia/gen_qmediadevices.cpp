...
public:
	...
	virtual ~VirtualQMediaDevices() override = default;
...
QMediaDevices* QMediaDevices_new() {
	return new (std::nothrow) VirtualQMediaDevices();
}

QMediaDevices* QMediaDevices_new2(QObject* parent) {
	return new (std::nothrow) VirtualQMediaDevices(parent);
}
...
QMetaObject* QMediaDevices_virtualbase_metaObject(const void* self) {
	return (QMetaObject*) static_cast<const VirtualQMediaDevices*>(self)->QMediaDevices::metaObject();
}
...
void* QMediaDevices_virtualbase_metacast(void* self, const char* param1) {
	return static_cast<VirtualQMediaDevices*>(self)->QMediaDevices::qt_metacast(param1);
}
...
int QMediaDevices_virtualbase_metacall(void* self, int param1, int param2, void** param3) {
	return static_cast<VirtualQMediaDevices*>(self)->QMediaDevices::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
}
...
bool QMediaDevices_virtualbase_event(void* self, QEvent* event) {
	return static_cast<VirtualQMediaDevices*>(self)->QMediaDevices::event(event);
}
...
bool QMediaDevices_virtualbase_eventFilter(void* self, QObject* watched, QEvent* event) {
	return static_cast<VirtualQMediaDevices*>(self)->QMediaDevices::eventFilter(watched, event);
}
...
void QMediaDevices_virtualbase_timerEvent(void* self, QTimerEvent* event) {
	static_cast<VirtualQMediaDevices*>(self)->QMediaDevices::timerEvent(event);
}
...
void QMediaDevices_virtualbase_childEvent(void* self, QChildEvent* event) {
	static_cast<VirtualQMediaDevices*>(self)->QMediaDevices::childEvent(event);
}
...
void QMediaDevices_virtualbase_customEvent(void* self, QEvent* event) {
	static_cast<VirtualQMediaDevices*>(self)->QMediaDevices::customEvent(event);
}
...
void QMediaDevices_virtualbase_connectNotify(void* self, QMetaMethod* signal) {
	static_cast<VirtualQMediaDevices*>(self)->QMediaDevices::connectNotify(*signal);
}
...
void QMediaDevices_virtualbase_disconnectNotify(void* self, QMetaMethod* signal) {
	static_cast<VirtualQMediaDevices*>(self)->QMediaDevices::disconnectNotify(*signal);
}
