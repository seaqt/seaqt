...
void miqt_exec_callback_QRadioDataControl_stationIdChanged(intptr_t, struct seaqt_string);
void miqt_exec_callback_QRadioDataControl_programTypeChanged(intptr_t, int);
void miqt_exec_callback_QRadioDataControl_programTypeNameChanged(intptr_t, struct seaqt_string);
void miqt_exec_callback_QRadioDataControl_stationNameChanged(intptr_t, struct seaqt_string);
void miqt_exec_callback_QRadioDataControl_radioTextChanged(intptr_t, struct seaqt_string);
