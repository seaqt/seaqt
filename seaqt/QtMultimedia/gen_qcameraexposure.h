#pragma once
#ifndef SEAQT_QTMULTIMEDIA_GEN_QCAMERAEXPOSURE_H
#define SEAQT_QTMULTIMEDIA_GEN_QCAMERAEXPOSURE_H
...
struct seaqt_array /* of int */  QCameraExposure_supportedIsoSensitivities(const QCameraExposure* self);
struct seaqt_array /* of double */  QCameraExposure_supportedApertures(const QCameraExposure* self);
struct seaqt_array /* of double */  QCameraExposure_supportedShutterSpeeds(const QCameraExposure* self);
