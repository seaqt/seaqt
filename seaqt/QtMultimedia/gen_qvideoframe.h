...
QVideoFrame* QVideoFrame_new_format(QVideoFrameFormat* format);
...
struct seaqt_string QVideoFrame_subtitleText(const QVideoFrame* self);
void QVideoFrame_setSubtitleText(QVideoFrame* self, struct seaqt_string text);
void QVideoFrame_paint(QVideoFrame* self, QPainter* painter, QRectF* rect, QVideoFrame__PaintOptions* options);

const QMetaObject* QVideoFrame_staticMetaObject();
