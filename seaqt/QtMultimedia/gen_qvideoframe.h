#pragma once
#ifndef SEAQT_QTMULTIMEDIA_GEN_QVIDEOFRAME_H
#define SEAQT_QTMULTIMEDIA_GEN_QVIDEOFRAME_H
...
struct seaqt_map /* of struct seaqt_string to QVariant* */  QVideoFrame_availableMetaData(const QVideoFrame* self);
QVariant* QVideoFrame_metaData(const QVideoFrame* self, struct seaqt_string key);
void QVideoFrame_setMetaData(QVideoFrame* self, struct seaqt_string key, QVariant* value);
