#pragma once
#ifndef SEAQT_QTMULTIMEDIA_GEN_QAUDIOFORMAT_H
#define SEAQT_QTMULTIMEDIA_GEN_QAUDIOFORMAT_H
...
void QAudioFormat_setCodec(QAudioFormat* self, struct seaqt_string codec);
struct seaqt_string QAudioFormat_codec(const QAudioFormat* self);
