...
typedef struct VirtualQRadioTuner VirtualQRadioTuner;
typedef struct QRadioTuner_VTable{
	void (*destructor)(VirtualQRadioTuner* self);
	QMetaObject* (*metaObject)(const VirtualQRadioTuner* self);
	void* (*metacast)(VirtualQRadioTuner* self, const char* param1);
	int (*metacall)(VirtualQRadioTuner* self, int param1, int param2, void** param3);
	int (*availability)(const VirtualQRadioTuner* self);
	bool (*isAvailable)(const VirtualQRadioTuner* self);
	QMediaService* (*service)(const VirtualQRadioTuner* self);
	bool (*bind)(VirtualQRadioTuner* self, QObject* param1);
	void (*unbind)(VirtualQRadioTuner* self, QObject* param1);
	bool (*event)(VirtualQRadioTuner* self, QEvent* event);
	bool (*eventFilter)(VirtualQRadioTuner* self, QObject* watched, QEvent* event);
	void (*timerEvent)(VirtualQRadioTuner* self, QTimerEvent* event);
	void (*childEvent)(VirtualQRadioTuner* self, QChildEvent* event);
	void (*customEvent)(VirtualQRadioTuner* self, QEvent* event);
	void (*connectNotify)(VirtualQRadioTuner* self, QMetaMethod* signal);
	void (*disconnectNotify)(VirtualQRadioTuner* self, QMetaMethod* signal);
}QRadioTuner_VTable;

void* QRadioTuner_vdata(VirtualQRadioTuner* self);
