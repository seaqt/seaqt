...
QVideoProbe* QVideoProbe_new() {
	return new (std::nothrow) VirtualQVideoProbe();
}

QVideoProbe* QVideoProbe_new2(QObject* parent) {
	return new (std::nothrow) VirtualQVideoProbe(parent);
}
...
QMetaObject* QVideoProbe_virtualbase_metaObject(const void* self) {
	return (QMetaObject*) static_cast<const VirtualQVideoProbe*>(self)->QVideoProbe::metaObject();
}
...
void* QVideoProbe_virtualbase_metacast(void* self, const char* param1) {
	return static_cast<VirtualQVideoProbe*>(self)->QVideoProbe::qt_metacast(param1);
}
...
int QVideoProbe_virtualbase_metacall(void* self, int param1, int param2, void** param3) {
	return static_cast<VirtualQVideoProbe*>(self)->QVideoProbe::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
}
...
bool QVideoProbe_virtualbase_event(void* self, QEvent* event) {
	return static_cast<VirtualQVideoProbe*>(self)->QVideoProbe::event(event);
}
...
bool QVideoProbe_virtualbase_eventFilter(void* self, QObject* watched, QEvent* event) {
	return static_cast<VirtualQVideoProbe*>(self)->QVideoProbe::eventFilter(watched, event);
}
...
void QVideoProbe_virtualbase_timerEvent(void* self, QTimerEvent* event) {
	static_cast<VirtualQVideoProbe*>(self)->QVideoProbe::timerEvent(event);
}
...
void QVideoProbe_virtualbase_childEvent(void* self, QChildEvent* event) {
	static_cast<VirtualQVideoProbe*>(self)->QVideoProbe::childEvent(event);
}
...
void QVideoProbe_virtualbase_customEvent(void* self, QEvent* event) {
	static_cast<VirtualQVideoProbe*>(self)->QVideoProbe::customEvent(event);
}
...
void QVideoProbe_virtualbase_connectNotify(void* self, QMetaMethod* signal) {
	static_cast<VirtualQVideoProbe*>(self)->QVideoProbe::connectNotify(*signal);
}
...
void QVideoProbe_virtualbase_disconnectNotify(void* self, QMetaMethod* signal) {
	static_cast<VirtualQVideoProbe*>(self)->QVideoProbe::disconnectNotify(*signal);
}
