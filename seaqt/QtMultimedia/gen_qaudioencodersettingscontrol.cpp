...
struct seaqt_string QAudioEncoderSettingsControl_tr(const char* s) {
...
struct seaqt_string QAudioEncoderSettingsControl_trUtf8(const char* s) {
...
struct seaqt_string QAudioEncoderSettingsControl_tr2(const char* s, const char* c) {
...
struct seaqt_string QAudioEncoderSettingsControl_tr3(const char* s, const char* c, int n) {
...
struct seaqt_string QAudioEncoderSettingsControl_trUtf82(const char* s, const char* c) {
...
struct seaqt_string QAudioEncoderSettingsControl_trUtf83(const char* s, const char* c, int n) {
