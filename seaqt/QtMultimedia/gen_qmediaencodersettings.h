#pragma once
#ifndef SEAQT_QTMULTIMEDIA_GEN_QMEDIAENCODERSETTINGS_H
#define SEAQT_QTMULTIMEDIA_GEN_QMEDIAENCODERSETTINGS_H
...
struct seaqt_string QAudioEncoderSettings_codec(const QAudioEncoderSettings* self);
void QAudioEncoderSettings_setCodec(QAudioEncoderSettings* self, struct seaqt_string codec);
...
QVariant* QAudioEncoderSettings_encodingOption(const QAudioEncoderSettings* self, struct seaqt_string option);
struct seaqt_map /* of struct seaqt_string to QVariant* */  QAudioEncoderSettings_encodingOptions(const QAudioEncoderSettings* self);
void QAudioEncoderSettings_setEncodingOption(QAudioEncoderSettings* self, struct seaqt_string option, QVariant* value);
void QAudioEncoderSettings_setEncodingOptions(QAudioEncoderSettings* self, struct seaqt_map /* of struct seaqt_string to QVariant* */  options);
...
QVariant* QVideoEncoderSettings_encodingOption(const QVideoEncoderSettings* self, struct seaqt_string option);
struct seaqt_map /* of struct seaqt_string to QVariant* */  QVideoEncoderSettings_encodingOptions(const QVideoEncoderSettings* self);
void QVideoEncoderSettings_setEncodingOption(QVideoEncoderSettings* self, struct seaqt_string option, QVariant* value);
void QVideoEncoderSettings_setEncodingOptions(QVideoEncoderSettings* self, struct seaqt_map /* of struct seaqt_string to QVariant* */  options);
...
struct seaqt_map /* of struct seaqt_string to QVariant* */  QImageEncoderSettings_encodingOptions(const QImageEncoderSettings* self);
void QImageEncoderSettings_setEncodingOption(QImageEncoderSettings* self, struct seaqt_string option, QVariant* value);
void QImageEncoderSettings_setEncodingOptions(QImageEncoderSettings* self, struct seaqt_map /* of struct seaqt_string to QVariant* */  options);
