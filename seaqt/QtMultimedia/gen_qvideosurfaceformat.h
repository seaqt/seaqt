#pragma once
#ifndef SEAQT_QTMULTIMEDIA_GEN_QVIDEOSURFACEFORMAT_H
#define SEAQT_QTMULTIMEDIA_GEN_QVIDEOSURFACEFORMAT_H
...
struct seaqt_array /* of struct seaqt_string */  QVideoSurfaceFormat_propertyNames(const QVideoSurfaceFormat* self);
