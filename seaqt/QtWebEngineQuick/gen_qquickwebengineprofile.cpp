...
public:
	...
	VirtualQQuickWebEngineProfile(const QQuickWebEngineProfile_VTable* vtbl, const QString& storageName): QQuickWebEngineProfile(storageName), vtbl(vtbl) {}
	...
	VirtualQQuickWebEngineProfile(const QQuickWebEngineProfile_VTable* vtbl, const QString& storageName, QObject* parent): QQuickWebEngineProfile(storageName, parent), vtbl(vtbl) {}
...
VirtualQQuickWebEngineProfile* QQuickWebEngineProfile_new_storageName(const QQuickWebEngineProfile_VTable* vtbl, size_t vdata, struct seaqt_string storageName) {
	QString storageName_QString = QString::fromUtf8(storageName.data, storageName.len);
	void* _mem_ = ::operator new(seaqt_aligned_sizeof<VirtualQQuickWebEngineProfile>() + vdata, std::nothrow);
	return _mem_ ? new (_mem_)VirtualQQuickWebEngineProfile(vtbl, storageName_QString) : nullptr;
}
...
VirtualQQuickWebEngineProfile* QQuickWebEngineProfile_new_storageName_parent(const QQuickWebEngineProfile_VTable* vtbl, size_t vdata, struct seaqt_string storageName, QObject* parent) {
	QString storageName_QString = QString::fromUtf8(storageName.data, storageName.len);
	void* _mem_ = ::operator new(seaqt_aligned_sizeof<VirtualQQuickWebEngineProfile>() + vdata, std::nothrow);
	return _mem_ ? new (_mem_)VirtualQQuickWebEngineProfile(vtbl, storageName_QString, parent) : nullptr;
}
...
QWebEngineExtensionManager* QQuickWebEngineProfile_extensionManager(QQuickWebEngineProfile* self) {
