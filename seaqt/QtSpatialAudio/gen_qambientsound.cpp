...
QAmbientSound* QAmbientSound_new(QAudioEngine* engine) {
	return new (std::nothrow) VirtualQAmbientSound(engine);
}
...
QMetaObject* QAmbientSound_virtualbase_metaObject(const void* self) {
	return (QMetaObject*) static_cast<const VirtualQAmbientSound*>(self)->QAmbientSound::metaObject();
}
...
void* QAmbientSound_virtualbase_metacast(void* self, const char* param1) {
	return static_cast<VirtualQAmbientSound*>(self)->QAmbientSound::qt_metacast(param1);
}
...
int QAmbientSound_virtualbase_metacall(void* self, int param1, int param2, void** param3) {
	return static_cast<VirtualQAmbientSound*>(self)->QAmbientSound::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
}
...
bool QAmbientSound_virtualbase_event(void* self, QEvent* event) {
	return static_cast<VirtualQAmbientSound*>(self)->QAmbientSound::event(event);
}
...
bool QAmbientSound_virtualbase_eventFilter(void* self, QObject* watched, QEvent* event) {
	return static_cast<VirtualQAmbientSound*>(self)->QAmbientSound::eventFilter(watched, event);
}
...
void QAmbientSound_virtualbase_timerEvent(void* self, QTimerEvent* event) {
	static_cast<VirtualQAmbientSound*>(self)->QAmbientSound::timerEvent(event);
}
...
void QAmbientSound_virtualbase_childEvent(void* self, QChildEvent* event) {
	static_cast<VirtualQAmbientSound*>(self)->QAmbientSound::childEvent(event);
}
...
void QAmbientSound_virtualbase_customEvent(void* self, QEvent* event) {
	static_cast<VirtualQAmbientSound*>(self)->QAmbientSound::customEvent(event);
}
...
void QAmbientSound_virtualbase_connectNotify(void* self, QMetaMethod* signal) {
	static_cast<VirtualQAmbientSound*>(self)->QAmbientSound::connectNotify(*signal);
}
...
void QAmbientSound_virtualbase_disconnectNotify(void* self, QMetaMethod* signal) {
	static_cast<VirtualQAmbientSound*>(self)->QAmbientSound::disconnectNotify(*signal);
}
