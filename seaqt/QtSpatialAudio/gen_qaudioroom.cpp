...
QAudioRoom* QAudioRoom_new(QAudioEngine* engine) {
	return new (std::nothrow) VirtualQAudioRoom(engine);
}
...
QMetaObject* QAudioRoom_virtualbase_metaObject(const void* self) {
	return (QMetaObject*) static_cast<const VirtualQAudioRoom*>(self)->QAudioRoom::metaObject();
}
...
void* QAudioRoom_virtualbase_metacast(void* self, const char* param1) {
	return static_cast<VirtualQAudioRoom*>(self)->QAudioRoom::qt_metacast(param1);
}
...
int QAudioRoom_virtualbase_metacall(void* self, int param1, int param2, void** param3) {
	return static_cast<VirtualQAudioRoom*>(self)->QAudioRoom::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
}
...
bool QAudioRoom_virtualbase_event(void* self, QEvent* event) {
	return static_cast<VirtualQAudioRoom*>(self)->QAudioRoom::event(event);
}
...
bool QAudioRoom_virtualbase_eventFilter(void* self, QObject* watched, QEvent* event) {
	return static_cast<VirtualQAudioRoom*>(self)->QAudioRoom::eventFilter(watched, event);
}
...
void QAudioRoom_virtualbase_timerEvent(void* self, QTimerEvent* event) {
	static_cast<VirtualQAudioRoom*>(self)->QAudioRoom::timerEvent(event);
}
...
void QAudioRoom_virtualbase_childEvent(void* self, QChildEvent* event) {
	static_cast<VirtualQAudioRoom*>(self)->QAudioRoom::childEvent(event);
}
...
void QAudioRoom_virtualbase_customEvent(void* self, QEvent* event) {
	static_cast<VirtualQAudioRoom*>(self)->QAudioRoom::customEvent(event);
}
...
void QAudioRoom_virtualbase_connectNotify(void* self, QMetaMethod* signal) {
	static_cast<VirtualQAudioRoom*>(self)->QAudioRoom::connectNotify(*signal);
}
...
void QAudioRoom_virtualbase_disconnectNotify(void* self, QMetaMethod* signal) {
	static_cast<VirtualQAudioRoom*>(self)->QAudioRoom::disconnectNotify(*signal);
}
