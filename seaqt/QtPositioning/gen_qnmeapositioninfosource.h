...
typedef struct QNmeaPositionInfoSource_VTable{
	...
	bool (*parsePosInfoFromNmeaData)(VirtualQNmeaPositionInfoSource* self, const char* data, int size, QGeoPositionInfo* posInfo, bool* hasFix);
...
struct seaqt_string QNmeaPositionInfoSource_trUtf82(const char* s, const char* c);
struct seaqt_string QNmeaPositionInfoSource_trUtf83(const char* s, const char* c, int n);
