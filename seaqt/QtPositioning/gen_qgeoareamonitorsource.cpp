...
public:
	...
	friend bool QGeoAreaMonitorSource_virtualbase_setBackendProperty(VirtualQGeoAreaMonitorSource* self, struct seaqt_string name, QVariant* value);
...
void QGeoAreaMonitorSource_connect_errorOccurred(QGeoAreaMonitorSource* self, intptr_t slot, void (*callback)(intptr_t, int), void (*release)(intptr_t)) {
	QGeoAreaMonitorSource::connect(self, static_cast<void (QGeoAreaMonitorSource::*)(QGeoAreaMonitorSource::Error)>(&QGeoAreaMonitorSource::errorOccurred), self, [callback, release = seaqt::release_callback{slot,release}](QGeoAreaMonitorSource::Error error) {
