...
public:
	...
	virtual bool parsePosInfoFromNmeaData(const char* data, int size, QGeoPositionInfo* posInfo, bool* hasFix) override {
		if (vtbl->parsePosInfoFromNmeaData_data_size_posInfo_hasFix == 0) {
		...
		bool* sigval4 = hasFix;
		bool callback_return_value = vtbl->parsePosInfoFromNmeaData_data_size_posInfo_hasFix(this, sigval1, sigval2, sigval3, sigval4);
		return callback_return_value;
	}

	friend bool QNmeaPositionInfoSource_virtualbase_parsePosInfoFromNmeaData_data_size_posInfo_hasFix(VirtualQNmeaPositionInfoSource* self, const char* data, int size, QGeoPositionInfo* posInfo, bool* hasFix);
	...
	friend bool QNmeaPositionInfoSource_protectedbase_parsePosInfoFromNmeaData_data_posInfo_hasFix(VirtualQNmeaPositionInfoSource* self, struct seaqt_string data, QGeoPositionInfo* posInfo, bool* hasFix);
...
bool QNmeaPositionInfoSource_protectedbase_parsePosInfoFromNmeaData_data_posInfo_hasFix(VirtualQNmeaPositionInfoSource* self, struct seaqt_string data, QGeoPositionInfo* posInfo, bool* hasFix) {
	...
	return self->QNmeaPositionInfoSource::parsePosInfoFromNmeaData(data_QByteArray, posInfo, hasFix);
}

void QNmeaPositionInfoSource_protectedbase_setError(VirtualQNmeaPositionInfoSource* self, int positionError) {
	self->QNmeaPositionInfoSource::setError(static_cast<VirtualQNmeaPositionInfoSource::Error>(positionError));
}
