...
public:
	...
	virtual QGeoSatelliteInfo::SatelliteSystem parseSatellitesInUseFromNmea(const char* data, int size, QList<int>& pnrsInUse) override {
		if (vtbl->parseSatellitesInUseFromNmea_data_size_pnrsInUse == 0) {
		...
		int callback_return_value = vtbl->parseSatellitesInUseFromNmea_data_size_pnrsInUse(this, sigval1, sigval2, sigval3);
		return static_cast<QGeoSatelliteInfo::SatelliteSystem>(callback_return_value);
	}

	friend int QNmeaSatelliteInfoSource_virtualbase_parseSatellitesInUseFromNmea_data_size_pnrsInUse(VirtualQNmeaSatelliteInfoSource* self, const char* data, int size, struct seaqt_array /* of int */  pnrsInUse);
	...
	virtual QNmeaSatelliteInfoSource::SatelliteInfoParseStatus parseSatelliteInfoFromNmea(const char* data, int size, QList<QGeoSatelliteInfo>& infos, QGeoSatelliteInfo::SatelliteSystem& system) override {
		if (vtbl->parseSatelliteInfoFromNmea_data_size_infos_system == 0) {
		...
		int callback_return_value = vtbl->parseSatelliteInfoFromNmea_data_size_infos_system(this, sigval1, sigval2, sigval3, sigval4);
		return static_cast<QNmeaSatelliteInfoSource::SatelliteInfoParseStatus>(callback_return_value);
	}

	friend int QNmeaSatelliteInfoSource_virtualbase_parseSatelliteInfoFromNmea_data_size_infos_system(VirtualQNmeaSatelliteInfoSource* self, const char* data, int size, struct seaqt_array /* of QGeoSatelliteInfo* */  infos, int* system);
	...
	friend int QNmeaSatelliteInfoSource_protectedbase_parseSatellitesInUseFromNmea_data_pnrsInUse(VirtualQNmeaSatelliteInfoSource* self, struct seaqt_string data, struct seaqt_array /* of int */  pnrsInUse);
	friend int QNmeaSatelliteInfoSource_protectedbase_parseSatelliteInfoFromNmea_data_infos_system(VirtualQNmeaSatelliteInfoSource* self, struct seaqt_string data, struct seaqt_array /* of QGeoSatelliteInfo* */  infos, int* system);
...
int QNmeaSatelliteInfoSource_virtualbase_parseSatellitesInUseFromNmea_data_size_pnrsInUse(VirtualQNmeaSatelliteInfoSource* self, const char* data, int size, struct seaqt_array /* of int */  pnrsInUse) {
...
int QNmeaSatelliteInfoSource_virtualbase_parseSatelliteInfoFromNmea_data_size_infos_system(VirtualQNmeaSatelliteInfoSource* self, const char* data, int size, struct seaqt_array /* of QGeoSatelliteInfo* */  infos, int* system) {
...
int QNmeaSatelliteInfoSource_protectedbase_parseSatellitesInUseFromNmea_data_pnrsInUse(VirtualQNmeaSatelliteInfoSource* self, struct seaqt_string data, struct seaqt_array /* of int */  pnrsInUse) {
	...
	QGeoSatelliteInfo::SatelliteSystem _ret = self->QNmeaSatelliteInfoSource::parseSatellitesInUseFromNmea(data_QByteArray, pnrsInUse_QList);
	return static_cast<int>(_ret);
}

int QNmeaSatelliteInfoSource_protectedbase_parseSatelliteInfoFromNmea_data_infos_system(VirtualQNmeaSatelliteInfoSource* self, struct seaqt_string data, struct seaqt_array /* of QGeoSatelliteInfo* */  infos, int* system) {
		QByteArrayView data_QByteArray(data.data, data.len);
		QList<QGeoSatelliteInfo> infos_QList;
		infos_QList.reserve(infos.len);
		QGeoSatelliteInfo** infos_arr = static_cast<QGeoSatelliteInfo**>(infos.data);
	...
	VirtualQNmeaSatelliteInfoSource::SatelliteInfoParseStatus _ret = self->QNmeaSatelliteInfoSource::parseSatelliteInfoFromNmea(data_QByteArray, infos_QList, (QGeoSatelliteInfo::SatelliteSystem&)(*system));
	return static_cast<int>(_ret);
}
