...
struct seaqt_array /* of QGeoAreaMonitorInfo* */  QGeoAreaMonitorSource_virtualbase_activeMonitors(const void* self);
bool QGeoAreaMonitorSource_override_virtual_activeMonitorsWithLookupArea(void* self, intptr_t slot);
struct seaqt_array /* of QGeoAreaMonitorInfo* */  QGeoAreaMonitorSource_virtualbase_activeMonitorsWithLookupArea(const void* self, QGeoShape* lookupArea);
