...
typedef struct QGeoPositionInfoSource_VTable{
	...
	bool (*setBackendProperty)(VirtualQGeoPositionInfoSource* self, struct seaqt_string name, QVariant* value);
	QVariant* (*backendProperty)(const VirtualQGeoPositionInfoSource* self, struct seaqt_string name);
