...
typedef struct QNmeaSatelliteInfoSource_VTable{
	...
	int (*parseSatellitesInUseFromNmea_data_size_pnrsInUse)(VirtualQNmeaSatelliteInfoSource* self, const char* data, int size, struct seaqt_array /* of int */  pnrsInUse);
	int (*parseSatelliteInfoFromNmea_data_size_infos_system)(VirtualQNmeaSatelliteInfoSource* self, const char* data, int size, struct seaqt_array /* of QGeoSatelliteInfo* */  infos, int* system);
...
int QNmeaSatelliteInfoSource_parseSatellitesInUseFromNmea_data_size_pnrsInUse(QNmeaSatelliteInfoSource* self, const char* data, int size, struct seaqt_array /* of int */  pnrsInUse);
int QNmeaSatelliteInfoSource_parseSatelliteInfoFromNmea_data_size_infos_system(QNmeaSatelliteInfoSource* self, const char* data, int size, struct seaqt_array /* of QGeoSatelliteInfo* */  infos, int* system);
