#pragma once
#ifndef SEAQT_QTPOSITIONING_GEN_QGEOSATELLITEINFO_H
#define SEAQT_QTPOSITIONING_GEN_QGEOSATELLITEINFO_H
...
const QMetaObject* QGeoSatelliteInfo_staticMetaObject();
