#pragma once
#ifndef SEAQT_QTPOSITIONING_GEN_QGEORECTANGLE_H
#define SEAQT_QTPOSITIONING_GEN_QGEORECTANGLE_H
...
bool QGeoRectangle_operatorNotEqual(const QGeoRectangle* self, QGeoRectangle* other);
