...
public:
	...
	friend bool QPdfSearchModel_virtualbase_clearItemData(VirtualQPdfSearchModel* self, QModelIndex* index);
	...
	friend void QPdfSearchModel_virtualbase_multiData(const VirtualQPdfSearchModel* self, QModelIndex* index, QModelRoleDataSpan* roleDataSpan);
	...
	friend void QPdfSearchModel_virtualbase_resetInternalData(VirtualQPdfSearchModel* self);
...
void QPdfSearchModel_connect_countChanged(QPdfSearchModel* self, intptr_t slot, void (*callback)(intptr_t), void (*release)(intptr_t)) {
	QPdfSearchModel::connect(self, static_cast<void (QPdfSearchModel::*)()>(&QPdfSearchModel::countChanged), self, [callback, release = seaqt::release_callback{slot,release}]() {
			callback(release.slot);
	});
}
