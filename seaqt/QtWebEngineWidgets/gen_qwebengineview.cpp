...
bool miqt_exec_callback_QWebEngineView_nativeEvent(QWebEngineView*, intptr_t, struct seaqt_string, void*, long*);
...
public:
	...
	friend bool QWebEngineView_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, long* result);
...
QWebEngineView* QWebEngineView_new2(QWidget* parent) {
...
bool QWebEngineView_virtualbase_nativeEvent(void* self, struct seaqt_string eventType, void* message, long* result) {
	QByteArray eventType_QByteArray(eventType.data, eventType.len);
	return static_cast<VirtualQWebEngineView*>(self)->QWebEngineView::nativeEvent(eventType_QByteArray, message, static_cast<long*>(result));
}
