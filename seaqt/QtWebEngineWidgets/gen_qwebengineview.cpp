...
public:
	...
	friend void QWebEngineView_virtualbase_enterEvent(VirtualQWebEngineView* self, QEvent* event);
	...
	friend bool QWebEngineView_virtualbase_nativeEvent(VirtualQWebEngineView* self, struct seaqt_string eventType, void* message, long* result);
...
struct seaqt_string QWebEngineView_trUtf8_s(const char* s) {
...
struct seaqt_string QWebEngineView_trUtf8_s_c(const char* s, const char* c) {
...
struct seaqt_string QWebEngineView_trUtf8_s_c_n(const char* s, const char* c, int n) {
...
bool QWebEngineView_virtualbase_nativeEvent(VirtualQWebEngineView* self, struct seaqt_string eventType, void* message, long* result) {
	...
	return self->QWebEngineView::nativeEvent(eventType_QByteArray, message, static_cast<long*>(result));
}
