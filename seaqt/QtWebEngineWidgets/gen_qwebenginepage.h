#pragma once
#ifndef SEAQT_QTWEBENGINEWIDGETS_GEN_QWEBENGINEPAGE_H
#define SEAQT_QTWEBENGINEWIDGETS_GEN_QWEBENGINEPAGE_H
...
typedef struct QWebEnginePage_VTable{
	...
	bool (*certificateError)(VirtualQWebEnginePage* self, QWebEngineCertificateError* certificateError);
