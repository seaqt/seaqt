#pragma once
#ifndef SEAQT_QTWEBENGINEWIDGETS_GEN_QWEBENGINESETTINGS_H
#define SEAQT_QTWEBENGINEWIDGETS_GEN_QWEBENGINESETTINGS_H
...
struct seaqt_string QWebEngineSettings_fontFamily(const QWebEngineSettings* self, int which);
...
void QWebEngineSettings_setDefaultTextEncoding(QWebEngineSettings* self, struct seaqt_string encoding);
struct seaqt_string QWebEngineSettings_defaultTextEncoding(const QWebEngineSettings* self);
