#pragma once
#ifndef SEAQT_QTWEBENGINEWIDGETS_GEN_QWEBENGINEPROFILE_H
#define SEAQT_QTWEBENGINEWIDGETS_GEN_QWEBENGINEPROFILE_H
...
struct seaqt_string QWebEngineProfile_trUtf8(const char* s);
