#pragma once
#ifndef SEAQT_QTWEBENGINEWIDGETS_GEN_QWEBENGINESCRIPTCOLLECTION_H
#define SEAQT_QTWEBENGINEWIDGETS_GEN_QWEBENGINESCRIPTCOLLECTION_H
...
QWebEngineScript* QWebEngineScriptCollection_findScript(const QWebEngineScriptCollection* self, struct seaqt_string name);
struct seaqt_array /* of QWebEngineScript* */  QWebEngineScriptCollection_findScripts(const QWebEngineScriptCollection* self, struct seaqt_string name);
...
struct seaqt_array /* of QWebEngineScript* */  QWebEngineScriptCollection_toList(const QWebEngineScriptCollection* self);
