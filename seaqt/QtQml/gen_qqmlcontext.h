...
struct seaqt_array /* of QQmlContext* */  QQmlContext_childContexts(const QQmlContext* self);
...
QObject* QQmlContext_findObjectRecursively(const QQmlContext* self, struct seaqt_string id);
struct seaqt_array /* of QObject* */  QQmlContext_findObjectsRecursively(const QQmlContext* self, struct seaqt_string id);
