...
QVariant* miqt_exec_callback_QQmlPropertyMap_updateValue(QQmlPropertyMap*, intptr_t, struct seaqt_string, QVariant*);
...
public:
	...
	friend QVariant* QQmlPropertyMap_virtualbase_updateValue(void* self, struct seaqt_string key, QVariant* input);
...
QQmlPropertyMap* QQmlPropertyMap_new() {
	return new (std::nothrow) VirtualQQmlPropertyMap();
}

QQmlPropertyMap* QQmlPropertyMap_new2(QObject* parent) {
	return new (std::nothrow) VirtualQQmlPropertyMap(parent);
}
...
QMetaObject* QQmlPropertyMap_virtualbase_metaObject(const void* self) {
	return (QMetaObject*) static_cast<const VirtualQQmlPropertyMap*>(self)->QQmlPropertyMap::metaObject();
}
...
void* QQmlPropertyMap_virtualbase_metacast(void* self, const char* param1) {
	return static_cast<VirtualQQmlPropertyMap*>(self)->QQmlPropertyMap::qt_metacast(param1);
}
...
int QQmlPropertyMap_virtualbase_metacall(void* self, int param1, int param2, void** param3) {
	return static_cast<VirtualQQmlPropertyMap*>(self)->QQmlPropertyMap::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
}
...
QVariant* QQmlPropertyMap_virtualbase_updateValue(void* self, struct seaqt_string key, QVariant* input) {
	QString key_QString = QString::fromUtf8(key.data, key.len);
	return new QVariant(static_cast<VirtualQQmlPropertyMap*>(self)->QQmlPropertyMap::updateValue(key_QString, *input));
}
...
bool QQmlPropertyMap_virtualbase_event(void* self, QEvent* event) {
	return static_cast<VirtualQQmlPropertyMap*>(self)->QQmlPropertyMap::event(event);
}
...
bool QQmlPropertyMap_virtualbase_eventFilter(void* self, QObject* watched, QEvent* event) {
	return static_cast<VirtualQQmlPropertyMap*>(self)->QQmlPropertyMap::eventFilter(watched, event);
}
...
void QQmlPropertyMap_virtualbase_timerEvent(void* self, QTimerEvent* event) {
	static_cast<VirtualQQmlPropertyMap*>(self)->QQmlPropertyMap::timerEvent(event);
}
...
void QQmlPropertyMap_virtualbase_childEvent(void* self, QChildEvent* event) {
	static_cast<VirtualQQmlPropertyMap*>(self)->QQmlPropertyMap::childEvent(event);
}
...
void QQmlPropertyMap_virtualbase_customEvent(void* self, QEvent* event) {
	static_cast<VirtualQQmlPropertyMap*>(self)->QQmlPropertyMap::customEvent(event);
}
...
void QQmlPropertyMap_virtualbase_connectNotify(void* self, QMetaMethod* signal) {
	static_cast<VirtualQQmlPropertyMap*>(self)->QQmlPropertyMap::connectNotify(*signal);
}
...
void QQmlPropertyMap_virtualbase_disconnectNotify(void* self, QMetaMethod* signal) {
	static_cast<VirtualQQmlPropertyMap*>(self)->QQmlPropertyMap::disconnectNotify(*signal);
}
