...
QJSValue* QJSValue_callWithArgs(const QJSValue* self, struct seaqt_array /* of QJSValue* */  args) {
...
QJSValue* QJSValue_callWithInstance2(const QJSValue* self, QJSValue* instance, struct seaqt_array /* of QJSValue* */  args) {
	QJSValueList args_QList;
	args_QList.reserve(args.len);
	QJSValue** args_arr = static_cast<QJSValue**>(args.data);
	for(size_t i = 0; i < args.len; ++i) {
...
QJSValue* QJSValue_callAsConstructorWithArgs(const QJSValue* self, struct seaqt_array /* of QJSValue* */  args) {
	QJSValueList args_QList;
	args_QList.reserve(args.len);
	QJSValue** args_arr = static_cast<QJSValue**>(args.data);
	for(size_t i = 0; i < args.len; ++i) {
