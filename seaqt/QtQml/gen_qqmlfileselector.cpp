...
QQmlFileSelector* QQmlFileSelector_new(QQmlEngine* engine) {
	return new (std::nothrow) VirtualQQmlFileSelector(engine);
}

QQmlFileSelector* QQmlFileSelector_new2(QQmlEngine* engine, QObject* parent) {
	return new (std::nothrow) VirtualQQmlFileSelector(engine, parent);
}
...
QMetaObject* QQmlFileSelector_virtualbase_metaObject(const void* self) {
	return (QMetaObject*) static_cast<const VirtualQQmlFileSelector*>(self)->QQmlFileSelector::metaObject();
}
...
void* QQmlFileSelector_virtualbase_metacast(void* self, const char* param1) {
	return static_cast<VirtualQQmlFileSelector*>(self)->QQmlFileSelector::qt_metacast(param1);
}
...
int QQmlFileSelector_virtualbase_metacall(void* self, int param1, int param2, void** param3) {
	return static_cast<VirtualQQmlFileSelector*>(self)->QQmlFileSelector::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
}
...
bool QQmlFileSelector_virtualbase_event(void* self, QEvent* event) {
	return static_cast<VirtualQQmlFileSelector*>(self)->QQmlFileSelector::event(event);
}
...
bool QQmlFileSelector_virtualbase_eventFilter(void* self, QObject* watched, QEvent* event) {
	return static_cast<VirtualQQmlFileSelector*>(self)->QQmlFileSelector::eventFilter(watched, event);
}
...
void QQmlFileSelector_virtualbase_timerEvent(void* self, QTimerEvent* event) {
	static_cast<VirtualQQmlFileSelector*>(self)->QQmlFileSelector::timerEvent(event);
}
...
void QQmlFileSelector_virtualbase_childEvent(void* self, QChildEvent* event) {
	static_cast<VirtualQQmlFileSelector*>(self)->QQmlFileSelector::childEvent(event);
}
...
void QQmlFileSelector_virtualbase_customEvent(void* self, QEvent* event) {
	static_cast<VirtualQQmlFileSelector*>(self)->QQmlFileSelector::customEvent(event);
}
...
void QQmlFileSelector_virtualbase_connectNotify(void* self, QMetaMethod* signal) {
	static_cast<VirtualQQmlFileSelector*>(self)->QQmlFileSelector::connectNotify(*signal);
}
...
void QQmlFileSelector_virtualbase_disconnectNotify(void* self, QMetaMethod* signal) {
	static_cast<VirtualQQmlFileSelector*>(self)->QQmlFileSelector::disconnectNotify(*signal);
}
