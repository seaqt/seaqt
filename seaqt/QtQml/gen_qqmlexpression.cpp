...
struct seaqt_string QQmlExpression_trUtf8_s(const char* s) {
...
void QQmlExpression_connect_valueChanged(QQmlExpression* self, intptr_t slot, void (*callback)(intptr_t), void (*release)(intptr_t)) {
	QQmlExpression::connect(self, static_cast<void (QQmlExpression::*)()>(&QQmlExpression::valueChanged), self, [callback, release = seaqt::release_callback{slot,release}]() {
...
struct seaqt_string QQmlExpression_trUtf8_s_c(const char* s, const char* c) {
...
struct seaqt_string QQmlExpression_trUtf8_s_c_n(const char* s, const char* c, int n) {
