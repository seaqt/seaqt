...
public:
	...
	VirtualQQmlApplicationEngine(const QQmlApplicationEngine_VTable* vtbl, QAnyStringView uri, QAnyStringView typeName): QQmlApplicationEngine(uri, typeName), vtbl(vtbl) {}
	...
	VirtualQQmlApplicationEngine(const QQmlApplicationEngine_VTable* vtbl, QAnyStringView uri, QAnyStringView typeName, QObject* parent): QQmlApplicationEngine(uri, typeName, parent), vtbl(vtbl) {}
...
VirtualQQmlApplicationEngine* QQmlApplicationEngine_new_uri_typeName(const QQmlApplicationEngine_VTable* vtbl, size_t vdata, struct seaqt_string uri, struct seaqt_string typeName) {
	...
	void* _mem_ = ::operator new(seaqt_aligned_sizeof<VirtualQQmlApplicationEngine>() + vdata, std::nothrow);
	return _mem_ ? new (_mem_)VirtualQQmlApplicationEngine(vtbl, uri_QString, typeName_QString) : nullptr;
}
...
VirtualQQmlApplicationEngine* QQmlApplicationEngine_new_uri_typeName_parent(const QQmlApplicationEngine_VTable* vtbl, size_t vdata, struct seaqt_string uri, struct seaqt_string typeName, QObject* parent) {
	QAnyStringView uri_QString = QAnyStringView(uri.data, uri.len);
	QAnyStringView typeName_QString = QAnyStringView(typeName.data, typeName.len);
	void* _mem_ = ::operator new(seaqt_aligned_sizeof<VirtualQQmlApplicationEngine>() + vdata, std::nothrow);
	return _mem_ ? new (_mem_)VirtualQQmlApplicationEngine(vtbl, uri_QString, typeName_QString, parent) : nullptr;
}
...
void QQmlApplicationEngine_loadFromModule(QQmlApplicationEngine* self, struct seaqt_string uri, struct seaqt_string typeName) {
	QAnyStringView uri_QString = QAnyStringView(uri.data, uri.len);
	QAnyStringView typeName_QString = QAnyStringView(typeName.data, typeName.len);
...
void QQmlApplicationEngine_connect_objectCreationFailed(QQmlApplicationEngine* self, intptr_t slot, void (*callback)(intptr_t, QUrl*), void (*release)(intptr_t)) {
	QQmlApplicationEngine::connect(self, static_cast<void (QQmlApplicationEngine::*)(const QUrl&)>(&QQmlApplicationEngine::objectCreationFailed), self, [callback, release = seaqt::release_callback{slot,release}](const QUrl& url) {
			const QUrl& url_ret = url;
			// Cast returned reference into pointer
