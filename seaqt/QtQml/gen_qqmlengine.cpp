...
void QQmlEngine_connect_offlineStoragePathChanged(QQmlEngine* self, intptr_t slot, void (*callback)(intptr_t), void (*release)(intptr_t)) {
	QQmlEngine::connect(self, static_cast<void (QQmlEngine::*)()>(&QQmlEngine::offlineStoragePathChanged), self, [callback, release = seaqt::release_callback{slot,release}]() {
