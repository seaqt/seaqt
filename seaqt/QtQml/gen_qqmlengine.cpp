...
void miqt_exec_callback_QQmlEngine_warnings(intptr_t, struct seaqt_array /* of QQmlError* */ );
...
public:
	...
	virtual ~VirtualQQmlEngine() override = default;
...
QQmlEngine* QQmlEngine_new() {
	return new (std::nothrow) VirtualQQmlEngine();
}

QQmlEngine* QQmlEngine_new2(QObject* p) {
	return new (std::nothrow) VirtualQQmlEngine(p);
}
...
bool QQmlEngine_addNamedBundle(QQmlEngine* self, struct seaqt_string param1, struct seaqt_string param2) {
...
struct seaqt_array /* of QQmlAbstractUrlInterceptor* */  QQmlEngine_urlInterceptors(const QQmlEngine* self) {
...
bool QQmlEngine_override_virtual_metaObject(void* self, intptr_t slot) {
	VirtualQQmlEngine* self_cast = dynamic_cast<VirtualQQmlEngine*>( (QQmlEngine*)(self) );
...
QMetaObject* QQmlEngine_virtualbase_metaObject(const void* self) {
	return (QMetaObject*) static_cast<const VirtualQQmlEngine*>(self)->QQmlEngine::metaObject();
}
...
void* QQmlEngine_virtualbase_metacast(void* self, const char* param1) {
	return static_cast<VirtualQQmlEngine*>(self)->QQmlEngine::qt_metacast(param1);
}
...
int QQmlEngine_virtualbase_metacall(void* self, int param1, int param2, void** param3) {
	return static_cast<VirtualQQmlEngine*>(self)->QQmlEngine::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
}
...
bool QQmlEngine_virtualbase_event(void* self, QEvent* param1) {
	return static_cast<VirtualQQmlEngine*>(self)->QQmlEngine::event(param1);
}
...
bool QQmlEngine_virtualbase_eventFilter(void* self, QObject* watched, QEvent* event) {
	return static_cast<VirtualQQmlEngine*>(self)->QQmlEngine::eventFilter(watched, event);
}
...
void QQmlEngine_virtualbase_timerEvent(void* self, QTimerEvent* event) {
	static_cast<VirtualQQmlEngine*>(self)->QQmlEngine::timerEvent(event);
}
...
void QQmlEngine_virtualbase_childEvent(void* self, QChildEvent* event) {
	static_cast<VirtualQQmlEngine*>(self)->QQmlEngine::childEvent(event);
}
...
void QQmlEngine_virtualbase_customEvent(void* self, QEvent* event) {
	static_cast<VirtualQQmlEngine*>(self)->QQmlEngine::customEvent(event);
}
...
void QQmlEngine_virtualbase_connectNotify(void* self, QMetaMethod* signal) {
	static_cast<VirtualQQmlEngine*>(self)->QQmlEngine::connectNotify(*signal);
}
...
void QQmlEngine_virtualbase_disconnectNotify(void* self, QMetaMethod* signal) {
	static_cast<VirtualQQmlEngine*>(self)->QQmlEngine::disconnectNotify(*signal);
}
